...
extends Class411 {
    ...
    Class248 field2321;
    Class248 field2322;
    private static Class447 INSTANCE;
    ...
    private static class_746 method10174(class_310 class_3102) {
        return Class447.method10329(class_3102);
    }
        ...
        block27: {
            block28: {
                block29: {
                    ...
                    if (a.method_11818() != Class447.field290.field_1724.method_5628()) {
                        return (boolean)((int)Class447.field2329[1]);
                    }
...
lbl14:
                    ...
                    switch (v0) {
                        ...
                        case 65482: {
                            if (!Class447.field290.field_1724.method_24828()) ** GOTO lbl21
                            v1 = 51090;
                            ** GOTO lbl25
lbl21:
                            // 1 sources
...
lbl25:
                                ...
                                switch (v1) {
                                    ...
                                    {
                                        return (boolean)(!((Boolean)Class447.method10310(this).method507()).booleanValue() ? (int)Class447.field2329[3] : (int)Class447.field2329[1]);
                                    }
                                }
                                break;
                            }
            ...
            if (((Boolean)Class447.method10223(Class447.method10191(this))).booleanValue()) {
                if (!Class447.method10252()) {
                    if (!((Boolean)Class447.method10281(this).method507()).booleanValue() || !this.method10336()) {
                        return (boolean)((int)Class447.field2329[1]);
                    }
                }
                if (((Boolean)this.field2328.method507()).booleanValue() && !Class447.method10265(Class447.field290).method_24828()) {
                    return (boolean)((int)Class447.field2329[1]);
                }
            }
            switch (((Class524)this.field2316.method507()).ordinal()) {
                case 0: {
                    if (((Float)Class447.method10248(this.field2334)).floatValue() != 0.0f) ** GOTO lbl57
...
lbl47:
                    ...
                    if (((Boolean)this.field2321.method507()).booleanValue()) {
                        ((bc)a).setVelocityX((int)Class447.field2329[1]);
                        ((bc)a).setVelocityY((int)Class447.field2329[1]);
                        ((bc)a).setVelocityZ((int)Class447.field2329[1]);
                        return (boolean)((int)Class447.field2329[1]);
                    }
                    return (boolean)((int)Class447.field2329[3]);
lbl57:
                    // 2 sources
                ...
                case 1: {
                    if (Class447.method10278(Class5723.field11056, ((Integer)this.field2331.method507()).intValue())) ** GOTO lbl75
...
lbl75:
                    ...
                    if (!(Class447.method10252() || Class447.method10346(this) != null || ((Boolean)this.field2318.method507()).booleanValue() && Class447.method10322())) {
                        return (boolean)((int)Class447.field2329[1]);
                    }
                    if (!this.field2327) {
                        this.field2310 = (int)Class447.field2329[3];
                    }
                    if (((Boolean)Class447.method10268(this.field2321)).booleanValue()) {
                        ((bc)a).setVelocityX((int)Class447.field2329[1]);
                        ((bc)a).setVelocityY((int)Class447.field2329[1]);
                        ((bc)a).setVelocityZ((int)Class447.field2329[1]);
                        break;
    ...
    private Boolean method1278() {
        if (Class447.method10289(this).method507() == Class524.field2596) {
    ...
    private boolean method10177(class_2338 a2) {
        class_238 b2 = Class447.field290.field_1724.method_5829();
        ...
        return Class447.field290.field_1724.method_37908().method_39454((class_1297)Class447.field290.field_1724, c2);
    }
    ...
    static {
        ___.___(26, Class447.class);
        ____.___26_270(Class447.class);
    }
    ...
    private static class_746 method10181(class_310 class_3102) {
        return Class447.method10194(class_3102);
    }

    private void method10182(double i2, double j2) {
        class_2338 k2 = class_2338.method_49637((double)i2, (double)Class447.field290.field_1724.method_23318(), (double)j2);
        if (this.method10177(k2)) {
            ...
            class_2350Array[(int)Class447.field2329[1]] = class_2350.field_11039;
            class_2350Array[(int)Class447.field2329[3]] = class_2350.field_11034;
            class_2350Array[(int)Class447.field2329[7]] = class_2350.field_11043;
            class_2350Array[(int)Class447.field2329[11]] = class_2350.field_11035;
    ...
    public static void method10186(Class447 class447, boolean bl2) {
    ...
    public List method10187(class_1657 d2, float e2) {
        ...
        do {
            ...
            if (!(e2 > 0.0f) || !(Class447.field290.field_1724.method_33571().method_1025(c2.method_46558()) > (double)(e2 * e2))) continue;
    ...
    private static void method10189(class_2664 a2) {
        ((bm)Class447.method10317(field290)).hookPlaySound(a2.method_11475(), a2.method_11477(), a2.method_11478(), (class_3414)class_3417.field_15152.comp_349(), class_3419.field_15245, 4.0f, (1.0f + (field289.nextFloat() - field289.nextFloat()) * Class1422.field5460) * 0.7f, (boolean)field2329[1], field289.nextLong());
    }
    ...
    public static Class248 method10191(Class447 class447) {
    ...
    private class_2338 method10193() {
        if (!((Boolean)Class447.method10323(this).method507()).booleanValue()) {
            return null;
        }
        class_238 e2 = Class447.field290.field_1724.method_5829().method_1014(0.001);
        class_2338.class_2339 f2 = new class_2338.class_2339();
        double[] dArray = field2333;
        int n2 = dArray.length;
        for (int i2 = (int)field2329[1]; i2 < n2; ++i2) {
            double d2 = dArray[i2];
            double[] dArray2 = Class447.method10337();
            int n3 = dArray2.length;
            for (int i3 = (int)field2329[1]; i3 < n3; ++i3) {
                double c2 = dArray2[i3];
                f2.method_10102(Class447.field290.field_1724.method_23317() + d2, Class447.field290.field_1724.method_23318(), Class447.field290.field_1724.method_23321() + c2);
    ...
    public static Class248 method10198(Class447 class447) {
        return class447.field2322;
    }

    private static int method10199(int n2, int n3, Class300 class300, Class767 class767) {
    ...
    public void method10203(Class50 a2) {
        if (((Boolean)this.field2308.method507()).booleanValue() && a2.method102().equals((Object)Class447.field290.field_1724)) {
            a2.method10();
        }
    }
    ...
    private Boolean method10208() {
        if (this.field2316.method507() == Class447.method10272()) {
            int n2 = (int)field2329[3];
    ...
    public void method10213(Class63 a2) {
        if (a2.method128() == Class543.field2691) {
            ...
            Class447.method10316(this, Class447.field290.field_1724.method_23317() - (double)Class447.field290.field_1724.method_17681() * 0.35, Class447.field290.field_1724.method_23321() + (double)Class447.field290.field_1724.method_17681() * 0.35);
            Class447.method10243(this, Class447.field290.field_1724.method_23317() - (double)Class447.field290.field_1724.method_17681() * 0.35, Class447.field290.field_1724.method_23321() - (double)Class447.field290.field_1724.method_17681() * Class5951.field11826);
            this.method10182(Class447.field290.field_1724.method_23317() + (double)Class447.field290.field_1724.method_17681() * 0.35, Class447.method10338(field290).method_23321() - (double)Class447.method10204(field290).method_17681() * 0.35);
            this.method10182(Class447.method10247(field290).method_23317() + (double)Class447.method10311(field290).method_17681() * 0.35, Class447.field290.field_1724.method_23321() + (double)Class447.field290.field_1724.method_17681() * 0.35);
        }
    }
    ...
    private static Class248 method10215(Class447 class447) {
        return Class447.method10279(class447);
    }
    ...
    public void method10230(Class210 b2) {
        block14: {
            block15: {
                block13: {
                    int n2;
                    int n3 = (Boolean)Class447.method10198(this).method507() != false ? 47330 : 47331;
                    block8: while (true) {
                        switch (n3) {
                            case 47331: {
                                n3 = 47329;
                            ...
                            case 47330: {
                                if (!((Boolean)this.field2311.method507()).booleanValue() || !Class447.method10252()) break block8;
                                Class447.method10220(Class5723.field11049, new Class1226((int)field2329[9], Class447.method10286(Class447.method10245(field290)), 89.0f));
                                break block8;
                            }
                        }
                        break;
                    ...
                    if (this.field2316.method507() == Class524.field2594) {
                        int n4 = 55623;
                        Class447.method10241(0.514358f, 0.63647825f);
                        return;
                    }
                    int n5 = 55624;
                    boolean bl2 = true;
                ...
                block10: while (true) {
                    switch (n6) {
                        ...
                        case 5211: {
                            Class447.method10339().method21341((class_2596)new class_2828.class_2830(Class447.field290.field_1724.method_23317(), Class447.field290.field_1724.method_23318(), Class447.field290.field_1724.method_23321(), Class447.method10174((class_310)Class447.field290).field_3941, Class447.field290.field_1724.field_3925, Class447.field290.field_1724.method_24828()));
                            class_2338 a2 = this.method10193();
                            if (a2 == null) break block10;
                            field290.method_1562().method_52787((class_2596)new class_2846(class_2846.class_2847.field_12973, a2, Class447.field290.field_1724.method_5735().method_10153()));
                            break block10;
                        }
                    }
                    break;
            ...
            Class447.method10186(this, (boolean)field2329[1]);
        }
    }

    public static Class447 method10231() {
        return INSTANCE;
    }

    private static void method10232(long l2) {
        Class447.method10288(l2);
    }
    ...
    public void method10235(Class133 k2) {
        class_2596 d2;
        if (Class447.field290.field_1724 == null) return;
        if (Class447.field290.field_1687 == null) {
            return;
        }
        ...
        if (class_25962 instanceof class_2664) {
            ...
            field290.method_40000(() -> Class447.method10189(b2));
            k2.method10();
            return;
        }
        class_25962 = k2.method251();
        ...
        block4: while (true) {
            switch (n2) {
                ...
                case 34100: {
                    ...
                    d2 = e2.method_11469((class_1937)Class447.field290.field_1687);
                    if (!(d2 instanceof class_1536)) return;
                    class_1536 c2 = (class_1536)d2;
                    if (c2.method_26957() != Class447.field290.field_1724) {
                        return;
                    }
                    k2.method10();
                    return;
        ...
        for (class_2596 h2 : j2.method_48324()) {
            ...
            if (h2 instanceof class_2743) {
                ...
                field290.method_40000(() -> Class447.method10306(g2));
                continue;
            }
            i2.add(h2);
        }
    ...
    private Boolean method10240() {
        return (Boolean)Class447.method10251(this).method507();
    }
    ...
    private static void method10243(Class447 class447, double d2, double d3) {
    ...
    public static Class248 method10251(Class447 class447) {
        return class447.field2322;
    }

    public static boolean method10252() {
        return Class447.method10292((class_1297)Class447.field290.field_1724, Class447.field290.field_1724.method_5829());
    }

    public static Class248 method10253(Class447 class447) {
    ...
    private Boolean method10255() {
        int n2;
        int n3 = Class447.method10340(this.field2316) == Class524.field2594 ? 35713 : 35714;
        block4: while (true) {
            switch (n3) {
                case 35714: {
                    n3 = 35712;
    ...
    private static List method10259(Class447 class447, class_1657 class_16572, float f2) {
        return class447.method10187(class_16572, f2);
    }

    private static class_746 method10260(class_310 class_3102) {
        return Class447.method10206(class_3102);
    }
    ...
    public void method1279() {
        if (this.field2310) {
            if (Class447.method10237(Class447.method10349(this)) == Class524.field2594) {
                Class447.method10250(Class5723.field11048, (class_2596)new class_2828.class_2830(Class447.field290.field_1724.method_23317(), Class447.method10181(field290).method_23318(), Class447.field290.field_1724.method_23321(), Class447.method10260((class_310)Class447.field290).field_3941, Class447.field290.field_1724.field_3925, Class447.method10273(field290).method_24828()));
                class_2338 a2 = this.method10193();
                if (a2 != null) {
                    field290.method_1562().method_52787((class_2596)new class_2846(class_2846.class_2847.field_12973, a2, Class447.field290.field_1724.method_5735().method_10153()));
                }
    ...
    private static int method10276(int n2, int n3, Class4113 class4113, Class453 class453) {
    ...
    public static Class248 method10279(Class447 class447) {
    ...
    public static Class248 method10281(Class447 class447) {
    ...
    private boolean method10284(class_2338 a, class_238 b) {
        block4: {
            block2: {
                block1: {
                    block3: {
                        if (Class447.field290.field_1687.method_22347(a) || !new class_238(a).method_994(b) || !Class447.field290.field_1687.method_8320(a).method_26234((class_1922)Class447.field290.field_1687, a)) break block2;
                        if (Class447.method10195(a)) break block3;
                        v0 = 24737;
                        ** GOTO lbl10
                    }
                    v0 = 24738;
...
lbl10:
                ...
                v1 = (int)Class447.field2329[3];
                break block4;
            }
            v1 = (int)Class447.field2329[1];
        }
        return (boolean)v1;
    }
    ...
    private static void method10288(long l2) {
        Class447.field2329[9] = l2 ^ 0xFD85F29AF882487BL;
        Class447.field2329[3] = l2 ^ 0xFD85F29AF8824B9DL;
        Class447.field2329[0] = l2 ^ 0xFD85F29AF8824BA0L;
        Class447.field2329[8] = l2 ^ 0xFD85F29AF8824B83L;
        Class447.field2329[4] = l2 ^ 0xFD85F29AF8824B54L;
        Class447.field2329[7] = l2 ^ 0xFD85F29AF8824B9EL;
        Class447.field2329[5] = l2 ^ 0xFD85F29AF8824A68L;
        Class447.field2329[2] = l2 ^ 0xFD85F29AF8824BAEL;
        Class447.field2329[1] = l2 ^ 0xFD85F29AF8824B9CL;
        Class447.field2329[10] = l2 ^ 0x27A0D65077DB463L;
        Class447.field2329[11] = l2 ^ 0xFD85F29AF8824B9FL;
        Class447.field2329[12] = l2 ^ 0xFD85F29AF8824B98L;
        Class447.field2329[6] = l2 ^ 0xFD85F29AF8824BF8L;
    }

    public static Class248 method10289(Class447 class447) {
        return class447.field2316;
    }
    ...
    public static boolean method10292(class_1297 a2, class_238 b2) {
        class_5329 c2 = new class_5329((class_1941)Class447.field290.field_1687, a2, b2, (boolean)field2329[1], Class447::method10209);
        do {
    ...
    public List method10294(class_1657 a2) {
        return Class447.method10259(this, a2, 0.0f);
    }

    private static boolean method10295(class_2338 a2) {
        return Class447.field290.field_1687.method_8320(Class447.field290.field_1724.method_20448() ? a2 : a2.method_10084()).method_45474();
    }
    ...
    public void method10305(Class59 b2) {
        if (((Boolean)this.field2314.method507()).booleanValue()) {
            ...
            Class447.method10309();
            Class6454.method24621(b2.method125(), new class_238(a2).method_1014(0.01), Class457.method10620().method10615((int)field2329[6]));
            Class447.method10218();
        }
    }

    private static void method10306(class_2664 a2) {
        ((bm)Class447.field290.field_1687).hookPlaySound(a2.method_11475(), a2.method_11477(), a2.method_11478(), (class_3414)class_3417.field_15152.comp_349(), class_3419.field_15245, 4.0f, (1.0f + (field289.nextFloat() - field289.nextFloat()) * Class3390.field7370) * 0.7f, (boolean)field2329[1], field289.nextLong());
    }
    ...
    public static Class248 method10310(Class447 class447) {
    ...
    private Boolean method10312() {
        return (Class447.method10319(this).method507() == Class447.method10291() ? (int)field2329[3] : (int)field2329[1]) != 0;
    }
    ...
    private static void method10316(Class447 class447, double d2, double d3) {
        class447.method10182(d2, d3);
    }
    ...
    private Boolean method10318() {
        return (((Float)this.field2334.method507()).floatValue() == 0.0f && ((Float)Class447.method10212(this.field2309)).floatValue() == 0.0f || this.field2316.method507() == Class524.field2594 ? (int)field2329[3] : (int)field2329[1]) != 0;
    }

    public static Class248 method10319(Class447 class447) {
        return class447.field2316;
    }
    ...
    public static boolean method10322() {
        return (Class447.field290.field_1724.method_18798().method_10216() == 0.0 && Class447.field290.field_1724.method_24828() && Class447.field290.field_1724.method_18798().method_10215() == 0.0 ? (int)field2329[3] : (int)field2329[1]) != 0;
    }

    public static Class248 method10323(Class447 class447) {
    ...
    private static int method10330(int n2, int n3, Class3466 class3466, Class426 class426) {
    ...
    private boolean method10336() {
        class_2338 a2 = Class447.field290.field_1724.method_24515().method_10086(Class447.field290.field_1724.method_20448() ? (int)field2329[3] : (int)field2329[7]);
        if (Class447.field290.field_1687.method_8320(a2).method_45474()) {
            return (int)field2329[1] != 0;
        }
        return this.method10294((class_1657)Class447.field290.field_1724).stream().noneMatch(Class447::method10295);
    }
    ...
    public String method1248() {
        ...
        objectArray[(int)Class447.field2329[1]] = field395.format(this.field2334.method507());
        objectArray[(int)Class447.field2329[3]] = field395.format(Class447.method10215(this).method507());
    ...
    public void method10344(Class195 a2) {
        if (((Boolean)Class447.method10301(this.field2325)).booleanValue()) {
            a2.method10();
        }
    }
    ...
    private static class_2338 method10346(Class447 class447) {
    ...
    public static Class248 method10349(Class447 class447) {
        return class447.field2316;
    }
