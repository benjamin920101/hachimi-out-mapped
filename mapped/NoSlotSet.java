...
extends Class278 {
    ...
    public void method2759(Class133 b2) {
        int n2;
        int n3 = n2 = NoSlotSet.method2765(this).method12595((int)field763[0]) ? 40933 : 40934;
        if (n2 != 40933) {
            if (n2 != 40934) return;
            NoSlotSet.method2757(0.49051142f, Class3395.field7383, 0.7881761f, 0.9422802f, Class3348.field7242, 0.90815943f);
            return;
        }
        int n4 = NoSlotSet.field290.field_1724 == null ? 48692 : 48693;
        block4: while (true) {
            switch (n4) {
                case 48693: {
                    n4 = 48691;
        ...
        NoSlotSet.field290.field_1724.field_3944.method_52787((class_2596)new class_2868(a2.method_11803()));
        NoSlotSet.method2761(NoSlotSet.method2758());
        NoSlotSet.method2766(NoSlotSet.method2767(field290)).method_52787((class_2596)new class_2868(NoSlotSet.field290.field_1724.method_31548().field_7545));
    }

    static {
        NoSlotSet.method2760(-1990105283534618005L);
    }
    ...
    private static void method2760(long l2) {
        NoSlotSet.field763[0] = l2 ^ 0xE461B9C9E54A839FL;
    }
    ...
    public static Class926 method2765(NoSlotSet class323) {
