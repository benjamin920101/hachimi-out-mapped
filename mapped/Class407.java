...
extends Class278 {
    ...
    public void method6395(Class184 a2) {
        if (Class407.method6397(field290) == null) {
            return;
        }
        if (((Boolean)this.field1502.method507()).booleanValue()) {
            if (a2.method360().method_5685().contains(Class407.method6402(field290))) {
                a2.method10();
            }
        }
    }
    ...
    public void method6396(Class119 a2) {
        a2.method10();
        Class407.method6401(a2, ((Float)Class407.method6404(this.field1501)).floatValue());
    }
    ...
    static {
        Class407.method6400(8808146478057988196L);
    }
    ...
    private static void method6400(long l2) {
        Class407.field1503[0] = l2 ^ 0x7A3CD28DE2412064L;
    }
    ...
    public void method6403(Class63 b2) {
        class_1297 c2 = Class407.method6405(field290).method_5854();
        if (c2 == null) {
            return;
        }
        c2.method_36456(Class407.field290.field_1724.method_36454());
        if (c2 instanceof class_1501) {
            class_1501 a2 = (class_1501)c2;
            a2.field_6241 = Class407.field290.field_1724.method_36454();
        }
    }
