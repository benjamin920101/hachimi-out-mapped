...
extends Class278 {
    ...
    Class248 field1514 = this.method450(new Class259("ZoomKey", "The zoom key bind", new Class246(this.method472() + "-zoomkey", (int)field1515[4], Zoom::method6454)));
    ...
    public void method6443(Class63 a2) {
        ...
        block8: while (true) {
            switch (n2) {
                ...
                case 16678: {
                    if (Zoom.field290.field_1755 != null) return;
                    ...
                    block9: while (true) {
                        switch (n3) {
                            ...
                            case 23398: {
                                if (this.field1511) {
                                    this.field1510 = (Integer)Zoom.field290.field_1690.method_41808().method_41753();
                                    this.field1511 = (int)field1515[7];
                                }
                                Zoom.field290.field_1690.field_1914 = (Boolean)Zoom.method6458(this).method507();
                                Zoom.method6448(Zoom.field290.field_1690, (boolean)field1515[2]);
                                Zoom.field290.field_1690.method_41808().method_41748((Object)((Integer)this.field1512.method507()));
                    ...
                    Zoom.field290.field_1690.field_1914 = (int)field1515[7];
                    Zoom.method6450(Zoom.method6449(field290), (boolean)field1515[7]);
                    Zoom.field290.field_1690.method_41808().method_41748((Object)Zoom.method6460(this));
    ...
    public void method6444(Class36 a2) {
        if (a2.method70() != (int)field1515[6]) {
            if (a2.method68() == Zoom.method6451((Class246)this.field1514.method507())) {
    ...
    private static void method6448(class_315 class_3152, boolean bl2) {
        Zoom.method6455(class_3152, bl2);
    }
    ...
    static {
        ___.___(37, Zoom.class);
        ____.___37_110(Zoom.class);
    }
    ...
    private static void method6456(long l2) {
        Zoom.field1515[2] = l2 ^ 0x11F70788EED350E0L;
        Zoom.field1515[0] = l2 ^ 0x11F70788EED350D3L;
        Zoom.field1515[3] = l2 ^ 0x11F70788EED35085L;
        Zoom.field1515[1] = l2 ^ 0x11F70788EED350EBL;
        Zoom.field1515[6] = l2 ^ 0x11F70788EED350E3L;
        Zoom.field1515[4] = l2 ^ 0x11F70788EED350A2L;
        Zoom.field1515[5] = l2 ^ 0x11F70788EED350FFL;
        Zoom.field1515[7] = l2 ^ 0x11F70788EED350E1L;
    }
    ...
    public static Class248 method6458(Zoom class409) {
    ...
    public static int method6460(Zoom class409) {
