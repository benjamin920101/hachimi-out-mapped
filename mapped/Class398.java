...
extends Class278 {
    ...
    public static boolean[] method5844(Class398 class398) {
    ...
    public static Class248 method5849(Class398 class398) {
    ...
    private static boolean[] method5852(Class398 class398) {
        return Class398.method5859(class398);
    }
    ...
    static {
        Class398.method5847(-8021509519660511870L);
    }

    public static int method5854(Class398 class398) {
    ...
    protected void method1274() {
        ...
        blArray[(int)Class398.field1390[4]] = (int)field1390[4];
        blArray[(int)Class398.field1390[1]] = (int)field1390[4];
        blArray[(int)Class398.field1390[0]] = (int)field1390[4];
        blArray[(int)Class398.field1390[2]] = (int)field1390[4];
    ...
    public void method5855(Class233 c2) {
        block1: {
            ...
            int n2;
            int n3;
            if (!((Boolean)Class398.method5849(this).method507()).booleanValue() || (n3 = (int)field1390[4]) >= (n2 = (blArray = Class398.method5867(this)).length)) break block1;
            ...
            Class398.method5860(c2.method6(), a2, (float)field290.method_22683().method_4486() / 2.0f - (float)Class6454.method24719(a2) / 2.0f, (float)field290.method_22683().method_4502() / 2.0f + (float)Class6454.method24637() - (float)((Integer)Class398.method5845(this.field1389)).intValue(), ((Color)this.field1388.method507()).getRGB());
        }
    }
    ...
    public void method5857(Class210 e2) {
        ...
        Iterator iterator = Class398.field290.field_1724.method_31548().field_7548.iterator();
        while (true) {
            block9: {
                block10: {
                    block8: {
                ...
                Class398.method5844((Class398)this)[g2] = (int)field1390[4];
                continue;
            }
            if (f2 == 0) {
            ...
            if (c2 < Class398.method5854(this)) {
                f2 = (int)field1390[1];
                this.field1391 = c2;
            }
            if (!Class398.method5852(this)[g2]) break;
        }
    ...
    public static boolean[] method5859(Class398 class398) {
        return class398.field1392;
    }
    ...
    private static void method5862(long l2) {
        Class398.field1390[1] = l2 ^ 0x90ADDF9776388D83L;
        Class398.field1390[6] = l2 ^ 0x90ADDF9776388D4AL;
        Class398.field1390[3] = l2 ^ 0x90ADDF9776388D96L;
        Class398.field1390[0] = l2 ^ 0x90ADDF9776388D80L;
        Class398.field1390[7] = l2 ^ 0x90ADDF9776388DE6L;
        Class398.field1390[2] = l2 ^ 0x90ADDF9776388D81L;
        Class398.field1390[9] = l2 ^ 0x6F52206889C7727DL;
        Class398.field1390[4] = l2 ^ 0x90ADDF9776388D82L;
        Class398.field1390[5] = l2 ^ 0x90ADDF9776388D86L;
        Class398.field1390[8] = l2 ^ 0x6F52206889C772BAL;
    }
    ...
    private static int method5865(int n2, int n3, Class909 class909, Class379 class379) {
    ...
    public static boolean[] method5867(Class398 class398) {
        return class398.field1392;
    }
