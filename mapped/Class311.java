...
extends Class278 {
    ...
    public static Class248 method2516(Class311 class311) {
    ...
    private boolean method2518(class_742 a2) {
        int n2;
        int n3 = a2 != Class311.field290.field_1724 ? 58510 : 58511;
        block4: while (true) {
            switch (n3) {
                case 58511: {
                    n3 = 58509;
                ...
                case 58510: {
                    if (Class311.method2530().method21243(a2.method_5477()) || a2 instanceof Class1468) break block4;
                    n2 = (int)field696[0];
                    return n2 != 0;
                }
            }
    ...
    private static Class248 method2519(Class311 class311) {
        return Class311.method2539(class311);
    }
    ...
    private static void method2523(long l2) {
        Class311.field696[2] = l2 ^ 0x2781C885FB16091BL;
        Class311.field696[1] = l2 ^ 0x2781C885FB16091EL;
        Class311.field696[3] = l2 ^ 0x2781C885FB16091CL;
        Class311.field696[0] = l2 ^ 0x2781C885FB16091FL;
    }
    ...
    private static int method2527(int n2, int n3, Class6417 class6417, Class436 class436) {
    ...
    public void method2528(Class63 b2) {
        int e2;
        if (b2.method128() != Class311.method2531()) {
            return;
        }
        if (((Boolean)this.field706.method507()).booleanValue() && !this.field704.method12595(Float.valueOf(((Float)Class311.method2516(this).method507()).floatValue() * 1000.0f))) {
            return;
        }
        if (((Boolean)this.field699.method507()).booleanValue()) {
            class_742 a2 = Class311.field290.field_1687.method_18456().stream().filter(this::method2526).findFirst().orElse(null);
            int n2 = a2 != null ? 5204 : 5205;
            while (true) {
                int n3;
                if ((n3 = n2) == 5204) {
                    Object[] objectArray = new Object[(int)field696[0]];
                    objectArray[(int)Class311.field696[1]] = a2.method_5477().getString();
        ...
        float c2 = Class311.method2520(field290).method_6032() + Class311.field290.field_1724.method_6067();
        ...
        if (c2 <= ((Float)this.field702.method507()).floatValue()) {
            if (!((Boolean)this.field703.method507()).booleanValue()) {
                Object[] objectArray = new Object[(int)field696[0]];
                objectArray[(int)Class311.field696[1]] = (int)c2;
                Class311.method2529(this, "[AutoLog] logged out with %d hearts remaining.", objectArray);
                return;
            }
            if (e2 != 0) {
                Object[] objectArray = new Object[(int)field696[3]];
                objectArray[(int)Class311.field696[1]] = d2;
                objectArray[(int)Class311.field696[0]] = (int)c2;
    ...
    private static void method2529(Class311 class311, String string, Object[] objectArray) {
    ...
    private void method2537(String a2, Object ... b2) {
        ...
        while (true) {
            int n4;
            if ((n4 = n3) == 29583) {
                Class311.field290.field_1687.method_8525();
                if ((Boolean)Class311.method2519(this).method507() == false) return;
                this.method1268();
                return;
            }
            if (n4 != 29584) break;
    ...
    static {
        Class311.method2523(2846776917243595038L);
    }

    public static Class248 method2539(Class311 class311) {
