...
extends Class278 {
    ...
    public void method2646(Class64 e2) {
        ...
        if (!(((Boolean)Tooltips.method2656(this.field744)).booleanValue() && (Class1256.method13556(f2) || (class_17922 = f2.method_7909()) instanceof class_1747 && (a2 = (class_1747)class_17922).method_7711() instanceof class_2480))) {
            if (!((Boolean)Tooltips.method2648(this.field743)).booleanValue()) {
                return;
            }
            ...
            Class6454.method24667(e2.field96.method_51448(), (double)e2.method133() + 8.0, (double)e2.method132() - 21.0, 128.0, Class3811.field8623, Colors.method10620().method10615((int)field741[3]));
            ...
            class_22 d2 = class_1806.method_7997((class_9209)c2, (class_1937)Tooltips.field290.field_1687);
            if (d2 != null) {
                Tooltips.field290.field_1773.method_3194().method_1773(e2.method130().method_51448(), (class_4597)e2.method130().method_51450(), c2, d2, (boolean)field741[0], (int)field741[0]);
            }
            Tooltips.method2660(e2).method_51448().method_22909();
            return;
        }
        Class1256.method13559(f2, field742);
        e2.method10();
        e2.field96.method_51448().method_22903();
        Tooltips.method2655(e2).method_51448().method_46416(0.0f, 0.0f, 600.0f);
        Class6454.method24667(Tooltips.method2658(e2).method_51448(), (double)e2.method133() + 8.0, (double)e2.method132() - 21.0, 150.0, 13.0, Colors.method10620().method10615((int)field741[3]));
        Tooltips.method2645((double)e2.method133() + 8.0, (double)e2.method132() - 21.0, (double)e2.method133() + 158.0, (double)e2.method132() - Class5427.field10106);
        Class6454.method24624(Tooltips.method2654(e2), f2.method_7964().getString(), (float)e2.method133() + Class6195.field12587, (float)e2.method132() - 18.0f, (int)field741[2]);
        Class6454.method24594();
        Class6454.method24667(Tooltips.method2651(e2).method_51448(), (double)Tooltips.method2650(e2) + 8.0, (double)e2.method132() - 8.0, 150.0, 55.0, (int)field741[5]);
        int b2 = (int)field741[1];
        while (true) {
            if (b2 >= field742.length) {
                Tooltips.method2657(e2).method_51448().method_22909();
                return;
            }
            ...
            e2.field96.method_51431(Tooltips.field290.field_1772, field742[b2], e2.method133() + b2 % (int)field741[4] * (int)field741[7] + (int)field741[4], e2.method132() + b2 / (int)field741[4] * (int)field741[7] - (int)field741[6]);
            ++b2;
        }
    }
    ...
    public boolean method2649() {
        return (Boolean)Tooltips.method2659(this.field739);
    }
    ...
    public static Tooltips method2652() {
        return INSTANCE;
    }

    private static void method2653(long l2) {
        Tooltips.field741[1] = l2 ^ 0x5EAE0CB02C679608L;
        Tooltips.field741[3] = l2 ^ 0x5EAE0CB02C6796A2L;
        Tooltips.field741[5] = l2 ^ 0x5EAE0CB05B679608L;
        Tooltips.field741[0] = l2 ^ 0x5EAE0CB02C679609L;
        Tooltips.field741[2] = l2 ^ 0xA151F34FD39869F7L;
        Tooltips.field741[8] = l2 ^ 0x5EAE0CB02C679613L;
        Tooltips.field741[6] = l2 ^ 0x5EAE0CB02C67960DL;
        Tooltips.field741[7] = l2 ^ 0x5EAE0CB02C679618L;
        Tooltips.field741[4] = l2 ^ 0x5EAE0CB02C679601L;
    }

    static {
        Tooltips.method2653(6822404436311643656L);
