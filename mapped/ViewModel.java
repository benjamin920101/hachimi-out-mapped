...
extends Class278 {
    ...
    private static class_7833 method2218() {
        return ViewModel.method2216();
    }

    @Class1
    public void method2219(Class97 a2) {
        a2.field135.method_22905(((Float)ViewModel.method2213(this.field627)).floatValue(), ((Float)this.field622.method507()).floatValue(), ((Float)this.field624.method507()).floatValue());
        a2.field135.method_22907(ViewModel.method2218().rotationDegrees(((Float)this.field621.method507()).floatValue()));
        if (a2.field134 == ViewModel.method2220()) {
            ViewModel.method2215(a2).method_46416(((Float)this.field623.method507()).floatValue(), ((Float)this.field620.method507()).floatValue(), ((Float)this.field625.method507()).floatValue());
            a2.field135.method_22907(ViewModel.method2212().rotationDegrees(((Float)this.field626.method507()).floatValue()));
            a2.field135.method_22907(class_7833.field_40718.rotationDegrees(((Float)this.field628.method507()).floatValue()));
        } else {
            a2.field135.method_46416(-((Float)ViewModel.method2214(this.field623)).floatValue(), ((Float)this.field620.method507()).floatValue(), ((Float)this.field625.method507()).floatValue());
            a2.field135.method_22907(class_7833.field_40716.rotationDegrees(-((Float)this.field626.method507()).floatValue()));
            ViewModel.method2221(a2).method_22907(class_7833.field_40718.rotationDegrees(-((Float)this.field628.method507()).floatValue()));
        }
    }
