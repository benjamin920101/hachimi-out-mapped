...
extends Class278 {
    ...
    public static Class248 method4636(Class362 class362) {
    ...
    public static Class248 method4639(Class362 class362) {
        return class362.field1166;
    }
    ...
    public void method4642(Class189 b2) {
        Class6253 a2;
        if (this.field1166.method507() != Class600.field2916 && Class362.method4645(b2) != null && (a2 = (Class6253)this.field1171.getOrDefault(b2.method367(), null)) != null) {
            b2.method10();
            if (Class362.method4636(this).method507() == Class600.field2919) {
                b2.method365(a2.method24146());
            } else {
                b2.method365(a2.method24139());
            }
            b2.method366((Class362.method4639(this).method507() == Class600.field2919 ? (int)field1168[3] : (int)field1168[0]) != 0);
        }
    }
    ...
    public void method4651(Class35 a2) {
        ...
        this.field1171.put(Class362.method4641(a2), b2);
        b2.method24140((boolean)field1168[3]);
    }

    public static Class248 method4652(Class362 class362) {
        return class362.field1170;
    }

    private static void method4653(long l2) {
        Class362.method4655(l2);
    }
            ...
            block7: {
                block6: {
                    ...
                    block5: {
                        block4: {
                            block3: {
                                if (Class362.method4652(this).method507() == Class477.field2494) break block2;
    ...
    private static void method4655(long l2) {
        Class362.field1168[2] = l2 ^ 0xEDF57414CA73FFF0L;
        Class362.field1168[1] = l2 ^ 0xEDF57414CA73FCD0L;
        Class362.field1168[3] = l2 ^ 0xEDF57414CA73FF39L;
        Class362.field1168[0] = l2 ^ 0xEDF57414CA73FF38L;
    }
    ...
    private static int method4657(int n2, int n3, Class380 class380, Class520 class520) {
    ...
    static {
        Class362.method4653(-1300005284781752520L);
    }
