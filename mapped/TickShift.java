...
extends Class278 {
    ...
    public static int method4858(TickShift class371) {
    ...
    private static void method4859(long l2) {
        TickShift.field1217[4] = l2 ^ 0x7BC19F7F4F0DAF53L;
        TickShift.field1217[2] = l2 ^ 0x7BC19F7F4F0DAF56L;
        TickShift.field1217[3] = l2 ^ 0x7BC19F7F4F0DAF7BL;
        TickShift.field1217[0] = l2 ^ 0x7BC19F7F4F0DAF52L;
        TickShift.field1217[1] = l2 ^ 0x7BC19F7F4F0DAF47L;
    }

    private static int method4860(TickShift class371) {
        return TickShift.method4863(class371);
    }

    private static void method4861(long l2) {
        TickShift.method4859(l2);
    }
    ...
    public static int method4863(TickShift class371) {
        return class371.field1218;
    }

    static {
        TickShift.method4861(8917584106306252627L);
    }
    ...
    public static CallSite SH9kdL1xOlHlb53A(MethodHandles.Lookup lookup, String string, MethodType methodType, String string2, String string3, String string4, Integer n2) {
        ...
        int n3 = n2;
        MethodType methodType2 = MethodType.fromMethodDescriptorString(TickShift.0djASNQharjBogQD(string7), TickShift.class.getClassLoader());
        try {
            if (n3 == 1) {
                return new ConstantCallSite(lookup.findVirtual(Class.forName(TickShift.0djASNQharjBogQD(string5)), TickShift.0djASNQharjBogQD(string6), methodType2).asType(methodType));
            }
            return new ConstantCallSite(lookup.findStatic(Class.forName(TickShift.0djASNQharjBogQD(string5)), TickShift.0djASNQharjBogQD(string6), methodType2).asType(methodType));
        }
