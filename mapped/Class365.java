...
extends Class278 {
    ...
    Class248 field1187 = this.method450(new Class259("ControlKey", "", new Class246(this.method472() + "-control", (int)field1189[1], Class365::method4732)));
    private static Class365 INSTANCE;
    Class248 field1188;
    private static long[] field1189;
    public class_243 field1190;
    public static boolean $skidonion$890408592;

    private static int method4696(int n2, int n3, Class418 class418, Class290 class290) {
    ...
    public class_241 method4698(float a2, float b2, float c2) {
        ...
        block4: while (true) {
            switch (n2) {
                ...
                case 46815: {
                    if (c2 == 0.0f) return new class_241((float)((double)(b2 * a2) * -Math.sin(Math.toRadians(this.field1180)) + (double)(c2 * a2) * Math.cos(Math.toRadians(Class365.method4715(this)))), (float)((double)(b2 * a2) * Math.cos(Math.toRadians(this.field1180)) - (double)(c2 * a2) * -Math.sin(Math.toRadians(this.field1180))));
                    b2 *= (float)Math.sin(0.7853981633974483);
                    c2 *= (float)Math.cos(0.7853981633974483);
                    return new class_241((float)((double)(b2 * a2) * -Math.sin(Math.toRadians(this.field1180)) + (double)(c2 * a2) * Math.cos(Math.toRadians(Class365.method4715(this)))), (float)((double)(b2 * a2) * Math.cos(Math.toRadians(this.field1180)) - (double)(c2 * a2) * -Math.sin(Math.toRadians(this.field1180))));
                }
            }
            break;
        }
    ...
    public void method4701(Class14 a2) {
        if (a2.method23() != Class365.method4743(field290)) {
            return;
        }
    ...
    public void method4703(Class63 e2) {
        ...
        if (!this.field1181 && ((Boolean)this.field1184.method507()).booleanValue()) {
            ...
            fArray[(int)Class365.field1189[0]] = this.field1180;
            fArray[(int)Class365.field1189[2]] = this.field1182;
            float[] b2 = fArray;
            class_243 c2 = Class365.method4746(this);
            class_239 d2 = Class976.method12737(Class365.field290.field_1724.method_55754(), c2, b2);
            if (d2.method_17783() == class_239.class_240.field_1332) {
                float[] a2 = Class1503.method14416(Class365.field290.field_1724.method_33571(), d2.method_17784());
                Class365.method4742(Class5723.field11049, new Class1226((int)field1189[2], a2[(int)field1189[0]], a2[(int)field1189[2]]));
            }
        }
    }
    ...
    public void method4704(Class44 a2) {
        a2.method89(this.field1181 ? this.field1185 : this.field1190.method_35590(this.field1185, (double)Class365.method4697(a2)));
    }

    private static void method4705(Class365 class365, float f2) {
        Class365.method4741(class365, f2);
    }
    ...
    public static void method4710(Class365 class365, float f2) {
        class365.field1182 = f2;
    }

    @Class1
    public void method4711(Class28 a2) {
        if (a2.method53() != Class365.field290.field_1724) {
            return;
        }
        if (!this.field1181 && this.field1188.method507() == Class365.method4725()) {
    ...
    public static void method4714(Class365 class365, boolean bl2) {
        class365.field1181 = bl2;
    }

    public static float method4715(Class365 class365) {
    ...
    protected void method1279() {
        if (Class365.method4700(field290) == null) {
            return;
        }
        Class365.method4736((class_310)Class365.field290).field_3913 = new class_743(Class365.field290.field_1690);
    }

    @Class1
    public void method4717(Class36 a2) {
        if (a2.method70() != (int)field1189[3]) {
            if (a2.method68() == Class365.method4754((Class246)this.field1187.method507())) {
                if (!((Boolean)this.field1183.method507()).booleanValue()) {
                    Class365.method4714(this, (a2.method70() == (int)field1189[2] ? (int)field1189[2] : (int)field1189[0]) != 0);
                } else if (a2.method70() == (int)field1189[2]) {
                    this.field1181 = !Class365.method4728(this) ? (int)field1189[2] : (int)field1189[0];
                }
            }
        }
    }

    public static Class365 method4718() {
        return INSTANCE;
    }

    public class_243 method4719() {
        return Class365.method4731(this);
    }

    public static void method4720(Class365 class365, boolean bl2) {
        class365.field1181 = bl2;
    }

    public static class_243 method4721(Class365 class365) {
        return class365.field1185;
    }

    public class_243 method4722() {
        return Class365.method4721(this);
    }

    public static float method4723(Class365 class365) {
        return class365.field1180;
    }
    ...
    public void method4726(Class221 a2) {
        if (a2.method412() == Class365.method4738(field290)) {
            this.method1268();
        }
    }
    ...
    public static boolean method4728(Class365 class365) {
        return class365.field1181;
    }

    public static class_243 method4729(Class365 class365) {
        return class365.field1185;
    }

    static {
        ___.___(52, Class365.class);
        ____.___52_430(Class365.class);
    }

    public static class_243 method4730(Class365 class365) {
        return class365.field1185;
    }

    private static class_243 method4731(Class365 class365) {
        return Class365.method4748(class365);
    }
    ...
    public float method4733(boolean a2, boolean b2) {
        ...
        if (a2) return Class365.method4750();
        int n2 = 34751;
        block4: while (true) {
            switch (n2) {
                case 34751: {
    ...
    private static void method4734(long l2) {
        Class365.field1189[3] = l2 ^ 0xAF3C359EAD47E297L;
        Class365.field1189[2] = l2 ^ 0xAF3C359EAD47E294L;
        Class365.field1189[0] = l2 ^ 0xAF3C359EAD47E295L;
        Class365.field1189[1] = l2 ^ 0xAF3C359EAD47E3C3L;
    }

    public float[] method4735() {
        float[] fArray = new float[(int)field1189[3]];
        fArray[(int)Class365.field1189[0]] = Class365.method4723(this);
        fArray[(int)Class365.field1189[2]] = this.field1182;
        return fArray;
    }
    ...
    private static class_757 method4739(class_310 class_3102) {
        return Class365.method4716(class_3102);
    }
    ...
    public static void method4741(Class365 class365, float f2) {
    ...
    private static class_243 method4746(Class365 class365) {
        return Class365.method4730(class365);
    }

    public static float method4747(Class365 class365) {
        return class365.field1182;
    }

    public static class_243 method4748(Class365 class365) {
    ...
    protected void method1274() {
        int n2 = Class365.method4706(field290) == null ? 24834 : 24835;
        block4: while (true) {
            switch (n2) {
                case 24835: {
                    n2 = 24833;
        ...
        Class365.method4720(this, (boolean)field1189[0]);
        this.field1185 = Class365.method4739(field290).method_19418().method_19326();
        this.field1190 = Class365.method4729(this);
        Class365.method4705(this, Class365.field290.field_1724.method_36454());
        this.field1182 = Class365.field290.field_1724.method_36455();
        Class365.field290.field_1724.field_3913 = new Class3586(this, Class365.field290.field_1690);
    }

    public void method4751(double a2, double b2) {
        float c2 = (float)b2 * 0.15f;
        float d2 = (float)a2 * Class1815.field6759;
        Class365 class365 = this;
        Class365.method4710(class365, Class365.method4747(class365) + c2);
        this.field1180 += d2;
