...
extends Class414 {
    ...
    Class248 field2034;
    Class248 field2035;
    Class248 field2036 = this.method450(new Class260("Timing", "Timing for replacing blocks", Class605.field2944, SelfTrap.method8950()));
    Class248 field2037;
    ...
    private static class_746 method8856(class_310 class_3102) {
        return SelfTrap.method8903(class_3102);
    }

    private static void method8857(SelfTrap class432) {
        class432.method8992();
    }
    ...
    private void method8861(Class133 c2) {
        if (SelfTrap.field290.field_1724 == null || SelfTrap.field290.field_1687 == null) {
            return;
        }
        class_2596 class_25962 = c2.method251();
        if (class_25962 instanceof class_5892) {
            class_5892 b2 = (class_5892)class_25962;
            class_1297 a2 = SelfTrap.method8919(field290).method_8469(b2.comp_2275());
            if (a2 == SelfTrap.field290.field_1724 && ((Boolean)this.field2018.method507()).booleanValue()) {
                this.method1273();
            }
        }
    }
    ...
    private boolean method8863(class_2338 e2, boolean f2) {
        ...
        block10: {
            int n2;
            Class3442 g2 = new Class3442(e2, (List)SelfTrap.method8953(this.field2042), (boolean)((Boolean)this.field2010.method507()), (Class607)((Object)this.field2023.method507()));
            h2 = SelfTrap.method8913(SelfTrap.method8916(), e2);
            if (((Boolean)SelfTrap.method8889(this.field2043)).booleanValue() && h2 != null && (h2.field12485.method12595((Double)this.field2016.method507() * 1000.0) || h2.field12483) || f2) {
            ...
            i2 = g2.method17369((Double)this.field2034.method507(), (Boolean)this.field2027.method507(), (Boolean)SelfTrap.method8989(this).method507(), (Double)this.field2031.method507());
            if ((Boolean)this.field2011.method507() == false) return Velocity.method10252();
            int n3 = 61874;
            boolean bl3 = true;
            do {
        ...
        int n4 = SelfTrap.method8956().method14262() ? 27584 : 27585;
        block5: while (true) {
            switch (n4) {
                case 27585: {
                    n4 = 27583;
                ...
                case 27584: {
                    int d2 = SelfTrap.field290.field_1687.method_8320(e2).method_45474() || h2 != null ? (int)field2040[4] : (int)field2040[0];
                    if (d2 == 0) return i2;
                    ...
                    Predicate<class_1297> c2 = SelfTrap::method8957;
                    Iterator iterator = SelfTrap.field290.field_1687.method_8333(null, b2, c2).iterator();
    ...
    private static void method8866(long l2) {
        SelfTrap.field2040[3] = l2 ^ 0x89B25F01118AC2D6L;
        SelfTrap.field2040[2] = l2 ^ 0x89B25F01118AC2DCL;
        SelfTrap.field2040[4] = l2 ^ 0x89B25F01118AC2D5L;
        SelfTrap.field2040[5] = l2 ^ 0x89B25F01118AC2C0L;
        SelfTrap.field2040[0] = l2 ^ 0x89B25F01118AC2D4L;
        SelfTrap.field2040[6] = l2 ^ 0x89B25F01118AC2D7L;
        SelfTrap.field2040[1] = l2 ^ 0x89B25F01118AC162L;
    }

    public static void method8867(SelfTrap class432, int n2) {
        class432.field2012 = n2;
    }

    public static Class248 method8868(SelfTrap class432) {
        return class432.field2034;
    }

    private boolean method8869() {
        if (this.field2012 > 0) {
            return SelfTrap.method8959();
        }
        if ((Integer)SelfTrap.method8896(this.field2046) > 0) {
    ...
    private void method8871(class_2338 a2, Set b2, boolean c2, boolean d2) {
        block6: {
            block5: {
                ...
                if (this.field2032.method507() == SelfTrap.method8893()) break block5;
                if (!Class5723.field11054.method22504(a2) || SelfTrap.method8954(this).method507() != Class549.field2720) break block6;
            }
            this.method8931(a2);
        }
        if (this.method8869()) {
            SelfTrap.method8906(this, a2);
        }
    }
    ...
    private Boolean method8878() {
        return (Boolean)SelfTrap.method8920(this.field2043);
    }

    public static Class248 method8879(SelfTrap class432) {
    ...
    public void method1274() {
        if (this.field2019.method507() == SelfTrap.method8884()) {
            SelfTrap.method8895();
        }
    ...
    private void method8892(class_2338 a2) {
        class_2680 b2 = SelfTrap.field290.field_1687.method_8320(a2);
        if (b2.method_26204() == class_2246.field_9987) {
            return;
        }
        class_2350 c2 = SelfTrap.method8852(a2, (Double)SelfTrap.method8860(SelfTrap.method8868(this)));
        if (c2 != null) {
            return;
        }
        List d2 = Class1745.method15597(a2, (Double)SelfTrap.method8909(this).method507(), (Integer)SelfTrap.method8908(this.field2046));
        if (this.method8943(d2)) {
            SelfTrap.method8862().add(d2);
        }
    }
    ...
    public static Class248 method8894(SelfTrap class432) {
    ...
    private static boolean method8900(class_744 class_7442) {
        return SelfTrap.method8933(class_7442);
    }
    ...
    private void method8902(Class210 a2) {
        this.method8978();
        if (((Boolean)this.field2017.method507()).booleanValue() && SelfTrap.method8856((class_310)SelfTrap.field290).field_6036 < SelfTrap.field290.field_1724.method_23318()) {
            this.method1273();
            return;
        }
        if (((Boolean)this.field2029.method507()).booleanValue() && SelfTrap.method8900(SelfTrap.method8905(SelfTrap.method8945(field290)))) {
            this.method1273();
            return;
        }
        if (this.field2009 > 0) {
        ...
        if (((Boolean)this.field2035.method507()).booleanValue() && !SelfTrap.field290.field_1724.method_24828()) {
            if (!(SelfTrap.method8942(field290).method_8320(SelfTrap.field290.field_1724.method_24515()).method_26204() instanceof class_2399)) {
                return;
            }
            Class1503.method14420();
            return;
        ...
        if (((Boolean)this.field2037.method507()).booleanValue()) {
            int n2 = SelfTrap.field290.field_1724.method_6128() ? 56018 : 56019;
            block4: while (true) {
                switch (n2) {
                    case 56019: {
                        n2 = 56017;
        ...
        if (((Boolean)SelfTrap.method8934(this.field2039)).booleanValue() && SelfTrap.field290.field_1724.method_52535()) {
            return;
        }
        if (!((Boolean)this.field1536.method507()).booleanValue() && SelfTrap.method8990(field290).method_6115()) {
            return;
        }
        if (Blink.method4987()) {
            return;
    ...
    private static void method8906(SelfTrap class432, class_2338 class_23382) {
        class432.method8892(class_23382);
    }

    private static boolean method8907(SelfTrap class432) {
    ...
    public static Class248 method8909(SelfTrap class432) {
        return class432.field2034;
    }
    ...
    private boolean method8915(class_2338 a2) {
        ...
        if (this.method8863(a2, (boolean)field2040[0])) {
            this.field2038 = SelfTrap.method8960(this) + (int)field2040[4];
    ...
    private static Class248 method8917(SelfTrap class432) {
        return SelfTrap.method8926(class432);
    }
    ...
    private static Class248 method8924(SelfTrap class432) {
        return SelfTrap.method8965(class432);
    }
    ...
    public void method8925(Class133 c2) {
        if (SelfTrap.field290.field_1724 == null) return;
        if (SelfTrap.method8922(field290) == null) {
            return;
        }
    ...
    public static Class248 method8926(SelfTrap class432) {
    ...
    private void method8931(class_2338 c2) {
        ...
        SelfTrap.method8973(this, c2.method_10084(), field2048, (boolean)field2040[0], (boolean)field2040[0]);
    }
    ...
    private void method8940(class_2596 g2) {
        ...
        if (g2 instanceof class_2626) {
            ...
            if (((Boolean)SelfTrap.method8985(this.field2045)).booleanValue()) {
                class_2338 a2 = b2.method_11309();
                if (SelfTrap.method8874().contains(a2) && b2.method_11308().method_45474()) {
        ...
        if (g2 instanceof class_2664) {
            ...
            if (((Boolean)SelfTrap.method8894(this).method507()).booleanValue()) {
        ...
        if (g2 instanceof class_2604 && (f2 = (class_2604)g2).method_11169().equals(SelfTrap.method8858())) {
            Iterator iterator;
            if (((Boolean)SelfTrap.method8924(this).method507()).booleanValue() && (iterator = field2048.iterator()).hasNext()) {
    ...
    static {
        ...
        SelfTrap.method8854(-8524646686465015084L);
    ...
    public SelfTrap() {
        ...
        class_2248Array[(int)SelfTrap.field2040[0]] = class_2246.field_10540;
        class_2248Array[(int)SelfTrap.field2040[4]] = class_2246.field_10443;
    ...
    public static Class248 method8954(SelfTrap class432) {
    ...
    private static boolean method8957(class_1297 a2) {
        return (a2 instanceof class_1511 && SelfTrap.method8935((class_1297)SelfTrap.field290.field_1724, a2.method_19538(), (boolean)field2040[4]) < (double)Class5659.method22223() ? (int)field2040[4] : (int)field2040[0]) != 0;
    }
    ...
    public static int method8960(SelfTrap class432) {
        return class432.field2038;
    }

    private static int method8961(int n2, int n3, Class3221 class3221, Crosshair class285) {
    ...
    private static void method8964(SelfTrap class432, class_2596 class_25962) {
        class432.method8974(class_25962);
    }

    public static Class248 method8965(SelfTrap class432) {
    ...
    public static SelfTrap method8968() {
        return INSTANCE;
    }

    private static void method8969(SelfTrap class432) {
        class432.method8983();
    }
    ...
    private static void method8973(SelfTrap class432, class_2338 class_23382, Set set, boolean bl2, boolean bl3) {
    ...
    private boolean method8976(class_2338 a2) {
        if (!(((Boolean)this.field2044.method507()).booleanValue() && a2.equals((Object)SelfTrap.method8886((class_1657)SelfTrap.field290.field_1724, (boolean)field2040[0]).method_10074()) && Class5723.field11054.method22497(a2))) {
    ...
    private boolean method8977(class_2338 a2) {
        ...
        if (!a2.equals((Object)Class5659.method22153((class_1657)SelfTrap.method8885(field290), (boolean)field2040[0]).method_10074())) return this.method8915(a2);
        if (!SelfTrap.method8870(Class5723.field11054, a2)) {
            n3 = 58472;
            n2 = n3;
    ...
    private void method8978() {
        ...
        block12: {
            block11: {
                block10: {
                    SelfTrap.method8857(this);
                    if (!((Boolean)this.field2014.method507()).booleanValue()) break block10;
                    if (!SelfTrap.field290.field_1724.method_20448()) break block11;
                }
                if (!((Boolean)this.field2049.method507()).booleanValue()) break block12;
                if (!SelfTrap.field290.field_1724.method_20448()) break block12;
            }
            class_2338 a2 = new class_2338.class_2339(SelfTrap.field290.field_1724.method_23317(), SelfTrap.field290.field_1724.method_5829().method_17940() + SelfTrap.field290.field_1724.method_23318(), SelfTrap.field290.field_1724.method_23321()).method_10084();
            field2048.add(a2);
            if (SelfTrap.method8907(this)) {
                this.method8892(a2);
            }
        }
        List h2 = Class5659.method22141(SelfTrap.field290.field_1724.method_19538());
        ...
        if (((Boolean)SelfTrap.method8917(this).method507()).booleanValue()) {
            for (class_2338 g2 : h2) {
                class_2350Array = SelfTrap.method8946();
                n3 = class_2350Array.length;
                for (n2 = (int)field2040[0]; n2 < n3; ++n2) {
        ...
        SelfTrap.method8969(this);
        SelfTrap.method8867(this, this.field2012 > 0 ? this.field2012 - (int)field2040[4] : (Integer)SelfTrap.method8879(this).method507());
    }
    ...
    private void method8983() {
        int n2 = SelfTrap.method8911().isEmpty() ? 41236 : 41237;
        block4: while (true) {
            switch (n2) {
                case 41237: {
                    n2 = 41235;
        ...
        if (!((Boolean)this.field2028.method507()).booleanValue()) {
            ...
            b2.ifPresent(SelfTrap::method8928);
            return;
        }
        ...
        while (true) {
            ...
            SelfTrap.method8882().addAll(a2.stream().map(Class653::method11461).collect(Collectors.toCollection(HashSet::new)));
        }
    }
    ...
    private static int method8987(int n2, int n3, Aura class434, Class6315 class6315) {
    ...
    public static Class248 method8989(SelfTrap class432) {
