...
extends Class278 {
    ...
    private static void method5899(long l2) {
        UnfocusedFPS.field1403[1] = l2 ^ 0x5E657E202EB1EF0DL;
        UnfocusedFPS.field1403[0] = l2 ^ 0x5E657E202EB1EF16L;
        UnfocusedFPS.field1403[2] = l2 ^ 0x5E657E202EB1EF6BL;
    }
    ...
    public void method5901(Class29 a2) {
        if (!field290.method_1569()) {
            a2.method10();
            a2.method58((Integer)UnfocusedFPS.method5900(this.field1402));
        }
    }
    ...
    public static CallSite 7dJ94xdhfxr6Lwb3(MethodHandles.Lookup lookup, String string, MethodType methodType, String string2, String string3, String string4, Integer n2) {
        ...
        int n3 = n2;
        MethodType methodType2 = MethodType.fromMethodDescriptorString(UnfocusedFPS.aj5iaYQy35yPDibZ(string7), UnfocusedFPS.class.getClassLoader());
        try {
            if (n3 == 1) {
                return new ConstantCallSite(lookup.findVirtual(Class.forName(UnfocusedFPS.aj5iaYQy35yPDibZ(string5)), UnfocusedFPS.aj5iaYQy35yPDibZ(string6), methodType2).asType(methodType));
            }
            return new ConstantCallSite(lookup.findStatic(Class.forName(UnfocusedFPS.aj5iaYQy35yPDibZ(string5)), UnfocusedFPS.aj5iaYQy35yPDibZ(string6), methodType2).asType(methodType));
        }
    ...
    static {
        UnfocusedFPS.method5899(6801981488900468499L);
    }
