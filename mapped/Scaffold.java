...
extends Class427 {
    ...
    private boolean method8759(class_2248 a2) {
        ...
        block5: {
            block4: {
                block3: {
                    block2: {
                        int n3 = ((Class544)((Object)Scaffold.method8804(this.field1993))).ordinal();
                    ...
                    n2 = Scaffold.method8787((Class257)this.field2006, a2);
                    break block5;
                }
                if (Scaffold.method8769((Class257)this.field1996, a2)) {
    ...
    private static Color method8763(Colors class457, int n2) {
        return class457.method10618(n2);
    }

    private static Map method8764(Scaffold class431) {
        return Scaffold.method8788(class431);
    }
    ...
    protected void method1279() {
        if (Scaffold.method8755(field290) != null) {
    ...
    static {
        Scaffold.method8828(-8885340399454484030L);
    }
    ...
    public static void method8770(Scaffold class431, Class3691 class3691) {
    ...
    private static Colors method8774() {
    ...
    private void method8780(boolean b2, float[] c2) {
        if (((Boolean)Scaffold.method8776(this.field1954)).booleanValue()) {
            ...
            this.field2003 = a2;
            if (b2) {
                if (((Boolean)Scaffold.method8824(this.field2008)).booleanValue()) {
    ...
    private static int method8786(int n2, int n3, Class894 class894, AntiCrawl class319) {
    ...
    public static Map method8788(Scaffold class431) {
    ...
    private static class_315 method8790(class_310 class_3102) {
        return Scaffold.method8782(class_3102);
    }
    ...
    public static Map method8792(Scaffold class431) {
        return class431.field1999;
    }
    ...
    private void method8796(Class3691 a2) {
        ...
        a2.method18153(Class1503.method14416(Scaffold.field290.field_1724.method_33571(), d2));
    ...
    private static double method8805(class_243 class_2432) {
        return Scaffold.method8848(class_2432);
    }
    ...
    private Boolean method1278() {
        return ((Boolean)Scaffold.method8820(this.field1994) == false ? (int)field2000[0] : (int)field2000[2]) != 0;
    }
    ...
    private static int method8810(int n2, int n3, AntiAFK class443, Class152 class152) {
    ...
    private Class3691 method8819(boolean g2) {
        int n2;
        int h2 = (int)Math.round(Scaffold.method8801(field290).method_23318()) - (int)field2000[0];
        if (((Boolean)Scaffold.method8814(this.field2004)).booleanValue() && Class1807.method15742()) {
            int n3 = !Scaffold.method8850(field290).method_24828() ? 48204 : 48205;
            block4: while (true) {
                switch (n3) {
                    case 48205: {
                        n3 = 48203;
                    ...
                    default: {
                        this.field2002 = (int)Math.floor(Scaffold.field290.field_1724.method_23318()) - (int)field2000[0];
                    }
                }
                break;
            }
        ...
        class_2338 i2 = this.method8811(Scaffold.field290.field_1724.method_23317(), h2, Scaffold.field290.field_1724.method_23321());
        if (!g2) {
            if (!Scaffold.field290.field_1687.method_8320(i2).method_45474()) return null;
        }
        ...
        for (n2 = (int)field2000[2]; n2 < n4; ++n2) {
            ...
            if (Scaffold.method8794(field290).method_8320(a2).method_45474()) continue;
        ...
        while (n2 < n4) {
            ...
            if (Scaffold.field290.field_1687.method_8320(e2).method_45474() && (n6 = (int)field2000[2]) < (n5 = (class_2350Array2 = class_2350.values()).length)) {
                class_2350 d2 = class_2350Array2[n6];
                class_2338 c2 = e2.method_10093(d2);
                if (!Scaffold.field290.field_1687.method_8320(c2).method_45474()) {
    ...
    public void method8823(Class59 g2) {
        if (((Boolean)this.field2001.method507()).booleanValue()) {
            int n2;
            Class6009.method23560();
            for (Map.Entry e2 : Scaffold.method8792(this).entrySet()) {
                ...
                Color c2 = Scaffold.method8763(Colors.method10620(), a2);
                Color d2 = Scaffold.method8774().method10618(b2);
                Class6454.method24734(g2.method125(), (class_2338)e2.getKey(), c2.getRGB());
                Class6454.method24642(Scaffold.method8784(g2), (class_2338)e2.getKey(), 1.5f, d2.getRGB());
            }
            Class6009.method23561();
            if (Scaffold.method8834(this) == null || this.field2005.method18157() == null) {
                return;
            }
            if (((Boolean)this.field2001.method507()).booleanValue()) {
                int n3 = 35445;
            ...
            Scaffold.method8764(this).put(this.field2005.method18154(), f2);
            this.field1999.entrySet().removeIf(Scaffold::method8836);
        }
    }
    ...
    private static void method8828(long l2) {
        Scaffold.field2000[3] = l2 ^ 0x84B0EDFBB6168938L;
        Scaffold.field2000[5] = l2 ^ 0x84B0EDFBB61689C0L;
        Scaffold.field2000[7] = l2 ^ 0x84B0EDFBB61689CBL;
        Scaffold.field2000[0] = l2 ^ 0x84B0EDFBB61689C3L;
        Scaffold.field2000[1] = l2 ^ 0x84B0EDFBB6168AD4L;
        Scaffold.field2000[4] = l2 ^ 0x84B0EDFBB6168A2AL;
        Scaffold.field2000[6] = l2 ^ 0x7B4F120449E9763DL;
        Scaffold.field2000[2] = l2 ^ 0x84B0EDFBB61689C2L;
    }
    ...
    private static class_304 method8832(class_315 class_3152) {
        return Scaffold.method8767(class_3152);
    }
    ...
    public static Class3691 method8834(Scaffold class431) {
    ...
    private static boolean method8836(Map.Entry a2) {
        return (Scaffold.method8849((Class6283)a2.getValue()) == 0.0 ? (int)field2000[0] : (int)field2000[2]) != 0;
    }
    ...
    private int method8838() {
        ...
        if (!e2.method_7960() && (class_17922 = e2.method_7909()) instanceof class_1747 && this.method8759((a2 = (class_1747)class_17922).method_7711())) {
            return Scaffold.method8775().method18969();
        }
        int f2 = (int)field2000[6];
        int g2 = (int)field2000[2];
        for (int d2 = (int)field2000[2]; d2 < (int)field2000[7]; ++d2) {
            class_1799 c2 = Scaffold.field290.field_1724.method_31548().method_5438(d2);
    ...
    public Scaffold() {
        ...
        class_2248Array[(int)Scaffold.field2000[2]] = class_2246.field_10566;
        class_2248Array[(int)Scaffold.field2000[0]] = class_2246.field_10540;
        ...
        class_2248Array2[(int)Scaffold.field2000[2]] = class_2246.field_10603;
