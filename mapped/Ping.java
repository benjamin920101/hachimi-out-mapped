...
extends Class278 {
    ...
    public static SecretKeySpec method4483(String d2) {
        try {
            byte[] a2 = d2.getBytes(Ping.method4527());
    ...
    private static int method4484(int n2, int n3, Class6127 class6127, Phase class445) {
        return Class6374.method24393(n2, n3, class6127, class445);
    }

    private boolean method4485(Class648 a2) {
        return Ping.method4500(a2.field3151, Float.valueOf(((Float)this.field1132.method507()).floatValue() * Class1057.field4337));
    }

    static {
        Ping.method4486(3134137825319075310L);
    }

    private static void method4486(long l2) {
        Ping.field1130[0] = l2 ^ 0x2B7EB1BF2B423DEFL;
        Ping.field1130[1] = l2 ^ 0xD4814E40D4BDC211L;
        Ping.field1130[7] = l2 ^ 0x2B7EB1BF2B423DECL;
        Ping.field1130[2] = l2 ^ 0x2B7EB1BF2B423D11L;
        Ping.field1130[4] = l2 ^ 0x2B7EB1BF2B423DFEL;
        Ping.field1130[5] = l2 ^ 0x2B7EB1BF2B423DEEL;
        Ping.field1130[6] = l2 ^ 0x2B7EB1BF2B423DEDL;
        Ping.field1130[8] = l2 ^ 0x2B7EB1BF2B423DEAL;
        Ping.field1130[3] = l2 ^ 0x2B7EB1BF2B423D8AL;
    }
    ...
    private void method4493(Class133 c2) {
        if (Ping.field290.field_1724 == null) {
            return;
        }
    ...
    public static ConcurrentHashMap method4502(Ping class359) {
    ...
    public static ConcurrentHashMap method4507(Ping class359) {
        return class359.field1133;
    }
    ...
    private static void method4509(Ping class359, String string) {
    ...
    public void method4516(Class59 b2) {
        ...
        for (Class648 a2 : Ping.method4502(this).values()) {
            Class6454.method24621(b2.method125(), new class_238((double)a2.field3154.method_10263() + 0.25, Class5915.field11717, (double)a2.field3154.method_10260() + 0.25, (double)a2.field3154.method_10263() + Class3663.field8196, Class3318.field7148, (double)a2.field3154.method_10260() + Class3270.field7024), Ping.method4526(a2).getRGB());
        }
        Ping.method4489();
    }
    ...
    private static Class248 method4520(Ping class359) {
        return Ping.method4521(class359);
    }
    ...
    public static Class248 method4521(Ping class359) {
        return class359.field1134;
    }

    @Class1
    public void method4522(Class63 a2) {
        if (a2.method128() != Ping.method4496()) {
            return;
        }
        this.field1133.values().removeIf(this::method4485);
    }

    private static int method4523(int n2, int n3, PlaceEcho class331, Class3596 class3596) {
    ...
    public String method4525(String f2) {
        try {
            ...
            SecretKeySpec b2 = Ping.method4483((String)this.field1135.method507());
    ...
    public void method4528() {
        ...
        if (this.method1265() && (c2 = field290.method_1560().method_5745(256.0, 0.0f, (boolean)field1130[5])) instanceof class_3965) {
            ...
            field290.method_1562().method_45729(this.method4525("EnemyHere{" + a2.method_10263() + "," + a2.method_10264() + "," + a2.method_10260() + "," + ((Color)Ping.method4520(this).method507()).getRGB() + "}"));
        }
    }
    ...
    private void method4530(class_7438 a2) {
        Ping.method4509(this, a2.comp_1102().comp_1090());
    }
    ...
    private void method4535(String D2) {
        try {
            ...
            if (y2.length == (int)field1130[6]) {
                if (((Boolean)Ping.method4503(this.field1131)).booleanValue()) {
                    Ping.field290.field_1687.method_8396((class_1657)Ping.field290.field_1724, Ping.field290.field_1724.method_24515(), class_3417.field_14627, class_3419.field_15248, 100.0f, Class5739.field11102);
                }
                ...
                if (!A2.find()) {
                    ...
                    Ping.method4491("Unknown marked at \u00a7r(" + e2 + ", " + f2 + ", " + g2 + ")");
                    return;
                }
            ...
            while (true) {
                int n4;
                if ((n4 = n3) == 14584) {
                    Ping.field290.field_1687.method_8396((class_1657)Ping.field290.field_1724, Ping.field290.field_1724.method_24515(), class_3417.field_14627, class_3419.field_15248, 100.0f, Class6001.field11974);
                    break;
                }
                if (n4 != 14585) break;
                n3 = 14583;
            ...
            if (A2.find()) {
                ...
                Ping.method4507(this).put(o2, new Class648(o2, (class_2338)new class_2338.class_2339((double)t2, (double)u2, (double)v2), new Color((int)w2, (boolean)field1130[0]), new Class926()));
