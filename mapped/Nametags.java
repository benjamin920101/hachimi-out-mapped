...
extends Class278 {
    ...
    public static int method1495(int a2) {
        ...
        if (((int)field473[3] | ~n2) - ~n2 != 0) {
            return Nametags.method1535();
        }
        return a2 | (int)field473[2];
    }

    private static Socials method1496() {
        return Socials.method10623();
    }

    public static Class248 method1497(Nametags class287) {
        return class287.field466;
    }

    private static class_746 method1498(class_310 class_3102) {
        return Nametags.method1612(class_3102);
    }

    public static Class248 method1499(Nametags class287) {
    ...
    private static Class248 method1509(Nametags class287) {
        return Nametags.method1542(class287);
    }
    ...
    private float method1510(int a2) {
        ...
        int n2 = (Boolean)Nametags.method1547(this).method507() != false ? 41183 : 41184;
        block4: while (true) {
            switch (n2) {
                case 41184: {
                    n2 = 41182;
    ...
    public static Class248 method1513(Nametags class287) {
    ...
    public Float method1517() {
        return (Float)Nametags.method1571(this.field470);
    }
    ...
    public static Class248 method1520(Nametags class287) {
    ...
    private static void method1524(Nametags class287, class_4587 class_45872, String string, float f2, float f3, int n2) {
    ...
    private void method1529(class_4587 g2, class_1799 h2, int i2, int j2) {
        ...
        if (h2.method_7947() != (int)field473[1]) {
            ...
            ((bC)Nametags.method1539(field290)).hookDrawLayer(a2, i2 + (int)field473[16] - Nametags.field290.field_1772.method_1727(a2), (float)j2 + Class472.field2463, Nametags.method1578((int)field473[4]), (boolean)field473[1], g2.method_23760().method_23761(), (class_4597)b2, class_327.class_6415.field_33994, (int)field473[0], (int)field473[13]);
            b2.method_22993();
            ((bC)Nametags.field290.field_1772).hookDrawLayer(a2, i2 + (int)field473[16] - Nametags.field290.field_1772.method_1727(a2), (float)j2 + 9.0f, Nametags.method1495((int)field473[4]), (boolean)field473[0], g2.method_23760().method_23761(), (class_4597)b2, class_327.class_6415.field_33994, (int)field473[0], (int)field473[13]);
            b2.method_22993();
        }
        if (h2.method_31578()) {
            ...
            Nametags.method1621(g2, e2, f2, 13.0, 2.0, (int)field473[2]);
    ...
    private static class_327 method1531(class_310 class_3102) {
        return Nametags.method1623(class_3102);
    }

    public static Class248 method1532(Nametags class287) {
    ...
    private static void method1538(long l2) {
        Nametags.method1544(l2);
    }

    private static class_327 method1539(class_310 class_3102) {
        return Nametags.method1618(class_3102);
    }
    ...
    private static int method1541(int n2, int n3, Parkour class377, Class156 class156) {
        return Class3449.method17511(n2, n3, class377, class156);
    }

    public static Class248 method1542(Nametags class287) {
    ...
    private static void method1544(long l2) {
        Nametags.field473[3] = l2 ^ 0xE58CA47CBE4BB9BFL;
        Nametags.field473[7] = l2 ^ 0x1A735B83424BBBB8L;
        Nametags.field473[10] = l2 ^ 0x1A735B83424BBBBCL;
        Nametags.field473[12] = l2 ^ 0x1A735B83174BBDBFL;
        Nametags.field473[16] = l2 ^ 0x1A735B83424BB9AEL;
        Nametags.field473[17] = l2 ^ 0xE58CA47CBDA4B8F8L;
        Nametags.field473[0] = l2 ^ 0x1A735B83424BB9BFL;
        Nametags.field473[5] = l2 ^ 0x1A735B83424BB9BAL;
        Nametags.field473[11] = l2 ^ 0x1A735B83424BB9BCL;
        Nametags.field473[19] = l2 ^ 0xE58CA47CBDB420BFL;
        Nametags.field473[1] = l2 ^ 0x1A735B83424BB9BEL;
        Nametags.field473[8] = l2 ^ 0x1A735B83424BB9BBL;
        Nametags.field473[2] = l2 ^ 0xE58CA47CBD4BB9BFL;
        Nametags.field473[4] = l2 ^ 0xE58CA47CBDB44640L;
        Nametags.field473[9] = l2 ^ 0x1A735B83424BB9BDL;
        Nametags.field473[18] = l2 ^ 0xE58CA47CBDB49CBFL;
        Nametags.field473[15] = l2 ^ 0x1A735B83424BB9B2L;
        Nametags.field473[6] = l2 ^ 0x1A735B83424BB940L;
        Nametags.field473[14] = l2 ^ 0xE58CA47CBD88F7FEL;
        Nametags.field473[13] = l2 ^ 0x1A735B8342BBB94FL;
        Nametags.field473[20] = l2 ^ 0x1A735B83424BBA57L;
    }
    ...
    private static int method1546(int n2, int n3, Scaffold class431, Class70 class70) {
        return Class3449.method17550(n2, n3, class431, class70);
    }

    public static Class248 method1547(Nametags class287) {
        return class287.field481;
    }
    ...
    public static Nametags method1554() {
        return INSTANCE;
    }

    static {
        Nametags.method1538(1905967686618954175L);
    }
    ...
    public void method1562(Class143 a2) {
        if (((Boolean)Nametags.method1499(this).method507()).booleanValue()) {
            Nametags.method1587(this).put(new Class647(a2.method281(), a2.method279()), System.currentTimeMillis());
        }
    }
    ...
    private String method1567(class_1657 l2) {
        ...
        block16: {
                    ...
                    block21: {
                        block19: {
                            block17: {
                                ...
                                class_124 b2 = Nametags.method1557();
                                break block18;
                            }
            ...
            h2 = h2.setScale((int)field473[1], Nametags.method1552());
            m2.append(g2);
            m2.append(h2.doubleValue());
            m2.append(" ");
        }
        int n4 = (Boolean)Nametags.method1565(Nametags.method1614(this)) == false ? 63954 : 63953;
        while ((n2 = n4) != 63953) {
            if (n2 != 63954) return m2.toString().trim();
            n4 = 63952;
        }
        if (l2 == Nametags.field290.field_1724) {
            return m2.toString().trim();
        }
        int k2 = Class5723.field11040.method11905((class_1297)l2);
        if (k2 <= 0) return m2.toString().trim();
        class_124 j2 = Nametags.method1550(k2);
        m2.append(j2);
        m2.append(-k2);
        m2.append(" ");
        return m2.toString().trim();
    ...
    public static Class248 method1574(Nametags class287) {
        return class287.field479;
    }

    @Class1
    public void method1575(Class168 a2) {
        if (a2.method325() instanceof class_1657 && a2.method325() != Nametags.method1581(field290)) {
            a2.method10();
        }
    }
    ...
    private static class_746 method1581(class_310 class_3102) {
        return Nametags.method1558(class_3102);
    }

    public static Class248 method1582(Nametags class287) {
        return class287.field477;
    }
...
lbl14:
                    ...
                    j = 0.0f;
                    k = (int)Nametags.field473[0];
                    l = (int)Nametags.field473[1];
                    var7_7 = i.iterator();
                    if (var7_7.hasNext()) {
                        a = (class_1799)var7_7.next();
                        j -= l != 0 ? 9.0f : 8.0f;
                        l = (int)Nametags.field473[0];
                    ...
                    if ((!((Boolean)Nametags.method1625(this).method507()).booleanValue() || !e) && (!((Boolean)Nametags.method1568(this.field476)).booleanValue() || e)) break block23;
                    if (e) ** GOTO lbl-1000
...
lbl50:
                ...
                d = Nametags.field290.method_1480().method_4019(f, (class_1937)Nametags.field290.field_1687, null, (int)Nametags.field473[0]);
                Nametags.field290.method_1480().method_23179(f, class_811.field_4319, (boolean)Nametags.field473[0], g, (class_4597)Nametags.field290.method_22940().method_23000(), (int)Nametags.field473[13], class_4608.field_21444, d);
                Nametags.field290.method_22940().method_23000().method_22993();
                g.method_22909();
                this.method1529(g, f, 0, (int)c);
                g.method_22905(0.5f, 0.5f, Class1443.field5495);
                if (f.method_7909() == class_1802.field_8367) {
                    if (((Boolean)Nametags.method1513(this).method507()).booleanValue()) {
                        v3 = 1.0f;
                        Class6322.method24332(0.8698739f, 0.74084914f);
                        return;
                    }
                    b = (m + -13.5f) * 2.0f;
                    Nametags.method1524(this, g, "God", 4.0f, b, (int)Nametags.field473[14]);
        ...
        v5 = 40272;
        Nametags.method1620(0.71535873f, 0.37510014f);
    }

    public static Class248 method1585(Nametags class287) {
        return class287.field470;
    }
    ...
    public static Map method1587(Nametags class287) {
    ...
    private static int method1592(int n2, int n3, Speed class352, Class5829 class5829) {
    ...
    private void method1593(class_4587 a2, class_1799 b2, float c2, float d2) {
        ...
        float f2 = (Font.method1855().method1265() ? Class5836.field11394.method14084(e2) / 2.0f : (float)Nametags.method1611(field290).method_1727(e2)) / 4.0f;
        this.method1609(a2, e2, (c2 - f2) * 2.0f, d2 * 2.0f, (int)field473[4]);
    }

    private static Colors method1594() {
    ...
    public void method1605(Class59 O2) {
        block38: {
            if (Nametags.field290.field_1773 == null || Nametags.field290.field_1687 == null || field290.method_1560() == null) {
                return;
            }
            Nametags.method1622();
            GL11.glDepthFunc((int)((int)field473[7]));
            class_4184 P2 = Nametags.field290.field_1773.method_19418();
            Iterator<Object> iterator = Nametags.field290.field_1687.method_18112().iterator();
            block23: while (true) {
                ...
                if (iterator.hasNext()) {
                    ...
                    if (((Boolean)Nametags.method1582(this).method507()).booleanValue()) {
                        this.field465.entrySet().removeIf(Nametags::method1613);
                ...
                block24: while (true) {
                    ...
                    switch (SwitchBootstraps.typeSwitch("typeSwitch", new Object[]{class_1657.class, class_1496.class, class_1321.class, class_1542.class, class_1684.class}, (Object)class_12973, n2)) {
                        case 0: {
                            ...
                            if (h2 == Nametags.field290.field_1724 && !Freecam.method4718().method1265() || !h2.method_5805()) continue block23;
                            ...
                            float f2 = Font.method1855().method1265() ? Nametags.method1516().method14084(a2) / 2.0f : (float)Nametags.field290.field_1772.method_1727(a2);
                            float g2 = f2 / 2.0f;
                        ...
                        case 1: {
                            ...
                            block26: while (true) {
                                switch (n6) {
                                    ...
                                    case 26089: {
                                        if (!((Boolean)Nametags.method1526(this.field475)).booleanValue()) break block26;
                        ...
                        case 3: {
                            ...
                            if (!((Boolean)Nametags.method1545(this.field469)).booleanValue()) {
                                n2 = (int)field473[8];
                                continue block24;
                            }
                            double u2 = Nametags.field290.field_1724.method_5739((class_1297)C2);
                            if (u2 > (double)((Float)this.field467.method507()).floatValue()) continue block23;
                            double v2 = u2 > (double)((Float)this.field460.method507()).floatValue() ? 1.0 - (u2 - (double)((Float)Nametags.method1532(this).method507()).floatValue()) / (double)(((Float)this.field467.method507()).floatValue() - ((Float)this.field460.method507()).floatValue()) : 1.0;
                            ...
                            block28: while (true) {
                                switch (n8) {
                                    ...
                                    case 12522: {
                                        object = " " + field395.format(Nametags.field290.field_1724.method_5739((class_1297)C2)) + "m";
                                        break block28;
                                    }
                                    default: {
                                        object = "";
                        ...
                        case 4: {
                            ...
                            if (!((Boolean)Nametags.method1574(this).method507()).booleanValue()) {
                                n2 = (int)field473[5];
                                continue block24;
                            }
    ...
    public Boolean method1607() {
        return (Boolean)Nametags.method1520(this).method507();
    }
    ...
    private void method1609(class_4587 b2, String c2, float d2, float e2, int f2) {
        if (Font.method1855().method1265()) {
            ...
            ((bC)Nametags.field290.field_1772).hookDrawLayer(c2, d2, e2, Nametags.method1495(f2), (boolean)field473[1], b2.method_23760().method_23761(), (class_4597)a2, class_327.class_6415.field_33994, (int)field473[0], (int)field473[13]);
            a2.method_22993();
            ((bC)Nametags.method1531(field290)).hookDrawLayer(c2, d2, e2, Nametags.method1523(f2), (boolean)field473[0], b2.method_23760().method_23761(), (class_4597)a2, class_327.class_6415.field_33994, (int)field473[0], (int)field473[13]);
            a2.method_22993();
        }
    }
    ...
    public static Class248 method1614(Nametags class287) {
    ...
    private int method1617(class_1657 a2) {
        if (a2 == Nametags.field290.field_1724) {
            return Nametags.method1594().method10615((int)field473[6]);
        }
        if (Nametags.method1537(Class5723.field11045, a2.method_5477())) {
            return Socials.method10623().method10627();
        }
        if (a2.method_5767()) {
    ...
    public static Class248 method1625(Nametags class287) {
        return class287.field481;
    }
    ...
    private void method1631(String a2, float b2, class_1657 c2, double d2, double e2, double f2, class_4184 g2) {
        ...
        float k2 = (float)((double)(Class3895.field8868 * ((Float)this.field486.method507()).floatValue()) + ((Boolean)Nametags.method1507(this.field485) != false && h2.method_1028(d2, j2, f2) > (double)(((Float)Nametags.method1505(this.field470)).floatValue() * ((Float)Nametags.method1585(this).method507()).floatValue()) ? (Math.sqrt(h2.method_1028(d2, j2, f2)) - (double)((Float)Nametags.method1509(this).method507()).floatValue()) * (double)-0.0025f * (double)((Float)Nametags.method1497(this).method507()).floatValue() : 0.0));
        i2.method_22907(class_7833.field_40714.rotationDegrees(g2.method_19329()));
        i2.method_22907(Nametags.method1590().rotationDegrees(g2.method_19330() + Class1381.field5335));
        ...
        if (((Boolean)this.field463.method507()).booleanValue()) {
            ...
            Objects.requireNonNull(Nametags.field290.field_1772);
            Nametags.method1528(i2, d3, Class6081.field12248, d4, 10.0, 0.0, (int)field473[12]);
        }
        if (((Boolean)this.field482.method507()).booleanValue()) {
            double d5 = -b2 - 1.0f;
            double d6 = b2 * 2.0f + 2.5f;
            Objects.requireNonNull(Nametags.field290.field_1772);
            Class6454.method24591(i2, d5, -1.0, d6, Class3362.field7293 + 1.0f, c2 != Nametags.method1498(field290) && Class5723.field11045.method21233(c2.method_5476().getString()) ? Nametags.method1496().method10627() : Colors.method10620().method10621().intValue());
        }
