...
extends Class278 {
    private static FireworkBoost INSTANCE;
    Class248 field578;
    ...
    private class_243 method2008() {
        Class57 a2 = new Class57((class_1309)FireworkBoost.field290.field_1724, FireworkBoost.method2025(field290).method_36454(), FireworkBoost.field290.field_1724.method_36455());
        Class3815.INSTANCE.method18539(a2);
        if (a2.method11()) {
            return FireworkBoost.method2032(a2);
        }
        return FireworkBoost.field290.field_1724.method_5720();
    }

    private static FireworkBoost method2009() {
        return FireworkBoost.method2021();
    }

    static {
        field583 = new long[2];
        FireworkBoost.method2033(8599846697402258100L);
    }
    ...
    public static Class248 method2016(FireworkBoost class299) {
    ...
    public static Class248 method2020(FireworkBoost class299) {
        return class299.field579;
    }

    public static FireworkBoost method2021() {
        return INSTANCE;
    }
    ...
    private Boolean method2026() {
        return (FireworkBoost.method2027(this.field579) == Class614.field2988 ? (int)field583[0] : (int)field583[1]) != 0;
    }
    ...
    private Boolean method2028() {
        return (FireworkBoost.method2022(this.field579) == Class614.field2988 ? (int)field583[0] : (int)field583[1]) != 0;
    }
    ...
    public void method2030(Class129 j2) {
        ...
        switch (((Class614)((Object)this.field579.method507())).ordinal()) {
            case 0: {
                ...
                double d2 = ((Float)FireworkBoost.method2016(this).method507()).floatValue();
                class_243 e2 = FireworkBoost.field290.field_1724.method_18798();
                FireworkBoost.method2034(j2, a2.field_1352 * d2 + (a2.field_1352 * b2 - e2.field_1352) * c2, a2.field_1351 * d2 + (a2.field_1351 * b2 - e2.field_1351) * c2, a2.field_1350 * d2 + (a2.field_1350 * b2 - e2.field_1350) * c2);
                break;
            }
            case 1: {
                class_243 f2 = FireworkBoost.method2035(this);
                double g2 = ((Float)this.field582.method507()).floatValue();
                class_243 h2 = f2.method_1021(g2);
                class_243 i2 = FireworkBoost.method2040(field290).method_18798();
                FireworkBoost.method2018(j2, h2.field_1352 - i2.field_1352, h2.field_1351 - i2.field_1351, h2.field_1350 - i2.field_1350);
            }
        }
    }

    private static int method2031(int n2, int n3, Notification class382, Class3317 class3317) {
    ...
    private static void method2033(long l2) {
        FireworkBoost.field583[1] = l2 ^ 0x7758CB01E17A52B4L;
        FireworkBoost.field583[0] = l2 ^ 0x7758CB01E17A52B5L;
    }
    ...
    private static class_243 method2035(FireworkBoost class299) {
        return class299.method2008();
    }

    private Boolean method1269() {
        return (FireworkBoost.method2015(this.field579) == FireworkBoost.method2014() ? (int)field583[0] : (int)field583[1]) != 0;
    }

    public static FireworkBoost method2036() {
        return FireworkBoost.method2009();
    }
    ...
    private Boolean method1278() {
        if (FireworkBoost.method2020(this).method507() == Class614.field2988) {
            FireworkBoost.method2012();
            return null;
        }
