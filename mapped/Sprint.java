...
extends Class411 {
    ...
    public static Class248 method9597(Sprint class442) {
        return class442.field2217;
    }

    static {
        field2214 = new long[3];
        Sprint.method9632(5765716148219280120L);
    }
    ...
    private static class_744 method9605(class_746 class_7462) {
        return Sprint.method9599(class_7462);
    }
    ...
    public static Class248 method9609(Sprint class442) {
    ...
    public void method9610(Class164 b2) {
        if (this.method9618()) {
            float a2 = this.method9636(Sprint.field290.field_1724.method_36454());
    ...
    private Boolean method1269() {
        int n2;
        if (this.field2217.method507() != Class548.field2714 && Sprint.method9641(this).method507() != Class548.field2715) {
            n2 = (int)field2214[2];
            return n2 != 0;
        }
        n2 = (int)field2214[0];
    ...
    public void method9612(Class151 d2) {
        if (((Boolean)Sprint.method9617(this.field2216)).booleanValue()) {
            ...
            block8: while (true) {
                switch (n2) {
                    ...
                    case 4490: {
                        if (this.field2217.method507() != Sprint.method9635()) break block8;
                    }
                    default: {
                        float a2 = d2.method294();
                        float b2 = Math.signum(Sprint.method9645(Sprint.method9595(Sprint.field290.field_1724)));
                        float c2 = 90.0f * Math.signum(Sprint.method9605((class_746)Sprint.method9606((class_310)Sprint.field290)).field_3907);
                        if (b2 != 0.0f) {
                            c2 *= b2 * 0.5f;
                        }
                        a2 -= c2;
    ...
    public void method9613(Class91 b2) {
        if (this.method9618()) {
            ...
            Sprint.method9622(field290).method_5728((boolean)field2214[0]);
        }
    }

    public static Sprint method9614() {
        return INSTANCE;
    }

    private static class_6880 method9615() {
        return Sprint.method9649();
    }
    ...
    private boolean method9618() {
        ...
        if (((Boolean)Sprint.method9607(Sprint.method9609(this))).booleanValue()) {
            if (Class5659.method22193(0.3)) {
                return (int)field2214[2] != 0;
            }
        }
        if (Class1807.method15753() && !Sprint.field290.field_1724.method_5715() && !Sprint.field290.field_1724.method_3144()) {
            if (!Sprint.method9627(field290).method_6128()) {
    ...
    private static int method9619(int n2, int n3, Class3957 class3957, HoleESP class315) {
    ...
    public void method9625(Class210 a2) {
        if (this.method9618()) {
            ...
            if (Sprint.method9597(this).method507() == Class548.field2712) {
                this.method6465(this.method9636(Sprint.method9600(field290).method_36454()), Sprint.field290.field_1724.method_36455());
            }
        }
    }

    private static class_746 method9626(class_310 class_3102) {
        return Sprint.method9616(class_3102);
    }
    ...
    private boolean method9631(float a2) {
        ...
        if (this.field2217.method507() == Class548.field2712 || Sprint.method9642(this).method507() == Sprint.method9623()) {
            return (Sprint.field290.field_1724.field_3913.field_3905 <= 1.0E-5f || Sprint.field290.field_1724.field_5976 && !Sprint.field290.field_1724.field_34927 ? (int)field2214[0] : (int)field2214[2]) != 0;
        }
        return (int)field2214[2] != 0;
    }

    private static void method9632(long l2) {
        Sprint.field2214[2] = l2 ^ 0x5003F049EA57FAF8L;
        Sprint.field2214[1] = l2 ^ 0x5003F049EA57FA96L;
        Sprint.field2214[0] = l2 ^ 0x5003F049EA57FAF9L;
    }
        ...
        block17: {
            block20: {
                block18: {
                    block16: {
                        block19: {
                            b = Sprint.method9621(Sprint.field290.field_1690).method_1434();
                            c = Sprint.field290.field_1690.field_1881.method_1434();
                            d = Sprint.field290.field_1690.field_1913.method_1434();
                            e = Sprint.field290.field_1690.field_1849.method_1434();
                            if (!b) break block18;
                            if (c) break block19;
                            v0 = 40702;
                            ** GOTO lbl14
...
lbl25:
    ...
    public static Class248 method9641(Sprint class442) {
        return class442.field2217;
    }

    public static Class248 method9642(Sprint class442) {
        return class442.field2217;
    }
