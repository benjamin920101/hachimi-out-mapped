...
extends Class414 {
    ...
    Class248 field1553;
    Class248 field1554;
    Class248 field1555 = this.method450(new Class260("SwapAction", "Decide which swap mode to use", Class607.field2953, PearlBlocker.method6636()));
    ...
    public static Class248 method6632(PearlBlocker class415) {
    ...
    private static Class5478 method6634() {
        return PearlBlocker.method6663();
    }
    ...
    static {
        PearlBlocker.method6676(2640297053292214378L);
    }
    ...
    public static Class248 method6645(PearlBlocker class415) {
    ...
    public static Class248 method6659(PearlBlocker class415) {
        return class415.field1541;
    }
    ...
    private static Map method6666(PearlBlocker class415) {
        return PearlBlocker.method6689(class415);
    }

    private static int method6667(int n2, int n3, Class130 class130, NoRotate class286) {
    ...
    private static Class248 method6669(PearlBlocker class415) {
        return PearlBlocker.method6729(class415);
    }
    ...
    public static Class248 method6671(PearlBlocker class415) {
        return class415.field1541;
    }
    ...
    private static Class248 method6675(PearlBlocker class415) {
        return PearlBlocker.method6683(class415);
    }

    private static void method6676(long l2) {
        PearlBlocker.field1544[6] = l2 ^ 0x24A4382E5AFE3856L;
        PearlBlocker.field1544[3] = l2 ^ 0x24A4382E5AFE386EL;
        PearlBlocker.field1544[5] = l2 ^ 0x24A4382E5AFE387EL;
        PearlBlocker.field1544[2] = l2 ^ 0x24A4382E5AFE3B82L;
        PearlBlocker.field1544[1] = l2 ^ 0x24A4382E5AFE3862L;
        PearlBlocker.field1544[8] = l2 ^ 0x24A4382E5AFE399EL;
        PearlBlocker.field1544[0] = l2 ^ 0x24A4382E5AFE386BL;
        PearlBlocker.field1544[4] = l2 ^ 0x24A4382E5AFE386AL;
        PearlBlocker.field1544[7] = l2 ^ 0x24A4382E5AFE3868L;
    }
    ...
    public static Class248 method6682(PearlBlocker class415) {
        return class415.field1548;
    }

    public static Class248 method6683(PearlBlocker class415) {
        return class415.field1555;
    }

    private static Class248 method6684(PearlBlocker class415) {
        return PearlBlocker.method6711(class415);
    }
    ...
    public static Map method6689(PearlBlocker class415) {
    ...
    public static Class248 method6691(PearlBlocker class415) {
    ...
    public static Class248 method6694(PearlBlocker class415) {
    ...
    public static Class248 method6702(PearlBlocker class415) {
    ...
    public void method6703(Class210 y) {
        ...
        z = (int)PearlBlocker.field1544[4];
        A = PearlBlocker.method6672(PearlBlocker.field290).method_33571();
        block8: for (class_1297 x : PearlBlocker.field290.field_1687.method_18112()) {
            block38: {
                block35: {
                    if (z > (Integer)this.field1552.method507()) {
                        return;
                    }
                    if (!(x instanceof class_1684) || !((q = (w = (class_1684)x).method_24921()) instanceof class_1657) || (r = (class_1657)q) == PearlBlocker.field290.field_1724) continue;
                    if (!((Boolean)PearlBlocker.method6707(this).method507()).booleanValue()) break block35;
                    v0 = 49298;
                    ** GOTO lbl21
                }
                v0 = 49299;
...
lbl21:
                    ...
                    switch (v0) {
                        ...
                        case 49298: {
                            if (!PearlBlocker.method6635(PearlBlocker.method6634(), r)) break block9;
                            continue block8;
                        }
                    }
                    break;
                ...
                block10: for (g = ((Integer)PearlBlocker.method6726(this).method507()).intValue(); g < (Integer)this.field1539.method507(); ++g) {
                    block37: {
                        block32: {
                            block36: {
                                e = v.method12121();
                                if (e != null) {
                                    if (!(((class_2338)PearlBlocker.method6666(this).get(w)).method_46558().method_1022(e.method_17784()) < 1.0)) break;
                                ...
                                c = new Class3442((class_2338)f, class_1802.field_8281, (boolean)((Boolean)PearlBlocker.method6671(this).method507()), (Class607)this.field1555.method507());
                                d = c.method17405((Double)this.field1538.method507(), (Boolean)PearlBlocker.method6721(this.field1542));
                                if (d) {
                                    s = f;
                                    t = c;
                                    u = null;
...
lbl58:
                        ...
                        if (c.field7521 && (c.field7527 || c.field7526) && c.field7516.method18523()) {
                            v2 = (int)PearlBlocker.field1544[0];
                        } else lbl-1000:
                        // 2 sources

                        {
                            v2 = b = (int)PearlBlocker.field1544[4];
                        }
                        if (b == 0) continue;
...
lbl76:
                ...
                for (o = ((Integer)this.field1540.method507()).intValue(); o < (Integer)PearlBlocker.method6679(PearlBlocker.method6730(this)); ++o) {
                    block34: {
                        block41: {
                            block40: {
                                block33: {
                                    block39: {
                                        l = v.method12121();
                                        if (l != null) {
                                            if (!(l.method_17784().method_1022(A) <= (Double)PearlBlocker.method6691(this).method507())) break;
                                            s = null;
                                            t = null;
                                            u = null;
                                            break;
                                        ...
                                        if (m.method_1022(A) > (Double)PearlBlocker.method6725(this).method507()) continue;
                                        ...
                                        j = new Class3442((class_2338)n, PearlBlocker.method6643(), (boolean)((Boolean)PearlBlocker.method6645(this).method507()), (Class607)this.field1555.method507());
                                        k = j.method17405((Double)PearlBlocker.method6704(this).method507(), (Boolean)PearlBlocker.method6700(this.field1542));
                                        if (k) {
                                            s = n;
                                            t = j;
                                            u = null;
...
lbl114:
                                ...
                                if (!PearlBlocker.method6638(j) && !j.field7526) ** GOTO lbl-1000
                                if (!PearlBlocker.method6644(j.field7516)) break block40;
                                v5 = 24983;
                                ** GOTO lbl127
                            }
                            v5 = 24984;
...
lbl127:
                                ...
                                switch (v5) {
                                    ...
                                    case 24983: {
                                        v6 = (int)PearlBlocker.field1544[0];
                                        break block15;
                                    }
                                    default: lbl-1000:
                                    // 4 sources
                                    ...
                                    {
                                        v6 = i = (int)PearlBlocker.field1544[4];
                                    }
                                }
                                break;
                            }
                            if (i == 0) continue;
                            h = Class1745.method15597((class_2338)n, (Double)PearlBlocker.method6713(this).method507(), (Integer)PearlBlocker.method6696(this.field1549));
...
lbl146:
                    ...
                    if (!PearlBlocker.method6670(((Class653)h.getLast()).method11461())) continue;
                    s = n;
                    t = j;
                    u = h;
                }
            ...
            if (u == null) {
                t.method17483((Boolean)this.field1548.method507(), (Boolean)this.field1542.method507(), (Double)PearlBlocker.method6639(this.field1553));
                ++z;
                continue;
            }
            if (((Boolean)PearlBlocker.method6669(this).method507()).booleanValue()) {
                for (Class653 p : u) {
                    PearlBlocker.method6718(new Class3442(PearlBlocker.method6652(p), class_1802.field_8281, (boolean)((Boolean)PearlBlocker.method6708(this).method507()), (Class607)PearlBlocker.method6675(this).method507()), (Double)this.field1538.method507(), (Boolean)this.field1548.method507(), (Boolean)PearlBlocker.method6712(this.field1542), (Double)PearlBlocker.method6664(this.field1553));
                    if (++z <= (Integer)PearlBlocker.method6722(this.field1552)) continue;
                    return;
                }
            } else {
                new Class3442(PearlBlocker.method6699((Class653)u.getFirst()), class_1802.field_8281, (boolean)((Boolean)PearlBlocker.method6659(this).method507()), (Class607)this.field1555.method507()).method17369((Double)this.field1538.method507(), (Boolean)PearlBlocker.method6697(PearlBlocker.method6682(this)), (Boolean)PearlBlocker.method6694(this).method507(), (Double)PearlBlocker.method6685(this.field1553));
                if (++z > (Integer)this.field1552.method507()) {
                    return;
                }
            }
            PearlBlocker.method6631(t, (Double)PearlBlocker.method6684(this).method507(), (Boolean)PearlBlocker.method6660(this.field1548), (Boolean)this.field1542.method507(), (Double)this.field1553.method507());
            if (++z <= (Integer)PearlBlocker.method6702(this).method507()) continue;
            return;
        }
    }

    public static Class248 method6704(PearlBlocker class415) {
    ...
    public static Class248 method6707(PearlBlocker class415) {
        return class415.field1554;
    }

    public static Class248 method6708(PearlBlocker class415) {
        return class415.field1541;
    }
    ...
    public static Class248 method6711(PearlBlocker class415) {
        return class415.field1538;
    }
    ...
    public static Class248 method6713(PearlBlocker class415) {
        return class415.field1538;
    }
    ...
    private static int method6715(int n2, int n3, Class697 class697, AutoArmor class279) {
    ...
    public static Class248 method6725(PearlBlocker class415) {
        return class415.field1547;
    }

    public static Class248 method6726(PearlBlocker class415) {
    ...
    public static Class248 method6729(PearlBlocker class415) {
        return class415.field1546;
    }

    private static Class248 method6730(PearlBlocker class415) {
        return PearlBlocker.method6632(class415);
    }
