...
extends Class451 {
    Class248 field2388;
    private static Class455 INSTANCE;
    ...
    private static void method10556(long l2) {
        Class455.field2403[0] = l2 ^ 0x7C55AA50F22E3EF5L;
        Class455.field2403[1] = l2 ^ 0x7C55AA50F22E3EF4L;
        Class455.field2403[2] = l2 ^ 0x7C55AA50F22E3E0FL;
    }
    ...
    public Boolean method10560() {
        return (Boolean)Class455.method10575(Class455.method10578(this));
    }

    public static void method10561(Class455 class455, float f2) {
        class455.field2392 = f2;
    }

    static {
        field2403 = new long[3];
        Class455.method10574(8959254298360692469L);
    }

    public static Class248 method10562(Class455 class455) {
        return class455.field2390;
    }

    public Boolean method10563() {
        return (Boolean)Class455.method10585(this.field2401);
    }
    ...
    public static Class248 method10565(Class455 class455) {
    ...
    private static Class248 method10567(Class455 class455) {
        return Class455.method10562(class455);
    }

    public static Class248 method10568(Class455 class455) {
        return class455.field2394;
    }

    public Class487 method10569() {
        return (Class487)((Object)Class455.method10567(this).method507());
    }
    ...
    public Boolean method10576() {
        return (Boolean)Class455.method10565(this).method507();
    }
    ...
    public void method10577(Class63 a2) {
        int n2 = a2.method128() == Class455.method10592() ? 54548 : 54549;
        block4: while (true) {
            switch (n2) {
                case 54549: {
                    n2 = 54547;
    ...
    public static Class248 method10578(Class455 class455) {
    ...
    public static Class455 method10581() {
        return INSTANCE;
    }
    ...
    public void method10582(Class68 a2) {
        if (a2.method128() == Class543.field2691) {
            if (Class455.method10571(a2) == this.field2398 && !((Boolean)this.field2398.method507()).booleanValue()) {
                this.field2392 = Float.NaN;
            }
        }
    }
    ...
    public void method10588(Class131 f2) {
        ...
        if (Class455.field290.field_1724 == null || Class455.field290.field_1687 == null) {
            return;
        }
        ...
        block4: while (true) {
            switch (n2) {
                ...
                case 29162: {
                    if (!((Boolean)Class455.method10593(this).method507()).booleanValue() || !((class_25962 = f2.method251()) instanceof class_2885)) break block4;
                    ...
                    class_3965 c2 = Class455.field290.field_1687.method_17742(new class_3959(Class455.method10587(field290).method_33571(), b2.method_46558().method_43206(a2.method_17780(), 0.5), class_3959.class_3960.field_17558, class_3959.class_242.field_1348, (class_1297)Class455.field290.field_1724));
                    if (!Class455.field290.field_1687.method_18026(Class455.field290.field_1724.method_5829().method_1012(0.0, Class3240.field6950, 0.0))) {
                        Class1503.method14420();
                        return;
                    }
                    if (c2 == null || c2.method_17783() != class_239.class_240.field_1332 || c2.method_17777().equals((Object)b2)) break block4;
                    Class455.method10561(this, -75.0f);
    ...
    public Boolean method10589() {
        return (Boolean)Class455.method10566(this.field2399);
    }

    private Boolean method10590() {
        return (Class455.method10572(this.field2404) == Class631.field3086 ? (int)field2403[1] : (int)field2403[0]) != 0;
    }
    ...
    private static Class543 method10592() {
        return Class455.method10596();
    }

    public static Class248 method10593(Class455 class455) {
        return class455.field2398;
    }

    public Boolean method10594() {
        return (Boolean)Class455.method10583(this.field2395);
    }

    private static Class248 method10595(Class455 class455) {
        return Class455.method10568(class455);
    }
    ...
    public Double method10597() {
        return (Double)Class455.method10595(this).method507();
    }
