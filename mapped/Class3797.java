...
public class Class3797 {
    ...
    public static int method18428(int n2, int n3, Class942 class942, Class610 class610) {
        int n4 = n2;
        return (0x15D1D43 | ~n4) - ~n4;
    }

    public static int method18429(int n2, int n3, Class14 class14, Class84 class84) {
        int n4 = n3;
        return n4 + ((n2 ^ 0xA655D73) & ~n4);
    }

    public static int method18430(int n2, int n3, Class159 class159, Class1384 class1384) {
