...
extends Class414 {
    ...
    public static Class248 method8256(AutoWeb class424) {
        return class424.field1853;
    }

    public static List method8257(AutoWeb class424) {
    ...
    public static int method8259(AutoWeb class424) {
    ...
    private void method8268(Class210 m2) {
        class_2338 k2;
        int n2;
        AutoWeb.method8302().clear();
        field1846.clear();
        field1865.clear();
        AutoWeb.method8294(this).clear();
        if (AutoWeb.method8259(this) > 0) {
            this.field1860 -= (int)field1855[2];
            return;
        }
        this.field1860 = (Integer)AutoWeb.method8291(this.field1856);
        if (((Boolean)this.field1867.method507()).booleanValue() && !AutoWeb.field290.field_1724.method_24828() && !(AutoWeb.method8264(field290).method_8320(AutoWeb.field290.field_1724.method_24515()).method_26204() instanceof class_2399)) {
            return;
        }
        if (((Boolean)this.field1847.method507()).booleanValue() && AutoWeb.field290.field_1724.method_6128()) {
            return;
        }
        ...
        block12: while (true) {
            switch (n3) {
                ...
                case 13437: {
                    if (!AutoWeb.field290.field_1724.method_52535()) {
                        int n4 = 45686;
                        Chams.method1924();
                        return;
                    }
        ...
        if (!((Boolean)this.field1536.method507()).booleanValue() && AutoWeb.field290.field_1724.method_6115()) {
            return;
        }
        if (Blink.method4987()) {
            int n6 = 48445;
        ...
        AutoWeb.method8281(this.field1871, this::method8269, (Class525)AutoWeb.method8272(this).method507(), (int)field1855[2]);
        ...
        for (int i2 = (int)field1855[1]; i2 < n9; ++i2) {
            ...
            class_243 a2 = n8.method_19538().method_1019(c2).method_1019(Class469.method10718(n8, (Integer)AutoWeb.method8293(this.field1852)));
            ...
            if (!((Boolean)this.field1861.method507()).booleanValue() || ((Boolean)AutoWeb.method8280(this.field1845)).booleanValue() && !n8.method_24828()) continue;
            field1865.add(b2.method_10086((int)field1855[3]));
        }
        if (!field1865.isEmpty()) {
            int f2 = (int)field1855[2];
            for (class_2338 d2 : AutoWeb.method8255()) {
                if (!AutoWeb.field290.field_1687.method_8320(d2).method_27852(class_2246.field_10343)) continue;
                f2 = (int)field1855[1];
                break;
            }
            if (f2 != 0) {
                for (class_2338 e2 : field1865) {
                    if (!AutoWeb.method8303(new Class3442(e2, class_1802.field_8786, (boolean)((Boolean)this.field1869.method507()), (Class607)((Object)AutoWeb.method8275(this.field1864))), (Double)this.field1866.method507(), (Boolean)this.field1857.method507(), (boolean)field1855[1], 3.0)) continue;
                    ++o2;
        ...
        if (!field1846.isEmpty()) {
            ...
            for (class_2338 g2 : field1846) {
                if (!AutoWeb.field290.field_1687.method_8320(g2).method_27852(AutoWeb.method8250())) continue;
                i3 = (int)field1855[1];
                break;
            }
            if (i3 != 0) {
                for (class_2338 h2 : field1846) {
                    if (!new Class3442(h2, class_1802.field_8786, (boolean)((Boolean)this.field1869.method507()), (Class607)((Object)this.field1864.method507())).method17369((Double)this.field1866.method507(), (Boolean)AutoWeb.method8309(this.field1857), (boolean)field1855[1], 3.0)) continue;
                    ++o2;
                    break;
                }
            }
        ...
        Iterator iterator = AutoWeb.method8274().iterator();
        if (iterator.hasNext()) {
            class_2338 j2 = (class_2338)iterator.next();
            if (AutoWeb.field290.field_1687.method_8320(j2).method_27852(class_2246.field_10343)) {
                ++l2;
            }
            Class1108.method12918(false);
            return;
        }
        if (l2 >= (Integer)AutoWeb.method8266(this.field1851)) {
            return;
        }
        iterator = field1850.iterator();
        do {
            if (!iterator.hasNext()) return;
        } while (!new Class3442(k2 = (class_2338)iterator.next(), class_1802.field_8786, (boolean)((Boolean)AutoWeb.method8301(this).method507()), (Class607)((Object)this.field1864.method507())).method17369((Double)this.field1866.method507(), (Boolean)this.field1857.method507(), (boolean)field1855[1], 3.0) || ++o2 < (Integer)this.field1870.method507());
    }
    ...
    private boolean method8269(class_1297 b2) {
        ...
        block14: {
            ...
            block13: {
                ...
                a2 = (class_1657)b2;
                if (b2.equals((Object)AutoWeb.field290.field_1724)) return (int)field1855[1] != 0;
                if (b2.equals((Object)AutoWeb.field290.field_1719)) {
                ...
                if (this.field1868.method507() == AutoWeb.method8290() && !b2.method_24828()) {
                    return (int)field1855[1] != 0;
                }
                if (this.field1868.method507() == AutoWeb.method8258() && b2.method_24828()) {
                    return (int)field1855[1] != 0;
                }
                int n5 = (double)AutoWeb.field290.field_1724.method_5739((class_1297)a2) > (Double)this.field1849.method507() ? 60677 : 60678;
                block4: while (true) {
                    switch (n5) {
                        case 60678: {
                            n5 = 60676;
    ...
    static {
        ...
        AutoWeb.method8289(573111651756848186L);
        field1850 = new HashSet();
        field1846 = new HashSet();
        field1865 = new HashSet();
    }

    public static Class248 method8272(AutoWeb class424) {
        return class424.field1859;
    }

    private static void method8273(long l2) {
        AutoWeb.field1855[5] = l2 ^ 0x7F41A02C39AB432L;
        AutoWeb.field1855[1] = l2 ^ 0x7F41A02C39AB43AL;
        AutoWeb.field1855[2] = l2 ^ 0x7F41A02C39AB43BL;
        AutoWeb.field1855[0] = l2 ^ 0x7F41A02C39AB430L;
        AutoWeb.field1855[7] = l2 ^ 0x7F41A02C39AB42EL;
        AutoWeb.field1855[4] = l2 ^ 0x7F41A02C39AB439L;
        AutoWeb.field1855[3] = l2 ^ 0x7F41A02C39AB438L;
        AutoWeb.field1855[6] = l2 ^ 0x7F41A02C39AB43EL;
    }

    private static Set method8274() {
        return AutoWeb.method8252();
    }
    ...
    private void method8284(Class133 c2) {
        class_5892 b2;
        class_1297 a2;
        if (AutoWeb.method8267(field290) == null || AutoWeb.field290.field_1687 == null) {
            return;
        }
        class_2596 class_25962 = c2.method251();
        if (class_25962 instanceof class_5892 && (a2 = AutoWeb.field290.field_1687.method_8469((b2 = (class_5892)class_25962).comp_2275())) == AutoWeb.field290.field_1724) {
            if (((Boolean)AutoWeb.method8256(this).method507()).booleanValue()) {
                this.method1273();
            }
        }
    }
    ...
    public AutoWeb() {
        ...
        class_243Array[(int)AutoWeb.field1855[1]] = new class_243(Class4184.field9768, Class3340.field7217, 0.3);
        class_243Array[(int)AutoWeb.field1855[2]] = new class_243(0.3, 0.3, -0.3);
        class_243Array[(int)AutoWeb.field1855[3]] = new class_243(-0.3, 0.3, 0.3);
        class_243Array[(int)AutoWeb.field1855[4]] = new class_243(-0.3, 0.3, Class1734.field6514);
        ...
        this.field1859 = this.method450(new Class260("Sort", "How to filter targets within range", Class525.field2605, AutoWeb.method8304()));
    ...
    private static List method8294(AutoWeb class424) {
        return AutoWeb.method8257(class424);
    }
    ...
    public static Class248 method8301(AutoWeb class424) {
