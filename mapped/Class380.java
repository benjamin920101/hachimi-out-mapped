...
extends Class278 {
    ...
    public static Class248 method5057(Class380 class380) {
    ...
    private static int method5059(int n2, int n3, Class1570 class1570, Class426 class426) {
    ...
    static {
        Class380.method5093(7465060931866073292L);
    }
    ...
    public Class380() {
        ...
        this.field1277 = this.method450(new Class260("Easing", "", Class489.field2533, Class380.method5097()));
    ...
    public static Class248 method5067(Class380 class380) {
        return class380.field1278;
    }

    public static Color method5068(Class380 class380) {
    ...
    public static Class248 method5070(Class380 class380) {
    ...
    public void method5085(Class59 j) {
        Class6009.method23560();
        block8: for (Class6161 d : Class380.method5098().field10997.values()) {
            block23: {
                block22: {
                    block17: {
                        block21: {
                            block19: {
                                block20: {
                                    block18: {
                                        a = d.method24094();
                                        if (a == null) continue;
                                        if (Class5659.method22191((double)d.field12481.method_10263() + Class812.field3591, (double)d.field12481.method_10264() + 0.5, (double)d.field12481.method_10260() + 0.5) > (double)((Float)Class380.method5057(this).method507()).floatValue()) {
                                            v0 = 9169;
...
lbl13:
                                        ...
                                        b = 0.5 * Class380.method5078((Class489)Class380.method5070(this).method507(), 1.0 - Math.min((double)d.field12485.method12592() / d.field12482, 1.0));
                                        ...
                                        if (((Boolean)this.field1274.method507()).booleanValue()) {
                                            Class6454.method24598(a.method_7334().getName(), d.field12481.method_46558().method_1031(0.0, (Boolean)this.field1278.method507() != false ? 0.15 : 0.0, 0.0), (int)Class380.field1276[9]);
                                        }
                                        if (!((Boolean)Class380.method5067(this).method507()).booleanValue()) continue;
                                        if (!Class380.method5087(d)) break block18;
                                        v2 = "\u00a74Failed";
                                        break block19;
                                    }
...
lbl37:
                                ...
                                v2 = Class380.field395.format(Math.min(1.0, (double)d.field12485.method12592() / d.field12482) * 100.0);
                            }
...
lbl55:
            ...
            Class6454.method24598(v2, v5.method_1031(0.0, v7, 0.0), Class380.method5088(d) != false ? (Class380.field290.field_1687.method_22347(d.field12481) != false ? this.field1280 : this.field1269).getRGB() : Class380.method5094(Class380.method5068(this), this.field1280, (double)d.field12485.method12592() / Class380.method5082(d)).getRGB());
        }
        if (((Boolean)this.field1273.method507()).booleanValue()) {
            for (Class6161 i : Class380.method5089(Class5723.field11054).values()) {
                e = i.method24094();
                if (e == null) continue;
    ...
    private static boolean method5087(Class6161 class6161) {
        return Class380.method5073(class6161);
    }
    ...
    private static void method5093(long l2) {
        Class380.field1276[6] = l2 ^ 0x6799395DAE8618C0L;
        Class380.field1276[8] = l2 ^ 0x6799395DAE8618ACL;
        Class380.field1276[4] = l2 ^ 0x6799395DAE8618CAL;
        Class380.field1276[0] = l2 ^ 0x6799395DAE8618CCL;
        Class380.field1276[7] = l2 ^ 0x6799395DAE86188AL;
        Class380.field1276[5] = l2 ^ 0x6799395DAE86187FL;
        Class380.field1276[1] = l2 ^ 0x6799395DAE8618A8L;
        Class380.field1276[3] = l2 ^ 0x6799395DAE861833L;
        Class380.field1276[2] = l2 ^ 0x6799395DAE8618CDL;
        Class380.field1276[9] = l2 ^ 0x9866C6A25179E733L;
    }
