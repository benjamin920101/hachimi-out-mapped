...
extends Class428 {
    ...
    private static Class429 INSTANCE;
    Class248 field1969;
    ...
    private static void method8609(long l2) {
        Class429.field1974[3] = l2 ^ 0x31D197FB11B407CAL;
        Class429.field1974[5] = l2 ^ 0x31D197FB11B40427L;
        Class429.field1974[2] = l2 ^ 0x31D197FB11B40735L;
        Class429.field1974[6] = l2 ^ 0xCE2E6804EE4BF830L;
        Class429.field1974[4] = l2 ^ 0x31D197FB11B407CDL;
        Class429.field1974[0] = l2 ^ 0x31D197FB11B407CEL;
        Class429.field1974[1] = l2 ^ 0x31D197FB11B407CFL;
    }
    ...
    private static Class248 method8630(Class429 class429) {
        return Class429.method8642(class429);
    }
    ...
    private void method8633(boolean a2, float[] b2) {
        ...
        if (a2) {
            Class429.method8612(b2[(int)field1974[1]], b2[(int)field1974[0]]);
        } else {
            Class1503.method14420();
        }
    }
    ...
    static {
        ___.___(24, Class429.class);
        ____.___24_400(Class429.class);
    }
    ...
    public static Class248 method8642(Class429 class429) {
    ...
    public void method8645(Class210 e) {
        block32: {
            block26: {
                f = (int)Class429.field1974[1];
                if (Class376.method4987()) {
                    this.field1963.clear();
                    return;
                }
                if (!((Boolean)Class429.method8673(this.field1536)).booleanValue() && this.method6626()) {
                    this.field1963.clear();
                    return;
                }
                if (!((Boolean)Class429.method8643(Class429.method8653(this))).booleanValue()) break block26;
                v0 = 39572;
                ** GOTO lbl16
            }
            v0 = 39573;
...
lbl16:
                ...
                switch (v0) {
                    ...
                    case 39572: {
                        v1 = this.method8592(Class429.method8641());
                        break block8;
                    }
                    default: {
            ...
            if (g == (int)Class429.field1974[6]) {
                this.field1963.clear();
                return;
            }
            if ((Integer)this.field1972.method507() > 0 && this.field1971 < (Integer)Class429.method8615(this.field1972)) {
                this.field1971 += (int)Class429.field1974[0];
                return;
            }
            h = new ArrayList<class_2338>();
            var5_5 = Class429.method8640(Class5723.field11042).iterator();
            block9: while (true) {
                block30: {
                    block25: {
                        block29: {
...
lbl41:
                                    ...
                                    if (!Class429.method8632(c)) break block28;
                                    v3 = 17493;
                                    ** GOTO lbl54
                                }
                                v3 = 17494;
...
lbl54:
                        ...
                        if (c.method24222() == Class537.field2659 && !((Boolean)this.field1960.method507()).booleanValue() || c.method24223((class_1297)Class429.field290.field_1724) > ((Class252)this.field1966).method564()) continue;
                        if (!Class429.field290.field_1687.method_8628(Class429.field1956, Class429.method8638(c), class_3726.method_16194())) {
                            Class6322.method24332(Class4213.field9862, 0.85810715f);
                            return;
                        }
                        if (!((Boolean)Class429.method8678(this.field1970)).booleanValue()) break block30;
                        var9_9 = Class429.field290.field_1687.method_18456().iterator();
lbl66:
                        // 2 sources
                        ...
                        while (true) {
                            block31: {
                                ...
                                if (b == Class429.field290.field_1724) continue;
                                if (Class5723.field11045.method21243(b.method_5477()) || (a = (double)Class429.field290.field_1724.method_5739((class_1297)b)) > (double)((Float)this.field1973.method507()).floatValue()) continue;
                                if (!(b.method_23318() >= c.method_10214())) break block25;
                                if (!(Class429.method8648(c, (class_1297)b) > ((Class252)Class429.method8630(this)).method564())) break block31;
                                v4 = 23797;
                                ** GOTO lbl80
                            }
                            v4 = 23798;
...
lbl80:
            ...
            if (this.field1963.isEmpty()) {
                if (((Boolean)Class429.method8650(this.field1964)).booleanValue()) {
                    this.method1268();
                }
                return;
            }
...
lbl104:
        ...
        while (f < (Integer)this.field1965.method507() && f < this.field1963.size()) {
            ...
            ++f;
            this.field1971 = (int)Class429.field1974[1];
            this.method8607(d, g);
        }
        if (((Boolean)Class429.method8637(this.field1954)).booleanValue()) {
            v6 = 23218;
    ...
    public void method8649(Class59 h2) {
        if (((Boolean)Class429.method8647(this.field1967)).booleanValue()) {
            Class6009.method23560();
            for (Map.Entry e2 : this.field1959.entrySet()) {
                Class429.method8626((Class6283)e2.getValue(), (boolean)field1974[1]);
                int a2 = (int)(40.0 * Class429.method8613((Class6283)e2.getValue()));
                ...
                Class6454.method24734(Class429.method8617(h2), (class_2338)e2.getKey(), c2.getRGB());
        ...
        this.field1959.entrySet().removeIf(Class429::method8664);
    }
    ...
    public static Class248 method8653(Class429 class429) {
    ...
    public static Class429 method8656() {
        return INSTANCE;
    }

    public static Class429 method8657() {
        return Class429.method8656();
    }
    ...
    private static boolean method8664(Map.Entry a2) {
        if (Class429.method8676((Class6283)a2.getValue()) == 0.0) {
    ...
    public void method8667(List c2) {
        ...
        if (iterator.hasNext()) {
            ...
            class_1297 a2 = Class429.field290.field_1687.method_8335(null, new class_238(b2)).stream().filter(Class429::method8616).findFirst().orElse(null);
            if (a2 == null) {
                Class6454.method24636(Class1086.field4410, 0.35856919577897084, 0.7659105459729633, 0.6778530231248059);
                return;
            }
            Class429.method8671(Class5723.field11048, (class_2596)class_2824.method_34206((class_1297)a2, (boolean)Class429.method8619(field290).method_5715()));
