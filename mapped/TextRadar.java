...
extends Class278 {
    ...
    Class248 field773;
    private static TextRadar INSTANCE;
    Class248 field774;
    Class248 field775;
    ...
    private static int method2794(int n2, int n3, NoSlotSet class323, Class274 class274) {
    ...
    private static double method2799(class_742 a2) {
        return TextRadar.field290.field_1724.method_5739((class_1297)a2);
    }

    private static void method2800(long l2) {
        TextRadar.field781[3] = l2 ^ 0x4FF207AFCD6F328EL;
        TextRadar.field781[1] = l2 ^ 0x4FF207AFCD6F328FL;
        TextRadar.field781[2] = l2 ^ 0x4FF207AFCD6F3167L;
        TextRadar.field781[8] = l2 ^ 0x4FF207AFCD6F328DL;
        TextRadar.field781[10] = l2 ^ 0x4FF207AFCD6F3285L;
        TextRadar.field781[0] = l2 ^ 0x4FF207AFCD6F3753L;
        TextRadar.field781[6] = l2 ^ 0x4FF207AFCD6F329BL;
        TextRadar.field781[5] = l2 ^ 0x4FF207AFCD6F32EBL;
        TextRadar.field781[7] = l2 ^ 0x4FF207AFCD6F3287L;
        TextRadar.field781[11] = l2 ^ 0x4FF207AFCD6F328BL;
        TextRadar.field781[9] = l2 ^ 0x4FF207AFCD6F3289L;
        TextRadar.field781[4] = l2 ^ 0x4FF207AFCD90CD70L;
    }
    ...
    private static Color method2803(Socials class458) {
    ...
    public void method2804(Class233 g2) {
        ...
        ArrayList<class_742> j2 = new ArrayList<class_742>(TextRadar.field290.field_1687.method_18456());
        j2.sort(Comparator.comparingDouble(TextRadar::method2799));
        ...
        while (iterator.hasNext()) {
            ...
            if (class_16572 == TextRadar.field290.field_1724 && !((Boolean)TextRadar.method2805(this.field778)).booleanValue()) {
                Class6454.method24636(0.5989633181437402, 0.3140710029600885, 0.9898780930631589, Class1009.field4180);
                return;
            }
            StringBuilder b2 = new StringBuilder();
            String c2 = " ";
            if (((Boolean)TextRadar.method2815(this).method507()).booleanValue()) {
                b2.append(TextRadar.method2791(class_16572));
            ...
            block5: while (true) {
                switch (n2) {
                    ...
                    case 54012: {
                        b2.append(c2);
                        b2.append(TextRadar.method2802());
                        b2.append(field395.format(TextRadar.field290.field_1724.method_5739((class_1297)class_16572)));
                        b2.append("m");
                        break block5;
                    }
                }
            ...
            if (((Boolean)TextRadar.method2813(this).method507()).booleanValue()) {
                ...
                if (class_16572.method_6059(class_1294.field_5910)) {
                    b2.append(c2);
                    b2.append(TextRadar.method2808());
                    b2.append("Lv.");
                    b2.append(class_16572.method_6112(TextRadar.method2811()).method_5578() + (int)field781[3]);
                    b2.append(c2);
                ...
                if (class_16572.method_6059(class_1294.field_5907)) {
                    b2.append(c2);
                    b2.append(TextRadar.method2796());
                    b2.append("Lv.");
            ...
            int e2 = (d2 = Class5723.field11045.method21261(class_16572)) ? TextRadar.method2803(Socials.method10623()).getRGB() : ((Color)this.field775.method507()).getRGB();
            Class6454.method24624(g2.method6(), b2.toString(), ((Integer)TextRadar.method2814(this).method507()).intValue(), h2, e2);
            h2 += i2;
        }
        return;
    }
    ...
    public class_124 method2807(int a2) {
        int n2 = (Boolean)TextRadar.INSTANCE.field776.method507() != false ? 64992 : 64993;
        block4: while (true) {
            switch (n2) {
                case 64993: {
                    n2 = 64991;
    ...
    private static void method2810(long l2) {
        TextRadar.method2800(l2);
    }

    static {
        field781 = new long[12];
        TextRadar.method2810(5760675325007573647L);
    }
    ...
    public static Class248 method2813(TextRadar class325) {
        return class325.field777;
    }

    public static Class248 method2814(TextRadar class325) {
        return class325.field773;
    }

    public static Class248 method2815(TextRadar class325) {
