...
extends Class278 {
    ...
    private static void method3738(PacketLogger class342, class_2596 class_25962, String string, Object[] objectArray) {
    ...
    public void method3741(Class63 a2) {
        int n2 = a2.method128() == PacketLogger.method3742() ? 46914 : 46915;
        block4: while (true) {
            switch (n2) {
                case 46915: {
                    n2 = 46913;
                ...
                case 46914: {
                    PacketLogger.method3750(this).removeIf(PacketLogger::method3769);
                    return;
                }
            }
            break;
...
lbl12:
                                        ...
                                        switch (v1) {
                                            ...
                                            case 26984: {
                                                ...
                                                this.method3746((class_2596)b, a.toString(), new Object[(int)PacketLogger.field973[1]]);
                                            }
                                        }
                                        break;
                                    }
...
lbl43:
                            ...
                            this.method3746((class_2596)d, c.toString(), new Object[(int)PacketLogger.field973[1]]);
                        }
                        if ((c = x.method251()) instanceof class_2828.class_2831) {
                            f = (class_2828.class_2831)c;
                            if (((Boolean)PacketLogger.method3754(this.field977)).booleanValue()) {
                                e = new StringBuilder();
                                ...
                                this.method3746((class_2596)f, e.toString(), new Object[(int)PacketLogger.field973[1]]);
                            }
                        }
                        if ((e = x.method251()) instanceof class_2828.class_5911) {
                            ...
                            if (((Boolean)this.field974.method507()).booleanValue()) {
                                ...
                                PacketLogger.method3738(this, (class_2596)h, (String)g /* !! */ , new Object[(int)PacketLogger.field973[1]]);
                            }
                        }
                        g /* !! */  = x.method251();
                        if (g /* !! */  instanceof class_2833) {
                            i = (class_2833)g /* !! */ ;
                            if (((Boolean)PacketLogger.method3770(this).method507()).booleanValue()) {
                                v4 = new Object[(int)PacketLogger.field973[5]];
                                v4[(int)PacketLogger.field973[1]] = i.method_12279();
                                v4[(int)PacketLogger.field973[0]] = i.method_12280();
                                v4[(int)PacketLogger.field973[2]] = i.method_12276();
                                v4[(int)PacketLogger.field973[3]] = Float.valueOf(i.method_12281());
                                v4[(int)PacketLogger.field973[4]] = Float.valueOf(i.method_12277());
                        ...
                        if ((g /* !! */  = x.method251()) instanceof class_2846) {
                            ...
                            if (((Boolean)this.field969.method507()).booleanValue()) {
                                v5 = new Object[(int)PacketLogger.field973[3]];
                                v5[(int)PacketLogger.field973[1]] = j.method_12363().name();
                                v5[(int)PacketLogger.field973[0]] = j.method_12360().name();
                                v5[(int)PacketLogger.field973[2]] = j.method_12362().method_23854();
                        ...
                        if ((g /* !! */  = x.method251()) instanceof class_2868) {
                            ...
                            if (((Boolean)this.field979.method507()).booleanValue()) {
                                v6 = new Object[(int)PacketLogger.field973[0]];
                                v6[(int)PacketLogger.field973[1]] = k.method_12442();
...
lbl104:
                ...
                l = (class_2879)g /* !! */ ;
                if (((Boolean)PacketLogger.method3753(PacketLogger.method3752(this))).booleanValue()) {
                    v8 = new Object[(int)PacketLogger.field973[0]];
                    v8[(int)PacketLogger.field973[1]] = l.method_12512().name();
            ...
            if (g /* !! */  instanceof class_6374) {
                m = (class_6374)g /* !! */ ;
                if (((Boolean)PacketLogger.method3747(this).method507()).booleanValue()) {
                    v9 = new Object[(int)PacketLogger.field973[0]];
                    v9[(int)PacketLogger.field973[1]] = m.method_36960();
            ...
            if (g /* !! */  instanceof class_2824) {
                n = (class_2824)g /* !! */ ;
                if (PacketLogger.field290.field_1687 != null && ((Boolean)this.field970.method507()).booleanValue()) {
                    this.method3746((class_2596)n, "InteractEntity", new Object[(int)PacketLogger.field973[1]]);
                }
            }
            if ((g /* !! */  = x.method251()) instanceof class_2885) {
                p = (class_2885)g /* !! */ ;
                if (((Boolean)PacketLogger.method3763(this).method507()).booleanValue()) {
                    o = p.method_12543();
                    v10 = new Object[(int)PacketLogger.field973[3]];
                    v10[(int)PacketLogger.field973[1]] = o.method_17777().method_23854();
                    v10[(int)PacketLogger.field973[0]] = o.method_17780().name();
                    v10[(int)PacketLogger.field973[2]] = p.method_12546().name();
            ...
            if (var2_2 instanceof class_2886) {
                q = (class_2886)var2_2;
                if (((Boolean)PacketLogger.method3757(this).method507()).booleanValue()) {
                    v11 = new Object[(int)PacketLogger.field973[0]];
                    v11[(int)PacketLogger.field973[1]] = q.method_12551().name();
            ...
            if ((var2_2 = x.method251()) instanceof class_2815) {
                ...
                if (((Boolean)this.field978.method507()).booleanValue()) {
                    v12 = new Object[(int)PacketLogger.field973[0]];
                    v12[(int)PacketLogger.field973[1]] = r.method_36168();
            ...
            if (var2_2 instanceof class_2848) {
                ...
                if (((Boolean)this.field985.method507()).booleanValue()) {
                    v13 = new Object[(int)PacketLogger.field973[0]];
                    v13[(int)PacketLogger.field973[1]] = s.method_12365().name();
            ...
            if ((var2_2 = x.method251()) instanceof class_2799) {
                ...
                if (((Boolean)this.field963.method507()).booleanValue()) {
                    v14 = new Object[(int)PacketLogger.field973[0]];
                    v14[(int)PacketLogger.field973[1]] = t.method_12119().name();
                    this.method3746((class_2596)t, "ClientStatus - mode: %s", v14);
                }
            }
            var2_2 = x.method251();
            if (!(var2_2 instanceof class_2813)) {
                PacketLogger.method3759();
                return;
            }
            u = (class_2813)var2_2;
...
lbl174:
            ...
            switch (v15) {
                ...
                case 63045: {
                    v16 = new Object[(int)PacketLogger.field973[4]];
                    v16[(int)PacketLogger.field973[1]] = u.method_12195().name();
                    v16[(int)PacketLogger.field973[0]] = u.method_12192();
                    v16[(int)PacketLogger.field973[2]] = u.method_12193();
                    v16[(int)PacketLogger.field973[3]] = u.method_12194();
        ...
        if (var2_2 instanceof class_2838) {
            ...
            if (((Boolean)this.field983.method507()).booleanValue()) {
                v17 = new Object[(int)PacketLogger.field973[0]];
                v17[(int)PacketLogger.field973[1]] = v.method_12293();
        ...
        if (var2_2 instanceof class_2793) {
            w = (class_2793)var2_2;
            if (((Boolean)PacketLogger.method3765(this).method507()).booleanValue()) {
                v18 = new Object[(int)PacketLogger.field973[0]];
                v18[(int)PacketLogger.field973[1]] = w.method_12086();
    ...
    private void method3746(class_2596 a2, String b2, Object ... c2) {
        ...
        if (((Boolean)PacketLogger.method3772(PacketLogger.method3755(this))).booleanValue()) {
            this.method1250(d2);
        }
        this.field975.add(new Class662(a2, System.currentTimeMillis()));
    }

    public static Class248 method3747(PacketLogger class342) {
    ...
    private static List method3750(PacketLogger class342) {
        return PacketLogger.method3751(class342);
    }

    public static List method3751(PacketLogger class342) {
        return class342.field975;
    }

    public static Class248 method3752(PacketLogger class342) {
    ...
    public static Class248 method3755(PacketLogger class342) {
    ...
    public static Class248 method3757(PacketLogger class342) {
    ...
    private static void method3761(long l2) {
        PacketLogger.field973[2] = l2 ^ 0x832536E69B98C291L;
        PacketLogger.field973[0] = l2 ^ 0x832536E69B98C292L;
        PacketLogger.field973[6] = l2 ^ 0x832536E69B98C92BL;
        PacketLogger.field973[5] = l2 ^ 0x832536E69B98C296L;
        PacketLogger.field973[3] = l2 ^ 0x832536E69B98C290L;
        PacketLogger.field973[4] = l2 ^ 0x832536E69B98C297L;
        PacketLogger.field973[1] = l2 ^ 0x832536E69B98C293L;
    }
    ...
    public static Class248 method3763(PacketLogger class342) {
    ...
    public static Class248 method3765(PacketLogger class342) {
        return class342.field968;
    }

    static {
        PacketLogger.method3761(-8996724316521839981L);
    }
    ...
    public static Class248 method3770(PacketLogger class342) {
    ...
    public void method3773(Class229 f2) {
        ...
        for (Class662 c2 : this.field975) {
            class_2596 a2 = PacketLogger.method3764(c2);
        ...
        while (true) {
            if (!iterator.hasNext()) {
                PacketLogger.method3758(String.join((CharSequence)",", h2));
                return;
            }
