...
extends Class278 {
    ...
    private static int method5764(Class457 class457, int n2) {
                ...
                block49: {
                    block53: {
                        block51: {
                            ...
                            block16: for (class_1297 k : Class397.field290.field_1687.method_18112()) {
                                block47: {
...
lbl13:
                                ...
                                j = (int)Class397.field1386[4];
                                for (h = (int)Class397.field1386[4]; h < (int)Class397.field1386[5]; ++h) {
                                    g = i.method12121();
                                    if (g != null) {
                                        if (g.method_17783() == class_239.class_240.field_1332 && g instanceof class_3965) {
                                            ...
                                            Class6454.method24658(K.method125(), b, c, d, b + (int)Class397.field1386[0], c + (int)Class397.field1386[0], d + (int)Class397.field1386[0], a, Class457.method10620().method10615((int)Class397.field1386[2]));
                                            continue block16;
                                        }
                                        ...
                                        f = (class_3966)g;
                                        Class6454.method24621(Class397.method5808(K), Class397.method5766(f.method_17782()), Class457.method10620().method10615((int)Class397.field1386[1]));
                                        Class6454.method24605(K.method125(), Class6023.method23731(f.method_17782()), 1.5f, Class457.method10620().method10615((int)Class397.field1386[6]));
                                        continue block16;
                                    }
                                    Class6454.method24682(Class397.method5783(K), new class_243(i.field_6014, i.field_6036, i.field_5969), i.method_19538(), 1.5f, Class457.method10620().method10618(j).getRGB());
                                    j += 40;
                                }
                            }
                        }
                        if (!((Boolean)Class397.method5776(this.field1384)).booleanValue()) break block52;
                        G = ((Integer)Class397.field290.field_1690.method_41808().method_41753()).intValue();
                        H = Class397.field290.field_1724.method_6047();
                        I = H.method_7909();
                        L.method_34425(Class397.field290.field_1773.method_22973(G));
...
lbl61:
                        ...
                        switch (v1) {
                            ...
                            {
                                if (Class397.field290.field_1724.method_6048() > 0) break block19;
                            }
                            default: {
                    ...
                    s = Class397.method5839(Class397.field290).method_36454();
                    t = Class6023.method23738(Class397.field290.field_1724.field_6014, Class397.field290.field_1724.method_23317(), Class397.field290.method_60646().method_60637((boolean)Class397.field1386[0]));
                    u = Class6023.method23738(Class397.method5838((class_310)Class397.field290).field_6036, Class397.field290.field_1724.method_23318(), Class397.field290.method_60646().method_60637((boolean)Class397.field1386[0]));
                    v = Class6023.method23738(Class397.field290.field_1724.field_5969, Class397.field290.field_1724.method_23321(), Class397.field290.method_60646().method_60637((boolean)Class397.field1386[0]));
                    u = u + (double)Class397.field290.field_1724.method_18381(Class397.field290.field_1724.method_18376()) - 0.1000000014901161;
                    if (I == Class397.field290.field_1724.method_6047().method_7909()) {
                    ...
                    x = -class_3532.method_15374((float)(s / 180.0f * Class4068.field9398)) * class_3532.method_15362((float)(Class397.field290.field_1724.method_36455() / 180.0f * 3.1415927f)) * w;
                    y = -class_3532.method_15374((float)((Class397.field290.field_1724.method_36455() + (float)(I instanceof class_1828 || I instanceof class_1803 || I instanceof class_1779 ? (int)Class397.field1386[3] : (int)Class397.field1386[4])) / 180.0f * 3.1415927f)) * w;
                    z = class_3532.method_15362((float)(s / 180.0f * 3.1415927f)) * class_3532.method_15362((float)(Class397.field290.field_1724.method_36455() / 180.0f * 3.1415927f)) * w;
                    A = (float)Class397.field290.field_1724.method_6048() / 20.0f;
                    A = (A * A + A * 2.0f) / 3.0f;
                    if (A > 1.0f) {
                        A = 1.0f;
                    }
                    ...
                    y *= (double)C;
                    z *= (double)C;
                    if (!Class397.field290.field_1724.method_24828()) {
                        y += Class397.field290.field_1724.method_18798().method_10214();
                    }
                    x += Class397.field290.field_1724.method_18798().method_10216();
                    z += Class397.field290.field_1724.method_18798().method_10215();
                    if (I instanceof class_1753) {
                        Class5836.method22885();
                        return;
                    }
                        ...
                        block60: {
                            block56: {
                                block55: {
                                    block50: {
                                        block54: {
                                            n = (int)Class397.field1386[4];
                                            E = new class_243(t, u, v);
                                            o = class_2338.method_49637((double)(t += x), (double)(u += y), (double)(v += z));
                                            if (Class397.field290.field_1687.method_8320(o).method_26204() == Class397.method5768()) {
                                                x *= 0.8;
                                                y *= 0.8;
                                                z *= 0.8;
                                            } else {
                                            ...
                                            if (!(Class397.method5770(Class397.field290).method_6047().method_7909() instanceof class_1764)) break block54;
                                            v5 = 4583;
                                            ** GOTO lbl145
                                        }
                                        v5 = 4584;
...
lbl145:
                            ...
                            var41_37 = Class397.field290.field_1687.method_8335(null, p).iterator();
                            block23: while (true) {
                                block58: {
                                    block57: {
...
lbl165:
                                    ...
                                    if (l == Class397.field290.field_1724) break block58;
                                    v7 = 45647;
                                    if (true) ** GOTO lbl178
                                }
                                v8 = 45648;
...
lbl178:
                                ...
                                Class6454.method24621(K.method125(), Class397.method5787(l), Class397.method5764(Class457.method10620(), (int)Class397.field1386[1]));
                                Class6454.method24605(K.method125(), Class6023.method23731(l), 1.5f, Class457.method10620().method10615((int)Class397.field1386[6]));
                                n = (int)Class397.field1386[0];
                            }
                            q = new class_243(t, u, v);
                            r = Class397.method5807(Class397.field290).method_17742(new class_3959(E, q, class_3959.class_3960.field_17558, class_3959.class_242.field_1348, (class_1297)Class397.field290.field_1724));
...
lbl212:
                            ...
                            switch (v10) {
                                ...
                                {
                                    Class6454.method24700(K.method125(), t - Class5763.field11171, u - 0.6000000238418579, v, t + 0.6000000238418579, u + Class1758.field6594, v, m, Class457.method10620().method10615((int)Class397.field1386[2]));
                                    break block27;
                                }
                                default: {
...
lbl221:
                                    ...
                                    Class6454.method24700(K.method125(), t, u - 0.6000000238418579, v - Class6006.field11986, t, u + Class1815.field6757, v + 0.6000000238418579, m, Class457.method10620().method10615((int)Class397.field1386[2]));
                                    break block27;
lbl223:
                                    // 1 sources

                                    Class6454.method24700(K.method125(), t - 0.6000000238418579, u, v - Class1702.field6312, t + 0.6000000238418579, u, v + 0.6000000238418579, m, Class457.method10620().method10615((int)Class397.field1386[2]));
                                }
                            }
                            break;
                        }
                    }
                    if (u < (double)Class397.field290.field_1687.method_31607()) break;
                    if (x == 0.0 && y == 0.0) {
                        if (z == 0.0) continue;
                    }
                    Class6454.method24682(Class397.method5825(K), E, q, 1.5f, Class457.method10620().method10621());
                    if (n == 0) continue;
                    F = (int)Class397.field1386[0];
                }
            }
    ...
    private static class_638 method5807(class_310 class_3102) {
        return Class397.method5811(class_3102);
    }
    ...
    private static void method5818(long l2) {
        Class397.field1386[1] = l2 ^ 0xDB9C041133C4236CL;
        Class397.field1386[6] = l2 ^ 0xDB9C041133C423D5L;
        Class397.field1386[3] = l2 ^ 0x2463FBEECC3BDCA8L;
        Class397.field1386[4] = l2 ^ 0xDB9C041133C42344L;
        Class397.field1386[5] = l2 ^ 0xDB9C041133C422B0L;
        Class397.field1386[0] = l2 ^ 0xDB9C041133C42345L;
        Class397.field1386[2] = l2 ^ 0xDB9C041133C423C8L;
    }
    ...
    static {
        Class397.method5818(-2622216411107024060L);
    }
