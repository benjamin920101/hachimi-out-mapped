...
extends Class278 {
    ...
    public void method4275(Class106 a2) {
        if (((Boolean)Animations.method4278(Animations.method4288(this))).booleanValue()) {
            a2.method10();
            Animations.method4277(a2, 0.0f);
        }
    }
    ...
    public void method4281(Class133 f2) {
        int n2;
        class_2616 e2;
        if (Animations.field290.field_1724 == null) {
            return;
        }
        ...
        if (!(class_25962 instanceof class_8042)) {
            ...
            n2 = ((Boolean)Animations.method4272(this.field1062)).booleanValue() ? 1476 : 1477;
        } else {
            ...
            while (true) {
                ...
                if (b2 instanceof class_2616) {
                    ...
                    if (((Boolean)Animations.method4292(this).method507()).booleanValue() && a2.method_11269() == Animations.field290.field_1724.method_5628() && (a2.method_11267() == 0 || a2.method_11267() == (int)field1056[4])) continue;
                }
                c2.add(b2);
            }
        }
        block5: while (true) {
            switch (n2) {
                ...
                case 1476: {
                    if (e2.method_11269() != Animations.field290.field_1724.method_5628() || e2.method_11267() != 0 && e2.method_11267() != (int)field1056[4]) return;
                    f2.method10();
                    return;
                }
            }
    ...
    static {
        Animations.method4287(-8175834399936236313L);
    }
    ...
    public static Class248 method4286(Animations class353) {
        return class353.field1057;
    }

    private static void method4287(long l2) {
        Animations.field1056[1] = l2 ^ 0x8E8999EE4161B4E7L;
        Animations.field1056[2] = l2 ^ 0x8E8999EE4161B4F3L;
        Animations.field1056[0] = l2 ^ 0x8E8999EE4161B4E1L;
        Animations.field1056[3] = l2 ^ 0x8E8999EE4161B4E6L;
        Animations.field1056[4] = l2 ^ 0x8E8999EE4161B4E4L;
    }

    private static Class248 method4288(Animations class353) {
        return Animations.method4286(class353);
    }

    @Class1
    public void method4289(Class122 a2) {
        if (((Boolean)Animations.method4294(this).method507()).booleanValue() && ((Boolean)this.field1064.method507()).booleanValue()) {
    ...
    public static Class248 method4292(Animations class353) {
    ...
    public static Class248 method4294(Animations class353) {
        return class353.field1057;
    }
    ...
    public void method4297(Class21 a2) {
        if (((Boolean)this.field1059.method507()).booleanValue()) {
            ...
            Animations.method4295(a2, (Boolean)this.field1063.method507());
        }
    }

    private Boolean method1278() {
        return (Boolean)Animations.method4279(this.field1061);
    }
