...
extends Class411 {
    ...
    public void method1274() {
        if (AntiAim.field290.field_1724 == null) {
            return;
        }
        AntiAim.method9475(this, AntiAim.field290.field_1724.method_36454());
        this.field2193 = AntiAim.field290.field_1724.method_36455();
    }
    ...
    static {
        AntiAim.method9465(-5277338910894286607L);
    }
    ...
    private static void method9465(long l2) {
        AntiAim.field2192[0] = l2 ^ 0xB6C3203898CC98F3L;
        AntiAim.field2192[2] = l2 ^ 0xB6C3203898CC98E5L;
        AntiAim.field2192[1] = l2 ^ 0xB6C3203898CC98C3L;
    }
    ...
    public void method9466(Class210 c2) {
        float f2;
        float f3;
        if (AntiAim.method9458(AntiAim.field290.field_1690).method_1434() || AntiAim.field290.field_1690.field_1904.method_1434()) {
            return;
        }
        switch (((Class587)((Object)this.field2190.method507())).ordinal()) {
            ...
            case 0: {
                f3 = AntiAim.field290.field_1724.method_36454();
                break;
            }
            case 1: {
                f3 = AntiAim.field290.field_1724.method_36454() + ((Float)this.field2185.method507()).floatValue();
                break;
            }
            case 2: {
            ...
            case 4: {
                f3 = AntiAim.method9470(field290).method_36454() + (AntiAim.field290.field_1724.field_6012 % (Integer)this.field2189.method507() == 0 ? ((Float)AntiAim.method9460(this.field2185)).floatValue() : -((Float)AntiAim.method9461(this.field2185)).floatValue());
            }
        }
        this.field2184 = f3;
        switch (((Class474)((Object)AntiAim.method9462(AntiAim.method9471(this)))).ordinal()) {
            default: {
                throw new MatchException(null, null);
            }
            case 0: {
                f2 = AntiAim.field290.field_1724.method_36455();
                break;
            }
            case 1: {
    ...
    public static Class248 method9471(AntiAim class439) {
        return class439.field2188;
    }

    public static void method9472(AntiAim class439, float f2) {
    ...
    public static void method9475(AntiAim class439, float f2) {
