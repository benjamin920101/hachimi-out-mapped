...
extends Class411 {
    ...
    private int method9481() {
        ...
        for (int c2 = (int)field2196[0]; c2 < (int)field2196[8]; ++c2) {
            class_1738 a2;
            class_1799 b2 = ClickTweaks.field290.field_1724.method_31548().method_5438(c2);
            ...
            if (a2.method_7686() == class_1740.field_21977) {
                if (ClickTweaks.method9487(ClickTweaks.method9508(this)) == Class476.field2488) {
                    d2 = c2;
                    break;
                }
            }
            if (a2.method_7686() == class_1740.field_7889 && ClickTweaks.method9486(this).method507() == Class476.field2490) {
                d2 = c2;
                break;
            }
            d2 = c2;
    ...
    private static class_2596 method9483(float a2, float b2, int c2) {
        return new class_2886(ClickTweaks.method9526(), c2, a2, b2);
    }
    ...
    public void method9485() {
        block8: {
            ...
            if (ClickTweaks.method9489((Class246)this.field2199.method507())) {
                if (((Class246)this.field2198.method507()).method500() == ((Class246)ClickTweaks.method9521(this.field2199)).method500()) {
                    return;
                }
            }
            a = ClickTweaks.method9498(new Class3812(class_1802.field_8639, (Class607)this.field2194.method507()));
            if (!ClickTweaks.field290.field_1724.method_6128()) ** GOTO lbl-1000
            if (!a.method18523()) {
                v0 = 40392;
...
lbl15:
            ...
            b = ClickTweaks.method9494(Class5723.field11058);
            ClickTweaks.method9479(a, b);
            ClickTweaks.method9500().method21353((class_7204)LambdaMetafactory.metafactory(null, null, null, (I)Lnet/minecraft/class_2596;, method9510(int ), (I)Lnet/minecraft/class_2596;)());
            ((Class480)ClickTweaks.method9542(this).method507()).method10782(class_1268.field_5808);
            a.method18534(b);
        }
    }

    public static Class248 method9486(ClickTweaks class440) {
    ...
    private static class_746 method9493(class_310 class_3102) {
        return ClickTweaks.method9516(class_3102);
    }
    ...
    public void method9502() {
        if (this.method1265()) {
            ...
            if (((Class246)this.field2199.method507()).field295) {
                if (ClickTweaks.method9509((Class246)this.field2201.method507()) == ((Class246)this.field2199.method507()).method500()) {
                    return;
                }
            }
            if (((Class246)ClickTweaks.method9538((Class248)ClickTweaks.method9511((ClickTweaks)this))).field295) {
                if (((Class246)this.field2201.method507()).method500() != ((Class246)ClickTweaks.method9477(this.field2198)).method500()) {
                    Class5836.method22897();
                    return;
                }
                return;
            }
            if (((Class246)ClickTweaks.method9484(this.field2201)).method500() == ((Class246)this.field2198.method507()).method500() && ClickTweaks.field290.field_1724.method_6128() && (a2 = ClickTweaks.method9515(new Class3812(class_1802.field_8639, (Class607)((Object)this.field2194.method507())))).method18523()) {
                return;
            }
            Class3812 b2 = new Class3812(class_1802.field_8634, (Class607)((Object)ClickTweaks.method9513(this.field2194))).method18502();
            if (!b2.method18523()) {
                return;
            }
            float c2 = ClickTweaks.method9493(field290).method_36454();
            float d2 = ClickTweaks.field290.field_1724.method_36455();
            int e2 = Class5723.field11058.method18969();
            ClickTweaks.method9476(c2, d2);
            b2.method18531(e2);
            Class5723.field11048.method21353(arg_0 -> ClickTweaks.method9483(c2, d2, arg_0));
    ...
    private static int method9504(ClickTweaks class440) {
    ...
    public void method9505() {
        if (this.method1265()) {
            ...
            class_239 c2;
            double b2 = ClickTweaks.field290.field_1724.method_55755();
            class_239 class_2392 = c2 = Freecam.method4718().method1265() ? Class976.method12718(b2, ClickTweaks.method9529(ClickTweaks.method9534()), Freecam.method4718().method4735()) : Class976.method12730(b2);
    ...
    private static void method9507(long l2) {
        ClickTweaks.field2196[2] = l2 ^ 0xD355DA342097B8E7L;
        ClickTweaks.field2196[8] = l2 ^ 0xD355DA342097B8C1L;
        ClickTweaks.field2196[7] = l2 ^ 0xD355DA342097B8E3L;
        ClickTweaks.field2196[0] = l2 ^ 0xD355DA342097B8E5L;
        ClickTweaks.field2196[3] = l2 ^ 0xD355DA342097B8E6L;
        ClickTweaks.field2196[6] = l2 ^ 0xD355DA342097B8ECL;
        ClickTweaks.field2196[9] = l2 ^ 0xD355DA342097B8C8L;
        ClickTweaks.field2196[1] = l2 ^ 0x2CAA25CBDF68471AL;
        ClickTweaks.field2196[4] = l2 ^ 0xD355DA342097B8E1L;
        ClickTweaks.field2196[5] = l2 ^ 0xD355DA342097B8E4L;
    }

    private static Class248 method9508(ClickTweaks class440) {
        return ClickTweaks.method9531(class440);
    }
    ...
    private static class_2596 method9510(int a2) {
        return new class_2886(ClickTweaks.method9530(), a2, ClickTweaks.field290.field_1724.method_36454(), ClickTweaks.field290.field_1724.method_36455());
    }

    public static Class248 method9511(ClickTweaks class440) {
        return class440.field2198;
    }

    private static class_2596 method9512(int a2) {
        return new class_2886(class_1268.field_5808, a2, ClickTweaks.field290.field_1724.method_36454(), ClickTweaks.field290.field_1724.method_36455());
    }
    ...
    private static int method9520(int n2, int n3, Strafe class282, Class829 class829) {
    ...
    private int method9525() {
        ...
        for (int b2 = (int)field2196[0]; b2 < (int)field2196[8]; ++b2) {
            class_1799 a2 = ClickTweaks.field290.field_1724.method_31548().method_5438(b2);
    ...
    private static class_243 method9529(Freecam class365) {
        return class365.method4722();
    }

    static {
        ClickTweaks.method9507(-3218426441266382619L);
    }
    ...
    public static Class248 method9531(ClickTweaks class440) {
        return class440.field2195;
    }
    ...
    public ClickTweaks() {
        ...
        class246Array[(int)ClickTweaks.field2196[0]] = (Class246)this.field2199.method507();
        class246Array[(int)ClickTweaks.field2196[5]] = (Class246)ClickTweaks.method9540(this.field2198);
        class246Array[(int)ClickTweaks.field2196[2]] = (Class246)this.field2201.method507();
        class246Array[(int)ClickTweaks.field2196[3]] = (Class246)this.field2197.method507();
    ...
    private static Freecam method9534() {
    ...
    public void method9535() {
        if (this.method1265()) {
            class_1738 f2;
            class_1799 h2 = ClickTweaks.field290.field_1724.method_31548().method_7372((int)field2196[2]);
            ...
            if (class_17922 instanceof class_1738 && (f2 = (class_1738)class_17922).method_7685() == class_1304.field_6174) {
                ...
                if (e2 != (int)field2196[1]) {
                    ...
                    ClickTweaks.method9490().method18923(e2);
                    ...
                    if (((Boolean)this.field2200.method507()).booleanValue() && !ClickTweaks.field290.field_1724.method_24828()) {
                        Class5723.field11048.method21341((class_2596)new class_2848((class_1297)ClickTweaks.field290.field_1724, class_2848.class_2849.field_12982));
                        ClickTweaks.field290.field_1724.method_23669();
                        int d2 = (int)field2196[1];
                        int b2 = (int)field2196[0];
                        if (b2 < (int)field2196[9]) {
                            class_1799 a2 = ClickTweaks.field290.field_1724.method_31548().method_5438(b2);
                            if (a2.method_7909() == ClickTweaks.method9523()) {
                                d2 = b2;
                            } else {
                                ++b2;
                                Class5836.method22890();
                ...
                int g2 = ClickTweaks.method9504(this);
    ...
    public static Class248 method9542(ClickTweaks class440) {
