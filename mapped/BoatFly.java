...
extends Class278 {
    ...
    private static boolean method2836(Disabler class390) {
                ...
                block17: {
                    block13: {
                        block16: {
                            block12: {
                                block15: {
                                    if (BoatFly.method2862(BoatFly.field290).method_5854() == null || BoatFly.method2836(Disabler.method5496())) {
                                        return;
                                    }
                                    c = BoatFly.field290.field_1724.method_5854();
                                    ...
                                    v0 = this;
                                    BoatFly.method2839(v0, BoatFly.method2842(v0) + (double)((Float)this.field796.method507()).floatValue());
                                    if (this.field794 > (double)((Float)this.field795.method507()).floatValue()) {
                                        this.field794 = ((Float)BoatFly.method2860(BoatFly.method2847(this))).floatValue();
                                    }
                                    c.method_36456(BoatFly.field290.field_1724.method_36454());
                                    if (c instanceof class_1501) {
                                        a = (class_1501)c;
                                        a.field_6241 = BoatFly.field290.field_1724.method_36454();
                                    }
                                    d = (int)BoatFly.field793[0];
                                    if (!BoatFly.method2870(this)) break block14;
                                    this.field788 += (int)BoatFly.field793[1];
                                    if (this.field788 < (int)BoatFly.field793[2]) break block15;
                                    v1 = 15149;
                                    ** GOTO lbl28
                                }
                                v1 = 15150;
...
lbl28:
                            ...
                            if (BoatFly.method2873(BoatFly.method2863(this)) != Class575.field2814) break block16;
                            v2 = 37525;
                            ** GOTO lbl40
                        }
                        v2 = 37526;
...
lbl40:
                    ...
                    BoatFly.method2875(this, (boolean)BoatFly.field793[1]);
                    break block18;
                }
                if (this.field789.method507() == BoatFly.method2867()) {
                    c.method_5814(c.method_23317(), c.method_23318() - 0.0313, c.method_23321());
                }
            }
            this.field788 = (int)BoatFly.field793[0];
            this.field797 = (int)BoatFly.field793[0];
            d = (int)BoatFly.field793[1];
        }
        c.method_18800(c.method_18798().field_1352, 0.0, c.method_18798().field_1350);
        if (BoatFly.field290.field_1690.field_1903.method_1434() && d == 0) {
            c.method_18800(c.method_18798().field_1352, (double)((Float)this.field790.method507()).floatValue(), c.method_18798().field_1350);
        } else if (BoatFly.field290.field_1690.field_1832.method_1434()) {
            c.method_18800(BoatFly.method2888(c.method_18798()), (double)(-((Float)BoatFly.method2871(this).method507()).floatValue()), c.method_18798().field_1350);
        }
        this.field794 = Math.max(this.field794, 0.2872999906539917);
        e = BoatFly.method2850(BoatFly.field290.field_1724.field_3913);
        f = BoatFly.field290.field_1724.field_3913.field_3907;
        g = BoatFly.method2884(BoatFly.field290).method_36454();
        if (e == 0.0f && f == 0.0f) {
            return;
        }
        h = Math.cos(Math.toRadians(g + 90.0f));
        i = Math.sin(Math.toRadians(g + Class6078.field12232));
        c.method_18800((double)e * this.field794 * h + (double)f * this.field794 * i, c.method_18798().field_1351, (double)e * BoatFly.method2885(this) * i - (double)f * this.field794 * h);
        b.method10();
    }

    public static void method2839(BoatFly class328, double d2) {
    ...
    public static double method2842(BoatFly class328) {
    ...
    private static Class248 method2847(BoatFly class328) {
        return BoatFly.method2879(class328);
    }
    ...
    public static Class248 method2853(BoatFly class328) {
    ...
    private static class_746 method2856(class_310 class_3102) {
        return BoatFly.method2840(class_3102);
    }

    private static boolean method2857(BoatFly class328, class_2833 class_28332, class_1297 class_12972) {
    ...
    public void method2861(Class131 d2) {
        if (BoatFly.field290.field_1724 == null || BoatFly.field290.field_1724.method_5854() == null) {
            return;
        }
        class_1297 e2 = BoatFly.method2856(field290).method_5854();
            ...
            block4: while (true) {
                switch (n2) {
                    ...
                    case 42313: {
                        ...
                        if (!this.field791) {
                            this.field797 = BoatFly.method2857(this, b2, e2);
                            this.field800 = a2;
                            break block4;
                        }
                        ((bH)b2).hookSetY(BoatFly.method2890(this) - 0.04);
        ...
        if ((class_25962 = d2.method251()) instanceof class_2848) {
            ...
            if (c2.method_12365() != BoatFly.method2855()) {
                BoatFly.method2886(1393832549, -1722093955, -1963766163, 2138821733);
                return;
            }
            if (BoatFly.method2889(field290).method_5854() != null && !BoatFly.field290.field_1724.method_5854().method_24828()) {
                d2.method10();
            }
        }
    }
    ...
    public static Class248 method2863(BoatFly class328) {
    ...
    public void method2866(Class109 a2) {
        if (BoatFly.field290.field_1724.method_5854() != null) {
            int n2 = 6656;
            Class5836.method22890();
            return;
        }
    ...
    private static void method2868(long l2) {
        BoatFly.field793[0] = l2 ^ 0x477324952AAA2FD3L;
        BoatFly.field793[2] = l2 ^ 0x477324952AAA2FC7L;
        BoatFly.field793[1] = l2 ^ 0x477324952AAA2FD2L;
    }
    ...
    public static boolean method2870(BoatFly class328) {
        return class328.field797;
    }

    static {
        BoatFly.method2868(5148499022099132371L);
    }

    public static Class248 method2871(BoatFly class328) {
        return class328.field790;
    }

    @Class1
    public void method2872(Class11 a2) {
        if (BoatFly.field290.field_1690.field_1832.method_1434()) {
            a2.method10();
        }
    }
    ...
    public static void method2875(BoatFly class328, boolean bl2) {
    ...
    public static Class248 method2879(BoatFly class328) {
    ...
    private static class_746 method2884(class_310 class_3102) {
        return BoatFly.method2891(class_3102);
    }
    ...
    public static double method2885(BoatFly class328) {
        return class328.field794;
    }
    ...
    private Boolean method1269() {
        return (Boolean)BoatFly.method2892(this).method507();
    }

    private static double method2888(class_243 class_2432) {
        return BoatFly.method2851(class_2432);
    }
    ...
    public static double method2890(BoatFly class328) {
    ...
    private static Class248 method2892(BoatFly class328) {
        return BoatFly.method2853(class328);
    }
