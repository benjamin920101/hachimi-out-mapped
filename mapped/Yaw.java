...
extends Class278 {
    ...
    public void method2821(Class209 b2) {
        int n2 = ((Boolean)Yaw.method2827(this.field786)).booleanValue() ? 13489 : 13490;
        int n3 = n2;
        if (n3 != 13489) {
            if (n3 == 13490) return;
            return;
            ...
            Yaw.field290.field_1724.method_36457(class_3532.method_15363((float)(Yaw.field290.field_1724.method_36455() + a2), (float)Class3749.field8487, (float)Class3239.field6945));
        }
    }

    static {
        Yaw.method2834(-5786006972326298065L);
    }
    ...
    private static void method2834(long l2) {
        Yaw.field787[0] = l2 ^ 0xAFB3F950728EBE2FL;
    }
