    ...
    public void method3778(Class63 r) {
        block19: {
            block20: {
                ...
                q = this.method3809(ChestStealer.field290.field_1724.field_7512);
                if (!((Boolean)ChestStealer.method3822(this).method507()).booleanValue()) break block20;
                l = new HashMap<Class942, Integer>();
                for (g = (int)ChestStealer.field989[0]; g < q; ++g) {
                    block17: {
                        block21: {
                            f = ChestStealer.field290.field_1724.field_7512.method_7611(g);
                            if (!f.method_7681()) continue;
                            e = Kit.method10551(f.method_7677());
                            if (e == null) continue;
...
lbl20:
                    ...
                    d = (int)ChestStealer.field989[0];
                    for (Class942 a : Kit.field2383.values()) {
                        block18: {
                            block22: {
...
lbl34:
                    ...
                    c = (int)ChestStealer.field989[0];
                    if (c < (int)ChestStealer.field989[10]) {
                        b = ChestStealer.method3780(ChestStealer.field290).method_31548().method_5438(c);
                ...
                m = (int)ChestStealer.field989[0];
                for (k = (int)ChestStealer.field989[0]; k < q; ++k) {
                    if (m >= (Integer)ChestStealer.method3823(this.field990)) {
                        return;
                    }
                    j = ChestStealer.field290.field_1724.field_7512.method_7611(k);
                    if (!j.method_7681() || (i = Kit.method10551(j.method_7677())) == null || (h = l.getOrDefault(i, (int)ChestStealer.field989[0]).intValue()) <= 0) continue;
                    h -= this.method3804(ChestStealer.field290.field_1724.field_7512.field_7763, j, h, ChestStealer.field290.field_1724.field_7512.method_7602().size(), j.method_7677());
                    l.put(i, h);
                }
                break block19;
            }
            p = (int)ChestStealer.field989[0];
            o = (int)ChestStealer.field989[0];
            while (true) {
                block23: {
                    if (o >= q) {
...
lbl77:
                ...
                n = ChestStealer.field290.field_1724.field_7512.method_7611(o);
                if (n.method_7681() && this.method3786(n.method_7677().method_7909())) {
                    this.method3793(ChestStealer.method3811((class_310)ChestStealer.field290).field_7512.field_7763, n);
                    ChestStealer.method3807(this).method12593();
                    ++p;
                }
                ++o;
            }
    ...
    private boolean method3786(class_1792 a2) {
        return ((Class249)ChestStealer.method3825(this)).method522(a2);
    }
    ...
    private void method3793(int a2, class_1735 b2) {
        ChestStealer.field290.field_1761.method_2906(a2, b2.field_7874, (int)field989[0], ChestStealer.method3790(), (class_1657)ChestStealer.field290.field_1724);
    }
    ...
    public static Class248 method3798(ChestStealer class344) {
    ...
    private static int method3800(int n2, int n3, Class1763 class1763, TridentTweaks class363) {
    ...
    private int method3804(int g2, class_1735 h2, int i2, int j2, class_1799 k2) {
        ...
        block13: while (true) {
            switch (n4) {
                ...
                case 29731: {
                    ChestStealer.field290.field_1761.method_2906(g2, h2.field_7874, (int)field989[0], class_1713.field_7794, (class_1657)ChestStealer.field290.field_1724);
                    if (i2 >= l2) return m2;
                    ...
                    block14: while (true) {
                        switch (n5) {
                            ...
                            case 49972: {
                                ...
                                ChestStealer.field290.field_1761.method_2906(g2, j2 - (int)field989[11] + (o2 >= (int)field989[4] ? o2 - (int)field989[4] : o2 + (int)field989[7]), (int)field989[0], class_1713.field_7794, (class_1657)ChestStealer.field290.field_1724);
                                return m2;
                            }
                        }
                        break;
    ...
    private static void method3806(long l2) {
        ChestStealer.field989[7] = l2 ^ 0x4A6BB0EECC755B3DL;
        ChestStealer.field989[9] = l2 ^ 0x4A6BB0EECC755B24L;
        ChestStealer.field989[12] = l2 ^ 0xB5944F11338AA4D9L;
        ChestStealer.field989[1] = l2 ^ 0x4A6BB0EECC755B27L;
        ChestStealer.field989[0] = l2 ^ 0x4A6BB0EECC755B26L;
        ChestStealer.field989[3] = l2 ^ 0x4A6BB0EECC755B2EL;
        ChestStealer.field989[10] = l2 ^ 0x4A6BB0EECC755B0FL;
        ChestStealer.field989[6] = l2 ^ 0x4A6BB0EECC755B05L;
        ChestStealer.field989[2] = l2 ^ 0x4A6BB0EECC755B23L;
        ChestStealer.field989[8] = l2 ^ 0x4A6BB0EECC755B25L;
        ChestStealer.field989[5] = l2 ^ 0x4A6BB0EECC755B22L;
        ChestStealer.field989[11] = l2 ^ 0x4A6BB0EECC755B02L;
        ChestStealer.field989[4] = l2 ^ 0x4A6BB0EECC755B2FL;
    }

    public static Class925 method3807(ChestStealer class344) {
    ...
    static {
        ChestStealer.method3806(5362574320993655590L);
    }
    ...
    public ChestStealer() {
        ...
        class_1792Array[(int)ChestStealer.field989[0]] = class_1802.field_8545;
        ...
        nArray[(int)ChestStealer.field989[0]] = (int)field989[3];
        nArray[(int)ChestStealer.field989[1]] = (int)field989[0];
        nArray[(int)ChestStealer.field989[9]] = (int)field989[6];
        nArray[(int)ChestStealer.field989[8]] = (int)field989[4];
    ...
    public static Class248 method3822(ChestStealer class344) {
    ...
    private static Class248 method3825(ChestStealer class344) {
        return ChestStealer.method3798(class344);
    }
    ...
    private static int method3827(int n2, int n3, AutoArmor class279, Class3221 class3221) {
