...
public class Class5540 {
    ...
    public static int method21760(int n2, int n3, Class131 class131, Class5829 class5829) {
        int n4 = n2;
        return n4 & 0xFDA3A191 | 0x25C5E6E & ~n4;
    }

    public static int method21761(int n2, int n3, Class246 class246, Class3511 class3511) {
        int n4 = n2 ^ 0x80541E18;
        int n5 = n3;
        return (n4 | n5) & (~n5 | ~n4);
    }

    public static int method21762(int n2, int n3, Class45 class45, Class187 class187) {
        int n4 = n2 ^ 0x5BDDFDDD;
        int n5 = n3;
        return n4 & ~n5 | n5 & ~n4;
    }

    public static int method21763(int n2, int n3, Class632 class632, Class157 class157) {
        return 262045676 + (n2 & 0xF0618013);
    }

    public static int method21764(int n2, int n3, Class5550 class5550, Class61 class61) {
        int n4 = n2;
    ...
    public static int method21769(int n2, int n3, Class72 class72, Class74 class74) {
        int n4 = n2;
