...
extends Class278 {
    ...
    Class248 field1151;
    Class248 field1152;
    private static Class360 INSTANCE;
    Class248 field1153;
    Class248 field1154;
    Class248 field1155;
    ...
    private static Class248 method4538(Class360 class360) {
        return Class360.method4547(class360);
    }
    ...
    public Color method4540(class_1297 b2) {
        if (b2 instanceof class_1657) {
            ...
            if (Class5723.field11045.method21243(a2.method_5477())) {
                return Class360.method4555(Class458.method10623());
            }
        ...
        if (Class360.method4551(b2)) {
            return (Color)Class360.method4571(this.field1148);
        }
    ...
    public static Class248 method4542(Class360 class360) {
    ...
    public static Class248 method4547(Class360 class360) {
    ...
    public void method4550(Class223 a2) {
        if (Class360.field290.field_1724 != null && this.field1150.method507() == Class635.field3107 && this.method4612(a2.method416())) {
            if (Class360.method4584(field290).method_5858(a2.method416()) > ((Class252)Class360.method4574(this)).method564()) {
                return;
            }
            a2.method10();
        }
    ...
    private static class_746 method4552(class_310 class_3102) {
        return Class360.method4567(class_3102);
    }
    ...
    public void method4553(Class59 e2) {
        ...
        Class360.method4565();
        Iterator iterator = Class360.field290.field_1687.method_18112().iterator();
        block4: while (true) {
            if (!iterator.hasNext()) {
            ...
            int n2 = d2 == Class360.method4552(field290) ? 36995 : 36996;
            block5: while (true) {
                switch (n2) {
                    case 36996: {
                        n2 = 36994;
            ...
            if (!(Class360.field290.field_1724.method_5858(d2) > ((Class252)this.field1140).method564())) break;
        }
        Class6009.method23560();
    }

    private static int method4554(int n2, int n3, Class685 class685, Class325 class325) {
        return Class1706.method15454(n2, n3, class685, class325);
    }

    private static Color method4555(Class458 class458) {
    ...
    static {
        Class360.method4610(191451798417938327L);
    }

    public static Class248 method4558(Class360 class360) {
    ...
    public static Class360 method4560() {
        return INSTANCE;
    }
    ...
    public static Class248 method4564(Class360 class360) {
    ...
    private static int method4569(int n2, int n3, Class291 class291, Class804 class804) {
    ...
    public static Class248 method4574(Class360 class360) {
        return class360.field1140;
    }
    ...
    private static int method4579(int n2, int n3, Class296 class296, Class190 class190) {
        return Class1706.method15445(n2, n3, class296, class190);
    }

    private Boolean method4580() {
        return (Boolean)Class360.method4558(this).method507();
    }

    private static int method4581(int n2, int n3, Class197 class197, Class285 class285) {
    ...
    public static Class248 method4583(Class360 class360) {
    ...
    public Color method4586(class_1297 b2) {
        ...
        while (true) {
            ...
            if ((n3 = n2) == 58218) {
                class_1657 a2 = (class_1657)b2;
                if (Class5723.field11045.method21243(a2.method_5477())) return Class458.method10623().method10630();
                return (Color)Class360.method4564(this).method507();
            }
            if (n3 != 58219) break;
            n2 = 58217;
        }
    ...
    public static Class248 method4588(Class360 class360) {
    ...
    private Boolean method4590() {
        return (Boolean)Class360.method4563(this.field1151);
    }
    ...
    public void method4594(Class89 a2) {
        int n2 = Class360.field290.field_1724 != null ? 46880 : 46881;
        block4: while (true) {
            switch (n2) {
                case 46881: {
                    n2 = 46879;
                ...
                case 46880: {
                    ...
                    if (Class360.method4614(field290).method_5858(a2.method177()) > ((Class252)Class360.method4538(this)).method564()) {
                        return;
                    }
                    a2.method10();
    ...
    private static int method4598(int n2, int n3, Class807 class807, Class354 class354) {
    ...
    private Boolean method4601() {
        return (Boolean)Class360.method4582(this.field1152);
    }
    ...
    public static Class248 method4605(Class360 class360) {
    ...
    private Boolean method4608() {
        return (Boolean)Class360.method4544(this.field1145);
    }

    public static Class248 method4609(Class360 class360) {
        return class360.field1152;
    }

    private static void method4610(long l2) {
        Class360.field1147[3] = l2 ^ 0x2A82C65744F975FL;
        Class360.field1147[0] = l2 ^ 0x2A82C65744F9796L;
        Class360.field1147[4] = l2 ^ 0x2A82C65744F97ABL;
        Class360.field1147[2] = l2 ^ 0x2A82C65744F97F3L;
        Class360.field1147[1] = l2 ^ 0x2A82C65744F9797L;
    }

    private Boolean method4611() {
        return (Boolean)Class360.method4542(this).method507();
    }
    ...
    public boolean method4612(class_1297 a2) {
        int n2;
        block10: {
            if (a2 instanceof class_1657 && ((Boolean)Class360.method4588(this).method507()).booleanValue()) {
                if (!((Boolean)Class360.method4568(this.field1143)).booleanValue()) {
                    if (a2 == Class360.field290.field_1724) return (int)field1147[1] != 0;
                }
                int n3 = (int)field1147[0];
                return Class360.method4592();
            }
            if (!Class1158.method13133(a2) || !((Boolean)Class360.method4609(this).method507()).booleanValue()) {
                if ((Class1158.method13121(a2) || Class1158.method13110(a2)) && ((Boolean)Class360.method4602(Class360.method4613(this))).booleanValue()) {
                    return Class408.method6431();
                }
                if (!Class1158.method13114(a2) || !((Boolean)this.field1149.method507()).booleanValue()) {
                    ...
                    block4: while (true) {
                        switch (n4) {
                            ...
                            default: {
                                if (!(a2 instanceof class_1542) || !((Boolean)Class360.method4605(this).method507()).booleanValue()) break block10;
                            }
                        }
                        break;
                    }
    ...
    public static Class248 method4613(Class360 class360) {
