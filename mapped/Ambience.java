...
extends Class278 {
    ...
    public void method1274() {
        if (Ambience.field290.field_1687 == null) {
            return;
        }
        Ambience.field290.field_1769.method_3279();
    }

    private static void method1673(long l2) {
        Ambience.field499[1] = l2 ^ 0xE0B9698C97A85E09L;
        Ambience.field499[0] = l2 ^ 0xE0B9698C97A85E08L;
    }

    @Class1
    public void method1674(Class68 a2) {
        if (Ambience.field290.field_1687 != null && a2.method140().method502() == this) {
            if (a2.method128() == Class543.field2691) {
                Ambience.method1682(field290).method_3279();
            }
        }
    }
    ...
    public void method1279() {
        if (Ambience.method1677(field290) == null) {
            return;
        }
        Ambience.field290.field_1769.method_3279();
    }
    ...
    public void method1681(Class128 a2) {
        if (((Boolean)Ambience.method1675(this.field497)).booleanValue()) {
            a2.method10();
    ...
    public static Ambience method1683() {
        return INSTANCE;
    }

    static {
        field499 = new long[2];
        Ambience.method1678(-2253654085961490935L);
    }
