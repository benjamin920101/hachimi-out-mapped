...
extends Class278 {
    ...
    private static void method2628(long l2) {
        Class317.field736[0] = l2 ^ 0x75684A6CEA8E8AC0L;
        Class317.field736[1] = l2 ^ 0x75684A6CEA8E8AC2L;
    }

    public static Map method2629(Class317 class317) {
    ...
    private static Map method2634(Class317 class317) {
        return Class317.method2629(class317);
    }
    ...
    public void method2635(Class133 h2) {
        if (Class317.method2640(field290) == null) {
            return;
        }
        ...
        block8: while (true) {
            switch (n2) {
                ...
                case 51361: {
                    ...
                    int n3 = (Boolean)Class317.method2644(this).method507() != false ? 7500 : 7501;
                    block9: while (true) {
                        switch (n3) {
                            case 7501: {
                                n3 = 7499;
                    ...
                    String f2 = (String)Class317.method2634(this).get(d2);
    ...
    static {
        Class317.method2628(8460093731667610304L);
    }
    ...
    public static Class248 method2644(Class317 class317) {
