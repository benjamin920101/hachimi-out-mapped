...
extends Class278 {
    ...
    private static void method2770(long l2) {
        Class324.field769[0] = l2 ^ 0x36EE7344D1D05B0FL;
        Class324.field769[1] = l2 ^ 0x36EE7344D1D05B0EL;
    }

    public static Class248 method2771(Class324 class324) {
        return class324.field768;
    }

    static {
        Class324.method2770(3958227861920307982L);
    }
    ...
    private static class_638 method2774(class_310 class_3102) {
        return Class324.method2785(class_3102);
    }
    ...
    public void method2775(Class131 b2) {
        ...
        if (class_25962 instanceof Class3833) {
            ...
            if (!((Boolean)Class324.method2784(Class324.method2771(this))).booleanValue()) {
    ...
    public void method2776(Class210 c2) {
        if (Class324.method2769(field290).method_3144()) {
            return;
        }
        for (class_1297 b2 : Class324.method2774(field290).method_18112()) {
            double a2 = Class324.method2788(field290).method_33571().method_1022(b2.method_19538());
            if (a2 > (double)((Float)this.field766.method507()).floatValue()) continue;
            if (!this.method2778(b2)) continue;
            Class324.method2790(field290).method_2905((class_1657)Class324.field290.field_1724, b2, Class324.method2777());
            return;
        }
    }
    ...
    private boolean method2778(class_1297 c2) {
        ...
        block3: {
            block2: {
                class_1498 a2;
                if (((Boolean)this.field771.method507()).booleanValue() && (c2 instanceof class_1498 && !(a2 = (class_1498)c2).method_6109() || c2 instanceof class_1506) || ((Boolean)Class324.method2782(this.field765)).booleanValue() && c2 instanceof class_1495 || ((Boolean)Class324.method2783(this).method507()).booleanValue() && c2 instanceof class_1500) break block2;
    ...
    public static Class248 method2783(Class324 class324) {
