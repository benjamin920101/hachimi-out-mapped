...
extends Class414 {
    ...
    private static Class418 INSTANCE;
    Class248 field1634;
    Class248 field1635;
    ...
    private Boolean method6970() {
        return ((Integer)Class418.method7028(this).method507() > 0 ? (int)field1626[0] : (int)field1626[1]) != 0;
    }

    public static Class248 method6971(Class418 class418) {
        return class418.field1645;
    }

    public static Class248 method6972(Class418 class418) {
    ...
    private void method6973() {
        ...
        if (((Boolean)this.field1638.method507()).booleanValue()) {
            for (List a2 : Class418.method7061()) {
            ...
            b2.ifPresent(Class418::method7059);
        }
    }

    public static void method6974(Class418 class418, int n2) {
    ...
    private void method6979(class_238 g2, class_1657 h2) {
        Class418.method7036(this);
        List i2 = Class418.method7034(h2.method_19538());
        for (class_2338 f2 : i2) {
            ...
            block13: {
                ...
                Class418.method7001(this, a2, field1631);
                if (((Boolean)this.field1621.method507()).booleanValue()) {
                    Class418.method7054(this, a2.method_10084(), field1631);
                }
                if (this.method7038()) {
                    this.method7033(a2);
                }
            ...
            if (((Boolean)this.field1634.method507()).booleanValue() && !i2.contains(f2.method_10074())) {
                Class418.method6985(this, f2.method_10074(), Class418.method7005());
            }
            ...
            for (n2 = (int)field1626[1]; n2 < n3; ++n2) {
                ...
                Class418.method6999(this, d2.method_10084(), Class418.method7035());
            }
        }
        this.method6973();
        if (this.field1628 > 0) {
        ...
        this.field1628 = (Integer)Class418.method7018(this).method507();
    }
    ...
    static {
        ...
        Class418.method7046(3173559586295040475L);
    ...
    public static Class248 method6984(Class418 class418) {
        return class418.field1641;
    }

    private static void method6985(Class418 class418, class_2338 class_23382, Set set) {
        class418.method7013(class_23382, set);
    }

    private static boolean method6986(class_1297 a2) {
        if (a2 instanceof class_1511 && Class5905.method23257((class_1297)Class418.field290.field_1724, a2.method_19538(), (boolean)field1626[1]) < (double)Class5659.method22223()) {
    ...
    private static int method6990(int n2, int n3, Class457 class457, Class62 class62) {
        return Class854.method12475(n2, n3, class457, class62);
    }

    public static int method6991(Class418 class418) {
    ...
    private static void method6994(Class418 class418, class_2596 class_25962) {
    ...
    private static void method6999(Class418 class418, class_2338 class_23382, Set set) {
        class418.method7013(class_23382, set);
    }
    ...
    private static void method7001(Class418 class418, class_2338 class_23382, Set set) {
        class418.method7013(class_23382, set);
    }
    ...
    private boolean method7002(class_2338 e2, boolean f2) {
        ...
        block8: {
            ...
            block6: {
                ...
                block7: {
                    block5: {
                        g2 = new Class3442(e2, (List)Class418.method6983(this.field1630), (boolean)((Boolean)this.field1644.method507()), (Class607)((Object)this.field1637.method507()));
                        h2 = Class418.method7045(Class5723.field11054, e2);
                        if (!((Boolean)Class418.method6971(this).method507()).booleanValue() || h2 == null) break block5;
                        if (Class418.method7004(Class418.method7040(h2), (Double)this.field1622.method507() * Class5618.field10723)) break block6;
                        n2 = !h2.field12483 ? 5122 : 5123;
                        break block7;
                    }
                    if (f2) break block6;
                    bl2 = g2.method17369((Double)this.field1627.method507(), (Boolean)Class418.method6984(this).method507(), (Boolean)this.field1647.method507(), (Double)Class418.method6978(this.field1640));
                    break block8;
                }
                while (true) {
                    int n3;
            ...
            bl2 = g2.method17378((Double)this.field1627.method507(), (Boolean)Class418.method7047(this).method507(), (Boolean)this.field1647.method507(), (Double)this.field1640.method507());
        }
        boolean i2 = bl2;
        if ((Boolean)this.field1620.method507() == false) return i2;
        if (!Class5723.field11056.method14262()) {
            return Class418.method6992();
        }
        int n4 = d2 = Class418.field290.field_1687.method_8320(e2).method_45474() || h2 != null ? (int)field1626[0] : (int)field1626[1];
        if (d2 == 0) {
            return i2;
        }
        ...
        Predicate<class_1297> c2 = Class418::method6986;
        Iterator iterator = Class418.method6982(field290).method_8333(null, b2, c2).iterator();
    ...
    public static Class248 method7007(Class418 class418) {
        return class418.field1623;
    }

    private boolean method7008(class_2338 a2) {
        if (this.field1619 >= (Integer)Class418.method7027(this).method507()) {
            return (int)field1626[1] != 0;
        }
    ...
    private class_1657 method7009() {
        ArrayList a2 = Lists.newArrayList((Iterable)Class418.field290.field_1687.method_18112());
        return a2.stream().filter(Class418::method7055).filter(this::method7053).min(Comparator.comparingDouble(Class418::method7037)).orElse(null);
    }
    ...
    private static Class248 method7018(Class418 class418) {
        return Class418.method7007(class418);
    }
    ...
    private static Class248 method7027(Class418 class418) {
        return Class418.method7043(class418);
    }

    private static Class248 method7028(Class418 class418) {
        return Class418.method7056(class418);
    }
    ...
    public Class418() {
        ...
        class_2248Array[(int)Class418.field1626[1]] = class_2246.field_10540;
    ...
    public static Class248 method7030(Class418 class418) {
        return class418.field1641;
    }

    public static Class418 method7031() {
        return INSTANCE;
    }
    ...
    private void method7033(class_2338 a2) {
        class_2680 b2 = Class418.field290.field_1687.method_8320(a2);
        ...
        List d2 = Class1745.method15597(a2, (Double)this.field1627.method507(), (Integer)Class418.method6972(this).method507());
        if (this.method7039(d2)) {
            Class418.method7011().add(d2);
        }
    }

    @Override
    public void method1279() {
        Class418.method6974(this, (int)field1626[1]);
    }
    ...
    private static void method7036(Class418 class418) {
        class418.method7050();
    }

    private static double method7037(class_1297 a2) {
        return Class418.field290.field_1724.method_5858(a2);
    }
    ...
    private boolean method7038() {
        int n2;
        if (this.field1628 <= 0 && (Integer)Class418.method6977(this.field1643) > 0) {
            n2 = (int)field1626[0];
            return n2 != 0;
        }
        n2 = (int)field1626[1];
    ...
    public static Class248 method7041(Class418 class418) {
        return class418.field1618;
    }

    private static class_638 method7042(class_310 class_3102) {
        return Class418.method6989(class_3102);
    }

    public static Class248 method7043(Class418 class418) {
    ...
    public void method7044(Class133 c2) {
        block10: {
            if (Class418.field290.field_1724 == null) {
                int n2 = 19950;
            ...
            block4: while (true) {
                switch (n3) {
                    ...
                    case 19949: {
                        if (Class418.method7042(field290) != null) break block4;
                    }
                    default: {
                        return;
                    }
            ...
            while (object.hasNext()) {
                ...
                Class418.method7063(this, a2);
            }
            return;
        }
        Class418.method6994(this, c2.method251());
    }
    ...
    private static void method7046(long l2) {
        Class418.field1626[3] = l2 ^ 0x2C0ABFA126A6C9D3L;
        Class418.field1626[5] = l2 ^ 0x2C0ABFA126A6C9CFL;
        Class418.field1626[0] = l2 ^ 0x2C0ABFA126A6C9DAL;
        Class418.field1626[4] = l2 ^ 0x2C0ABFA126A6C9D9L;
        Class418.field1626[6] = l2 ^ 0x2C0ABFA126A6CA5FL;
        Class418.field1626[1] = l2 ^ 0x2C0ABFA126A6C9DBL;
        Class418.field1626[2] = l2 ^ 0x2C0ABFA126A6C9D8L;
    }

    private static Class248 method7047(Class418 class418) {
        return Class418.method7030(class418);
    }
    ...
    private void method7050() {
        ...
        field1633.clear();
        field1631.clear();
        int n2 = Class418.method6991(this) <= 0 ? 39054 : 39055;
        block4: while (true) {
            switch (n2) {
                case 39055: {
                    n2 = 39053;
    ...
    private boolean method7053(class_1297 a2) {
        return (Class418.field290.field_1724.method_5858(a2) <= ((Class252)this.field1627).method564() ? (int)field1626[0] : (int)field1626[1]) != 0;
    }

    private static void method7054(Class418 class418, class_2338 class_23382, Set set) {
        class418.method7013(class_23382, set);
    }
        ...
        block8: {
            block6: {
                block7: {
                    ...
                    if (Class418.method6993(Class418.field290) == a) break block7;
                    v0 = 11285;
                    ** GOTO lbl10
                }
                v0 = 11286;
...
lbl22:
    ...
    public static Class248 method7056(Class418 class418) {
        return class418.field1643;
    }
    ...
    private static void method7063(Class418 class418, class_2596 class_25962) {
        class418.method7020(class_25962);
    }
    ...
    public void method7065(Class210 a2) {
        if (Class418.method7006()) {
            return;
        }
        if (!((Boolean)Class418.method7022(this.field1536)).booleanValue() && Class418.field290.field_1724.method_6115()) {
            return;
        }
        ...
        this.field1624 = (Integer)Class418.method7041(this).method507();
        this.field1619 = (int)field1626[1];
        Class418.method7066().removeIf(this::method7008);
