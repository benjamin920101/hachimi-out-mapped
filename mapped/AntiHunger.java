...
extends Class278 {
    ...
    static {
        AntiHunger.method2819(-8057559171137731796L);
    }
    ...
    public static Class248 method2816(AntiHunger class326) {
    ...
    private static void method2818(long l2) {
        AntiHunger.field785[1] = l2 ^ 0x902DCC9FE7A5032CL;
        AntiHunger.field785[0] = l2 ^ 0x902DCC9FE7A5032DL;
    }

    private static void method2819(long l2) {
        AntiHunger.method2818(l2);
    }
    ...
    public void method2820(Class131 c2) {
        if (AntiHunger.field290.field_1724 == null) return;
        if (AntiHunger.field290.field_1687 == null) return;
        if (AntiHunger.field290.field_1724.method_6128()) return;
        if (AntiHunger.field290.field_1724.method_3144()) return;
        class_2596 class_25962 = c2.method251();
        if (class_25962 instanceof class_2828) {
            class_2828 a2 = (class_2828)class_25962;
            if (((Boolean)AntiHunger.method2816(this).method507()).booleanValue() && !a2.method_12273() && AntiHunger.field290.field_1724.field_6017 <= 3.0f) {
                ((bH)a2).hookSetOnGround((!AntiHunger.field290.field_1724.method_3144() ? (int)field785[0] : (int)field785[1]) != 0);
                return;
            }
        }
        ...
        if (b2.method_12365() != AntiHunger.method2817()) {
