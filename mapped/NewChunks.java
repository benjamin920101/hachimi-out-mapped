...
extends Class278 {
    ...
    public static Set method5573(NewChunks class392) {
    ...
    public void method5577(Class133 N) {
        block75: {
            block74: {
                if (NewChunks.field290.field_1687 == null) {
                    return;
                }
                var2_2 = N.method251();
                ...
                D = new class_2818((class_1937)NewChunks.field290.field_1687, C);
                E = M.method_38598().method_38586();
                F = (int)NewChunks.field1359[1];
                G = (int)NewChunks.field1359[1];
                H = new class_2540(Unpooled.copiedBuffer((ByteBuffer)E.nioBuffer()));
                if (E.readableBytes() < (int)NewChunks.field1359[17]) {
                    return;
                }
                E.readShort();
                I = E.readUnsignedByte();
                if (I >= (int)NewChunks.field1359[11] && I <= (int)NewChunks.field1359[12]) {
                    a = E.method_10816();
                    if (a == 0 && NewChunks.field290.field_1687.method_27983() != class_1937.field_25181) {
                        G = (int)NewChunks.field1359[0];
                    }
                }
                if (H.readableBytes() < (int)NewChunks.field1359[8]) {
                    return;
                }
                K = (int)NewChunks.field1359[1];
                L = (int)NewChunks.field1359[1];
                try {
                    for (J = (int)NewChunks.field1359[1]; H.readableBytes() > 0 && J < (int)NewChunks.field1359[12] && H.readableBytes() >= (int)NewChunks.field1359[0]; ++J) {
                        block76: {
                            block85: {
                                block73: {
                                    block84: {
                                        block77: {
                                            block78: {
                                                ...
                                                if (v < (int)NewChunks.field1359[11]) break block77;
                                                if (v > (int)NewChunks.field1359[12]) break block77;
                                                g = D.method_12006()[J];
                                                h = g.method_12265();
                                                i = new HashSet<class_2680>();
                                                for (d = (int)NewChunks.field1359[1]; d < (int)NewChunks.field1359[6]; ++d) {
                                                    for (c = (int)NewChunks.field1359[1]; c < (int)NewChunks.field1359[6]; ++c) {
                                                        for (b = (int)NewChunks.field1359[1]; b < (int)NewChunks.field1359[6]; ++b) {
                                                ...
                                                l = (int)NewChunks.field1359[1];
                                                m = i.size();
                                                if (m > (int)NewChunks.field1359[0]) break block78;
                                                v0 = 39095;
                                                ** GOTO lbl54
                                            }
                                            v0 = 39096;
...
lbl54:
                                            ...
                                            if (m < j) {
                                                k = (int)NewChunks.field1359[8];
                                                ++K;
                                            }
                                            for (f = (int)NewChunks.field1359[1]; f < j; ++f) {
                                                block83: {
                                                    block81: {
                                                        block82: {
                                                            block79: {
                                                                block80: {
                                                                    e = H.method_10816();
                                                                    if (f == 0 && e == 0 && NewChunks.field290.field_1687.method_27983() == class_1937.field_25179) {
                                                                        ++k;
                                                                    }
                                                                    if (f != (int)NewChunks.field1359[0]) break block79;
                                                                    if (e == (int)NewChunks.field1359[22]) break block80;
                                                                    if (e == (int)NewChunks.field1359[0]) break block80;
                                                                    if (e != (int)NewChunks.field1359[20] && e != (int)NewChunks.field1359[18]) break block79;
                                                                }
                                                                if (NewChunks.field290.field_1687.method_27983() != class_1937.field_25179) {
                                                                    NewChunks.method5604();
                                                                    return;
                                                                }
                                                                ++k;
                                                            }
                                                            if (f != (int)NewChunks.field1359[8]) break block81;
                                                            if (e == (int)NewChunks.field1359[18]) break block82;
                                                            if (e == (int)NewChunks.field1359[19]) break block82;
                                                            if (e != (int)NewChunks.field1359[13]) break block81;
                                                        }
                                                        if (NewChunks.field290.field_1687.method_27983() == class_1937.field_25179) {
                                                            ++k;
                                                        }
                                                    }
                                                    if (J != (int)NewChunks.field1359[11]) break block83;
                                                    v1 = 17957;
                                                    ** GOTO lbl92
                                                }
                                                v1 = 17958;
...
lbl92:
                                                    ...
                                                    switch (v1) {
                                                        ...
                                                        case 17957: {
                                                            if (e != (int)NewChunks.field1359[15]) break block24;
                                                            if (NewChunks.field290.field_1687.method_27983() != NewChunks.method5588()) break block24;
                                                            if (this.field1354.contains(C)) break block24;
                                                            if (this.field1364.contains(C)) break block24;
                                                            NewChunks.method5621(this).add(C);
                                                            return;
                                                        }
                                                    }
                                                    break;
                                                ...
                                                if (e != 0) continue;
                                                if (((NewChunks.field290.field_1687.method_27983() == class_1937.field_25180 ? (int)NewChunks.field1359[0] : (int)NewChunks.field1359[1]) | (NewChunks.field290.field_1687.method_27983() == class_1937.field_25181 ? (int)NewChunks.field1359[0] : (int)NewChunks.field1359[1])) == 0) continue;
                                                ++l;
                                            }
                                            if (l >= (int)NewChunks.field1359[8]) {
                                                ++L;
                                            }
                                            if (k >= (int)NewChunks.field1359[8]) {
                                                ++K;
                                            }
                                            n = H.method_10816();
                                            if (H.readableBytes() < n * (int)NewChunks.field1359[12]) {
                                                H.method_52994(H.readableBytes());
                                                break;
                                            }
                                            H.method_52994(n * (int)NewChunks.field1359[12]);
                                            NewChunks.method5664();
                                            return;
                                        }
                                        if (v != (int)NewChunks.field1359[16]) break;
                                        o = H.method_10816();
                                        if (H.readableBytes() < o * (int)NewChunks.field1359[12]) break block84;
                                        v2 = 21910;
                                        if (true) ** GOTO lbl132
                                    }
                                    v3 = 21911;
...
lbl132:
                                ...
                                H.method_52994(o * (int)NewChunks.field1359[12]);
                        ...
                        if (H.readableBytes() < (int)NewChunks.field1359[0]) break;
                        w = H.readUnsignedByte();
                        if (w == 0) {
                            p = H.method_10816();
                            if (p != (int)NewChunks.field1359[14]) {
                                Class1668.method15147(2059780144, 596590147, -531938624, -513060707);
                                return;
                            }
                            if (NewChunks.field290.field_1687.method_27983() != class_1937.field_25181) continue;
                            F = (int)NewChunks.field1359[0];
                            continue;
                        }
                        if (w >= (int)NewChunks.field1359[0]) {
                            if (w <= (int)NewChunks.field1359[17]) {
                                t = H.method_10816();
                                r = (int)NewChunks.field1359[1];
                                while (true) {
                                    if (r >= t) {
                                    ...
                                    if (H.readableBytes() < (int)NewChunks.field1359[0]) break;
                                    q = H.method_10816();
                                    if (r == 0 && q == (int)NewChunks.field1359[14] && NewChunks.field290.field_1687.method_27983() == class_1937.field_25181) {
                                        F = (int)NewChunks.field1359[0];
                                    }
                                    ++r;
                                }
                                if (H.readableBytes() < (int)NewChunks.field1359[0]) break;
                                s = H.method_10816();
                                if (H.readableBytes() >= s * (int)NewChunks.field1359[12]) {
                                    H.method_52994(s * (int)NewChunks.field1359[12]);
                                    continue;
                                }
                                H.method_52994(H.readableBytes());
                                break;
                        ...
                        if (w != (int)NewChunks.field1359[21]) break;
                        u = H.method_10816();
                        if (H.readableBytes() >= u * (int)NewChunks.field1359[12]) {
                            H.method_52994(u * (int)NewChunks.field1359[12]);
                    ...
                    if (J > 0) {
                        if (NewChunks.field290.field_1687.method_27983() != class_1937.field_25180) {
                        ...
                        if (NewChunks.field290.field_1687.method_27983() == class_1937.field_25179 && (y = (double)K / (double)J * 100.0) >= 65.0) {
                            F = (int)NewChunks.field1359[0];
                        }
                    }
                    break block74;
                    ...
                    block86: {
                        B.printStackTrace();
                        if (NewChunks.field290.field_1687.method_27983() == class_1937.field_25180 || NewChunks.method5637(NewChunks.field290).method_27983() == class_1937.field_25181) {
                            ...
                            F = (int)NewChunks.field1359[1];
                            if (!NewChunks.method5645(this).contains(C) && !this.field1364.contains(C)) {
                                NewChunks.method5619(this).add(C);
                                return;
                            }
                        }
                        if (NewChunks.field290.field_1687.method_27983() != class_1937.field_25179) break block74;
...
lbl224:
            ...
            if (F == 0) {
                try {
                    if (!NewChunks.method5603(this).contains(C) && !this.field1364.contains(C)) {
                        NewChunks.method5573(this).add(C);
                    }
                }
    ...
    public static Class248 method5578(NewChunks class392) {
    ...
    public void method1279() {
        NewChunks.method5620(this).clear();
    }
    ...
    public void method5584(Class59 d2) {
        ...
        if (((Boolean)NewChunks.method5633(this).method507()).booleanValue()) {
            for (class_1923 a2 : this.field1364) {
                Class6454.method24605(d2.method125(), new class_238((double)a2.method_8326(), (double)((Integer)this.field1362.method507()).intValue(), (double)a2.method_8328(), (double)a2.method_8327() + 1.0, (double)((Integer)NewChunks.method5618(this).method507()).intValue(), (double)a2.method_8329() + 1.0), 1.5f, ((Color)this.field1361.method507()).getRGB());
            }
        }
        if (((Boolean)NewChunks.method5602(this.field1358)).booleanValue()) {
            for (class_1923 b2 : this.field1354) {
                NewChunks.method5644(NewChunks.method5623(d2), new class_238((double)b2.method_8326(), (double)((Integer)this.field1362.method507()).intValue(), (double)b2.method_8328(), (double)b2.method_8327() + 1.0, (double)((Integer)this.field1362.method507()).intValue(), (double)b2.method_8329() + 1.0), Class3734.field8429, ((Color)this.field1365.method507()).getRGB());
            }
        }
        ...
        block6: while (true) {
            switch (n2) {
                ...
                case 1986: {
                    for (class_2338 c2 : NewChunks.method5648(this)) {
                        Class6454.method24734(d2.method125(), c2, Class4045.method20093(((Color)NewChunks.method5625(this).method507()).getRGB(), (int)field1359[10]));
                        Class6454.method24642(d2.method125(), c2, 1.5f, Class4045.method20093(((Color)this.field1357.method507()).getRGB(), (int)field1359[9]));
                        if (!((Boolean)NewChunks.method5578(this).method507()).booleanValue()) continue;
    ...
    public static Set method5585(NewChunks class392) {
        return class392.field1354;
    }
    ...
    private static int method5592(int n2, int n3, Class115 class115, Tracers class334) {
    ...
    public static Set method5603(NewChunks class392) {
        return class392.field1354;
    }
    ...
    private static int method5606(int n2, int n3, Class70 class70, Kit class454) {
    ...
    public void method5611(Class63 h) {
        ...
        block4: while (true) {
            ...
            e = (class_2636)g;
            if (NewChunks.method5643(e.method_11390()) == (int)NewChunks.field1359[7] || NewChunks.field290.field_1687.method_27983() == class_1937.field_25180 && e.method_11390().field_9154 == 0) continue;
            f = e.method_11016();
            if (!this.field1363.contains(f)) {
                NewChunks.method5590();
                return;
            }
            v0 = 15812;
            if (true) ** GOTO lbl20
...
lbl20:
            ...
            d = (int)NewChunks.field1359[5];
            while (true) {
                if (d < (int)NewChunks.field1359[4]) ** break;
                continue block4;
                block7: for (c = (int)NewChunks.field1359[5]; c < (int)NewChunks.field1359[4]; ++c) {
                    for (b = (int)NewChunks.field1359[5]; b < (int)NewChunks.field1359[4]; ++b) {
                        a = new class_2338(f.method_10263() + d, f.method_10264() + c, f.method_10260() + b);
                        if (NewChunks.method5676(NewChunks.field290).method_8320(a).method_26204() != class_2246.field_10034) continue;
                        this.field1363.add(f);
                        if (!((Boolean)NewChunks.method5631(this).method507()).booleanValue()) continue block7;
                        v1 = new Object[(int)NewChunks.field1359[8]];
                        v1[(int)NewChunks.field1359[1]] = this.field291;
                        v1[(int)NewChunks.field1359[0]] = f.method_23854();
    ...
    public static Class248 method5618(NewChunks class392) {
        return class392.field1362;
    }

    public static Set method5619(NewChunks class392) {
        return class392.field1354;
    }

    public static List method5620(NewChunks class392) {
        return class392.field1363;
    }

    public static Set method5621(NewChunks class392) {
        return class392.field1354;
    }
    ...
    public static Class248 method5625(NewChunks class392) {
    ...
    public static Class248 method5631(NewChunks class392) {
    ...
    public static Class248 method5633(NewChunks class392) {
    ...
    public static Set method5645(NewChunks class392) {
        return class392.field1354;
    }
    ...
    public static List method5648(NewChunks class392) {
        return class392.field1363;
    }
    ...
    static {
        NewChunks.method5660(4122013719330392031L);
    }
    ...
    private static void method5660(long l2) {
        NewChunks.field1359[6] = l2 ^ 0x393455A36BF987CFL;
        NewChunks.field1359[3] = l2 ^ 0xC6CBAA5C9406781FL;
        NewChunks.field1359[15] = l2 ^ 0x393455A36BF98790L;
        NewChunks.field1359[19] = l2 ^ 0x393455A36BF987D5L;
        NewChunks.field1359[9] = l2 ^ 0x393455A36BF9874EL;
        NewChunks.field1359[12] = l2 ^ 0x393455A36BF987D7L;
        NewChunks.field1359[2] = l2 ^ 0x393455A36BF986DFL;
        NewChunks.field1359[1] = l2 ^ 0x393455A36BF987DFL;
        NewChunks.field1359[4] = l2 ^ 0x393455A36BF987CEL;
        NewChunks.field1359[21] = l2 ^ 0x393455A36BF987D9L;
        NewChunks.field1359[8] = l2 ^ 0x393455A36BF987DDL;
        NewChunks.field1359[20] = l2 ^ 0x393455A36BF987D6L;
        NewChunks.field1359[16] = l2 ^ 0x393455A36BF987D0L;
        NewChunks.field1359[10] = l2 ^ 0x393455A36BF98799L;
        NewChunks.field1359[13] = l2 ^ 0x393455A36BF9D0F1L;
        NewChunks.field1359[0] = l2 ^ 0x393455A36BF987DEL;
        NewChunks.field1359[7] = l2 ^ 0x393455A36BF987CBL;
        NewChunks.field1359[18] = l2 ^ 0x393455A36BF9914AL;
        NewChunks.field1359[22] = l2 ^ 0x393455A36BF9878FL;
        NewChunks.field1359[5] = l2 ^ 0xC6CBAA5C9406782FL;
        NewChunks.field1359[17] = l2 ^ 0x393455A36BF987DCL;
        NewChunks.field1359[14] = l2 ^ 0x393455A36BF987F8L;
        NewChunks.field1359[11] = l2 ^ 0x393455A36BF987DBL;
    }
    ...
    public static List method5668(NewChunks class392) {
        return class392.field1363;
    }
    ...
    public void method5673(Class117 a2) {
        ...
        NewChunks.method5585(this).clear();
    }
    ...
    private static int method5677(int n2, int n3, GodMode class403, Class1226 class1226) {
