...
extends Class414 {
    ...
    Class248 field2170;
    Class248 field2171;
    private static Class437 INSTANCE;
    Class248 field2172;
    Class248 field2173;
    Class248 field2174;
    ...
    private static boolean method9398(class_2338 a2) {
        return (!(Class437.field290.field_1687.method_8320(a2).method_26204() instanceof class_2480) ? (int)field2175[2] : (int)field2175[0]) != 0;
    }
    ...
    private void method9400() {
        for (class_2586 d2 : Class437.method9414()) {
            class_2627 c2;
            if (!(d2 instanceof class_2627) || this.field2169.contains((c2 = (class_2627)d2).method_11016()) || !((double)class_3532.method_15355((float)((float)Class437.field290.field_1724.method_5707(c2.method_11016().method_46558()))) <= (Double)Class437.method9418(Class437.method9433(this)))) continue;
            ...
            boolean b2 = a2.method17369((Double)Class437.method9415(this.field2177), (Boolean)this.field2176.method507(), (Boolean)Class437.method9410(this.field2173), (Double)this.field2171.method507());
            if (!b2) continue;
            return;
        }
    }
    ...
    public void method9401(Class4104 a2) {
        if (Class437.method9432(a2) instanceof class_2480) {
            this.field2169.add(a2.field9517);
        }
    }

    private static Class425 method9402() {
    ...
    private static class_746 method9406(class_310 class_3102) {
        return Class437.method9426(class_3102);
    }
    ...
    public static Class437 method9408() {
        return INSTANCE;
    }
    ...
    public static Class437 method9419() {
        return Class437.method9408();
    }
    ...
    private static void method9423(long l2) {
        Class437.field2175[3] = l2 ^ 0x3FCD4ABEACE152A2L;
        Class437.field2175[0] = l2 ^ 0x3FCD4ABEACE152A8L;
        Class437.field2175[1] = l2 ^ 0x3FCD4ABEACE152A1L;
        Class437.field2175[2] = l2 ^ 0x3FCD4ABEACE152A9L;
    }
    ...
    public static Class248 method9425(Class437 class437) {
    ...
    private Boolean method1278() {
        return (this.field2168.method507() == Class437.method9434() ? (int)field2175[2] : (int)field2175[0]) != 0;
    }

    public static Class248 method9427(Class437 class437) {
        return class437.field2170;
    }

    public static Class248 method9428(Class437 class437) {
        return class437.field2170;
    }
    ...
    static {
        ...
        Class437.method9413(4597412977419834024L);
    }
    ...
    public void method9430(Class210 a2) {
        ...
        if (!((Boolean)this.field1536.method507()).booleanValue() && Class437.method9406(field290).method_6115()) {
            return;
        }
        this.field2169.removeIf(Class437::method9398);
        int n2 = ((Class574)((Object)Class437.method9422(Class437.method9425(this)))).ordinal() ^ 0x20724F6A;
        if (n2 != 544362344) {
            if (n2 == 544362346) {
                this.method9400();
            } else {
    ...
    public Class437() {
        ...
        this.field2172 = this.method450(new Class260("SwapAction", "Decide which swap mode to use", Class607.field2953, Class437.method9417(), this::method9409));
        INSTANCE = this;
    }

    private static Class248 method9433(Class437 class437) {
        return Class437.method9428(class437);
    }
    ...
    private void method9436() {
        Class425 c2 = Class437.method9402();
        for (class_2586 b2 : Class437.method9441()) {
            class_2627 a2;
            if (!(b2 instanceof class_2627) || this.field2169.contains((a2 = (class_2627)b2).method_11016()) || !((double)class_3532.method_15355((float)((float)Class437.field290.field_1724.method_5707(a2.method_11016().method_46558()))) <= (Double)Class437.method9416(Class437.method9427(this)))) continue;
