...
extends Class414 {
    ...
    static {
        Class434.method9102(-1646076626498103767L);
    }

    public static Class248 method9079(Class434 class434) {
        return class434.field2101;
    }

    public static int method9080(Class434 class434) {
    ...
    private void method9081() {
        ...
        block8: while (true) {
            switch (n3) {
                ...
                case 55337: {
                    int n4 = ((Class586)((Object)Class434.method9115(this.field2090))).ordinal();
                    if (n4 == 0) {
                        if (this.field2103 >= Class434.method9132(this).size()) {
                            n2 = 41006;
                            break block8;
                        }
                        n2 = 41007;
                ...
                default: {
                    Class434.method9142(this).forEach(this::method9112);
                    return;
                }
            }
            break;
        ...
        Class434 class434 = this;
        Class434.method9168(class434, Class434.method9186(class434) + (int)field2102[1]);
    }
    ...
    public class_1297 method9086() {
        if (!Class434.method9143(this).isEmpty()) {
    ...
    private boolean method9099(class_1297 a2) {
        block8: {
            ...
            return (Boolean)Class434.method9161(this.field2082);
        }
        if (a2 instanceof class_1429) {
            return (Boolean)Class434.method9169(this.field2076);
        }
    ...
    public static Class248 method9100(Class434 class434) {
    ...
    private static void method9102(long l2) {
        Class434.field2102[2] = l2 ^ 0xE927F6078C81D623L;
        Class434.field2102[0] = l2 ^ 0xE927F6078C81D629L;
        Class434.field2102[5] = l2 ^ 0xE927F6078C81D62BL;
        Class434.field2102[4] = l2 ^ 0xE927F6078C81D62AL;
        Class434.field2102[1] = l2 ^ 0xE927F6078C81D628L;
        Class434.field2102[3] = l2 ^ 0xE927F6078C81D495L;
    }
    ...
    private void method9108(Class131 a2) {
        if (a2.method251() instanceof class_2868) {
            this.field2079 = (Integer)Class434.method9100(this).method507();
        }
    }

    private static class_746 method9109(class_310 class_3102) {
        return Class434.method9118(class_3102);
    }
    ...
    private void method9112(class_1297 d2) {
        ...
        if (Class434.method9074(field290).method_33571().method_1022(f2) > (Double)this.field2093.method507()) {
            return;
        }
        if (((Boolean)Class434.method9137(this.field2081)).booleanValue()) {
            float[] a2 = Class1503.method14416(Class434.method9075(field290).method_33571(), f2);
            Class1503.method14417(a2[(int)field2102[0]], a2[(int)field2102[1]]);
        }
        int g2 = (int)field2102[0];
        if (((Boolean)Class434.method9136(this.field2101)).booleanValue()) {
            if (!Class307.method2260().method1265()) {
        ...
        if (Class1745.field6552) {
            Class434.method9177(Class434.field290.field_1724).method_52787((class_2596)class_2824.method_34206((class_1297)d2, (boolean)Class434.field290.field_1724.method_5715()));
            Class434.field290.field_1724.method_7350();
        } else {
            Class434.field290.field_1761.method_2918((class_1657)Class434.field290.field_1724, d2);
        }
        Class434.method9178((Class480)((Object)this.field2095.method507()), class_1268.field_5808);
        if (((Boolean)Class434.method9076(Class434.method9079(this))).booleanValue() && !Class307.method2260().method1265()) {
            if (g2 != 0) {
                Class434.method9179(Class5723.field11048, (class_2596)new class_2848((class_1297)Class434.field290.field_1724, class_2848.class_2849.field_12985));
            }
            ...
            block4: while (true) {
                switch (n3) {
                    ...
                    case 61514: {
                        float[] c2 = Class1503.method14416(Class434.field290.field_1724.method_33571(), f2);
        ...
        if (((Boolean)this.field2081.method507()).booleanValue()) {
            Class434.method9078().method12049();
        }
        Class434.method9097(Class434.method9150(this));
    }
    ...
    private boolean method9114() {
        ...
        do {
            ...
            return Class3979.method19539();
        } while (!((b2 = (class_1297)iterator.next()) instanceof class_1657) || !(a2 = (class_1657)b2).method_6061(Class434.field290.field_1687.method_48963().method_48802((class_1657)Class434.field290.field_1724)) || this.field2075.method507() != Class596.field2898);
    ...
    private boolean method9116(class_1297 h2) {
        int n2;
        class_6025 b2;
        if (h2.equals((Object)Class434.field290.field_1724)) return (int)field2102[0] != 0;
        if (h2.equals((Object)Class434.field290.field_1719)) {
            return (int)field2102[0] != 0;
        }
        ...
        class_243 i2 = Class5449.method21096(Class434.method9127(field290).method_33571(), h2.method_5829());
        if (Class434.field290.field_1724.method_33571().method_1022(i2) > (Double)this.field2093.method507()) {
            return (int)field2102[0] != 0;
        }
        ...
        if (Class5659.method22162(h2)) {
            return Class434.method9171(Class5524.field10443, 0.4046020534069612, 0.6105274656698135, 0.9465661573176375);
        }
        if (Class434.method9181(field290).method_33571().method_1022(i2) > (Double)this.field2098.method507()) {
            return (int)field2102[0] != 0;
        }
        if (((Boolean)this.field2080.method507()).booleanValue() && h2 instanceof class_6025 && (b2 = (class_6025)h2).method_6139() != null && b2.method_6139().equals(Class434.field290.field_1724.method_5667())) {
            return (int)field2102[0] != 0;
        }
        ...
        if (h2 instanceof class_1657) {
            ...
            if (Class434.method9111(this.field2075) == Class596.field2896) {
                if (f2.method_6061(Class434.field290.field_1687.method_48963().method_48802((class_1657)Class434.method9092(field290)))) {
                    return Class1807.method15753();
                }
                int n5 = 37155;
                block16: while (true) {
        ...
        int n6 = ((Class576)((Object)Class434.method9119(this.field2096))).ordinal() ^ 0x3B4C86E7;
        if (n6 == 994871013) {
            n2 = (int)field2102[1];
            return n2 != 0;
        }
    ...
    private static boolean method9117(Class434 class434) {
    ...
    public static List method9121(Class434 class434) {
    ...
    private static boolean method9125(Class434 class434) {
    ...
    private static int method9128(int n2, int n3, Class160 class160, Class301 class301) {
    ...
    private Boolean method1278() {
        if (!((Boolean)this.field2091.method507()).booleanValue()) {
            ...
            Class434.method9145(0.5427801f, 0.33802336f);
            return null;
        }
        return (boolean)field2102[0];
    }

    private static List method9132(Class434 class434) {
        return Class434.method9121(class434);
    }
    ...
    private static int method9138(int n2, int n3, Class3741 class3741, Class298 class298) {
    ...
    private static List method9142(Class434 class434) {
        return Class434.method9155(class434);
    }

    public static List method9143(Class434 class434) {
        return class434.field2078;
    }
    ...
    public static Class248 method9147(Class434 class434) {
    ...
    private static Class926 method9150(Class434 class434) {
        return Class434.method9151(class434);
    }

    public static Class926 method9151(Class434 class434) {
        return class434.field2092;
    }

    private static Class248 method9152(Class434 class434) {
        return Class434.method9147(class434);
    }
    ...
    public static List method9155(Class434 class434) {
        return class434.field2078;
    }
    ...
    private boolean method9160() {
        int n2;
        if (Class434.method9125(this)) {
            return Class434.method9164(field290).method_6047().method_7909() instanceof class_1743;
        }
        switch (((Class535)((Object)this.field2074.method507())).ordinal()) {
            case 1: {
                boolean bl2 = Class434.method9193(field290).method_6047().method_7909() instanceof class_1743;
                return Class5659.method22229(Class3498.field7695, Class971.field4056, Class1037.field4264, 0.15052012017169802);
            }
            case 0: {
                n2 = Class434.field290.field_1724.method_6047().method_7909() instanceof class_1829;
                return n2 != 0;
            }
            case 2: {
                n2 = Class434.field290.field_1724.method_6047().method_7909() instanceof class_9362;
                return n2 != 0;
            }
            case 3: {
                n2 = Class434.field290.field_1724.method_6047().method_7909() instanceof class_1835;
                return n2 != 0;
            }
            case 4: {
                if (!(Class434.field290.field_1724.method_6047().method_7909() instanceof class_1743 || Class434.field290.field_1724.method_6047().method_7909() instanceof class_1829 || Class434.field290.field_1724.method_6047().method_7909() instanceof class_9362 || Class434.method9109(field290).method_6047().method_7909() instanceof class_1835)) {
                    n2 = (int)field2102[0];
                    return n2 != 0;
                }
                n2 = (int)field2102[1];
    ...
    private static class_746 method9164(class_310 class_3102) {
        return Class434.method9122(class_3102);
    }
    ...
    public static void method9168(Class434 class434, int n2) {
    ...
    public void method9182(Class210 e2) {
                    ...
                    block26: {
                        block25: {
                            block24: {
                                ...
                                if (Class3493.method17602((class_1657)Class434.field290.field_1724) == class_1934.field_9219) {
                                    return;
                                }
                                ...
                                if (Class434.method9152(this).method507() != Class609.field2963) {
                                    Class1503.method14417(0.9301087f, Class3975.field9068);
                                    return;
                                }
                                int n2 = 34418;
                                if (!Class434.method9117(this)) {
                                    return;
                                }
                                ...
                                predicate = Class434::method9095;
                                break block27;
                            }
                            predicate = Class434::method9087;
                            break block27;
                        }
                        predicate = Class434::method9153;
                        break block27;
                    }
                    predicate = Class434::method9185;
                    break block27;
                }
                predicate = Class434::method9130;
            }
            Predicate<class_1799> b2 = predicate;
            c2 = Class434.method9156(new Class3812(b2, (Class607)((Object)this.field2086.method507())));
            d2 = Class5723.field11058.method18969();
            int n3 = !this.method9114() ? 64311 : 64310;
            while (true) {
                int n4;
                if ((n4 = n3) == 64310) {
                    a2 = new Class3812(Class434::method9157, (Class607)((Object)this.field2086.method507())).method18502();
                    if (a2.method18523()) {
                        break;
                    }
                } else if (n4 == 64311) {
        ...
        if (this.field2077.method507() != Class609.field2963) {
            Class434.method9158(c2, d2);
            if (Class434.method9110(this.field2086) != Class607.field2953) return;
            Class434.field290.field_1724.method_31548().field_7545 = c2.method18530();
            return;
        }
        c2.method18531(d2);
        this.method9081();
    ...
    private static int method9186(Class434 class434) {
        return Class434.method9080(class434);
    }
