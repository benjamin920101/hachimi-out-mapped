...
extends Class278 {
    ...
    public static Class248 method3035(Class334 class334) {
    ...
    public static Class248 method3037(Class334 class334) {
    ...
    private Boolean method1278() {
        return (Boolean)Class334.method3041(this.field854);
    }
    ...
    private Color method3042(class_1297 b2) {
        ...
        if (((Boolean)Class334.method3065(this).method507()).booleanValue()) {
            return (Color)Class334.method3066(this.field853);
        }
        if (b2 instanceof class_1657) {
            class_1657 a2 = (class_1657)b2;
            if (((Boolean)Class334.method3037(this).method507()).booleanValue()) {
                if (Class334.method3070(Class5723.field11045, a2.method_5477())) {
                    return Class458.method10623().method10630();
                }
        ...
        if ((Class1158.method13110(b2) || Class1158.method13121(b2)) && ((Boolean)this.field867.method507()).booleanValue()) {
            return (Color)Class334.method3057(this).method507();
        }
        if (Class1158.method13114(b2) && ((Boolean)this.field868.method507()).booleanValue()) {
            return (Color)Class334.method3048(this).method507();
        }
        if (b2 instanceof class_1542) {
            if (((Boolean)Class334.method3068(this).method507()).booleanValue()) {
    ...
    public static Class248 method3043(Class334 class334) {
    ...
    public static Class248 method3048(Class334 class334) {
    ...
    private static void method3055(long l2) {
        Class334.field860[0] = l2 ^ 0xB8D1F8A5612B2FE2L;
        Class334.field860[4] = l2 ^ 0xB8D1F8A5612B2FE3L;
        Class334.field860[2] = l2 ^ 0xB8D1F8A5612B2F86L;
        Class334.field860[5] = l2 ^ 0xB8D1F8A5612B2F2AL;
        Class334.field860[3] = l2 ^ 0xB8D1F8A5612B2FDEL;
        Class334.field860[1] = l2 ^ 0xB8D1F8A5612B2F1DL;
    }
    ...
    public static Class248 method3057(Class334 class334) {
    ...
    private static Class365 method3061() {
    ...
    static {
        Class334.method3030(-5129045111414771742L);
    }
    ...
    private static double method3064(class_243 class_2432) {
        return Class334.method3056(class_2432);
    }

    private static Class248 method3065(Class334 class334) {
        return Class334.method3035(class334);
    }
    ...
    public static Class248 method3068(Class334 class334) {
    ...
    public void method3069(Class59 l2) {
        void m2;
        if (Class334.method3054(field290) == null) return;
        ...
        if (Class334.method3047(Class334.field290.field_1690)) {
            return;
        }
        class_4587 n4 = new class_4587();
        double o2 = ((Integer)Class334.field290.field_1690.method_41808().method_41753()).intValue();
        n4.method_34425(Class334.field290.field_1773.method_22973(o2));
        ...
        class_243 q2 = Class334.method3036((class_1297)m2, l2.method124());
        class_4184 r2 = Class334.field290.field_1773.method_19418();
        ...
        if (Class334.method3061().method1265()) {
            class_243 b2 = Class365.method4718().method4722();
            class_243 c2 = Class6023.method23730(b2, Class365.method4718().method4719(), l2.method124());
            float[] d2 = Class365.method4718().method4735();
            t2 = Class334.method3064(b2) - c2.field_1352;
        ...
        Iterator iterator = Class334.field290.field_1687.method_18112().iterator();
        while (true) {
            Color j2;
            int i2;
            if (!iterator.hasNext()) {
            ...
            if (k2 == null || !k2.method_5805() || k2 == Class334.field290.field_1724) continue;
            if (i2 == 0 || k2 instanceof class_1657 && Class5723.field11045.method21243(k2.method_5476()) && !((Boolean)Class334.method3029(this.field859)).booleanValue() || (j2 = this.method3042(k2)) == null) continue;
            class_243 e2 = Class334.method3072(k2, Class334.method3067(l2));
            ...
            Class334.method3045(l2.method125(), y2, new class_243(f2, g2, h2).method_1031(0.0, this.method3051(k2), 0.0), ((Float)Class334.method3039(Class334.method3043(this))).floatValue(), j2.getRGB());
        }
    }
