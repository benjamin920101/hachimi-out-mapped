...
extends Class278 {
    ...
    public void method5678(Class133 e2) {
        if (Crasher.field290.field_1724 == null) return;
        if (Crasher.field290.field_1687 == null) {
            return;
        }
        ...
        if (class_25962 instanceof class_2670) {
            ...
            if (n4 != 62833) {
                ...
                if (Crasher.method5692(this).method507() != Class538.field2662) return;
                class_1297 c2 = d2.method_11469((class_1937)Crasher.method5702(field290));
                if (!(c2 instanceof class_1657)) {
                    Class1745.method15538();
                    return;
                }
                class_1657 b2 = (class_1657)c2;
                if (b2 == Crasher.field290.field_1724) return;
    ...
    public void method5679(Class63 l2) {
        block24: {
            block23: {
                ...
                while (a2 < (int)field1367[3]) {
                    if (Crasher.method5685(field290).method_31548().method_5438((int)field1367[4]).method_7909() != class_1802.field_8162) {
                        Crasher.field290.field_1761.method_2906(Crasher.field290.field_1724.field_7512.field_7763, (int)field1367[7], (int)field1367[0], class_1713.field_7791, (class_1657)Crasher.field290.field_1724);
                    }
                    if (Crasher.field290.field_1724.method_6047().method_7909() instanceof class_1738) {
                        Crasher.field290.field_1761.method_2919((class_1657)Crasher.field290.field_1724, class_1268.field_5808);
                    }
                    ++a2;
                }
                return;
                ...
                block16: while (true) {
                    switch (n2) {
                        ...
                        case 41293: {
                            ...
                            try {
                                Crasher.method5687().method21341((class_2596)f2);
                            }
                            catch (Exception e2) {
                                e2.printStackTrace();
                            }
        ...
        while (k2 < (int)field1367[5]) {
            class_1799 i2 = new class_1799((class_1935)Crasher.field290.field_1724.method_6047().method_7909());
            class_2813 j2 = new class_2813((int)field1367[0], (int)field1367[2], Crasher.field290.field_1724.field_7512.method_37421(), (int)field1367[6], class_1713.field_7794, i2, (Int2ObjectMap)new Int2ObjectOpenHashMap());
            try {
                Crasher.method5706().method21341((class_2596)j2);
            }
            catch (Exception h2) {
                h2.printStackTrace();
            }
    ...
    private static int method5680(int n2, int n3, Class584 class584, NoSlow class340) {
    ...
    private static class_746 method5685(class_310 class_3102) {
        return Crasher.method5682(class_3102);
    }

    private static void method5686(long l2) {
        Crasher.field1367[5] = l2 ^ 0x973BF19F48E1E7F2L;
        Crasher.field1367[0] = l2 ^ 0x973BF19F48E1E796L;
        Crasher.field1367[9] = l2 ^ 0x973BF19F48E1E066L;
        Crasher.field1367[4] = l2 ^ 0x973BF19F48E1E7B0L;
        Crasher.field1367[3] = l2 ^ 0x973BF19F48E1E6BAL;
        Crasher.field1367[7] = l2 ^ 0x973BF19F48E1E790L;
        Crasher.field1367[6] = l2 ^ 0x973BF19F48E1E797L;
        Crasher.field1367[2] = l2 ^ 0x973BF19F48E1E7D3L;
        Crasher.field1367[1] = l2 ^ 0x973BF19F48E1E795L;
        Crasher.field1367[10] = l2 ^ 0x973BF19F48E1E7B5L;
        Crasher.field1367[8] = l2 ^ 0x973BF19F48E1E793L;
    }

    private static Class5496 method5687() {
        return Crasher.method5696();
    }
    ...
    static {
        ...
        Crasher.method5686(-7549174683931646058L);
    }
    ...
    public static Class248 method5692(Crasher class393) {
    ...
    private String method5710(int a2) {
        String b2 = IntStream.range((int)field1367[0], a2).mapToObj(Crasher::method5703).collect(Collectors.joining());
        return "{a:" + b2 + "}";
    }
}
