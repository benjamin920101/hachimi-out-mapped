...
extends Class411 {
    ...
    private static Class413 INSTANCE;
    private static long[] field1534;
    private int field1535;

    private static void method6571(long l2) {
        Class413.field1534[3] = l2 ^ 0x8135D0021A90857AL;
        Class413.field1534[5] = l2 ^ 0x7ECA2FFDE56F7A8CL;
        Class413.field1534[4] = l2 ^ 0x8135D0021A908557L;
        Class413.field1534[1] = l2 ^ 0x8135D0021A908573L;
        Class413.field1534[0] = l2 ^ 0x8135D0021A908780L;
        Class413.field1534[2] = l2 ^ 0x8135D0021A908572L;
    }
    ...
    private static int method6574(Class413 class413) {
        return Class413.method6577(class413);
    }

    private static int method6575(int n2, int n3, Class715 class715, Class338 class338) {
        return Class5983.method23406(n2, n3, class715, class338);
    }

    public static Class413 method6576() {
        return INSTANCE;
    }
    ...
    public static int method6577(Class413 class413) {
    ...
    public void method6580(Class210 h2) {
        ...
        for (int e2 = (int)field1534[1]; e2 < (int)field1534[4]; ++e2) {
            class_1799 d2 = Class413.field290.field_1724.method_31548().method_5438(e2);
        ...
        for (int g2 = (int)field1534[1]; g2 < (int)field1534[3]; ++g2) {
            class_1799 f2 = Class413.method6584(field290).method_31548().method_5438(g2);
            if (f2.method_7960() || f2.method_7909() != class_1802.field_8102) continue;
            k2 = g2;
            break;
        }
        float l2 = class_1753.method_7722((int)Class413.method6574(this));
        if (Class413.field290.field_1724.method_6047().method_7909() != class_1802.field_8102 || k2 == (int)field1534[5] || i2 == (int)field1534[5]) {
            this.method1268();
            return;
        }
        this.method6465(Class413.field290.field_1724.method_36454(), -90.0f);
        if (i2 != (int)field1534[3]) {
            if (Class413.field290.field_1724.field_7512.method_34255().method_7909() != Class413.method6585()) {
                Class413.field290.field_1761.method_2906((int)field1534[1], i2 < (int)field1534[3] ? i2 + (int)field1534[4] : i2, (int)field1534[1], Class413.method6572(), (class_1657)Class413.field290.field_1724);
            }
            if (Class413.field290.field_1724.field_7512.method_34255().method_7909() == Class413.method6586()) {
                Class413.field290.field_1761.method_2906((int)field1534[1], (int)field1534[3], (int)field1534[1], Class413.method6595(), (class_1657)Class413.field290.field_1724);
            }
            if (!Class413.field290.field_1724.field_7512.method_34255().method_7960()) {
                Class413.field290.field_1761.method_2906((int)field1534[1], i2 < (int)field1534[3] ? i2 + (int)field1534[4] : i2, (int)field1534[1], Class413.method6606(), (class_1657)Class413.field290.field_1724);
            }
        }
        if (!(l2 >= 0.15f)) {
            Class413.field290.field_1690.field_1904.method_23481((boolean)field1534[2]);
            this.field1535 = Class413.method6596(this) + (int)field1534[2];
            return;
        }
        this.field1533.add(j2);
        Class413.field290.field_1690.field_1904.method_23481((boolean)field1534[1]);
        ...
        Class413.field290.field_1724.method_6075();
    ...
    static {
        ...
        Class413.method6571(-9136167561596992141L);
    }
    ...
    public void method1279() {
        ((Class6188)Class413.method6602(Class413.field290.field_1690)).method24106();
    ...
    public static int method6596(Class413 class413) {
        return class413.field1535;
    }
