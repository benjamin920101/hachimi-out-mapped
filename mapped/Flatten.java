...
extends Class414 {
    ...
    static {
        ...
        Flatten.method8578(4916600860289975438L);
    ...
    private boolean method8567(class_2338 a2) {
        ...
        Class6161 c2 = Flatten.method8564(Flatten.method8583(), a2);
        if (((Boolean)Flatten.method8571(this).method507()).booleanValue() && c2 != null && (c2.field12485.method12595((Double)Flatten.method8580(this.field1943) * 1000.0) || Flatten.method8573(c2))) {
    ...
    public static Class248 method8570(Flatten class426) {
        return class426.field1945;
    }

    public static Class248 method8571(Flatten class426) {
    ...
    private void method8576(Class210 d2) {
        ...
        if (((Boolean)this.field1944.method507()).booleanValue()) {
            if (Flatten.method8577((class_746)Flatten.field290.field_1724).field_3904) {
                this.method1273();
                return;
            }
        }
        ...
        Flatten.method8586(this, (Integer)Flatten.method8590(this).method507());
        if (((Boolean)Flatten.method8570(this).method507()).booleanValue()) {
            if (!Flatten.method8568(field290).method_24828() && !(Flatten.field290.field_1687.method_8320(Flatten.field290.field_1724.method_24515()).method_26204() instanceof class_2399)) {
                return;
            }
        }
        if (((Boolean)Flatten.method8591(this.field1934)).booleanValue() && !Velocity.method10252()) {
            return;
        }
        if (((Boolean)Flatten.method8565(this.field1949)).booleanValue() && Flatten.field290.field_1724.method_6128()) {
            return;
        }
        if (((Boolean)this.field1932.method507()).booleanValue() && Flatten.field290.field_1724.method_52535()) {
            return;
        }
        if (!((Boolean)this.field1536.method507()).booleanValue() && Flatten.field290.field_1724.method_6115()) {
            return;
        }
        if (Blink.method4987()) {
            return;
        ...
        if (((Boolean)this.field1948.method507()).booleanValue()) {
            List b2 = Flatten.method8574(Flatten.field290.field_1724.method_19538());
            ...
            while (true) {
                ...
                if (b2.contains(a2.method_10074()) || ((Boolean)this.field1951.method507()).booleanValue() && !Class1215.method13246((class_1297)Flatten.field290.field_1724, new class_238(a2))) continue;
                field1947.add(a2.method_10074());
            }
        }
        if (!((Boolean)this.field1951.method507()).booleanValue() || Class1215.method13246((class_1297)Flatten.field290.field_1724, new class_238(Flatten.field290.field_1724.method_24515()))) {
            field1947.add(Flatten.field290.field_1724.method_24515().method_10074());
        }
        int e2 = (int)field1950[0];
        for (class_2338 c2 : Flatten.method8585()) {
    ...
    private static void method8578(long l2) {
        Flatten.field1950[0] = l2 ^ 0x443B466EE3F6C48EL;
        Flatten.field1950[2] = l2 ^ 0x443B466EE3F6C486L;
        Flatten.field1950[5] = l2 ^ 0x443B466EE3F6C738L;
        Flatten.field1950[4] = l2 ^ 0x443B466EE3F6C49AL;
        Flatten.field1950[1] = l2 ^ 0x443B466EE3F6C48FL;
        Flatten.field1950[3] = l2 ^ 0x443B466EE3F6C48CL;
    }
    ...
    private void method8579(Class133 c2) {
        ...
        if (class_25962 instanceof class_5892 && (a2 = Flatten.field290.field_1687.method_8469((b2 = (class_5892)class_25962).comp_2275())) == Flatten.field290.field_1724 && ((Boolean)Flatten.method8589(this).method507()).booleanValue()) {
            this.method1273();
        }
    }
    ...
    public static void method8584(Flatten class426, int n2) {
    ...
    private static void method8586(Flatten class426, int n2) {
        Flatten.method8584(class426, n2);
    }
    ...
    public Flatten() {
        ...
        class_2248Array[(int)Flatten.field1950[0]] = class_2246.field_10540;
    ...
    public static Class248 method8589(Flatten class426) {
        return class426.field1939;
    }

    public static Class248 method8590(Flatten class426) {
