...
extends Class411 {
    ...
    Class248 field2179;
    private static Class438 INSTANCE;
    Class248 field2180;
    ...
    public void method9446(Class51 a2) {
        if (((Boolean)Class438.method9457(this.field2180)).booleanValue()) {
            a2.method10();
        }
    }
    ...
    private static void method9448(long l2) {
        Class438.field2181[1] = l2 ^ 0x740AC6C00108F49DL;
        Class438.field2181[0] = l2 ^ 0x740AC6C00108F489L;
        Class438.field2181[2] = l2 ^ 0x740AC6C00108F49CL;
    }
    ...
    public void method9449(Class63 a2) {
        if (a2.method128() != Class438.method9447()) return;
        int n2 = (Boolean)Class438.method9456(Class438.method9454(this)) == false ? 47722 : 47721;
        block4: while (true) {
            switch (n2) {
                case 47722: {
                    n2 = 47720;
                ...
                case 47721: {
                    if (!Class438.field290.field_1690.field_1869.method_1434()) return;
                    if (!Class438.method9452(this.field2178, (Number)this.field2179.method507())) {
                        return;
                    }
                    Class5723.field11048.method21341((class_2596)new class_2846(class_2846.class_2847.field_12975, class_2338.field_10980, Class438.method9445()));
                    Class438.method9451(this.field2178);
                    return;
                }
            }
            break;
    ...
    private static void method9453(long l2) {
        Class438.method9448(l2);
    }

    static {
        field2181 = new long[3];
        Class438.method9453(8361714186120131741L);
    }

    public static Class248 method9454(Class438 class438) {
        return class438.field2182;
    }

    public static Class438 method9455() {
        return INSTANCE;
    }
