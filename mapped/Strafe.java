...
extends Class278 {
    ...
    private static Speed method1412() {
    ...
    static {
        Strafe.method1424(-6481786793092716587L);
    }
    ...
    public void method1423(Class210 a2) {
        class_243 b2 = Strafe.field290.field_1724.method_18798();
    ...
    private static void method1424(long l2) {
        Strafe.field435[0] = l2 ^ 0xA60C1140EFE3E7D4L;
        Strafe.field435[1] = l2 ^ 0xA60C1140EFE3E7D5L;
    }
                            ...
                            block14: {
                                block16: {
                                    block17: {
                                        ...
                                        if (Flight.method1355().method1265()) break block16;
...
lbl26:
                    ...
                    if (((Boolean)this.field431.method507()).booleanValue()) {
                        d.method10();
                        Strafe.method1416(d, 0.0);
                        d.method389(0.0);
                    }
                    return;
                }
                if (!Strafe.method1408(Strafe.field290).method_24828() && !((Boolean)this.field434.method507()).booleanValue() || Strafe.method1414(Strafe.field290.field_1724.method_18798()) < 0.0 && !((Boolean)this.field433.method507()).booleanValue()) {
                    return;
                }
                e = 1.0;
                f = 1.0;
                if (!((Boolean)this.field438.method507()).booleanValue()) break block20;
                if (!Strafe.method1430(Strafe.field290).method_6059(class_1294.field_5904)) break block21;
                v2 = 27537;
                if (true) ** GOTO lbl50
            }
            v3 = 27538;
...
lbl50:
                ...
                switch (v2) {
                    ...
                    case 27537: {
                        a = Strafe.field290.field_1724.method_6112(class_1294.field_5904).method_5578();
        ...
        if (((Boolean)Strafe.method1429(this).method507()).booleanValue()) {
            if (Strafe.method1411(Strafe.field290).method_6059(class_1294.field_5909)) {
                b = Strafe.field290.field_1724.method_6112(class_1294.field_5909).method_5578();
                f = 1.0 + 0.2 * (b + 1.0);
            }
        }
        ...
        if (((Boolean)Strafe.method1435(this).method507()).booleanValue()) {
            g = Math.max(g, this.field437);
        }
        h = Speed.method4109().method3980((float)g);
        d.method10();
    ...
    public static Class248 method1429(Strafe class282) {
    ...
    private static class_746 method1430(class_310 class_3102) {
        return Strafe.method1410(class_3102);
    }
    ...
    public static Class248 method1435(Strafe class282) {
        return class282.field436;
    }

    @Class1
    public void method1436(Class133 i2) {
        if (Strafe.field290.field_1724 == null || Strafe.field290.field_1687 == null) {
            return;
        }
        if (((Boolean)this.field439.method507()).booleanValue()) {
            ...
            if (class_25962 instanceof class_2743) {
                ...
                if (d2.method_11818() != Strafe.method1428(field290).method_5628()) {
                    return;
                }
                double a2 = Math.sqrt(d2.method_11815() * d2.method_11815() + d2.method_11819() * d2.method_11819());
                class_241 b2 = Strafe.method1412().method3980((float)a2);
                bc c2 = (bc)d2;
                c2.setVelocityX((int)((double)(Strafe.method1405(b2) * ((Float)this.field441.method507()).floatValue()) * 8000.0));
                ...
                if (class_25962 instanceof class_2664) {
                    ...
                    class_241 f2 = Speed.method4109().method3980((float)e2);
                    j g2 = (j)h2;
                    g2.setPlayerVelocityX(f2.field_1343 * ((Float)this.field441.method507()).floatValue());
                    g2.setPlayerVelocityZ(f2.field_1342 * ((Float)Strafe.method1432(this.field441)).floatValue());
                }
            }
        }
    }
