...
extends Class278 {
    ...
    public void method4439(Class131 a2) {
        if (Class357.field290.field_1724 == null) {
            return;
        }
    ...
    public static ConcurrentMap method4440(Class357 class357) {
    ...
    private void method4442(class_2596 a2, Long b2) {
        ...
        if ((float)c2 > ((Float)this.field1120.method507()).floatValue()) {
            Class357.field290.field_1724.field_3944.method_52787(a2);
    ...
    static {
        Class357.method4448(2047238709616732913L);
    }
    ...
    private static ConcurrentMap method4445(Class357 class357) {
        return Class357.method4440(class357);
    }
    ...
    public void method1279() {
        ...
        if (!Class357.method4447(this).isEmpty()) {
            Class357.method4445(this).forEach(Class357::method4446);
    ...
    public static ConcurrentMap method4447(Class357 class357) {
        return class357.field1121;
    }

    private static void method4448(long l2) {
        Class357.field1119[0] = l2 ^ 0x1C6940C279226AF1L;
    }
