...
extends Class278 {
    ...
    private static Class351 INSTANCE;
    ...
    private static class_746 method3888(class_310 class_3102) {
        return Class351.method3899(class_3102);
    }
    ...
    public static boolean method3893(Class351 class351) {
    ...
    static {
        Class351.method3919(-83979887782282276L);
    }
    ...
    private void method3901() {
        if (this.method1265()) {
            Class351.method3917(this, (!this.field1021 ? (int)field1022[1] : (int)field1022[0]) != 0);
        }
    }
    ...
    public Class351() {
        ...
        class246Array[(int)Class351.field1022[0]] = (Class246)this.field1017.method507();
        class246Array[(int)Class351.field1022[1]] = (Class246)this.field1029.method507();
    ...
    public static void method3905(Class351 class351, class_1792 class_17922) {
    ...
    public void method1279() {
        ...
        Class351.method3905(this, null);
        this.field1028 = null;
    }

    public static Class248 method3906(Class351 class351) {
        return class351.field1033;
    }

    @Class1
    public void method3907(Class228 a2) {
        this.field1023 = Class351.method3909(class_1802.field_8288);
    }

    private Set method3908() {
        LinkedHashSet<String> a2 = new LinkedHashSet<String>();
        if (Class351.method3890((class_310)Class351.field290).field_7512.field_7763 != 0) {
            a2.add("Current screen handler is not the player inventory");
        }
        if (!Class351.field290.field_1724.field_7512.method_34255().method_7960()) {
    ...
    public static Class248 method3913(Class351 class351) {
    ...
    private class_1792 method3914() {
        block2: {
            block3: {
                if (!((Boolean)Class351.method3913(this).method507()).booleanValue() || !Class4196.method20811(class_1802.field_8463, (boolean)field1022[1])) break block2;
                if (Class351.method3943(field290).method_6059(class_1294.field_5898)) break block3;
    ...
    private static void method3917(Class351 class351, boolean bl2) {
        Class351.method3953(class351, bl2);
    }
    ...
    private static void method3919(long l2) {
        Class351.field1022[0] = l2 ^ 0xFED5A4BCAC75BBDCL;
        Class351.field1022[3] = l2 ^ 0x12A5B43538A4423L;
        Class351.field1022[5] = l2 ^ 0xFED5A4BCAC75BBFFL;
        Class351.field1022[4] = l2 ^ 0xFED5A4BCAC75BBF8L;
        Class351.field1022[1] = l2 ^ 0xFED5A4BCAC75BBDDL;
        Class351.field1022[6] = l2 ^ 0xFED5A4BCAC75BBD5L;
        Class351.field1022[2] = l2 ^ 0xFED5A4BCAC75BBDEL;
        Class351.field1022[8] = l2 ^ 0xFED5A4BCAC75BBF4L;
        Class351.field1022[7] = l2 ^ 0xFED5A4BCAC75BBF1L;
    }
    ...
    private void method3921() {
        if (this.method1265()) {
            this.field1025 = !Class351.method3965(this) ? (int)field1022[1] : (int)field1022[0];
        }
    }

    private static int method3922(int n2, int n3, Class390 class390, Class3511 class3511) {
    ...
    public static Class248 method3926(Class351 class351) {
    ...
    public void method3927(Class133 e) {
        block9: {
            block8: {
                block10: {
                    if (Class351.field290.field_1724 == null || Class351.field290.field_1687 == null) {
                        return;
                    }
                    var2_2 = e.method251();
...
lbl17:
            ...
            b = Class351.method3961(this);
            if (b.isEmpty()) {
                a = System.currentTimeMillis() - Class351.method3970(this);
                v1 = new Object[(int)Class351.field1022[1]];
                v1[(int)Class351.field1022[0]] = a;
                this.method1249("Failed to replace totem in %sms!", v1);
            } else {
                v2 = new Object[(int)Class351.field1022[1]];
                v2[(int)Class351.field1022[0]] = String.join((CharSequence)", ", b);
                this.method1249("Failed to replace totem! Possible reasons: %s", v2);
            }
        }
        if ((var2_2 = e.method251()) instanceof class_2653 && (d = (class_2653)var2_2).method_11450() == (int)Class351.field1022[7] && this.field1028 == class_1802.field_8288) {
            if (Class351.field290.field_1724.method_6079().method_7909() != Class351.method3947() || !d.method_11449().method_7960()) {
                return;
            }
    ...
    public static void method3928(Class351 class351, boolean bl2) {
    ...
    public static int method3932(Class351 class351) {
        return class351.field1024;
    }

    public static Class351 method3933() {
        return INSTANCE;
    }

    public static int method3934(Class351 class351) {
        return class351.field1024;
    }

    public static void method3935(Class351 class351, boolean bl2) {
        class351.field1027 = bl2;
    }
    ...
    public static Class248 method3938(Class351 class351) {
        return class351.field1030;
    }

    public static boolean method3939(Class351 class351) {
        return class351.field1025;
    }
    ...
    private static class_746 method3946(class_310 class_3102) {
        return Class351.method3891(class_3102);
    }
    ...
    public static void method3949(Class351 class351, class_1792 class_17922) {
    ...
    public String method1248() {
        if (Class351.method3939(this)) {
            return "Shield," + Class4196.method20813(class_1802.field_8288);
        }
        if (this.field1021) {
            return "Chorus, " + Class351.method3887(class_1802.field_8288);
        }
        return String.valueOf(Class4196.method20813(class_1802.field_8288));
    }

    public static void method3953(Class351 class351, boolean bl2) {
        class351.field1021 = bl2;
    }

    public static class_1792 method3954(Class351 class351) {
    ...
    public static long method3959(Class351 class351) {
        return class351.field1016;
    }

    private static Class248 method3960(Class351 class351) {
        return Class351.method3938(class351);
    }

    private static Set method3961(Class351 class351) {
        return class351.method3908();
    }

    private boolean method3962(float d2) {
        ArrayList e2 = Lists.newArrayList((Iterable)Class351.field290.field_1687.method_18112());
        for (class_1297 c2 : e2) {
            if (c2 == null || !c2.method_5805() || !(c2 instanceof class_1511)) continue;
            class_1511 a2 = (class_1511)c2;
            if (Class351.field290.field_1724.method_5858(c2) > 144.0) {
                return Class376.method4987();
            }
            double b2 = Class5905.method23257((class_1297)Class351.field290.field_1724, a2.method_19538(), (boolean)field1022[0]);
            if ((double)d2 - b2 > (double)((Float)Class351.method3926(this).method507()).floatValue()) continue;
    ...
    private static boolean method3965(Class351 class351) {
        return Class351.method3893(class351);
    }

    private static class_239 method3966(class_310 class_3102) {
        return Class351.method3897(class_3102);
    }

    private boolean method3967() {
        float a2 = Class5659.method22208();
        return (a2 <= ((Float)this.field1030.method507()).floatValue() || (Boolean)this.field1036.method507() != false && this.method3962(a2) || (float)Class5659.method22205(Class351.method3888((class_310)Class351.field290).field_6017, 1.0f) + 0.5f > Class351.field290.field_1724.method_6032() && (Boolean)this.field1019.method507() != false ? (int)field1022[1] : (int)field1022[0]) != 0;
    }
            ...
            block42: {
                block41: {
                    block39: {
                        block40: {
                            block38: {
                                if (Class351.field290.field_1724 == null || g.method128() != Class543.field2690) {
                                    return;
                                }
                                Class351.method3949(this, ((Class612)this.field1026.method507()).method11303());
                                if (this.field1021) break block38;
                                if (!this.field1025) break block39;
                                break block40;
                            }
                            if (Class351.method3946(Class351.field290).method_7357().method_7904(class_1802.field_8233)) {
                                this.field1021 = (int)Class351.field1022[0];
                                this.method3969(g);
                                return;
                            }
                ...
                c = Class351.field290.field_1724.method_6047().method_7909();
                if (!Class351.method3931((class_310)Class351.field290).field_1904.method_1434()) break block37;
                if (!((Boolean)Class351.method3892(this.field1031)).booleanValue()) ** GOTO lbl45
...
lbl45:
                                        ...
                                        if (((Boolean)this.field1015.method507()).booleanValue() && c instanceof class_1810 || ((Boolean)Class351.method3906(this).method507()).booleanValue() && c == class_1802.field_8288) break block12;
            ...
            if (Class351.method3955() >= ((Float)Class351.method3960(this).method507()).floatValue()) {
                var3_4 = Class351.method3966(Class351.field290);
                if (!(var3_4 instanceof class_3965)) {
                    this.field1028 = this.method3914();
                } else {
                    b = (class_3965)var3_4;
                    a = Class351.method3904(Class351.field290).method_8320(b.method_17777());
        ...
        if (Class351.field290.field_1724.method_6079().method_7909() == this.field1028) {
            return;
        }
        h = (int)Class351.field1022[5];
        if (this.field1024 != (int)Class351.field1022[3] && this.field1035 != null && (e = Class351.method3950(Class351.field290).method_31548().method_5438(Class351.method3934(this))).method_7909().equals(this.field1028) && this.field1035.equals(Class351.field290.field_1724.method_6079().method_7909())) {
            d = Class351.method3932(this);
            this.field1024 = (int)Class351.field1022[3];
            this.field1035 = null;
            h = d;
        }
        block14: while (true) {
            ...
            block15: while (true) {
                switch (v3) {
                    ...
                    case 4238: {
                        if (Class351.method3944(Class351.field290).method_31548().method_5438(h).method_7909() == this.field1028) {
                            if (h < (int)Class351.field1022[6]) {
                                this.field1035 = Class351.method3954(this);
                                this.field1024 = h;
                            }
                            if (h < (int)Class351.field1022[6]) {
                                v4 = h + (int)Class351.field1022[4];
                                Class351.method3894();
                                return;
                            }
                            f = h;
                            Class351.method3928(this, (boolean)Class351.field1022[1]);
                            if (((Boolean)this.field1018.method507()).booleanValue()) {
                                Class351.field290.field_1761.method_2906((int)Class351.field1022[0], f, (int)Class351.field1022[8], class_1713.field_7791, (class_1657)Class351.field290.field_1724);
                                this.field1027 = (int)Class351.field1022[0];
                                return;
                            }
                            if (Class351.field290.field_1724.field_7512.method_34255().method_7909() != this.field1028) {
                                Class351.method3903(Class351.field290).method_2906((int)Class351.field1022[0], f, (int)Class351.field1022[0], class_1713.field_7790, (class_1657)Class351.field290.field_1724);
                            }
                            if (Class351.method3956((class_310)Class351.field290).field_7512.method_34255().method_7909() == this.field1028) {
                                Class351.field290.field_1761.method_2906((int)Class351.field1022[0], (int)Class351.field1022[7], (int)Class351.field1022[0], class_1713.field_7790, (class_1657)Class351.field290.field_1724);
                                this.field1023 = Class4196.method20813(class_1802.field_8288) + (int)Class351.field1022[1];
                            }
                            Class351.method3935(this, (boolean)Class351.field1022[0]);
                            if (!Class351.field290.field_1724.field_7512.method_34255().method_7960()) {
                                if (Class351.field290.field_1724.method_6079().method_7909() != this.field1028) {
                                    v5 = 9762;
                                ...
                                while (true) {
                                    if ((var5_8 = v6) == 9761) {
                                        Class351.field290.field_1761.method_2906((int)Class351.field1022[0], f, (int)Class351.field1022[0], class_1713.field_7790, (class_1657)Class351.field290.field_1724);
                                        return;
                                    }
    ...
    private static long method3970(Class351 class351) {
        return Class351.method3959(class351);
    }
