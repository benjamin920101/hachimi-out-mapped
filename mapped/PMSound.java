...
extends Class278 {
    Class248 field1213 = this.method450(new Class260("Sounds", "The sound to play for PM", Class630.field3080, PMSound.method4857()));
    private static PMSound INSTANCE;

    public static PMSound method4852() {
        return INSTANCE;
    }
