...
extends Class411 {
    ...
    Class248 field2207;
    Class248 field2208;
    public static Class441 INSTANCE;
    Class248 field2209;
    Class248 field2210;
    ...
    private static void method9545(long l2) {
        Class441.field2212[6] = l2 ^ 0x9D059EF2D81D2C51L;
        Class441.field2212[7] = l2 ^ 0x9D059EF2D81D2C75L;
        Class441.field2212[0] = l2 ^ 0x9D059EF2D81D2C58L;
        Class441.field2212[5] = l2 ^ 0x9D059EF2D81D2FDCL;
        Class441.field2212[3] = l2 ^ 0x9D059EF2D81D2C59L;
        Class441.field2212[8] = l2 ^ 0x9D059EF2D81D2C7CL;
        Class441.field2212[1] = l2 ^ 0x62FA610D27E2D3A7L;
        Class441.field2212[4] = l2 ^ 0x9D059EF2D81D2C5BL;
        Class441.field2212[2] = l2 ^ 0x9D059EF2D81D2C5AL;
    }
    ...
    public Class441() {
        ...
        class246Array[(int)Class441.field2212[0]] = (Class246)c2.method507();
        class246Array[(int)Class441.field2212[3]] = (Class246)b2.method507();
        class246Array[(int)Class441.field2212[2]] = (Class246)a2.method507();
    ...
    private static int method9552(Class441 class441, class_6880 class_68802) {
        return class441.method9587(class_68802);
    }

    static {
        field2212 = new long[9];
        Class441.method9545(-7132119669026247592L);
    }
    ...
    private static int method9555(int n2, int n3, Class6154 class6154, Class362 class362) {
    ...
    public static Class248 method9557(Class441 class441) {
    ...
    public boolean method9561(class_6880 c) {
        block15: {
            block18: {
                block17: {
                    block16: {
                        if (!((Boolean)Class441.method9585(this).method507()).booleanValue()) {
                            if (Class441.field290.field_1724.method_6115()) {
                                return (boolean)((int)Class441.field2212[0]);
                            }
                        }
                        d = Class441.method9552(this, c);
                        if (d == (int)Class441.field2212[1]) break block15;
                        a = Class5723.field11058.method18969();
                        b = Class441.method9577(Class441.field290).method_36454();
                        if (!((Boolean)Class441.method9581(this).method507()).booleanValue() || !((Boolean)Class441.method9551(this.field2207)).booleanValue()) break block16;
                        Class5723.field11058.method18951(d, Class5723.field11058.method18969());
                        break block17;
                    }
                    if (d < (int)Class441.field2212[6]) {
                        Class441.method9589().method18887(d);
...
lbl22:
                        ...
                        switch (v1) {
                            ...
                            case 13837: {
                                Class5723.field11058.method18951(d, Class441.method9576().method18969());
                            }
                        }
                        break;
                    }
                ...
                ((Class480)Class441.method9580(this.field2213)).method10782(class_1268.field_5808);
...
lbl40:
                ...
                switch (v2) {
                    ...
                    case 64556: {
                        Class441.method9562(Class441.method9569(), d, Class5723.field11058.method18969());
                        break block9;
                    }
                    default: lbl-1000:
                    // 2 sources
                    ...
                    {
                        if (d < (int)Class441.field2212[6]) {
                            Class441.method9563().method18987(a);
                            break block9;
                        }
            ...
            Class441.method9568();
            return (boolean)((int)Class441.field2212[3]);
        }
        return (boolean)((int)Class441.field2212[0]);
    }
    ...
    private void method9565() {
        this.method9561(Class441.method9560());
    }

    public static Class248 method9566(Class441 class441) {
        return class441.field2206;
    }

    public static Class248 method9567(Class441 class441) {
    ...
    private static Class248 method9578(Class441 class441) {
        return Class441.method9566(class441);
    }
    ...
    private static Class248 method9581(Class441 class441) {
        return Class441.method9557(class441);
    }
    ...
    public static Class248 method9584(Class441 class441) {
        return class441.field2211;
    }

    public static Class248 method9585(Class441 class441) {
        return class441.field2210;
    }
    ...
    public int method9587(class_6880 e2) {
        ...
        block4: while (true) {
            if (((Boolean)Class441.method9584(this).method507()).booleanValue()) {
            ...
            block5: while (true) {
                switch (n3) {
                    ...
                    case 28915: {
                        class_1799 b2 = Class441.field290.field_1724.method_31548().method_5438(d2);
                        if (b2.method_7909() == Class441.method9571()) {
    ...
    public void method9591(Class210 a2) {
        block14: {
            block13: {
                if (!this.field2203.method12595(Float.valueOf(((Float)Class441.method9578(this).method507()).floatValue() * 1000.0f))) {
                    return;
                }
                if (!((Boolean)Class441.method9567(this).method507()).booleanValue() && Class441.field290.field_1724.method_6115()) {
                    return;
                }
                if (Class376.method4987()) {
                    return;
                }
                if (!((Boolean)this.field2205.method507()).booleanValue() || Class441.field290.field_1724.method_24828()) break block13;
                if (!Class5659.method22193(1.0) || !Class447.method10292((class_1297)Class441.method9549(field290), new class_238(Class441.method9570(field290).method_24515().method_10074()))) break block14;
            }
            if (((Boolean)this.field2209.method507()).booleanValue() && (!Class441.field290.field_1724.method_6059(class_1294.field_5907) || Class441.field290.field_1724.method_6112(class_1294.field_5907).method_5578() < (int)field2212[3])) {
                ...
                Class441.method9559(this.field2203);
                return;
            }
            if (((Boolean)Class441.method9579(this.field2208)).booleanValue()) {
                if (!Class441.field290.field_1724.method_6059(class_1294.field_5904)) {
            ...
            if (((Boolean)this.field2204.method507()).booleanValue() && !Class441.field290.field_1724.method_6059(class_1294.field_5910)) {
