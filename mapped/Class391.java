...
extends Class278 {
    ...
    private static class_746 method5555(class_310 class_3102) {
        return Class391.method5570(class_3102);
    }
    ...
    private static void method5558(long l2) {
        Class391.field1353[1] = l2 ^ 0x621633CB32866A54L;
        Class391.field1353[0] = l2 ^ 0x621633CB32866A77L;
    }
    ...
    public void method5562(Class190 a2) {
        if (((Boolean)Class391.method5568(this.field1351)).booleanValue() && !field290.method_1542()) {
            a2.method10();
        }
    }
    ...
    public void method5564(Class133 c2) {
        if (Class391.field290.field_1687 == null) {
            return;
        }
        ...
        class_1297 a2 = b2.method_11469((class_1937)Class391.field290.field_1687);
        if (a2 == null) return;
        if (!a2.method_5805()) {
            int n2 = 39296;
            Class4146.method20697();
        ...
        block4: while (true) {
            switch (n3) {
                ...
                case 39295: {
                    if (a2 != Class391.field290.field_1724) return;
                    if (Class391.method5551(Class391.method5563()).method_7909() == Class391.method5561()) {
                        Class391.field290.field_1724.method_31548().method_5441(Class5723.field11058.method18969());
                        return;
                    }
                    if (Class391.field290.field_1724.method_6079().method_7909() != class_1802.field_8288) {
                        return;
                    }
                    Class391.method5560(Class391.method5555(field290).method_31548()).set((int)field1353[0], (Object)class_1799.field_8037);
                    return;
                }
            }
            break;
    ...
    private static class_2596 method5566(Class222 a2, int b2) {
        return new class_2885(Class391.method5559(a2), a2.method415(), b2);
    }

    @Class1
    public void method5567(Class222 a2) {
        if (((Boolean)this.field1352.method507()).booleanValue()) {
            if (Class391.field290.field_1724.method_5998(a2.method413()).method_7909() instanceof class_1747 && !field290.method_1542()) {
                a2.method10();
                Class5723.field11048.method21353(arg_0 -> Class391.method5566(a2, arg_0));
                Class391.field290.field_1724.method_6104(Class391.method5552(a2));
            }
        }
    }
    ...
    static {
        Class391.method5558(7067893613023619703L);
    }
