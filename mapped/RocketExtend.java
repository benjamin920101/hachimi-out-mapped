...
extends Class278 {
    ...
    private static RocketExtend INSTANCE;
    ...
    public static void method5326(RocketExtend class385, class_1671 class_16712) {
    ...
    private static boolean method5328(RocketExtend class385) {
        return RocketExtend.method5330(class385);
    }
    ...
    public static boolean method5330(RocketExtend class385) {
        return class385.field1310;
    }

    static {
        RocketExtend.method5336(6119346525133812197L);
    }

    public static boolean method5331(RocketExtend class385) {
        return class385.field1310;
    }
    ...
    private static boolean method5334(RocketExtend class385) {
        return RocketExtend.method5331(class385);
    }

    @Class1
    public void method5335(Class133 c2) {
        if (RocketExtend.field290.field_1724 == null || RocketExtend.method5354(field290) == null) {
            return;
        }
    ...
    private void method5337() {
        var1_1 = RocketExtend.method5356(this).iterator();
        while (true) {
            block2: {
                block3: {
...
lbl11:
    ...
    public static RocketExtend method5338() {
        return INSTANCE;
    }
    ...
    private static void method5343(long l2) {
        RocketExtend.field1308[1] = l2 ^ 0x54EC493E301F9A05L;
        RocketExtend.field1308[0] = l2 ^ 0x54EC493E301F31E5L;
        RocketExtend.field1308[2] = l2 ^ 0x54EC493E301F31E4L;
    }
    ...
    public void method5347(Class131 b2) {
        int n2;
        if (RocketExtend.field290.field_1724 == null) return;
        if (RocketExtend.field290.field_1687 == null) {
            return;
        }
        int n3 = 34724;
        boolean bl2 = true;
        ...
        while (true) {
            ...
            if ((n5 = n4) == 3821) {
                ...
                if (!RocketExtend.method5328(this)) return;
                b2.method10();
    ...
    public static class_1671 method5348(RocketExtend class385) {
        return class385.field1309;
    }

    public static void method5349(RocketExtend class385, boolean bl2) {
        class385.field1310 = bl2;
    }

    private static void method5350(RocketExtend class385) {
        class385.method5337();
    }
    ...
    private static void method5353(RocketExtend class385, class_1671 class_16712) {
        RocketExtend.method5355(class385, class_16712);
    }

    private static class_638 method5354(class_310 class_3102) {
        return RocketExtend.method5344(class_3102);
    }
    ...
    public void method1279() {
        if (this.field1309 != null) {
            ((au)this.field1309).hookExplodeAndRemove();
            RocketExtend.method5353(this, null);
        }
        RocketExtend.method5349(this, (boolean)field1308[0]);
        this.field1312.method12593();
        this.method5337();
    }

    public static void method5355(RocketExtend class385, class_1671 class_16712) {
        class385.field1309 = class_16712;
    }

    public static List method5356(RocketExtend class385) {
        return class385.field1311;
    }

    @Override
    public String method1248() {
        if (!RocketExtend.method5334(this)) {
            this.field1312.method12593();
        }
        ...
        block14: {
            ...
            block15: {
                ...
                block13: {
                    block12: {
                        if (c2.method128() == Class543.field2690) {
                            int n3 = 56641;
                            RocketExtend.method5359(0.8267002f, 0.77328753f);
                            return;
                        }
                        int n4 = 56640;
                        block8: while (true) {
                        ...
                        iterator = RocketExtend.field290.field_1687.method_18112().iterator();
                        break block13;
                    }
                    if ((Disabler.method5496().method5458() || !RocketExtend.field290.field_1724.method_24828()) && !this.field1312.method12595((int)field1308[1])) break block14;
                    this.field1310 = (int)field1308[0];
                ...
                while (iterator.hasNext()) {
                    ...
                    if (!(b2 instanceof class_1671) || !((au)(a2 = (class_1671)b2)).hookWasShotByEntity() || ((au)a2).hookGetShooter() != RocketExtend.field290.field_1724) continue;
                    this.field1309 = a2;
                    break;
                }
                this.field1312.method12593();
            ...
            block10: while (true) {
                switch (n2) {
                    ...
                    case 10915: {
                        ((au)RocketExtend.method5348(this)).hookExplodeAndRemove();
                        RocketExtend.method5326(this, null);
                        break block10;
                    }
                }
                break;
            }
            RocketExtend.method5350(this);
        }
    }
