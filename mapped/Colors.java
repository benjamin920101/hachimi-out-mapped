...
extends Class451 {
    ...
    private static void method10617(long l2) {
        Colors.field2412[2] = l2 ^ 0xA0CA40AA8349AED1L;
        Colors.field2412[0] = l2 ^ 0xA0CA40AA8349AE4DL;
        Colors.field2412[1] = l2 ^ 0xA0CA40AA8349AE2EL;
        Colors.field2412[3] = l2 ^ 0xA0CA40AA8349AE64L;
    }

    public Color method10618(int a2) {
        Class251 b2 = (Class251)this.field2411;
        return new Color(Colors.method10613(b2), b2.method539(), Colors.method10616(b2), class_3532.method_15340((int)a2, (int)((int)field2412[2]), (int)((int)field2412[1])));
    }
    ...
    public static Colors method10620() {
        return INSTANCE;
    }
    ...
    static {
        ...
        Colors.method10617(-6860599981254267183L);
    }
