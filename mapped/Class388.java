...
extends Class278 {
    ...
    Class248 field1335;
    Class248 field1336;
    Class248 field1337 = this.method450(new Class260("Totem", "Modify totem particle rendering", Class488.field2530, Class388.method5398()));
    ...
    public static Class248 method5393(Class388 class388) {
    ...
    public static Class248 method5395(Class388 class388) {
        return class388.field1337;
    }
    ...
    public static Class248 method5399(Class388 class388) {
        return class388.field1335;
    }

    private static Class248 method5400(Class388 class388) {
        return Class388.method5412(class388);
    }
    ...
    public void method5401(Class54 a2) {
        block10: {
            block9: {
                if (((Boolean)this.field1333.method507()).booleanValue() && a2.method107() == class_2398.field_11226 || ((Boolean)this.field1324.method507()).booleanValue() && (Class388.method5410(a2) == class_2398.field_11236 || a2.method107() == class_2398.field_11221) || ((Boolean)this.field1323.method507()).booleanValue() && a2.method107() == class_2398.field_11248 || ((Boolean)this.field1327.method507()).booleanValue() && a2.method107() == class_2398.field_11218 || ((Boolean)this.field1328.method507()).booleanValue() && (a2.method107() == Class388.method5421() || a2.method107() == class_2398.field_11213)) break block9;
                ...
                if (!((Boolean)this.field1332.method507() != false && a2.method107() == class_2398.field_11217 || (Boolean)this.field1326.method507() != false && Class388.method5414(a2) == class_2398.field_17430) && (!((Boolean)this.field1325.method507()).booleanValue() || a2.method107() != Class388.method5418() && Class388.method5413(a2) != class_2398.field_22446 && a2.method107() != class_2398.field_22448)) break block10;
            }
            a2.method10();
        }
    }
    ...
    static {
        Class388.method5404(3832612892629948888L);
    }

    private static void method5404(long l2) {
        Class388.field1329[1] = l2 ^ 0x35302D1EAACA59C8L;
        Class388.field1329[4] = l2 ^ 0x35302D1EAACA59DDL;
        Class388.field1329[7] = l2 ^ 0x35302D1EAACA59DBL;
        Class388.field1329[2] = l2 ^ 0x35302D1EAACA59A0L;
        Class388.field1329[0] = l2 ^ 0x35302D1EAACA59D8L;
        Class388.field1329[8] = l2 ^ 0x35302D1EAACA59DCL;
        Class388.field1329[5] = l2 ^ 0x35302D1EAACA59C6L;
        Class388.field1329[3] = l2 ^ 0x35302D1EAACA59D9L;
        Class388.field1329[6] = l2 ^ 0x35302D1EAACA59C1L;
    }

    private Boolean method1269() {
        return (Class388.method5393(this).method507() == Class488.field2532 ? (int)field1329[3] : (int)field1329[0]) != 0;
    }
    ...
    public void method5411(Class39 a2) {
        if (this.field1337.method507() != Class488.field2529) {
            if (a2.method76() == class_2398.field_11220) {
                a2.method10();
                Class388.method5394(a2, (Integer)Class388.method5399(this).method507());
                a2.method74((Integer)this.field1334.method507());
            }
        }
    }

    public static Class248 method5412(Class388 class388) {
        return class388.field1337;
    }
    ...
    public void method5415(Class53 h2) {
        if (Class388.method5407(Class388.method5400(this)) != Class488.field2532) return;
        h2.method10();
    ...
    private Boolean method5416() {
        if (Class388.method5395(this).method507() != Class488.field2529) {
