...
extends Class414 {
    ...
    private boolean method6731(class_2338 a2) {
        if (!((Boolean)Surround.method6831(this.field1579)).booleanValue()) {
            return Velocity.method10252();
        }
        if (!a2.equals((Object)Class5659.method22153((class_1657)Surround.field290.field_1724, (boolean)field1590[3]).method_10074()) || !Surround.method6850(Class5723.field11054, a2)) {
    ...
    private static void method6734(Surround class416, class_2338 class_23382) {
    ...
    private boolean method6740() {
        return (Surround.method6822(this) <= 0 && (Integer)this.field1567.method507() > 0 ? (int)field1590[1] : (int)field1590[3]) != 0;
    }
    ...
    public Surround() {
        ...
        class_2248Array[(int)Surround.field1590[3]] = class_2246.field_10540;
        class_2248Array[(int)Surround.field1590[1]] = class_2246.field_10443;
    ...
    private static boolean method6741(Surround class416, class_2338 class_23382, boolean bl2) {
        return class416.method6761(class_23382, bl2);
    }

    private static void method6742(long l2) {
        Surround.method6791(l2);
    }
    ...
    private static boolean method6749(class_1297 a2) {
        return (a2 instanceof class_1511 && Class5905.method23257((class_1297)Surround.method6786(field290), a2.method_19538(), (boolean)field1590[1]) < (double)Class5659.method22223() ? (int)field1590[1] : (int)field1590[3]) != 0;
    }
    ...
    private Boolean method6752() {
        if (Surround.method6794(this).method507() == Class611.field2975) {
    ...
    private void method6755() {
        ...
        block11: {
            block12: {
                block10: {
                    Iterator iterator;
                    this.method6812();
                    if (((Boolean)Surround.method6780(Surround.method6811(this))).booleanValue() && !Surround.field290.field_1724.method_20448() || ((Boolean)this.field1563.method507()).booleanValue() && Surround.field290.field_1724.method_20448()) {
                        class_2338 a2 = new class_2338.class_2339(Surround.field290.field_1724.method_23317(), Surround.field290.field_1724.method_5829().method_17940() + Surround.field290.field_1724.method_23318(), Surround.field290.field_1724.method_23321()).method_10084();
                        field1589.add(a2);
                        if (this.method6740()) {
                            Surround.method6734(this, a2);
                        }
                    }
                    if (!(iterator = (e2 = Class5659.method22141(Surround.method6842(field290).method_19538())).iterator()).hasNext()) break block10;
                    d2 = (class_2338)iterator.next();
                    if (!((Boolean)Surround.method6803(this.field1586)).booleanValue()) break block11;
                    break block12;
                }
                this.method6840();
                ...
                block5: while (true) {
                    switch (n4) {
                        ...
                        case 31251: {
                            ...
                            if (!e2.contains(b2)) {
                                this.method6835(b2, Surround.method6834(), (boolean)field1590[1]);
                            }
                            ++n3;
                            continue block4;
                        }
        ...
        if (!e2.contains(d2.method_10074())) {
            this.method6835(d2.method_10074(), Surround.method6805(), (boolean)field1590[3]);
        }
    ...
    private boolean method6758(class_2338 a2) {
        if (Surround.method6767(this) >= (Integer)Surround.method6785(this.field1593)) {
            return (int)field1590[3] != 0;
        }
    ...
    private boolean method6761(class_2338 e2, boolean f2) {
        boolean i2;
        Class3442 g2 = new Class3442(e2, (List)Surround.method6759(this.field1594), (boolean)((Boolean)this.field1588.method507()), (Class607)((Object)this.field1571.method507()));
        Class6161 h2 = Class5723.field11054.method22525(e2);
        boolean bl2 = i2 = (Boolean)this.field1573.method507() != false && h2 != null && (h2.field12485.method12595((Double)Surround.method6847(this).method507() * 1000.0) || h2.field12483) || f2 ? g2.method17378((Double)this.field1568.method507(), (Boolean)this.field1583.method507(), (Boolean)this.field1559.method507(), (Double)this.field1565.method507()) : g2.method17369((Double)Surround.method6851(this.field1568), (Boolean)this.field1583.method507(), (Boolean)Surround.method6764(this).method507(), (Double)Surround.method6854(this.field1565));
        ...
        block4: while (true) {
            switch (n2) {
                ...
                case 45037: {
                    int d2 = Surround.field290.field_1687.method_8320(e2).method_45474() || h2 != null ? (int)field1590[1] : (int)field1590[3];
                    if (d2 == 0) return i2;
                    ...
                    Predicate<class_1297> c2 = Surround::method6749;
                    Iterator iterator = Surround.field290.field_1687.method_8333(null, b2, c2).iterator();
                    while (iterator.hasNext()) {
                        class_1297 a2 = (class_1297)iterator.next();
                        Surround.method6772(a2, (Double)this.field1565.method507(), (Boolean)this.field1583.method507());
                    }
                    return i2;
                }
            }
    ...
    public void method6762(Class133 c2) {
        if (Surround.method6806(field290) == null) return;
        if (Surround.field290.field_1687 == null) {
            return;
        }
    ...
    public static Class248 method6763(Surround class416) {
        return class416.field1564;
    }

    public static Class248 method6764(Surround class416) {
        return class416.field1559;
    }

    public static Class248 method6765(Surround class416) {
    ...
    public static int method6767(Surround class416) {
    ...
    public static Class248 method6770(Surround class416) {
        return class416.field1560;
    }

    private void method6771(class_2596 a2) {
        if (this.field1584.method507() != Surround.method6814()) {
            return;
        }
    ...
    public static Class248 method6773(Surround class416) {
    ...
    private static void method6775(Surround class416, class_2338 class_23382, Set set, boolean bl2) {
    ...
    public static Surround method6779() {
        return INSTANCE;
    }
    ...
    private static Class248 method6781(Surround class416) {
        return Surround.method6855(class416);
    }

    @Override
    public void method1274() {
        if (Surround.method6849(this).method507() == Class624.field3049) {
    ...
    private void method6783(class_2338 a2) {
        class_2680 b2 = Surround.field290.field_1687.method_8320(a2);
        if (b2.method_26204() == class_2246.field_9987) {
            return;
        }
        class_2350 c2 = Surround.method6838(a2, (Double)this.field1568.method507());
        if (c2 != null) {
            return;
        }
    ...
    private static class_746 method6786(class_310 class_3102) {
        return Surround.method6747(class_3102);
    }
    ...
    private static void method6791(long l2) {
        Surround.field1590[6] = l2 ^ 0x83969D72151121EEL;
        Surround.field1590[0] = l2 ^ 0x83969D72151121E5L;
        Surround.field1590[3] = l2 ^ 0x83969D72151121EDL;
        Surround.field1590[2] = l2 ^ 0x83969D72151121EFL;
        Surround.field1590[4] = l2 ^ 0x83969D72151121F9L;
        Surround.field1590[1] = l2 ^ 0x83969D72151121ECL;
        Surround.field1590[5] = l2 ^ 0x83969D721511225BL;
    }

    public static int method6792(Surround class416) {
    ...
    public static Class248 method6794(Surround class416) {
        return class416.field1584;
    }
    ...
    private Boolean method1269() {
        return (Surround.method6820(this).method507() == Class611.field2975 ? (int)field1590[1] : (int)field1590[3]) != 0;
    }

    private static int method6798(int n2, int n3, Rotations class456, Class553 class553) {
    ...
    public static Class248 method6801(Surround class416) {
    ...
    private Boolean method1278() {
        int n2 = Surround.method6788(Surround.method6833(this)) != Surround.method6782() ? 32567 : 32566;
        while (true) {
            int n3;
            int n4;
            if ((n4 = n2) == 32566) {
    ...
    public static Class248 method6811(Surround class416) {
    ...
    private void method6817(Class133 c2) {
        if (Surround.field290.field_1724 == null || Surround.field290.field_1687 == null) {
            return;
        }
        class_2596 class_25962 = c2.method251();
        if (class_25962 instanceof class_5892) {
            class_5892 b2 = (class_5892)class_25962;
            class_1297 a2 = Surround.method6737(field290).method_8469(b2.comp_2275());
            if (a2 == Surround.method6815(field290)) {
                if (((Boolean)Surround.method6763(this).method507()).booleanValue()) {
                    this.method1273();
                }
            }
        }
    ...
    public static Class248 method6820(Surround class416) {
        return class416.field1584;
    }
    ...
    private static int method6822(Surround class416) {
        return Surround.method6792(class416);
    }
        ...
        block8: {
            ...
            if (g2 instanceof class_2626) {
                ...
                if (((Boolean)this.field1587.method507()).booleanValue()) {
                    ...
                    if (Surround.method6777().contains(a2)) {
                        if (b2.method_11308().method_45474()) {
                            Surround.method6741(this, a2, (boolean)field1590[1]);
                        }
                    }
                }
            }
    ...
    private void method6830(class_2338 c2) {
        ...
        for (int i2 = (int)field1590[3]; i2 < n2; ++i2) {
            ...
            Surround.method6775(this, a2, Surround.method6768(), (boolean)field1590[3]);
        }
    ...
    private static boolean method6832(Surround class416) {
        return class416.method6740();
    }

    private static Class248 method6833(Surround class416) {
        return Surround.method6773(class416);
    }

    private static Set method6834() {
        return Surround.method6746();
    }
    ...
    private void method6840() {
        ...
        if (((Boolean)this.field1557.method507()).booleanValue()) {
            ...
            Optional<List> b2 = Surround.method6795().stream().min(Comparator.comparingInt(List::size));
            b2.ifPresent(Surround::method6732);
        }
    }
    ...
    private static int method6845(int n2, int n3, Class533 class533, PacketFly class305) {
    ...
    private static Class248 method6847(Surround class416) {
        return Surround.method6765(class416);
    }
    ...
    static {
        ...
        Surround.method6742(-8964804894929116691L);
    ...
    public static Class248 method6849(Surround class416) {
    ...
    private void method6852(Class210 a2) {
        if (SelfTrap.method8968().method1265()) {
            return;
        }
        this.method6755();
        if (((Boolean)Surround.method6770(this).method507()).booleanValue() && Surround.field290.field_1724.field_6036 < Surround.field290.field_1724.method_23318()) {
            this.method1273();
            return;
        }
        if (((Boolean)this.field1576.method507()).booleanValue() && Surround.method6853(Surround.field290.field_1724.field_3913)) {
            this.method1273();
            return;
        }
        if (this.field1556 > 0) {
        ...
        if (((Boolean)Surround.method6790(this.field1569)).booleanValue()) {
            if (!Surround.field290.field_1724.method_24828()) {
                int n2 = 31564;
            ...
            block4: while (true) {
                switch (n3) {
                    ...
                    case 31564: {
                        if (Surround.field290.field_1687.method_8320(Surround.field290.field_1724.method_24515()).method_26204() instanceof class_2399) break block4;
                        return;
                    }
                }
                break;
        ...
        if (((Boolean)this.field1581.method507()).booleanValue()) {
            if (Surround.field290.field_1724.method_6128()) return;
        }
        if (((Boolean)Surround.method6829(Surround.method6781(this))).booleanValue()) {
            if (Surround.field290.field_1724.method_52535()) return;
        }
        if (!((Boolean)this.field1536.method507()).booleanValue() && Surround.field290.field_1724.method_6115()) {
            return;
        }
        if (Blink.method4987()) {
            return;
        ...
        Surround.method6808().removeIf(this::method6758);
        if (field1578.isEmpty()) {
            return;
        }
        field1578.removeIf(this::method6758);
        field1591.removeIf(this::method6731);
        Surround.method6784().removeIf(this::method6758);
    }
    ...
    public static Class248 method6855(Surround class416) {
        return class416.field1570;
    }

    private boolean method6856(class_2338 a2) {
        if (!(((Boolean)Surround.method6807(Surround.method6801(this))).booleanValue() && a2.equals((Object)Class5659.method22153((class_1657)Surround.field290.field_1724, (boolean)field1590[3]).method_10074()) && Class5723.field11054.method22497(a2))) {
            return this.method6758(a2);
        }
        return (int)field1590[3] != 0;
    }
