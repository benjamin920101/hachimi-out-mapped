...
extends Class278 {
    ...
    static {
        Avoid.method2053(-8020297743476490369L);
    }

    private static void method2053(long l2) {
        Avoid.field587[1] = l2 ^ 0x90B22DB217377F7FL;
        Avoid.field587[0] = l2 ^ 0x90B22DB217377F7EL;
    }
    ...
    public void method2056(Class178 a2) {
        ...
        if ((Boolean)this.field593.method507() != false && a2.method350() == class_2246.field_10036 && Avoid.field290.field_1724.method_23318() < (double)b2.method_10264() + 1.0 || (Boolean)this.field589.method507() != false && a2.method350() == class_2246.field_10029 || (Boolean)this.field590.method507() != false && a2.method350() == Avoid.method2055() || ((Boolean)this.field592.method507()).booleanValue() && !Class1215.method13261(b2.method_10263(), b2.method_10260())) {
            a2.method10();
    ...
    public void method2062(Class63 a2) {
        ...
        int n2 = (Boolean)Avoid.method2059(this.field588) != false ? 6833 : 6834;
        block4: while (true) {
            switch (n2) {
                case 6834: {
                    n2 = 6832;
                ...
                case 6833: {
                    if (Avoid.field290.field_1724.method_7325()) return;
                    if (!(Avoid.field290.field_1724.method_23318() < (double)Avoid.field290.field_1687.method_31607())) {
                        return;
                    }
