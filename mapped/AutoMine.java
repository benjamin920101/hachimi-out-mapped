...
extends Class414 {
    ...
    private static boolean method9195(SpeedMine class425, class_2338 class_23382, int n2) {
    ...
    private boolean method9197(class_1297 b2) {
        if (b2 instanceof class_1657) {
            ...
            if (b2.equals((Object)AutoMine.field290.field_1724) || b2.equals((Object)AutoMine.field290.field_1719)) {
                return (int)field2106[0] != 0;
            }
            if (a2.method_29504() || !b2.method_5805()) {
                return (int)field2106[0] != 0;
            }
            if ((double)AutoMine.field290.field_1724.method_5739((class_1297)a2) > (Double)this.field2119.method507()) {
                return (int)field2106[0] != 0;
            }
            if (a2.method_7337()) {
                return (int)field2106[0] != 0;
    ...
    private boolean method9200(class_2338 a, boolean b) {
        c = AutoMine.field290.field_1687.method_8320(a.method_10074()).method_26204();
        d = AutoMine.field290.field_1687.method_8320(a).method_26204();
        ...
        block8: while (true) {
            switch (v0) {
                ...
                default: {
                    if (!(AutoMine.field290.field_1724.method_33571().method_1022(a.method_46558()) <= (Double)this.field2117.method507()) || !(d instanceof class_2189) && !(d instanceof class_2358) && !this.method9216(d) || this.method9244(new class_238((double)a.method_10263(), (double)a.method_10264(), (double)a.method_10260(), (double)(a.method_10263() + (int)AutoMine.field2106[1]), (double)(a.method_10264() + (int)AutoMine.field2106[2]), (double)(a.method_10260() + (int)AutoMine.field2106[1])))) break block8;
                    if (!b) ** GOTO lbl-1000
                    if (!Class5659.method22125((class_1657)AutoMine.method9196(AutoMine.field290), a, (boolean)AutoMine.field2106[1], (boolean)AutoMine.field2106[1], (boolean)AutoMine.field2106[1], (boolean)AutoMine.field2106[1])) ** GOTO lbl17
                    v1 = 46102;
                    ** GOTO lbl21
lbl17:
                    // 1 sources
...
lbl29:
    ...
    private static List method9204(class_243 a2) {
        return AutoMine.method9236(new class_238(a2.method_10216() - 0.25, a2.method_10214() + 1.5, a2.method_10215() - Class1425.field5463, a2.method_10216() + 0.25, a2.method_10214() + 1.5, a2.method_10215() + Class3348.field7241));
    }

    public static AutoMine method9205() {
        return AutoMine.method9207();
    }
    ...
    public static AutoMine method9207() {
        return INSTANCE;
    }

    private static Class248 method9208(AutoMine class435) {
        return AutoMine.method9270(class435);
    }
    ...
    private static boolean method9210(SpeedMine class425, class_2338 class_23382, int n2) {
    ...
    private static int method9213(int n2, int n3, NoSoundLag class303, Class1 class1) {
    ...
    private double method9219(class_2338 a2) {
        return a2.method_19770((class_2374)AutoMine.field290.field_1724.method_19538());
    }
    ...
    public static Class248 method9223(AutoMine class435) {
    ...
    private static int method9225(int n2, int n3, Class127 class127, TrueSight class341) {
        return Class468.method10666(n2, n3, class127, class341);
    }

    public static Class5512 method9226(SpeedMine class425) {
        return class425.field1893;
    }

    public static void method9227(AutoMine class435, class_1297 class_12972) {
    ...
    public static List method9229(AutoMine class435) {
    ...
    public static Class248 method9231(AutoMine class435) {
    ...
    public class_1297 method9235() {
        return AutoMine.method9268(this);
    }
    ...
    public static class_1297 method9238(AutoMine class435) {
    ...
    private static void method9243(long l2) {
        AutoMine.field2106[5] = l2 ^ 0x1B3E8C3777A101A0L;
        AutoMine.field2106[7] = l2 ^ 0x1B3E8C3777A101ADL;
        AutoMine.field2106[1] = l2 ^ 0x1B3E8C3777A101A4L;
        AutoMine.field2106[8] = l2 ^ 0x1B3E8C3777A101A1L;
        AutoMine.field2106[3] = l2 ^ 0x1B3E8C3777A101A6L;
        AutoMine.field2106[4] = l2 ^ 0x1B3E8C3777A101A2L;
        AutoMine.field2106[6] = l2 ^ 0x1B3E8C3777A101AFL;
        AutoMine.field2106[10] = l2 ^ 0x1B3E8C3777A101A3L;
        AutoMine.field2106[9] = l2 ^ 0x1B3E8C3777A101ACL;
        AutoMine.field2106[0] = l2 ^ 0x1B3E8C3777A101A5L;
        AutoMine.field2106[2] = l2 ^ 0x1B3E8C3777A101A7L;
    }

    private boolean method9244(class_238 a2) {
        return Class1158.method13141(a2, AutoMine::method9269);
    }
    ...
    public static Class5512 method9247(SpeedMine class425) {
        return class425.field1893;
    }
    ...
    public String method1248() {
        if (this.field2115 != null) {
            return AutoMine.method9238(this).method_5477().getString();
        }
        return super.method1248();
    }

    public static void method9248(AutoMine class435, class_2338 class_23382) {
    ...
    public static Class248 method9251(AutoMine class435) {
        return class435.field2109;
    }

    static {
        AutoMine.method9243(1963160657438245285L);
    }
    ...
    private static boolean method9255(SpeedMine class425, class_2338 class_23382, int n2) {
        return class425.method8537(class_23382, n2);
    }
    ...
    private static class_638 method9257(class_310 class_3102) {
        return AutoMine.method9202(class_3102);
    }
    ...
    private boolean method9259() {
        int n2;
        class_2338 a2 = Class5659.method22153((class_1657)AutoMine.field290.field_1724, (boolean)field2106[0]);
    ...
    private static Class248 method9261(AutoMine class435) {
        return AutoMine.method9223(class435);
    }

    public static List method9262(AutoMine class435) {
        return class435.field2111;
    }
    ...
    public static Class248 method9265(AutoMine class435) {
        ...
        block45: {
            block43: {
                block44: {
                    ...
                    i = SpeedMine.method8407();
                    Class3493.method17601(this.field2108, (Predicate<class_1297>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Z, method9197(net.minecraft.entity.Entity ), (Lnet/minecraft/class_1297;)Z)((AutoMine)this), (Class525)AutoMine.method9231(this).method507(), (int)AutoMine.field2106[1]);
                    if (this.field2108.isEmpty()) {
                        AutoMine.method9227(this, null);
                        return;
                    }
...
lbl18:
                    ...
                    switch (v0) {
                        ...
                        case 3181: {
                            if (AutoMine.method9247(i) == null) break block20;
                            if (i.field1918.field10395.equals((Object)AutoMine.method9226((SpeedMine)i).field10395)) ** GOTO lbl26
                            v1 = 9656;
                            ** GOTO lbl30
lbl26:
                            // 1 sources
...
lbl33:
                            ...
                            if (AutoMine.method9271(AutoMine.field290).method_22347(i.field1893.field10395)) ** GOTO lbl36
                            v2 = 34477;
                            ** GOTO lbl40
lbl36:
                            // 1 sources
...
lbl43:
            ...
            if (!((Boolean)this.field1536.method507()).booleanValue() && AutoMine.field290.field_1724.method_6115()) {
                return;
            }
            if (((Boolean)AutoMine.method9194(this.field2112)).booleanValue()) {
                for (class_2338 a : AutoMine.method9242(this.field2115.method_19538())) {
                    if (!this.method9216(AutoMine.field290.field_1687.method_8320(a).method_26204()) || !AutoMine.method9210(i, a, (Integer)AutoMine.method9251(this).method507())) continue;
                    return;
                }
            }
            if (((Boolean)AutoMine.method9265(this).method507()).booleanValue()) {
                for (Object b : AutoMine.method9204(this.field2115.method_19538())) {
                    if (!this.method9216(AutoMine.method9257(AutoMine.field290).method_8320((class_2338)b).method_26204()) || !AutoMine.method9255(i, (class_2338)b, (Integer)this.field2109.method507())) continue;
                    return;
                }
            }
            ...
            switch (v3) {
                ...
                case 30487: {
                    ...
                    while (true) {
                        ...
                        var11_11 = (int)AutoMine.field2106[0];
                        block27: while (true) {
...
lbl95:
                                ...
                                switch (v6) {
                                    ...
                                    case 57198: {
                                        ...
                                        if (!this.method9200(c, (boolean)AutoMine.field2106[1])) ** GOTO lbl105
                                        v7 = 8055;
                                        ** GOTO lbl109
lbl105:
                                        // 1 sources
...
lbl109:
                                            ...
                                            switch (v7) {
...

                                                {
                                                    ...
                                                    if (!this.method9200(c, (boolean)AutoMine.field2106[0])) {
                                                        Class6322.method24332(0.5230954f, 0.5780253f);
                                                        return;
                                                    }
                                                    AutoMine.method9262(this).add(c);
                                                }
                                            }
                                            break;
                                        }
                    ...
                    if (AutoMine.method9229(this).isEmpty()) {
                        return;
                    }
                    if (this.field2104 != null && this.field2111.contains(this.field2104)) {
                        AutoMine.method9195(i, this.field2104, (Integer)this.field2109.method507());
                        AutoMine.method9248(this, null);
                        return;
                    }
...
lbl140:
                    ...
                    this.field2111.sort(Comparator.comparingDouble((ToDoubleFunction<class_2338>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)D, method9219(net.minecraft.util.math.BlockPos ), (Lnet/minecraft/class_2338;)D)((AutoMine)this)));
                    g = (class_2338)this.field2111.getFirst();
                    if (this.field2111.size() >= (int)AutoMine.field2106[2] && i.field1893 == null) {
                        i.method8517((class_2338)this.field2111.get((int)AutoMine.field2106[1]), (Integer)this.field2109.method507());
                        this.field2104 = g;
                        return;
                    }
    ...
    public AutoMine() {
        ...
        class_2248Array[(int)AutoMine.field2106[0]] = class_2246.field_10540;
        class_2248Array[(int)AutoMine.field2106[1]] = class_2246.field_22423;
        class_2248Array[(int)AutoMine.field2106[2]] = class_2246.field_22109;
        class_2248Array[(int)AutoMine.field2106[3]] = class_2246.field_22108;
        class_2248Array[(int)AutoMine.field2106[8]] = class_2246.field_23152;
        class_2248Array[(int)AutoMine.field2106[5]] = class_2246.field_10535;
        class_2248Array[(int)AutoMine.field2106[10]] = class_2246.field_10485;
        class_2248Array[(int)AutoMine.field2106[4]] = class_2246.field_10443;
        class_2248Array[(int)AutoMine.field2106[7]] = class_2246.field_10327;
        ...
        class_2248Array2[(int)AutoMine.field2106[0]] = class_2246.field_10343;
        ...
        this.field2113 = this.method450(new Class260("Sort", "How to filter targets within range", Class525.field2605, AutoMine.method9246()));
    ...
    public static class_1297 method9268(AutoMine class435) {
        return class435.field2115;
    }
    ...
    private static boolean method9269(class_1297 a2) {
        ...
        if (!(a2 instanceof class_1542) && !(a2 instanceof class_1511)) {
            ...
            return AutoMine.method9256(0.5971396529011599);
        }
        return (int)field2106[0] != 0;
    }

    public static Class248 method9270(AutoMine class435) {
