...
extends Class278 {
    ...
    private static int method2984(int n2, int n3, Class27 class27, Spammer class406) {
    ...
    public void method2987(Class68 a2) {
        if (a2.method128() == Class543.field2691 && a2.method140() == this.field845) {
            if (ClickGui.field290.field_1687 == null) {
    ...
    public void method1274() {
        if (ClickGui.field290.field_1724 == null || ClickGui.field290.field_1687 == null) {
            this.method1273();
            return;
        }
    ...
    static {
        ...
        ClickGui.method3023(-2237513891722289416L);
    }
    ...
    public static ClickGui method2989() {
        return INSTANCE;
    }
    ...
    public int method2991() {
        return ClickGui.method3007().method10618((int)(100.0 * ClickGui.method3022(this.field839))).getRGB();
    }
    ...
    public float method2996() {
        return (float)ClickGui.method2995(ClickGui.method3025(this));
    }

    public int method2997(float a2) {
        return Colors.method10620().method10618((int)((double)(100.0f * a2) * this.field839.method24281())).getRGB();
    }
    ...
    public boolean method2998() {
        return (ClickGui.method2989().method2985() == 1.0f ? (int)field849[3] : (int)field849[2]) != 0;
    }

    public int method2999() {
        return ClickGui.method2993();
    }

    @Class1
    public void method3000(Class210 a2) {
        if (!(ClickGui.field290.field_1755 instanceof Class1450)) {
            this.method1268();
        }
    }
    ...
    public boolean method3003() {
        return (Boolean)ClickGui.method3024(this).method507();
    }
    ...
    private static void method3006() {
        if (ClickGui.field290.field_1755 instanceof Class1450) {
            ClickGui.field290.field_1724.method_3137();
        }
    }

    private static Colors method3007() {
    ...
    public void method1279() {
        int n2 = ClickGui.method3001(field290) != null ? 34374 : 34375;
        block4: while (true) {
            switch (n2) {
                case 34375: {
                    n2 = 34373;
                ...
                case 34374: {
                    if (ClickGui.field290.field_1687 != null) break block4;
                }
                default: {
                    return;
                }
        ...
        if (ClickGui.method3010() != null) {
            ClickGui.method3008().method14372();
        }
        field290.execute(ClickGui::method3006);
    ...
    public boolean method3019() {
        return (Boolean)ClickGui.method2986(this.field841);
    }
    ...
    public class_437 method3020() {
        ...
        if (field838 == null) {
            ClickGui.method3016(((Float)this.field845.method507()).floatValue());
            field838 = new Class1450(this);
            Class3979.field9083.method14361();
        }
        if (ClickGui.method3027() != ((Float)this.field845.method507()).floatValue()) {
            d\u200e = ((Float)this.field845.method507()).floatValue();
            field838 = new Class1450(this);
        }
        return field838;
    ...
    public int method3021(int a2) {
        return Colors.method10620().method10618((int)((double)a2 * this.field839.method24281())).getRGB();
    }
    ...
    private static void method3023(long l2) {
        ClickGui.field849[2] = l2 ^ 0xE0F2C0F867E41EF8L;
        ClickGui.field849[11] = l2 ^ 0xE0F2C0F8671BE107L;
        ClickGui.field849[10] = l2 ^ 0xE0F2C0F867E41E07L;
        ClickGui.field849[9] = l2 ^ 0xE0F2C0F867E41EE0L;
        ClickGui.field849[5] = l2 ^ 0xE0F2C0F867E41EFAL;
        ClickGui.field849[7] = l2 ^ 0xE0F2C0F867E41FA0L;
        ClickGui.field849[8] = l2 ^ 0xE0F2C0F867E41EE6L;
        ClickGui.field849[4] = l2 ^ 0xE0F2C0F867E41EFCL;
        ClickGui.field849[3] = l2 ^ 0xE0F2C0F867E41EF9L;
        ClickGui.field849[0] = l2 ^ 0xE0F2C0F867E41E9CL;
        ClickGui.field849[6] = l2 ^ 0xE0F2C0F867E41EC4L;
        ClickGui.field849[1] = l2 ^ 0xE0F2C0F867E41EFDL;
    }

    public static Class248 method3024(ClickGui class333) {
        return class333.field837;
    }

    public static Class6283 method3025(ClickGui class333) {
    ...
    public int method3028(int a2, float b2) {
        return Colors.method10620().method10618((int)((double)((float)a2 * b2) * this.field839.method24281())).getRGB();
    }
