...
public class AutoCrawlTrap
extends Class428 {
    private List field1975;
    private static AutoCrawlTrap INSTANCE;
    ...
    public static AutoCrawlTrap method8679() {
        return INSTANCE;
    }

    private void method8680(class_2338 a2, int b2) {
        AutoCrawlTrap.method8694().method12794(a2, b2, (Boolean)this.field1952.method507(), (boolean)field1991[0], (boolean)field1991[4], this::method8722);
        this.field1977.put(a2, System.currentTimeMillis());
        this.field1981 = AutoCrawlTrap.method8701(this) + (int)field1991[4];
    }

    public static List method8681(AutoCrawlTrap class430) {
    ...
    public static int method8683(AutoCrawlTrap class430) {
        return class430.field1981;
    }

    private static void method8684(long l2) {
        AutoCrawlTrap.field1991[2] = l2 ^ 0x502914DC9A8D6FD6L;
        AutoCrawlTrap.field1991[5] = l2 ^ 0x502914DC9A8D6F26L;
        AutoCrawlTrap.field1991[1] = l2 ^ 0x502914DC9A8D6C34L;
        AutoCrawlTrap.field1991[4] = l2 ^ 0x502914DC9A8D6FDDL;
        AutoCrawlTrap.field1991[0] = l2 ^ 0x502914DC9A8D6FDCL;
        AutoCrawlTrap.field1991[6] = l2 ^ 0xAFD6EB2365729023L;
        AutoCrawlTrap.field1991[3] = l2 ^ 0x502914DC9A8D6FDEL;
    }
    ...
    private static class_746 method8686(class_310 class_3102) {
        return AutoCrawlTrap.method8741(class_3102);
    }
    ...
    public void method8687(Class59 h2) {
                ...
                case 2687: {
                    ...
                    while (true) {
                        if (!iterator.hasNext()) {
                            ...
                            if (!AutoCrawlTrap.method8696(this).isEmpty()) break;
                            return;
                        }
                        Map.Entry e2 = iterator.next();
                        AutoCrawlTrap.method8737((Class6283)e2.getValue(), (boolean)field1991[0]);
                        int a2 = (int)(40.0 * AutoCrawlTrap.method8710((Class6283)e2.getValue()));
                        int b2 = (int)(100.0 * AutoCrawlTrap.method8745((Class6283)e2.getValue()));
                    ...
                    for (class_2338 g2 : this.field1975) {
                        Class6283 f2 = new Class6283((boolean)field1991[4], ((Integer)AutoCrawlTrap.method8739(this.field1988)).intValue());
        ...
        this.field1985.entrySet().removeIf(AutoCrawlTrap::method8744);
    }
    ...
    private boolean method8688(class_1657 a2, class_2338 b2) {
        int n2;
        if (!a2.method_24828() && AutoCrawlTrap.method8693(field290).method_8320(b2.method_10084()).method_45474() && AutoCrawlTrap.method8689(field290).method_8320(b2.method_10086((int)field1991[3])).method_45474()) {
            n2 = (int)field1991[0];
            return n2 != 0;
        }
        n2 = (int)field1991[4];
    ...
    private static Class1011 method8694() {
        return AutoCrawlTrap.method8712();
    }
    ...
    private static boolean method8695(class_238 a2, class_1297 b2) {
        int n2;
        if (AutoCrawlTrap.method8733().method24270(b2) && AutoCrawlTrap.method8709(Class5723.field11050, b2).method_994(a2)) {
            n2 = (int)field1991[4];
            return n2 != 0;
        }
        n2 = (int)field1991[0];
    ...
    public static List method8696(AutoCrawlTrap class430) {
    ...
    private static int method8701(AutoCrawlTrap class430) {
        return AutoCrawlTrap.method8683(class430);
    }
    ...
    private void method8704(class_2596 e2) {
        ...
        if (b2.method_45474() && AutoCrawlTrap.field290.field_1687.method_8628(field1956, c2, class_3726.method_16194())) {
    ...
    public void method1279() {
        ...
        AutoCrawlTrap.method8708(this).clear();
        this.field1982 = null;
    }
    ...
    public static Class248 method8707(AutoCrawlTrap class430) {
        return class430.field1978;
    }

    public static Map method8708(AutoCrawlTrap class430) {
    ...
    public List method8715(List g2) {
        ...
        block4: while (iterator.hasNext()) {
            ...
            Long a2 = (Long)AutoCrawlTrap.method8747(this).get(f2);
            if (((Float)AutoCrawlTrap.method8707(this).method507()).floatValue() > 0.0f && a2 != null && (float)(System.currentTimeMillis() - a2) < ((Float)this.field1978.method507()).floatValue() * 50.0f) continue;
            class_238 b2 = new class_238(f2);
            List<class_1297> c2 = AutoCrawlTrap.field290.field_1687.method_8335(null, b2).stream().filter(this::method8720).toList();
            boolean d2 = c2.stream().allMatch(arg_0 -> AutoCrawlTrap.method8695(b2, arg_0));
            if (!AutoCrawlTrap.field290.field_1687.method_8320(f2).method_45474()) {
                if (!d2) {
                ...
                block5: while (true) {
                    switch (n2) {
                        ...
                        case 63418: {
                            if (Class5723.field11054.method22542(f2, Class827.field3627) && ((Boolean)AutoCrawlTrap.method8728(this).method507()).booleanValue()) break block5;
                            continue block4;
                        }
                    }
                    break;
            ...
            if ((e2 = AutoCrawlTrap.field290.field_1724.method_5707(f2.method_46558())) > ((Class252)this.field1987).method564() || !AutoCrawlTrap.field290.field_1687.method_8628(field1956, f2, class_3726.method_16194())) continue;
            h2.add(f2);
        }
        return h2;
    }

    private static void method8716(AutoCrawlTrap class430, class_2596 class_25962) {
    ...
    public static List method8719(AutoCrawlTrap class430) {
        return class430.field1976;
    }

    private boolean method8720(class_1297 a2) {
        return AutoCrawlTrap.method8753(this, a2);
    }

    public static void method8721(AutoCrawlTrap class430, List list) {
    ...
    public static Class248 method8728(AutoCrawlTrap class430) {
    ...
    public static class_1657 method8736(AutoCrawlTrap class430) {
    ...
    public static class_1657 method8738(AutoCrawlTrap class430) {
        return class430.field1982;
    }
    ...
    public static Map method8740(AutoCrawlTrap class430) {
    ...
    public void method8742(Class210 b2) {
        ...
        if (c2 == (int)field1991[6]) {
            AutoCrawlTrap.method8681(this).clear();
            this.field1975.clear();
            return;
        }
        this.field1982 = this.method6615(((Float)this.field1984.method507()).floatValue());
        if (AutoCrawlTrap.method8736(this) == null) {
            this.field1976.clear();
            this.field1975.clear();
            return;
        }
        class_2338 d2 = Class5659.method22153(AutoCrawlTrap.method8738(this), (boolean)field1991[0]);
        this.field1976 = this.method8735(this.field1982, d2);
        if (!this.method8688(this.field1982, d2) || AutoCrawlTrap.method8719(this).isEmpty()) {
            return;
        }
        AutoCrawlTrap.method8721(this, this.method8715(this.field1976));
        if (this.field1975.isEmpty()) {
            return;
        }
        this.field1975.sort(Comparator.comparingInt(class_2382::method_10264));
        while (this.field1981 < (Integer)AutoCrawlTrap.method8699(this.field1989)) {
    ...
    static {
        ...
        AutoCrawlTrap.method8684(5776170934797692892L);
    }
    ...
    public void method8746(Class133 c2) {
        if (AutoCrawlTrap.method8686(field290) == null || AutoCrawlTrap.method8700(field290) == null) {
            return;
        }
        ...
        block4: while (true) {
            switch (n2) {
                ...
                default: {
                    AutoCrawlTrap.method8716(this, c2.method251());
                }
            }
            break;
        }
    ...
    private static Map method8747(AutoCrawlTrap class430) {
        return AutoCrawlTrap.method8740(class430);
    }
    ...
    private static boolean method8753(AutoCrawlTrap class430, class_1297 class_12972) {
