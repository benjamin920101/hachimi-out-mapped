...
extends Class278 {
    ...
    public static Class248 method5257(Class384 class384) {
        return class384.field1305;
    }

    public static Class248 method5258(Class384 class384) {
        return class384.field1300;
    }

    public static Class248 method5259(Class384 class384) {
        return class384.field1300;
    }
    ...
    private static Class248 method5263(Class384 class384) {
        return Class384.method5324(class384);
    }
    ...
    private static Class248 method5272(Class384 class384) {
        return Class384.method5279(class384);
    }
    ...
    public static Class248 method5275(Class384 class384) {
    ...
    public static Class248 method5279(Class384 class384) {
    ...
    private static Class248 method5283(Class384 class384) {
        return Class384.method5306(class384);
    }
    ...
    public static Class248 method5285(Class384 class384) {
        return class384.field1300;
    }

    private static void method5286(long l2) {
        Class384.field1307[1] = l2 ^ 0x32A6D7759D5270FAL;
        Class384.field1307[0] = l2 ^ 0x32A6D7759D5270FBL;
        Class384.field1307[2] = l2 ^ 0x32A6D7759D527004L;
    }

    private static Color method5287(Class384 class384, class_2338 class_23382) {
    ...
    private static int method5289(int n2, int n3, Class586 class586, Class308 class308) {
    ...
    private static Class248 method5292(Class384 class384) {
        return Class384.method5259(class384);
    }

    private static Color method5293(Class384 class384, class_2338 class_23382) {
        return class384.method5321(class_23382);
    }
    ...
    private static Color method5295(Class384 class384, class_2338 class_23382) {
        return class384.method5321(class_23382);
    }
    ...
    public static Class248 method5297(Class384 class384) {
    ...
    public void method5299(Class59 t) {
        block29: {
            block31: {
                block30: {
                    if (Class384.field290.field_1724 == null || Class384.field290.field_1687 == null || !Class384.field290.field_1724.method_24828()) {
                        return;
                    }
                    Class6009.method23560();
                    u = Class384.method5281(Class384.field290).method_24515();
                    v = Class384.field290.field_1724.method_19538();
                    w = v.method_10216() - (double)u.method_10263();
                    x = v.method_10215() - (double)u.method_10260();
                    var8_6 = class_2350.values();
                    var9_7 = var8_6.length;
                    block12: for (var10_8 = (int)Class384.field1307[0]; var10_8 < var9_7; ++var10_8) {
                        block28: {
                            g = var8_6[var10_8];
                            if (!g.method_10166().method_10179()) continue;
                            a = u.method_10093(g);
                            if (!Class384.field290.field_1687.method_8320(a).method_45474()) break block28;
                            v0 = 60558;
                            ** GOTO lbl22
                        }
                        v0 = 60559;
...
lbl22:
                    ...
                    if (!((Boolean)Class384.method5272(this).method507()).booleanValue()) break block29;
                    l = u.method_10263();
                    m = u.method_10264();
                    n = u.method_10260();
                    o = u.method_10093(Class384.method5294()).method_10093(class_2350.field_11043);
                    p = Class384.method5295(this, o);
                    if (p != null && w <= 0.35 && x <= Class1010.field4184) {
                        if (!((Boolean)this.field1302.method507()).booleanValue()) {
                            h = new class_238((double)o.method_10263(), (double)o.method_10264(), (double)o.method_10260(), (double)(o.method_10263() + (int)Class384.field1307[1]), (double)o.method_10264() + 0.01, (double)(o.method_10260() + (int)Class384.field1307[1]));
                            Class384.method5278(t.method125(), h, p.getRGB());
                            Class6454.method24605(t.method125(), h, ((Float)Class384.method5307(this).method507()).floatValue(), p.getRGB());
                            while (true) {
                                // Infinite loop
                            }
                        }
                        Class6454.method24627(t.method125(), l, m, n, l, m + 1.0, n, ((Float)Class384.method5310(this).method507()).floatValue(), p.getRGB());
                    }
...
lbl50:
                        ...
                        switch (v2) {
                            ...
                            case 61501: {
                                if (!((Boolean)this.field1302.method507()).booleanValue()) {
                                    i = new class_238((double)o.method_10263(), (double)o.method_10264(), (double)o.method_10260(), (double)(o.method_10263() + (int)Class384.field1307[1]), (double)o.method_10264() + 0.01, (double)(o.method_10260() + (int)Class384.field1307[1]));
                                ...
                                Class6454.method24627(t.method125(), l, m, n + 1.0, l, m + 1.0, n + 1.0, ((Float)Class384.method5258(this).method507()).floatValue(), q.getRGB());
                            }
                        }
                        break;
                    }
                }
                if ((r = Class384.method5287(this, o = u.method_10093(Class384.method5284()).method_10093(class_2350.field_11043))) != null) {
                    v3 = 3887;
...
lbl104:
                        ...
                        k = new class_238((double)o.method_10263(), (double)o.method_10264(), (double)o.method_10260(), (double)(o.method_10263() + (int)Class384.field1307[1]), (double)o.method_10264() + 0.01, (double)(o.method_10260() + (int)Class384.field1307[1]));
                        Class6454.method24621(t.method125(), k, s.getRGB());
                        Class6454.method24605(t.method125(), k, ((Float)Class384.method5285(this).method507()).floatValue(), s.getRGB());
                        break block18;
lbl112:
                        // 1 sources

                        Class6454.method24627(Class384.method5260(t), l + 1.0, m, n + 1.0, l + 1.0, m + 1.0, n + 1.0, ((Float)Class384.method5312(this.field1300)).floatValue(), s.getRGB());
                    }
                }
                break;
            }
    ...
    public static Class248 method5305(Class384 class384) {
        return class384.field1300;
    }

    public static Class248 method5306(Class384 class384) {
        return class384.field1300;
    }

    public static Class248 method5307(Class384 class384) {
        return class384.field1300;
    }

    static {
        Class384.method5265(3649841448180936955L);
    }
    ...
    public static Class248 method5310(Class384 class384) {
        return class384.field1300;
    }
    ...
    private Color method5321(class_2338 a2) {
        class_2680 b2 = Class384.method5266(field290).method_8320(a2);
        if (b2.method_26215()) {
            return null;
        }
        class_2680 c2 = Class384.field290.field_1687.method_8320(a2.method_10074());
        Color d2 = null;
        ...
        block4: while (true) {
            switch (n2) {
                ...
                case 51607: {
                    return (Color)Class384.method5275(this).method507();
                }
            }
            break;
        }
        if ((Boolean)Class384.method5303(Class384.method5263(this)) == false) return d2;
        if (!Class5595.method21937(c2.method_26204())) return (Color)this.field1301.method507();
        return (Color)Class384.method5257(this).method507();
    }
    ...
    public static Class248 method5324(Class384 class384) {
