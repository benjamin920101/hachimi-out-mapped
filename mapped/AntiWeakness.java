...
extends Class278 {
    ...
    Class926 field555;
    boolean field556;
    public static AntiWeakness INSTANCE;
    Class248 field557;
    ...
    public boolean method1857() {
        class_1792 a2 = AntiWeakness.method1878(Class5723.field11058).method_7909();
        if (a2 instanceof class_1829) return (int)field554[1] != 0;
        if (a2 instanceof class_1810) {
            return (int)field554[1] != 0;
        }
        class_1293 b2 = AntiWeakness.method1863(field290).method_6112(class_1294.field_5911);
        class_1293 c2 = AntiWeakness.field290.field_1724.method_6112(class_1294.field_5910);
        ...
        Class3812 d2 = new Class3812(AntiWeakness::method1869, (Class607)((Object)this.field558.method507())).method18502();
    ...
    public static Class248 method1859(AntiWeakness class297) {
        return class297.field558;
    }

    static {
        AntiWeakness.method1870(-5748649816544614985L);
    }
    ...
    private static void method1870(long l2) {
        AntiWeakness.field554[1] = l2 ^ 0xB038B17312BE65B6L;
        AntiWeakness.field554[0] = l2 ^ 0xB038B17312BE65B7L;
    }
    ...
    public static void method1875(AntiWeakness class297, boolean bl2) {
    ...
    public void method1877(Class131 g2) {
        block8: {
            ...
            block7: {
                block6: {
                    if (AntiWeakness.field290.field_1724 == null) return;
                    if (AntiWeakness.field290.field_1687 == null) return;
                    if (this.field556) {
                        return;
                    }
        ...
        class_1293 c2 = AntiWeakness.field290.field_1724.method_6112(class_1294.field_5911);
        class_1293 d2 = AntiWeakness.field290.field_1724.method_6112(class_1294.field_5910);
        if (c2 == null) return;
        if (d2 != null && c2.method_5578() < d2.method_5578()) {
            return;
        }
        Class3812 e2 = new Class3812(AntiWeakness::method1862, (Class607)((Object)AntiWeakness.method1861(AntiWeakness.method1859(this)))).method18502();
        if (!e2.method18523()) return;
        int a2 = Class5723.field11058.method18969();
        this.field556 = (int)field554[1];
        AntiWeakness.method1872(e2, a2);
        AntiWeakness.method1871(Class5723.field11048, g2.method251());
        e2.method18534(a2);
        AntiWeakness.method1875(this, (boolean)field554[0]);
