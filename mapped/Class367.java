...
extends Class278 {
    ...
    private static Class367 INSTANCE;
    ...
    private static class_638 method4787(class_310 class_3102) {
        return Class367.method4794(class_3102);
    }
    ...
    public void method4789(Class136 a2) {
        if (!((Boolean)Class367.method4793(this).method507()).booleanValue()) {
            Class367.method4792();
            return;
        }
        if (Class367.field290.field_1724.method_6047().method_7909() instanceof class_1747) {
            return;
        }
        a2.method10();
    }
    ...
    public static Class248 method4793(Class367 class367) {
    ...
    public void method4795(Class131 d2) {
        if (Class367.method4797(field290) == null || Class367.field290.field_1687 == null) {
            return;
        }
        ...
        class_2680 b2 = Class367.method4787(field290).method_8320(a2);
    ...
    private static void method4796(long l2) {
        Class367.field1197[1] = l2 ^ 0x34BB78EF2B520016L;
        Class367.field1197[0] = l2 ^ 0x34BB78EF2B520017L;
    }
    ...
    public static Class248 method4798(Class367 class367) {
        return class367.field1195;
    }

    @Class1
    public void method4799(Class222 a2) {
        class_2338 b2 = Class367.method4786(a2).method_17777();
        class_2680 c2 = Class367.field290.field_1687.method_8320(b2);
        if (((Class257)Class367.method4798(this)).method600(c2.method_26204())) {
            a2.method10();
        }
    }
    ...
    static {
        ...
        Class367.method4796(3799763679236456470L);
    }

    public static Class367 method4800() {
        return INSTANCE;
    }
