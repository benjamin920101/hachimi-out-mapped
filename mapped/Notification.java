...
extends Class278 {
    ...
    public void method5103(String b2, int c2) {
        if (this.method1265() && Notification.method5110(this).method507() != Class616.field2999) {
            if (c2 != 0) {
                for (Class5876 a2 : this.field1285) {
                    if (Notification.method5117(a2) != c2) continue;
                    a2.field11612 = (int)field1289[2];
                }
            }
            Notification.method5104(this).add(new Class5876(b2, c2));
        }
    }

    public static List method5104(Notification class382) {
    ...
    private static void method5106(long l2) {
        Notification.field1289[1] = l2 ^ 0xFC34A74BBF3FDB4AL;
        Notification.field1289[0] = l2 ^ 0xFC34A74BBF3FDBB7L;
        Notification.field1289[2] = l2 ^ 0xFC34A74BBF3FDB49L;
        Notification.field1289[3] = l2 ^ 0xFC34A74BBF3FDB48L;
    }

    private static int method5107(int n2, int n3, AntiLevitation class308, Class5540 class5540) {
    ...
    public static Class248 method5110(Notification class382) {
    ...
    public static double method5112(Notification class382) {
    ...
    public static List method5116(Notification class382) {
        return class382.field1285;
    }
    ...
    protected void method1279() {
        Notification.method5116(this).clear();
    }

    static {
        field1289 = new long[4];
        Notification.method5106(-273409733589738680L);
    }
    ...
    public void method5122(Class233 c) {
        d = (int)((float)Notification.field290.method_22683().method_4486() / 2.0f);
        e = Class6454.method24637() + (int)Notification.field1289[1];
        f = ~(e - 1) + (int)Notification.field1289[1];
...
lbl15:
                ...
                Notification.method5111(b, (boolean)Notification.field1289[2]);
                b.field11613.method12593();
            }
            if (b.field11615) {
                Notification.method5102(b, 1.0 - this.field1288.method10803(Math.min((double)b.field11613.method12592() / this.field1286, 1.0)));
            } else {
                b.field11611 = this.field1288.method10803(Math.min((double)b.field11613.method12592() / Notification.method5112(this), 1.0));
            }
            ...
            Notification.method5113(c.method6(), b.field11616, (float)d - (float)a / 2.0f, 0.0f, new Color((int)Notification.field1289[0], (int)Notification.field1289[0], (int)Notification.field1289[0], (int)(Class5965.field11862 * b.field11611)).getRGB());
