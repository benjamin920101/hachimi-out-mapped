...
extends Class278 {
    ...
    private void method4661(Class131 b2) {
        ...
        if (((Boolean)TridentTweaks.method4674(this.field1175)).booleanValue() && (class_25962 = b2.method251()) instanceof class_2846) {
            class_2846 a2 = (class_2846)class_25962;
            if (a2.method_12363() != class_2846.class_2847.field_12974) {
                Class5836.method22897();
                return;
            }
            TridentTweaks.field290.field_1761.method_2906(TridentTweaks.method4662((class_310)TridentTweaks.field290).field_7512.field_7763, (int)field1172[0], TridentTweaks.field290.field_1724.method_31548().field_7545, class_1713.field_7791, (class_1657)TridentTweaks.field290.field_1724);
        }
    }

    private static class_746 method4662(class_310 class_3102) {
        return TridentTweaks.method4664(class_3102);
    }

    @Class1
    public void method4663(Class144 a2) {
        if (((Boolean)TridentTweaks.method4675(this).method507()).booleanValue()) {
            a2.method10();
        }
    }
    ...
    private static class_2846.class_2847 method4665() {
        return TridentTweaks.method4668();
    }

    private static void method4666(long l2) {
        TridentTweaks.field1172[2] = l2 ^ 0xBDEDA4368CBF1385L;
        TridentTweaks.field1172[0] = l2 ^ 0xBDEDA4368CBF1386L;
        TridentTweaks.field1172[3] = l2 ^ 0xBDEDA4368CBF1391L;
        TridentTweaks.field1172[1] = l2 ^ 0xBDEDA4368CBF1384L;
    }

    public static Class248 method4667(TridentTweaks class363) {
    ...
    static {
        TridentTweaks.method4666(-4760968676864224379L);
    }
    ...
    public void method4670(Class63 a2) {
        ...
        if (TridentTweaks.field290.field_1724.method_6047().method_7909() == class_1802.field_8547 && TridentTweaks.field290.field_1724.method_6048() >= (Integer)this.field1176.method507()) {
            Class5723.field11048.method21341((class_2596)new class_2846(TridentTweaks.method4665(), class_2338.field_10980, TridentTweaks.method4677()));
            TridentTweaks.field290.field_1724.method_6075();
        }
    }
    ...
    private void method4672(Class132 b2) {
        if (((Boolean)this.field1175.method507()).booleanValue()) {
            ...
            if (class_25962 instanceof class_2846) {
                class_2846 a2 = (class_2846)class_25962;
                if (a2.method_12363() == class_2846.class_2847.field_12974) {
                    TridentTweaks.field290.field_1761.method_2906(TridentTweaks.field290.field_1724.field_7512.field_7763, (int)field1172[0], TridentTweaks.field290.field_1724.method_31548().field_7545, class_1713.field_7791, (class_1657)TridentTweaks.field290.field_1724);
                }
            }
        }
    }
    ...
    public static Class248 method4675(TridentTweaks class363) {
        return class363.field1177;
    }

    private static int method4676(int n2, int n3, Class3815 class3815, Disabler class390) {
        return Class3419.method17243(n2, n3, class3815, class390);
    }

    private Boolean method1269() {
        return (Boolean)TridentTweaks.method4669(TridentTweaks.method4667(this));
    }
