...
extends Class278 {
    Class248 field745;
    Class248 field746 = this.method450(new Class260("Selection", "How to use the blocks setting", Class547.field2710, AntiCrawl.method2665()));
    Class248 field747;
    Class248 field748;
    Class248 field749;
    private static long[] field750 = new long[6];

    private static int method2661(int n2, int n3, ExtraTab class316, Class1394 class1394) {
    ...
    private static int method2664(int n2, int n3, Swing class309, Class428 class428) {
    ...
    public boolean method2672(class_2338 a2) {
        int n2;
        if (!AntiCrawl.method2671((class_1297)AntiCrawl.field290.field_1724, new class_238(a2))) {
            return (int)field750[4] != 0;
        }
        class_2248 b2 = AntiCrawl.field290.field_1687.method_8320(a2).method_26204();
    ...
    private static int method2678(int n2, int n3, Zoom class409, Nuker class420) {
    ...
    public void method2682(Class210 e) {
        block5: {
            block6: {
                f = SpeedMine.method8407();
                var3_3 = Class5659.method22137().iterator();
                if (!var3_3.hasNext()) break block5;
                d = (class_2338)var3_3.next();
                if (Class5595.method21942(d) && AntiCrawl.method2694((class_1297)AntiCrawl.field290.field_1724, new class_238(d))) {
                    return;
                }
                if (this.field748.method507() != AntiCrawl.method2689() && !AntiCrawl.field290.field_1724.method_20448() && AntiCrawl.method2703(this.field748) != Class585.field2854) break block6;
                block0: for (class_2338 a : Class5659.method22165()) {
                    block7: {
                        if (!this.method2672(a) || !AntiCrawl.field290.field_1687.method_22347(a.method_10074())) continue;
...
lbl18:
            ...
            if (AntiCrawl.method2695(AntiCrawl.method2701(this)) != Class585.field2857 && !AntiCrawl.field290.field_1724.method_20448()) {
                Class1668.method15147(-415398920, 985373715, 2097311684, 1788581164);
                return;
            }
            for (class_2338 b : Class5659.method22165()) {
                if (!this.method2672(b) || !f.method8537(b, (Integer)AntiCrawl.method2685(this.field749))) continue;
                return;
            }
    ...
    private static int method2684(int n2, int n3, AutoLog class311, Class691 class691) {
    ...
    static {
        AntiCrawl.method2704(-3434029600840107264L);
    }

    public AntiCrawl() {
        super("AntiCrawl", "Auto mine target blocks", Class556.field2758);
        class_2248[] class_2248Array = new class_2248[(int)field750[2]];
        class_2248Array[(int)AntiCrawl.field750[4]] = class_2246.field_10540;
        class_2248Array[(int)AntiCrawl.field750[0]] = class_2246.field_10443;
        class_2248Array[(int)AntiCrawl.field750[1]] = class_2246.field_22423;
        class_2248Array[(int)AntiCrawl.field750[3]] = class_2246.field_22108;
        ...
        class_2248Array2[(int)AntiCrawl.field750[4]] = class_2246.field_10036;
        this.field745 = this.method450(new Class257("Blacklist", "Valid block blacklist", class_2248Array2));
        this.field748 = this.method450(new Class260("While", "Mining in some case", Class585.field2853, AntiCrawl.method2706()));
    ...
    public static Class248 method2696(AntiCrawl class319) {
    ...
    public static Class248 method2701(AntiCrawl class319) {
        return class319.field748;
    }
    ...
    private static void method2704(long l2) {
        AntiCrawl.field750[0] = l2 ^ 0xD057E045B5BFBB01L;
        AntiCrawl.field750[5] = l2 ^ 0xD057E045B5BFBB0AL;
        AntiCrawl.field750[2] = l2 ^ 0xD057E045B5BFBB04L;
        AntiCrawl.field750[3] = l2 ^ 0xD057E045B5BFBB03L;
        AntiCrawl.field750[1] = l2 ^ 0xD057E045B5BFBB02L;
        AntiCrawl.field750[4] = l2 ^ 0xD057E045B5BFBB00L;
    }
    ...
    private static Class248 method2708(AntiCrawl class319) {
        return AntiCrawl.method2696(class319);
    }
