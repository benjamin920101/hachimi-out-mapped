...
extends Class278 {
    ...
    public static CallSite jht3jet8QbbqsGeL(MethodHandles.Lookup lookup, String string, MethodType methodType, String string2, String string3, String string4, Integer n2) {
        ...
        int n3 = n2;
        MethodType methodType2 = MethodType.fromMethodDescriptorString(TrueSight.yIDP1Bdw6Bmv5OQP(string7), TrueSight.class.getClassLoader());
        try {
            if (n3 == 1) {
                return new ConstantCallSite(lookup.findVirtual(Class.forName(TrueSight.yIDP1Bdw6Bmv5OQP(string5)), TrueSight.yIDP1Bdw6Bmv5OQP(string6), methodType2).asType(methodType));
            }
            return new ConstantCallSite(lookup.findStatic(Class.forName(TrueSight.yIDP1Bdw6Bmv5OQP(string5)), TrueSight.yIDP1Bdw6Bmv5OQP(string6), methodType2).asType(methodType));
        }
    ...
    private static void method3732(long l2) {
        TrueSight.field962[0] = l2 ^ 0xAE61EF5F40025F5AL;
    }
    ...
    static {
        TrueSight.method3732(-5881156445994328229L);
    }
    ...
    public void method3735(Class152 a2) {
        ...
        block4: while (true) {
            switch (n2) {
                ...
                case 32551: {
                    if (((Boolean)TrueSight.method3736(this).method507()).booleanValue() && !(a2.method297() instanceof class_1657)) return;
                    a2.method10();
                    return;
                }
            }
    ...
    public static Class248 method3736(TrueSight class341) {
