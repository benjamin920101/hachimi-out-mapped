...
public class Class5633 {
    ...
    public static int method22056(int n2, int n3, Class1750 class1750, Class3505 class3505) {
        int n4 = n3;
        return n4 + ((n2 ^ 0x60FE0128) & ~n4);
    }

    public static int method22057(int n2, int n3, Class5444 class5444, Class543 class543) {
        int n4 = n2 ^ 0x410345B8;
        return (n3 | ~n4) - ~n4;
    }

    public static int method22058(int n2, int n3, Class199 class199, Class529 class529) {
        return 244012809 + (n2 & 0xF174A8F6);
    }

    public static int method22059(int n2, int n3, Class253 class253, Class608 class608) {
        int n4 = n2;
