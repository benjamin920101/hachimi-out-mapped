...
extends Class278 {
    ...
    public void method4807(Class59 J2) {
        block26: {
                ...
                block25: {
                    ...
                    block23: {
                        ...
                        block4: while (true) {
                            ...
                            double D2 = StorageESP.field290.field_1724.method_5707(I2.method_11016().method_46558());
                            int n2 = D2 > StorageESP.method4832((Class252)StorageESP.method4824(this)) ? 16527 : 16528;
                            block5: while (true) {
                                switch (n2) {
                                    case 16528: {
                                        n2 = 16526;
                        ...
                        G2 = (100.0 - StorageESP.field290.field_1724.method_5707(F2)) / 100.0;
                    ...
                    if (k2 == class_2745.field_12571) {
                        ...
                        if (((Boolean)this.field1206.method507()).booleanValue()) {
                            Class6454.method24621(StorageESP.method4828(J2), c2, a2);
                        }
                        Class6454.method24605(J2.method125(), c2, ((Float)StorageESP.method4845(this).method507()).floatValue(), b2);
                        break block26;
                    } else {
                        ...
                        if (k2 == class_2745.field_12569) {
                            ...
                            if (((Boolean)StorageESP.method4839(this.field1206)).booleanValue()) {
            ...
            Class6454.method24642(J2.method125(), H2, ((Float)StorageESP.method4826(StorageESP.method4836(this))).floatValue(), C2);
        }
        while (true) {
            // Infinite loop
        }
    ...
    private static void method4808(long l2) {
        StorageESP.field1199[5] = l2 ^ 0xC73E6F4F1B7BB041L;
        StorageESP.field1199[0] = l2 ^ 0xC73E6F4F1B7BB024L;
        StorageESP.field1199[2] = l2 ^ 0xC73E6F4F1B7BB040L;
        StorageESP.field1199[4] = l2 ^ 0xC73E6F4F1B7BB0BFL;
        StorageESP.field1199[3] = l2 ^ 0xC73E6F4F1B7BB0ECL;
        StorageESP.field1199[1] = l2 ^ 0xC73E6F4F1B7BB025L;
        StorageESP.field1199[6] = l2 ^ 0xC73E6F4F1B7BB04EL;
    }
    ...
    public static StorageESP method4810() {
        return INSTANCE;
    }
    ...
    public Color method4813(class_2586 a2) {
        ...
        if (a2 instanceof class_2611) {
            return (Color)StorageESP.method4846(this).method507();
        }
    ...
    public static Class248 method4824(StorageESP class369) {
    ...
    public static Class248 method4827(StorageESP class369) {
    ...
    public static Class248 method4836(StorageESP class369) {
    ...
    private Boolean method1278() {
        return (Boolean)StorageESP.method4851(this).method507();
    }
    ...
    private Boolean method4844() {
        return (Boolean)StorageESP.method4847(this).method507();
    }

    public static Class248 method4845(StorageESP class369) {
        return class369.field1201;
    }

    public static Class248 method4846(StorageESP class369) {
        return class369.field1207;
    }

    private Boolean method1269() {
        return (Boolean)StorageESP.method4843(this.field1202);
    }

    private static Class248 method4847(StorageESP class369) {
        return StorageESP.method4827(class369);
    }

    static {
        StorageESP.method4808(-4089709026051641308L);
    }
    ...
    public static Class248 method4851(StorageESP class369) {
