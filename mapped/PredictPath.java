...
extends Class278 {
    ...
    static {
        ...
        PredictPath.method5009(6630429727677193158L);
    ...
    public void method5005(Class63 f2) {
        if (f2.method128() == Class543.field2691) {
            Iterator iterator = PredictPath.field290.field_1687.method_18456().iterator();
            if (iterator.hasNext()) {
                class_1657 e2 = (class_1657)iterator.next();
                List a2 = PredictPath.method5017().getOrDefault(e2, new ArrayList());
                a2.clear();
                field1261.put(e2, a2);
                ...
                PredictPath.method5007().put(e2, d2);
                while (true) {
                    // Infinite loop
                }
            }
    ...
    private static void method5011(long l2) {
        PredictPath.field1260[1] = l2 ^ 0x5C0404B532639BC6L;
        PredictPath.field1260[0] = l2 ^ 0x5C0404B532639BC2L;
        PredictPath.field1260[2] = l2 ^ 0x5C0404B532639BCCL;
        PredictPath.field1260[3] = l2 ^ 0x5C0404B532639BA2L;
    }

    @Class1
    public void method5012(Class59 i2) {
        PredictPath.method5006();
        for (class_1657 h2 : PredictPath.field290.field_1687.method_18456()) {
            class_243 b2 = (class_243)PredictPath.method5015().get(h2);
            ...
            Class6454.method24621(i2.method125(), new class_238(f2.method_10216() - 0.1, f2.method_10214() + Class6190.field12575, f2.method_10215() - 0.1, f2.method_10216() + 0.1, f2.method_10214(), f2.method_10215() + 0.1), Colors.method10620().method10615((int)field1260[3]));
            class_243 g2 = e2;
