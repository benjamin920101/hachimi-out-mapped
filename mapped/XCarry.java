...
extends Class278 {
    ...
    private static void method5385(long l2) {
        XCarry.field1322[0] = l2 ^ 0x25B89E062FA32D53L;
    }

    static {
        XCarry.method5385(2718096124524309843L);
    }
    ...
    private static class_746 method5387(class_310 class_3102) {
        return XCarry.method5386(class_3102);
    }
    ...
    public void method5388(Class131 b2) {
        class_2815 a2;
        if (XCarry.field290.field_1724 == null) {
            return;
        }
        class_2596 class_25962 = b2.method251();
        if (class_25962 instanceof class_2815 && ((a2 = (class_2815)class_25962).method_36168() == XCarry.method5387((class_310)XCarry.field290).field_7498.field_7763 || ((Boolean)this.field1321.method507()).booleanValue())) {
            b2.method10();
        }
    }
    ...
    public static CallSite XKr1Ckdwi9vPkMnI(MethodHandles.Lookup lookup, String string, MethodType methodType, String string2, String string3, String string4, Integer n2) {
        ...
        int n3 = n2;
        MethodType methodType2 = MethodType.fromMethodDescriptorString(XCarry.xO9oVK972BqOV0h8(string7), XCarry.class.getClassLoader());
        try {
            if (n3 == 1) {
                return new ConstantCallSite(lookup.findVirtual(Class.forName(XCarry.xO9oVK972BqOV0h8(string5)), XCarry.xO9oVK972BqOV0h8(string6), methodType2).asType(methodType));
            }
            return new ConstantCallSite(lookup.findStatic(Class.forName(XCarry.xO9oVK972BqOV0h8(string5)), XCarry.xO9oVK972BqOV0h8(string6), methodType2).asType(methodType));
        }
