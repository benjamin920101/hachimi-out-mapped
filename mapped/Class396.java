...
extends Class278 {
    double field1373;
    double field1374;
    private static Class396 INSTANCE;
    Class248 field1375;
    Class248 field1376;
    double field1377;
    double field1378;
    ...
    public void method1274() {
        if (Class396.field290.field_1724 == null) {
            return;
        }
        this.field1373 = Class396.field290.field_1724.method_23317();
        this.field1381 = Class396.field290.field_1724.method_23320();
        this.field1379 = Class396.field290.field_1724.method_23321();
        Class396.method5746(this, this.field1373);
        this.field1377 = this.field1381;
        Class396.method5748(this, this.field1379);
    }
    ...
    public void method5736(Class72 a2) {
        a2.method10();
        Class396.method5744(a2, ((Float)Class396.method5732(this.field1382)).floatValue());
    }
    ...
    public static double method5740(Class396 class396) {
        return class396.field1379;
    }

    public double method5741() {
        return Class6023.method23738(Class396.method5752(this), Class396.method5762(this), field290.method_60646().method_60637((boolean)field1383[1]));
    }

    public static Class248 method5742(Class396 class396) {
    ...
    public static void method5746(Class396 class396, double d2) {
    ...
    public static void method5748(Class396 class396, double d2) {
        class396.field1378 = d2;
    }

    @Class1
    public void method5749(Class210 a2) {
        if (!((Boolean)Class396.method5751(Class396.method5742(this))).booleanValue()) {
            return;
        }
        this.field1374 = this.field1373;
        this.field1377 = this.field1381;
        Class396.method5754(this, Class396.method5740(this));
        double b2 = (Class396.method5759(field290).method_31044().method_31034() ? (Float)this.field1380.method507() : (Float)this.field1375.method507()).floatValue();
        this.field1373 = Class396.method5737(this.field1373, Class396.field290.field_1724.method_23317(), b2);
        this.field1381 = Class396.method5737(this.field1381, Class396.field290.field_1724.method_23320(), b2);
        this.field1379 = Class396.method5737(this.field1379, Class396.field290.field_1724.method_23321(), b2);
    }

    public static Class396 method5750() {
        return INSTANCE;
    }
    ...
    public static double method5752(Class396 class396) {
        return class396.field1374;
    }

    public double method5753() {
        return Class396.method5745(this.field1377, this.field1381, field290.method_60646().method_60637((boolean)field1383[1]));
    }

    static {
        field1383 = new long[2];
        Class396.method5755(6245001628648447190L);
    }

    public static void method5754(Class396 class396, double d2) {
        class396.field1378 = d2;
    }

    private static void method5755(long l2) {
        Class396.field1383[1] = l2 ^ 0x56AAB3E4D1539CD7L;
        Class396.field1383[0] = l2 ^ 0x56AAB3E4D1539CD6L;
    }
    ...
    public void method5758(Class44 a2) {
        ...
        double b2 = (Class396.method5739(field290).method_31044().method_31034() ? (Float)Class396.method5743(this.field1380) : (Float)this.field1375.method507()).floatValue();
        if (b2 == 1.0) {
            return;
        }
        Class396.method5756(a2, new class_243(this.method5741(), this.method5753(), this.method5734()));
    }
    ...
    public static double method5762(Class396 class396) {
