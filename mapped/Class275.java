...
extends Class268 {
    ...
    private static int method1150(int n2, int n3, StorageESP class369, Class572 class572) {
    ...
    private static boolean method1152(ClickGui class333) {
    ...
    private static ClickGui method1154() {
        return ClickGui.method2989();
    }

    private static ClickGui method1155() {
        return ClickGui.method2989();
    }
    ...
    public void method825(class_332 a2, float b2, float c2, float d2, float e2, float f2) {
        ...
        this.method771(a2, this.field354.method512() + " [Edit]", b2 + 2.0f, c2 + ClickGui.method2989().method3018() * Class275.method1157(), i2);
    }
