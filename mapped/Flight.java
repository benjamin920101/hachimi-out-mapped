...
extends Class278 {
    ...
    public void method1323(Class210 f2) {
        block24: {
            int n2;
            if (!((Boolean)Flight.method1381(this.field415)).booleanValue()) {
                ...
                block4: while (true) {
                    switch (n3) {
                        ...
                        case 10824: {
                            if (!Flight.method1359((class_310)Flight.field290).field_5976) break block4;
                        }
                        default: {
                            this.field423 = 0.0;
                        }
                ...
                this.field423 = Flight.method1350(this) + (double)((Float)this.field419.method507()).floatValue();
                if (Flight.method1349(this) > (double)((Float)this.field427.method507()).floatValue()) {
                    this.field423 = ((Float)Flight.method1332(this).method507()).floatValue();
                    Class1807.method15744();
                    return;
                }
            }
            if (Flight.method1333(Flight.method1346())) {
            ...
            if (!((Class633)((Object)this.field418.method507())).equals((Object)Class633.field3093)) {
                ...
                this.method1340();
                Flight.field290.field_1724.method_31549().method_7248((float)(this.field423 * (double)0.05f));
            }
            ...
            if (this.field425) {
                ...
                if (this.field420 >= (int)field424[1]) {
                    ...
                    } else if (Flight.method1343(this.field421) == Class519.field2568) {
                        Flight.field290.field_1724.method_5814(Flight.field290.field_1724.method_23317(), Flight.field290.field_1724.method_23318() - 0.0313, Flight.field290.field_1724.method_23321());
                        if (Flight.method1372(this.field418) == Class633.field3093) {
                            this.method1368();
                            Flight.method1367(Class5723.field11052, 0.0);
                            g2 = (int)field424[2];
                        }
                    }
            ...
            if (!Flight.field290.field_1690.field_1903.method_1434()) {
                int n4 = 6961;
        ...
        if (Flight.field290.field_1690.field_1832.method_1434()) {
            Class5723.field11052.method14002(-((Float)this.field422.method507()).floatValue());
        }
        this.field423 = Math.max(this.field423, (double)0.2873f);
        float a2 = Flight.method1371(Flight.field290.field_1724.field_3913);
        float b2 = Flight.field290.field_1724.field_3913.field_3907;
        float c2 = Flight.field290.field_1724.method_36454();
        if (a2 == 0.0f && b2 == 0.0f) {
        ...
        Flight.method1374(Class5723.field11052, (double)a2 * this.field423 * d2 + (double)b2 * this.field423 * e2, (double)a2 * Flight.method1339(this) * e2 - (double)b2 * this.field423 * d2);
    }

    private static void method1324(long l2) {
        Flight.method1370(l2);
    }

    private static int method1325(int n2, int n3, NoSoundLag class303, Class941 class941) {
        return Class668.method11534(n2, n3, class303, class941);
    }

    @Class1
    public void method1326(Class131 d2) {
        if (Flight.field290.field_1724 == null) {
            return;
        }
        ...
        if (class_25962 instanceof class_2828) {
            ...
            if (this.field421.method507() != Class519.field2564) {
                ...
                if (!Double.isNaN(b2)) {
                    ...
                    Flight.method1335(this, b2);
                    return;
                }
                if (this.field416) {
                    class_2828.class_2830 a2 = c2.method_36172() ? new class_2828.class_2830(Flight.field290.field_1724.method_23317(), Flight.field290.field_1724.method_23318() - 0.04, Flight.field290.field_1724.method_23321(), Flight.field290.field_1724.method_36454(), Flight.field290.field_1724.method_36455(), c2.method_12273()) : new class_2828.class_2829(Flight.method1357(field290).method_23317(), Flight.field290.field_1724.method_23318() - 0.04, Flight.method1380(field290).method_23321(), c2.method_12273());
                    d2.method10();
                    Flight.method1348(Class5723.field11048, (class_2596)a2);
                    Flight.method1329(this, (boolean)field424[0]);
                }
            }
        }
    }
    ...
    static {
        Flight.method1324(-6916547495688292192L);
    }
    ...
    public static void method1329(Flight class280, boolean bl2) {
    ...
    public static Class248 method1332(Flight class280) {
        return class280.field427;
    }

    private static boolean method1333(Disabler class390) {
    ...
    public static void method1335(Flight class280, double d2) {
    ...
    private boolean method1338(class_2828 a2) {
        int n2;
        double b2 = class_3532.method_15350((double)a2.method_12268(Flight.field290.field_1724.method_23318()), (double)-2.0E7, (double)2.0E7);
        double c2 = b2 - this.field426;
        if (c2 >= -0.03125 && !Flight.field290.field_1724.field_36331) {
            int n3 = this.method1315((class_1297)Flight.method1336(field290)) ? 37120 : 37121;
            block4: while (true) {
                switch (n3) {
                    case 37121: {
                        n3 = 37119;
    ...
    public static double method1339(Flight class280) {
        return class280.field423;
    }

    private void method1340() {
        Flight.field290.field_1724.method_31549().field_7478 = (int)field424[2];
        Flight.method1362(Flight.field290.field_1724.method_31549(), (boolean)field424[2]);
    }
    ...
    private static Disabler method1346() {
        return Disabler.method5496();
    }
    ...
    public static double method1349(Flight class280) {
        return class280.field423;
    }

    public static double method1350(Flight class280) {
        return class280.field423;
    }
    ...
    public static Flight method1352() {
        return INSTANCE;
    }
    ...
    public static Flight method1355() {
        return Flight.method1352();
    }
    ...
    private static void method1362(class_1656 class_16562, boolean bl2) {
        Flight.method1337(class_16562, bl2);
    }
    ...
    private void method1368() {
        int n2 = !Flight.field290.field_1724.method_7337() ? 20093 : 20094;
        block4: while (true) {
            switch (n2) {
                case 20094: {
                    n2 = 20092;
                ...
                case 20093: {
                    Flight.field290.field_1724.method_31549().field_7478 = (int)field424[0];
                    break block4;
                }
            }
            break;
        }
        Flight.method1353(Flight.field290.field_1724.method_31549(), (boolean)field424[0]);
        Flight.field290.field_1724.method_31549().method_7248(Class3540.field7837);
    }
    ...
    private static void method1370(long l2) {
        Flight.field424[0] = l2 ^ 0xA0037CB2B761B8A0L;
        Flight.field424[2] = l2 ^ 0xA0037CB2B761B8A1L;
        Flight.field424[1] = l2 ^ 0xA0037CB2B761B8B4L;
    }
    ...
    public void method1274() {
        if (Flight.method1364(this.field418) == Class633.field3093) {
            this.method1340();
        }
        this.field423 = 0.0;
    }
    ...
    public static Class248 method1378(Flight class280) {
    ...
    private static class_746 method1380(class_310 class_3102) {
        return Flight.method1322(class_3102);
    }
    ...
    public String method1248() {
        return Class5587.method21919((Enum)Flight.method1317(Flight.method1378(this)));
    }
