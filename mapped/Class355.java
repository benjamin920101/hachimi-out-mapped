...
extends Class278 {
    ...
    private static void method4318(Class355 class355, int n2) {
        Class355.method4321(class355, n2);
    }
        ...
        block8: {
            block10: {
                block9: {
                    ...
                    if (Class355.field290.field_1724.method_3144() || Class355.field290.field_1724.method_6128() || Class355.method4334(field290).method_21754() || Class355.method4361(field290).method_5771() || Class355.field290.field_1724.method_5799() || Class355.field290.field_1724.field_3913.field_3904 || Class355.method4336((class_310)Class355.field290).field_3913.field_3903) break block9;
                    if (Class5723.field11056.method14268(field1071[4])) break block10;
                }
                return;
            }
            if (!Class355.method4339().method14268(field1071[4])) {
                Class5836.method22885();
                return;
            }
            if (this.field1075.method12595((int)field1071[4])) {
                if (!Class352.method4109().method1265()) {
                    if (!Class383.method5143().method1265()) {
                        if (!Class280.method1355().method1265() && !Class305.method2203().method1265()) {
    ...
    public static Class248 method4320(Class355 class355) {
        return class355.field1074;
    }

    public static void method4321(Class355 class355, int n2) {
    ...
    public static void method4324(Class355 class355, int n2) {
        class355.field1072 = n2;
    }
    ...
    public void method1279() {
        Class355.method4347(this, (boolean)field1071[0]);
        Class355.method4318(this, (int)field1071[0]);
    }

    private Boolean method1269() {
        return (Class355.method4320(this).method507() == Class623.field3045 ? (int)field1071[1] : (int)field1071[0]) != 0;
    }
                    ...
                    block15: {
                        block12: {
                            block14: {
                                ...
                                this.field1073 = Class355.field290.field_1724.method_24828();
                                if (this.field1074.method507() != Class623.field3045) break block13;
                                if (Class355.field290.field_1724.method_3144() || Class355.field290.field_1724.method_6128()) ** GOTO lbl-1000
                                if (Class355.field290.field_1724.method_21754()) break block14;
                                v0 = 62513;
                                ** GOTO lbl13
                            }
                            v0 = 62514;
...
lbl13:
                        ...
                        if (Class355.method4346(Class355.field290).method_5771() || Class355.field290.field_1724.method_5799()) ** GOTO lbl-1000
                        if (Class355.field290.field_1724.field_3913.field_3904) break block15;
                        v1 = 4389;
                        ** GOTO lbl26
                    }
                    v1 = 4390;
...
lbl26:
                        ...
                        switch (v1) {
                            ...
                            case 4389: {
                                if (Class355.method4340(Class355.field290.field_1724.field_3913)) ** GOTO lbl33
                                v2 = 61344;
                                ** GOTO lbl37
lbl33:
                                // 1 sources
...
lbl40:
                                ...
                                if (Class5723.field11056.method14268(Class355.field1071[4])) break block5;
                            }
lbl41:
                            // 3 sources
                    ...
                    if (Class355.method4356().method1265()) break block16;
                    if (Class280.method1355().method1265()) {
                        Class5836.method22897();
                        return;
                    }
                    if (!Class305.method2203().method1265()) break block17;
                }
                return;
            }
            a = this.method4354();
            if (a > Class1151.field4606 && a <= (double)((Float)this.field1070.method507()).floatValue() && Class355.method4330(Class355.field290).method_24828()) {
                Class5723.field11052.method14005(Class355.method4325((class_310)Class355.field290).method_18798().field_1352 * 0.05, Class355.field290.field_1724.method_18798().field_1350 * 0.05);
                Class5723.field11052.method14002((Boolean)this.field1076.method507() != false ? Class355.method4337((class_310)Class355.field290).method_18798().field_1351 - 0.6200000047683716 : -3.0);
            }
        }
    }
    ...
    public static Class248 method4329(Class355 class355) {
    ...
    public static void method4333(Class355 class355, int n2) {
        class355.field1072 = n2;
    }
    ...
    static {
        Class355.method4344(-5222446475159178398L);
    }
    ...
    private static void method4344(long l2) {
        Class355.field1071[2] = l2 ^ 0xB7862499BDA57361L;
        Class355.field1071[0] = l2 ^ 0xB7862499BDA57362L;
        Class355.field1071[4] = l2 ^ 0xB7862499BDA5708AL;
        Class355.field1071[1] = l2 ^ 0xB7862499BDA57363L;
        Class355.field1071[3] = l2 ^ 0xB7862499BDA57367L;
    }
    ...
    public static void method4347(Class355 class355, boolean bl2) {
    ...
    public static Class248 method4350(Class355 class355) {
        return class355.field1074;
    }
    ...
    private double method4354() {
        class_238 b2 = Class355.field290.field_1724.method_5829();
        for (double a2 = 0.0; a2 < (double)((Float)this.field1070.method507()).floatValue() + Class5714.field11013; a2 += 0.01) {
            if (Class355.field290.field_1687.method_8587((class_1297)Class355.field290.field_1724, b2.method_989(0.0, -a2, 0.0))) continue;
            return a2;
        }
        return Class5130.field10067;
    }

    private static int method4355(int n2, int n3, Class436 class436, Class1745 class1745) {
        return Class1044.method12878(n2, n3, class436, class1745);
    }

    private static Class383 method4356() {
        return Class383.method5143();
    }
    ...
    public void method4357(Class204 a2) {
        block7: {
            block6: {
                if (Class280.method1355().method1265()) break block6;
                if (!Class305.method2203().method1265()) break block7;
            }
            return;
        }
        if (!this.field1068) {
        ...
        if (Class355.method4350(this).method507() == Class623.field3044) {
            a2.method386(0.0);
            Class355.method4338(a2, 0.0);
            Class5723.field11052.method14005(0.0, 0.0);
            Class355 class355 = this;
            Class355.method4333(class355, class355.field1072 + (int)field1071[1]);
            if (this.field1072 > (Integer)Class355.method4329(this).method507()) {
