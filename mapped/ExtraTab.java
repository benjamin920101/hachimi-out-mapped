...
extends Class278 {
    ...
    private static String method2610(ExtraTab class316, String string) {
    ...
    public void method2612(Class219 a2) {
        a2.method10();
        a2.method409((Integer)ExtraTab.method2619(this.field734));
    }
    ...
    static {
        ExtraTab.method2627(-5930131986350071357L);
    }
    ...
    private static boolean method2617(Socials class458) {
    ...
    public void method2618(Class10 a2) {
        a2.method10();
        a2.method18((Integer)ExtraTab.method2623(this.field735));
    }
    ...
    public void method2624(Class77 e2) {
        ...
        int n2;
        int n3;
        String[] f2 = ExtraTab.method2620(e2).getString().split(" ");
        ...
        if (((Boolean)this.field732.method507()).booleanValue() && ExtraTab.method2617(Socials.method10623())) {
            stringArray = f2;
            n2 = stringArray.length;
            for (n3 = (int)field733[6]; n3 < n2; ++n3) {
                String d2 = stringArray[n3];
                String c2 = ExtraTab.method2610(this, d2);
    ...
    private static void method2627(long l2) {
        ExtraTab.field733[4] = l2 ^ 0xADB3F060AA6C222BL;
        ExtraTab.field733[2] = l2 ^ 0xADB3F060AA6C21A7L;
        ExtraTab.field733[7] = l2 ^ 0xADB3F060AA6C2164L;
        ExtraTab.field733[1] = l2 ^ 0xADB3F060AA6C2193L;
        ExtraTab.field733[0] = l2 ^ 0xADB3F060AA6C21C2L;
        ExtraTab.field733[6] = l2 ^ 0xADB3F060AA6C21C3L;
        ExtraTab.field733[5] = l2 ^ 0xADB3F060AA6C21D7L;
        ExtraTab.field733[3] = l2 ^ 0xADB3F060AA6C210BL;
    }
