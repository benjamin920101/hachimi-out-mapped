...
extends Class278 {
    ...
    private static void method1747(long l2) {
        PacketCanceler.field527[0] = l2 ^ 0x7DA847205834630AL;
    }

    private static Class248 method1748(PacketCanceler class294) {
        return PacketCanceler.method1766(class294);
    }
    ...
    public static Class248 method1752(PacketCanceler class294) {
            ...
            block26: {
                block25: {
                    block24: {
                        ...
                        if (a.method251() instanceof class_2840 && ((Boolean)PacketCanceler.method1748(this).method507()).booleanValue()) {
                            a.method10();
                            PacketCanceler.method1755(false);
                            return;
                        }
                    ...
                    if (!((Boolean)PacketCanceler.method1774(this.field533)).booleanValue()) break block25;
                    a.method10();
                    break block19;
                }
                if (!(a.method251() instanceof class_2873)) ** GOTO lbl-1000
                if (!((Boolean)PacketCanceler.method1764(PacketCanceler.method1761(this))).booleanValue()) break block26;
                v0 = 63131;
                ** GOTO lbl53
            }
            v0 = 63132;
...
lbl53:
                ...
                switch (v0) {
...

                    {
                        ...
                        if (!((Boolean)PacketCanceler.method1776(this.field524)).booleanValue()) ** GOTO lbl64
                        v1 = 47672;
                        ** GOTO lbl68
lbl64:
                        // 1 sources
...
lbl87:
                        ...
                        if (((Boolean)PacketCanceler.method1765(this.field535)).booleanValue()) {
                            a.method10();
                            break block8;
                        }
lbl90:
                        ...
                        if (((Boolean)PacketCanceler.method1768(this).method507()).booleanValue()) {
                            a.method10();
                            break block8;
                        }
...
lbl107:
    ...
    private static Class248 method1761(PacketCanceler class294) {
        return PacketCanceler.method1777(class294);
    }
    ...
    public static Class248 method1766(PacketCanceler class294) {
    ...
    static {
        PacketCanceler.method1747(9054565255072736010L);
    }

    private static Class248 method1768(PacketCanceler class294) {
        return PacketCanceler.method1752(class294);
    }
    ...
    public static Class248 method1777(PacketCanceler class294) {
