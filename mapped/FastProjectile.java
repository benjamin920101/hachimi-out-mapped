...
extends Class278 {
    ...
    public static Class248 method1685(FastProjectile class291) {
    ...
    private void method1687() {
        double b2 = FastProjectile.field290.field_1724.method_23317();
        double c2 = FastProjectile.field290.field_1724.method_23318();
        double d2 = FastProjectile.field290.field_1724.method_23321();
        Class5723.field11048.method21341((class_2596)new class_2848((class_1297)FastProjectile.field290.field_1724, class_2848.class_2849.field_12981));
        for (int a2 = (int)field504[0]; a2 < (int)field504[2]; ++a2) {
            FastProjectile.method1702().method21341((class_2596)new class_2828.class_2829(b2, c2 - 1.0E-10, d2, (boolean)field504[1]));
            FastProjectile.method1703().method21341((class_2596)new class_2828.class_2829(b2, c2 + 1.0E-10, d2, (boolean)field504[0]));
        }
    }
    ...
    private static Class925 method1691(FastProjectile class291) {
        return FastProjectile.method1699(class291);
    }

    private static void method1692(long l2) {
        FastProjectile.field504[1] = l2 ^ 0x5342D8129650FCAEL;
        FastProjectile.field504[2] = l2 ^ 0x5342D8129650FCCBL;
        FastProjectile.field504[0] = l2 ^ 0x5342D8129650FCAFL;
    }
    ...
    public void method1693(Class131 e2) {
        ...
        block15: {
            block13: {
                ...
                block14: {
                    block12: {
                        if (FastProjectile.field290.field_1724 == null) {
                            return;
                        }
                        if (!this.field503.method12595(Float.valueOf(((Float)this.field505.method507()).floatValue() * 1000.0f))) {
                            return;
                        ...
                        a2 = FastProjectile.field290.field_1724.method_5998(b2.method_12551());
                        if ((a2.method_7909() == class_1802.field_8436 || a2.method_7909() == class_1802.field_8150) && ((Boolean)FastProjectile.method1685(this).method507()).booleanValue()) break block13;
                        n3 = a2.method_7909() != FastProjectile.method1690() ? 37664 : 37663;
                        break block14;
                    }
                    a2 = e2.method251();
                ...
                block8: while (true) {
                    switch (n3) {
                        ...
                        default: {
                            ...
                            if ((Boolean)FastProjectile.method1697(this).method507() == false) return;
                            break block8;
                        }
                    }
                    break;
            ...
            FastProjectile.method1691(this).method12593();
            this.method1687();
            return;
        }
        block9: while (true) {
            switch (n2) {
                ...
                case 65281: {
                    ...
                    class_1799 c2 = FastProjectile.field290.field_1724.method_6047();
    ...
    public static Class248 method1697(FastProjectile class291) {
    ...
    public static Class925 method1699(FastProjectile class291) {
    ...
    static {
        FastProjectile.method1701(5999595227953822895L);
    }

    private static void method1701(long l2) {
        FastProjectile.method1692(l2);
    }

    private static Class5496 method1702() {
        return FastProjectile.method1695();
    }
