...
extends Class278 {
    ...
    public static Class248 method3565(NoSlow class340) {
        return class340.field960;
    }

    private static Class248 method3566(NoSlow class340) {
        return NoSlow.method3673(class340);
    }
    ...
    public static Class248 method3568(NoSlow class340) {
    ...
    public boolean method3574() {
        int n2;
        if (!(NoSlow.field290.field_1755 == null || NoSlow.field290.field_1755 instanceof class_408 || NoSlow.field290.field_1755 instanceof class_498 || NoSlow.field290.field_1755 instanceof class_418)) {
            n2 = (int)field957[0];
            return n2 != 0;
        }
        n2 = (int)field957[1];
    ...
    public static Class248 method3578(NoSlow class340) {
    ...
    public void method3579(Class70 a2) {
        if (((Boolean)this.field960.method507()).booleanValue() && !this.field945 && this.method3629()) {
            ...
            Class5723.field11048.method21341((class_2596)new class_2848((class_1297)NoSlow.field290.field_1724, class_2848.class_2849.field_12979));
        }
    }
    ...
    public void method3581(Class65 a2) {
        if (a2.method128() == Class543.field2690 && ((Boolean)NoSlow.method3622(this).method507()).booleanValue()) {
            if (NoSlow.method3718(field290).method_6115() && !NoSlow.method3576(field290).method_5715() && ((Boolean)this.field955.method507()).booleanValue()) {
                if (((Boolean)this.field942.method507()).booleanValue()) {
                    NoSlow.field290.field_1761.method_2906(NoSlow.field290.field_1724.field_7512.field_7763, (int)field957[0], (int)field957[1], class_1713.field_7790, (class_1657)NoSlow.field290.field_1724);
                }
                if (NoSlow.field290.field_1724.method_6058() == NoSlow.method3626() && NoSlow.method3699(this, NoSlow.method3652(NoSlow.method3598()))) {
                    NoSlow.method3713(Class5723.field11048, NoSlow::method3681);
                } else if (NoSlow.method3631(this, NoSlow.field290.field_1724.method_6079())) {
                    Class5723.field11048.method21353(NoSlow::method3710);
                }
            }
        }
    }
    ...
    public void method3584(Class142 b2) {
        ...
        if (!(c2 instanceof class_2560) || !((Boolean)NoSlow.method3668(this).method507()).booleanValue()) {
            int n2;
            ...
            float a2 = ((Float)NoSlow.method3566(this).method507()).floatValue();
    ...
    public static Class248 method3587(NoSlow class340) {
        return class340.field952;
    }
                ...
                block6: {
                    block3: {
                        block5: {
                            ...
                            if (!((Boolean)this.field942.method507()).booleanValue() || NoSlow.field290.field_1724 == null) break block4;
...
lbl11:
                    ...
                    NoSlow.method3614(NoSlow.field290, (int)NoSlow.field957[1]);
                    a.method10();
                    break block4;
                }
                if (!NoSlow.field290.field_1724.method_5998(a.field41).method_7909().method_57347().method_57832(class_9334.field_50075)) break block7;
                v1 = 54675;
                ** GOTO lbl27
            }
            v1 = 54676;
...
lbl27:
            ...
            NoSlow.field290.field_1761.method_2906(NoSlow.method3694((class_310)NoSlow.field290).field_7512.field_7763, (int)NoSlow.field957[0], (int)NoSlow.field957[1], NoSlow.method3691(), (class_1657)NoSlow.field290.field_1724);
        }
    }
    ...
    private static void method3592(class_744 class_7442, float f2) {
        NoSlow.method3688(class_7442, f2);
    }

    @Override
    public void method1279() {
        if (((Boolean)NoSlow.method3565(this).method507()).booleanValue() && this.field945) {
            NoSlow.method3659(Class5723.field11048, (class_2596)new class_2848((class_1297)NoSlow.method3639(field290), class_2848.class_2849.field_12984));
        }
        this.field945 = (int)field957[1];
        NoSlow.method3658(Class5723.field11047, 1.0f);
    }
    ...
    public static int method3602(NoSlow class340) {
    ...
    public void method3604(Class69 d2) {
        if (NoSlow.method3664(field290) != null && ((Boolean)this.field958.method507()).booleanValue() && NoSlow.method3611(this)) {
            if (d2.method128() == Class543.field2690) {
                ...
                class_304Array[(int)NoSlow.field957[1]] = NoSlow.method3608((class_310)NoSlow.field290).field_1903;
                class_304Array[(int)NoSlow.field957[0]] = NoSlow.method3624(NoSlow.field290.field_1690);
                class_304Array[(int)NoSlow.field957[5]] = NoSlow.field290.field_1690.field_1881;
                class_304Array[(int)NoSlow.field957[2]] = NoSlow.method3569(NoSlow.field290.field_1690);
                class_304Array[(int)NoSlow.field957[4]] = NoSlow.method3621(NoSlow.field290.field_1690);
    ...
    private static class_746 method3607(class_310 class_3102) {
        return NoSlow.method3597(class_3102);
    }

    private static class_315 method3608(class_310 class_3102) {
        return NoSlow.method3726(class_3102);
    }
    ...
    private static boolean method3611(NoSlow class340) {
    ...
    private static void method3614(class_310 class_3102, int n2) {
        NoSlow.method3656(class_3102, n2);
    }
    ...
    private static class_315 method3617(class_310 class_3102) {
        return NoSlow.method3670(class_3102);
    }
    ...
    public static Class248 method3622(NoSlow class340) {
        return class340.field952;
    }

    private static Class248 method3623(NoSlow class340) {
        return NoSlow.method3661(class340);
    }
    ...
    public boolean method3629() {
        ...
        block6: {
            block7: {
                if (Disabler.method5496().method5488()) return (int)field957[0] != 0;
                if (((Boolean)NoSlow.method3578(this).method507()).booleanValue() && ((Boolean)NoSlow.method3568(this).method507()).booleanValue() && NoSlow.field290.field_1724.method_6115() && NoSlow.field290.field_1724.method_6048() <= (int)field957[0]) {
                    if ((Boolean)NoSlow.method3618(this.field955) == false) return Class5659.method22194();
                    return (int)field957[1] != 0;
                }
                if (((Boolean)NoSlow.method3623(this).method507()).booleanValue() && !this.method3714()) {
                    return (int)field957[1] != 0;
                }
                if (NoSlow.field290.field_1724.method_3144() || NoSlow.method3607(field290).method_5715()) break block6;
                if (NoSlow.field290.field_1724.method_6115() && ((Boolean)NoSlow.method3650(this).method507()).booleanValue()) break block7;
                if (!NoSlow.method3609(field290).method_6039()) {
                    return NoSlow.method3635();
                }
                if (!((Boolean)NoSlow.method3685(this).method507()).booleanValue()) break block6;
                if ((Boolean)this.field953.method507() != false) return Replenish.method6431();
                if (((Boolean)NoSlow.method3587(this).method507()).booleanValue()) break block6;
            }
            n2 = (int)field957[0];
            return n2 != 0;
        }
    ...
    private static boolean method3631(NoSlow class340, class_1799 class_17992) {
    ...
    private static int method3634(int n2, int n3, ElytraTweaks class354, Class50 class50) {
    ...
    static {
        ...
        NoSlow.method3721(-5213004647679476764L);
    }
    ...
    public static Class248 method3650(NoSlow class340) {
    ...
    private static class_746 method3657(class_310 class_3102) {
        return NoSlow.method3674(class_3102);
    }
    ...
    public static Class248 method3661(NoSlow class340) {
    ...
    private static class_746 method3664(class_310 class_3102) {
        return NoSlow.method3697(class_3102);
    }
    ...
    public static Class248 method3668(NoSlow class340) {
        return class340.field946;
    }

    private static int method3669(int n2, int n3, Class115 class115, FastPlace class386) {
    ...
    private static class_746 method3671(class_310 class_3102) {
        return NoSlow.method3638(class_3102);
    }
    ...
    public static Class248 method3673(NoSlow class340) {
    ...
    private static class_2596 method3681(int a2) {
        return new class_2886(class_1268.field_5808, a2, NoSlow.field290.field_1724.method_36454(), NoSlow.field290.field_1724.method_36455());
    }
    ...
    public void method3684(Class49 b2) {
        block5: {
            block4: {
                if (((Boolean)NoSlow.method3724(this).method507()).booleanValue() && NoSlow.field290.field_1724.method_5715()) break block4;
                if (!((Boolean)this.field941.method507()).booleanValue()) break block5;
                if (!NoSlow.field290.field_1724.method_20448()) break block5;
            }
            float a2 = 1.0f / (float)NoSlow.field290.field_1724.method_45325(class_5134.field_51584);
            b2.field66.field_3905 *= a2;
            class_744 class_7442 = b2.field66;
            NoSlow.method3592(class_7442, NoSlow.method3666(class_7442) * a2);
        }
        if (this.method3629()) {
            b2.field66.field_3905 = NoSlow.method3586(b2.field66) * Class3671.field8213;
            class_744 class_7443 = b2.field66;
            NoSlow.method3705(class_7443, NoSlow.method3605(class_7443) * Class5479.field10269);
        }
    }

    private Boolean method1269() {
        return ((Boolean)NoSlow.method3695(this.field946) != false || (Boolean)this.field951.method507() != false ? (int)field957[0] : (int)field957[1]) != 0;
    }

    public static Class248 method3685(NoSlow class340) {
    ...
    private static class_746 method3694(class_310 class_3102) {
        return NoSlow.method3662(class_3102);
    }
    ...
    private static boolean method3699(NoSlow class340, class_1799 class_17992) {
        return class340.method3573(class_17992);
    }
    ...
    public void method3700(Class159 a2) {
        if (a2.method314() == class_2246.field_10030 && ((Boolean)this.field956.method507()).booleanValue()) {
            a2.method10();
            NoSlow.method3577(a2, Class3436.field7490);
        }
    }
    ...
    private static class_746 method3704(class_310 class_3102) {
        return NoSlow.method3653(class_3102);
    }
    ...
    public static Class248 method3707(NoSlow class340) {
        return class340.field958;
    }

    @Class1
    public void method3708(Class104 a2) {
        if (a2.method189() == NoSlow.method3596() && ((Boolean)this.field947.method507()).booleanValue() || a2.method189() == class_2246.field_21211 && ((Boolean)this.field943.method507()).booleanValue()) {
            a2.method10();
        }
    }
    ...
    public void method3709(Class63 f2) {
        ...
        block16: {
            block15: {
                ...
                if (((Boolean)this.field955.method507()).booleanValue() && ((Boolean)NoSlow.method3693(this.field952)).booleanValue() && ((Boolean)this.field942.method507()).booleanValue()) {
                    this.field944 = NoSlow.method3602(this) - (int)field957[0];
                    if (NoSlow.method3599(field290).method_6115()) {
                        NoSlow.method3711(this, (int)field957[5]);
                    }
                }
                ...
                if ((Boolean)NoSlow.method3687(NoSlow.method3707(this)) == false) return;
                if (!this.method3574()) {
                    return;
                }
                d2 = field290.method_22683().method_4490();
                class_304[] class_304Array = new class_304[(int)field957[6]];
                class_304Array[(int)NoSlow.field957[1]] = NoSlow.method3617((class_310)NoSlow.field290).field_1903;
                class_304Array[(int)NoSlow.field957[0]] = NoSlow.field290.field_1690.field_1894;
                class_304Array[(int)NoSlow.field957[5]] = NoSlow.field290.field_1690.field_1881;
                class_304Array[(int)NoSlow.field957[2]] = NoSlow.field290.field_1690.field_1849;
                class_304Array[(int)NoSlow.field957[4]] = NoSlow.field290.field_1690.field_1913;
                ...
                while (true) {
                    if (n4 >= n3) {
                        ...
                        b2 = NoSlow.method3671(field290).method_36454();
                        c2 = NoSlow.field290.field_1724.method_36455();
        ...
        NoSlow.field290.field_1724.method_36456(b2);
        NoSlow.method3676(field290).method_36457(class_3532.method_15363((float)c2, (float)-90.0f, (float)90.0f));
    }

    private static class_2596 method3710(int a2) {
        return new class_2886(class_1268.field_5810, a2, NoSlow.method3704(field290).method_36454(), NoSlow.field290.field_1724.method_36455());
    }

    public static void method3711(NoSlow class340, int n2) {
        class340.field944 = n2;
    }

    public static NoSlow method3712() {
        return INSTANCE;
    }
    ...
    private boolean method3714() {
        block9: {
            if (NoSlow.field290.field_1724.method_5715() || NoSlow.method3575(NoSlow.field290).method_20448() || NoSlow.method3657(NoSlow.field290).method_3144()) break block9;
            if (NoSlow.field290.field_1724.method_6014() >= (int)NoSlow.field957[6]) break block9;
            if (!PacketEat.method4874().method1265()) ** GOTO lbl17
            if (!PacketEat.method4874().method4876()) ** GOTO lbl17
        }
        if (NoSlow.field290.field_1724.method_6048() <= (int)NoSlow.field957[0]) {
...
lbl12:
            ...
            switch (v0) {
                ...
                case 8565: {
                    if (NoSlow.field290.field_1724.method_6048() % (int)NoSlow.field957[5] == 0) ** GOTO lbl19
lbl17:
                    // 3 sources

                    v1 = (int)NoSlow.field957[0];
                    break block4;
                }
lbl19:
                // 2 sources
    ...
    public static Class248 method3717(NoSlow class340) {
    ...
    private static void method3721(long l2) {
        NoSlow.field957[7] = l2 ^ 0xB7A7AFE4829ABAE3L;
        NoSlow.field957[0] = l2 ^ 0xB7A7AFE4829ABBE5L;
        NoSlow.field957[2] = l2 ^ 0xB7A7AFE4829ABBE7L;
        NoSlow.field957[1] = l2 ^ 0xB7A7AFE4829ABBE4L;
        NoSlow.field957[9] = l2 ^ 0xB7A7AFE4829ABAEDL;
        NoSlow.field957[5] = l2 ^ 0xB7A7AFE4829ABBE6L;
        NoSlow.field957[3] = l2 ^ 0xB7A7AFE4829ABAECL;
        NoSlow.field957[4] = l2 ^ 0xB7A7AFE4829ABBE0L;
        NoSlow.field957[8] = l2 ^ 0xB7A7AFE4829ABAE2L;
        NoSlow.field957[6] = l2 ^ 0xB7A7AFE4829ABBE1L;
    }
    ...
    public static Class248 method3724(NoSlow class340) {
    ...
    public void method3728(Class65 c2) {
        block5: {
            block6: {
                ...
                if (!((Boolean)NoSlow.method3702(this.field953)).booleanValue()) break block5;
            }
            if (((Boolean)this.field946.method507()).booleanValue()) {
                class_238 b2 = NoSlow.field290.field_1724.method_5829();
