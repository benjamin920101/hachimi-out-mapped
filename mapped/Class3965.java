...
public class Class3965 {
    ...
    public static int method19479(int n2, int n3, Class3586 class3586, Class4157 class4157) {
        return 845273200 + (n2 & 0xCD9E278F);
    }

    public static int method19480(int n2, int n3, Class2 class2, Class30 class30) {
        int n4 = n3;
        return n4 + ((n2 ^ 0x6FFDBFDF) & ~n4);
    }

    public static int method19481(int n2, int n3, Class62 class62, Class3933 class3933) {
        int n4 = n2 ^ 0x6A97E1F9;
        return (n3 | ~n4) - ~n4;
    }
}
