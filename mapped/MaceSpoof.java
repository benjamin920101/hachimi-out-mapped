...
extends Class278 {
    ...
    public void method2715(Class131 f2) {
        block17: {
            ...
            block18: {
                block16: {
                    if (MaceSpoof.method2736(field290) == null) return;
                    int n3 = MaceSpoof.field290.field_1687 != null ? 19517 : 19518;
                    block8: while (true) {
                        switch (n3) {
                            case 19518: {
                                n3 = 19516;
                    ...
                    if (MaceSpoof.field290.field_1724.method_6047().method_7909() != MaceSpoof.method2724()) {
                        return;
                    }
                    ...
                    if (((Boolean)this.field756.method507()).booleanValue() && !MaceSpoof.field290.field_1724.method_24828() && !MaceSpoof.method2718(MaceSpoof.field290.field_1724.method_31549())) {
                        return;
                    }
                    if (MaceSpoof.field290.field_1724.method_5771()) return;
                    if (MaceSpoof.field290.field_1724.method_5869()) return;
                    if (!((Boolean)this.field754.method507()).booleanValue()) break block17;
                    n2 = b2.method18778() instanceof class_1511 ? 10711 : 10712;
                    break block18;
                }
                if (MaceSpoof.method2745(this.field759) != Class559.field2769) return;
                ...
                if (!MaceSpoof.method2732(d2)) return;
                int c2 = Class5723.field11058.method18969();
                MaceSpoof.method2721(this, (boolean)field761[0]);
                d2.method18531(c2);
                MaceSpoof.method2743(MaceSpoof.method2727(), f2.method251());
                d2.method18534(c2);
        ...
        while (true) {
            if (a2 >= (int)field761[2]) {
                MaceSpoof.method2722(this, ((Float)MaceSpoof.method2717(this).method507()).floatValue());
                this.method2742(0.0);
                this.field760.method12593();
                return;
            }
    ...
    public static Class248 method2717(MaceSpoof class322) {
    ...
    public static Class248 method2719(MaceSpoof class322) {
    ...
    public static void method2721(MaceSpoof class322, boolean bl2) {
        class322.field757 = bl2;
    }

    private static void method2722(MaceSpoof class322, double d2) {
    ...
    private static void method2726(long l2) {
        MaceSpoof.field761[0] = l2 ^ 0xED976F17AA718571L;
        MaceSpoof.field761[2] = l2 ^ 0xED976F17AA718574L;
        MaceSpoof.field761[1] = l2 ^ 0xED976F17AA718570L;
    }
    ...
    public MaceSpoof() {
        ...
        this.field755 = this.method450(new Class260("SwapAction", "Decide which swap mode to use", Class607.field2953, MaceSpoof.method2753(), this::method2746));
    ...
    private Boolean method2731() {
        if (MaceSpoof.method2734(MaceSpoof.method2747(this)) == MaceSpoof.method2720()) {
    ...
    public static Class248 method2733(MaceSpoof class322) {
        return class322.field759;
    }
    ...
    public static Class248 method2738(MaceSpoof class322) {
        return class322.field759;
    }

    static {
        field761 = new long[3];
        MaceSpoof.method2726(-1326469417802824336L);
    }
    ...
    private Boolean method1278() {
        return (this.field759.method507() == MaceSpoof.method2751() ? (int)field761[0] : (int)field761[1]) != 0;
    }
    ...
    private void method2742(double a2) {
        MaceSpoof.field290.field_1724.field_3944.method_52787((class_2596)new class_2828.class_2829(MaceSpoof.field290.field_1724.method_23317(), MaceSpoof.field290.field_1724.method_23318() + a2, MaceSpoof.method2723(field290).method_23321(), (boolean)field761[1]));
    }
    ...
    private Boolean method2746() {
        return (MaceSpoof.method2719(this).method507() == Class559.field2769 ? (int)field761[0] : (int)field761[1]) != 0;
    }

    private static Class248 method2747(MaceSpoof class322) {
        return MaceSpoof.method2733(class322);
    }

    private static int method2748(int n2, int n3, NoSoundLag class303, Class5628 class5628) {
    ...
    private Boolean method1269() {
        return (MaceSpoof.method2738(this).method507() == MaceSpoof.method2741() ? (int)field761[0] : (int)field761[1]) != 0;
    }
