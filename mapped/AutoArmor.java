...
extends Class278 {
    ...
    private static Queue method1284(AutoArmor class279) {
        return AutoArmor.method1293(class279);
    }

    @Class1
    public void method1285(Class210 n2) {
        if (!(AutoArmor.field290.field_1755 == null || AutoArmor.field290.field_1755 instanceof class_490 && ((Boolean)AutoArmor.method1314(this.field406)).booleanValue())) {
            return;
        }
        this.field405.clear();
        this.field411.clear();
        AutoArmor.method1308(this).clear();
        this.field414.clear();
            ...
            block16: {
                block17: {
                    block15: {
                        ...
                        class_1799 a2 = AutoArmor.method1309(field290).method_31548().method_5438(f2);
                        ...
                        AutoArmor.method1284(this).add(e2);
                        continue;
                    }
        ...
        for (int m2 = (int)field412[1]; m2 < (int)field412[3]; ++m2) {
            class_1799 k2 = AutoArmor.field290.field_1724.method_31548().method_7372(m2);
    ...
    public static Queue method1293(AutoArmor class279) {
    ...
    private static void method1299(long l2) {
        AutoArmor.field412[2] = l2 ^ 0x7F4AFAA94143719DL;
        AutoArmor.field412[5] = l2 ^ 0x7F4AFAA9414371B0L;
        AutoArmor.field412[4] = l2 ^ 0x7F4AFAA9414371B1L;
        AutoArmor.field412[0] = l2 ^ 0x7F4AFAA9414371B8L;
        AutoArmor.field412[3] = l2 ^ 0x7F4AFAA9414371BDL;
        AutoArmor.field412[1] = l2 ^ 0x7F4AFAA9414371B9L;
    }
    ...
    public static Queue method1305(AutoArmor class279) {
    ...
    static {
        AutoArmor.method1299(9172419195944792505L);
    }

    public static Queue method1308(AutoArmor class279) {
    ...
    public void method1311(int a2, int b2) {
        class_1799 c2 = AutoArmor.field290.field_1724.method_31548().method_7372(a2);
        ...
        AutoArmor.method1313(Class5723.field11058, a2);
        if (d2 != 0) {
            Class5723.field11058.method18923(b2 < (int)field412[5] ? b2 + (int)field412[2] : b2);
        }
    }
