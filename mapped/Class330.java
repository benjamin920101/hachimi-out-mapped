...
extends Class278 {
    ...
    private static void method2894(long l2) {
        Class330.field806[1] = l2 ^ 0x1BFF00BE6036E57CL;
        Class330.field806[4] = l2 ^ 0x1BFF00BE6036E561L;
        Class330.field806[3] = l2 ^ 0x1BFF00BE6036E564L;
        Class330.field806[5] = l2 ^ 0x1BFF00BE6036E565L;
        Class330.field806[0] = l2 ^ 0x1BFF00BE6036E56FL;
        Class330.field806[2] = l2 ^ 0x1BFF00BE6036E56AL;
    }

    private static class_437 method2895(class_310 class_3102) {
        return Class330.method2905(class_3102);
    }
    ...
    public void method2899(Class63 b2) {
        ...
        if (Class330.field290.field_1755 == null || Class330.method2895(field290) instanceof class_408 || ((Boolean)this.field808.method507()).booleanValue()) {
            if (Class330.field290.field_1724.method_6047().method_7909() != class_1802.field_8378) {
                return;
            }
            class_1536 a2 = Class330.field290.field_1724.field_7513;
            ...
            if (this.field811) {
                ...
                this.field810 = Class330.method2900(this) - (int)field806[3];
            }
        }
        this.field809 -= (int)field806[3];
    }

    private static int method2900(Class330 class330) {
        return Class330.method2902(class330);
    }
    ...
    public static int method2902(Class330 class330) {
    ...
    public void method2903(Class133 d2) {
        class_2767 c2;
        if (Class330.field290.field_1724 == null) {
            return;
        }
        class_2596 class_25962 = d2.method251();
        if (class_25962 instanceof class_2767 && (c2 = (class_2767)class_25962).method_11894().comp_349() == class_3417.field_14660 && Class330.field290.field_1724.method_6047().method_7909() == Class330.method2898()) {
            class_1536 a2 = Class330.field290.field_1724.field_7513;
            if (a2 == null || a2.method_6947() != Class330.field290.field_1724) {
                return;
            }
    ...
    static {
        Class330.method2894(2017331975743268197L);
    }
