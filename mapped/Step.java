...
extends Class278 {
    ...
    private Boolean method3132() {
        return (Step.method3180(this.field881) != Class578.field2830 ? (int)field879[0] : (int)field879[1]) != 0;
    }

    @Class1(priority=-100)
    public void method3133(Class69 a2) {
        if (Step.method3197(this.field881) == Step.method3188() && Step.method3155(this)) {
            Step.method3193((class_746)Step.field290.field_1724).field_3904 = (int)field879[0];
        }
    }
    ...
    public static Class248 method3135(Step class338) {
    ...
    public void method3136(Class65 d2) {
        ...
        double b2 = Step.field290.field_1724.method_23318() - Step.method3173((class_310)Step.field290).field_6036;
        if (b2 <= 0.5) return;
        ...
        if (((Boolean)this.field883.method507()).booleanValue()) {
            Step.method3226(Class5723.field11047, b2 > 1.0 ? 0.15f : 0.35f);
            Step.method3151(this, (boolean)field879[0]);
        }
        double[] dArray = c2;
        ...
        while (true) {
            if (n5 >= n4) {
                Step.method3182(this).method12593();
                return;
            }
            double a2 = dArray[n5];
            Class5723.field11048.method21341((class_2596)new class_2828.class_2829(Step.field290.field_1724.field_6014, Step.field290.field_1724.field_6036 + a2, Step.field290.field_1724.field_5969, (boolean)field879[1]));
            ++n5;
        }
    }
    ...
    private static void method3138(Step class338, float f2) {
        Step.method3149(class338, f2);
    }

    private static Class248 method3139(Step class338) {
        return Step.method3147(class338);
    }
    ...
    private double[] method3143(double a2) {
        ...
        if (((Boolean)this.field884.method507()).booleanValue()) {
            if (a2 > 1.1661) {
                ...
                dArray[(int)Step.field879[1]] = 0.42;
                dArray[(int)Step.field879[0]] = Class1677.field6216;
                dArray[(int)Step.field879[6]] = 1.001;
                dArray[(int)Step.field879[7]] = Class6332.field13036;
                dArray[(int)Step.field879[2]] = a2;
                b2 = dArray;
            } else if (a2 > 1.015) {
                double[] dArray = new double[(int)field879[2]];
                dArray[(int)Step.field879[1]] = 0.42;
                dArray[(int)Step.field879[0]] = 0.7532;
                dArray[(int)Step.field879[6]] = 1.001;
                dArray[(int)Step.field879[7]] = a2;
                b2 = dArray;
            } else if (a2 > Class4378.field9985) {
                double[] dArray = new double[(int)field879[7]];
                dArray[(int)Step.field879[1]] = 0.42 * a2;
                dArray[(int)Step.field879[0]] = 0.7532 * a2;
                dArray[(int)Step.field879[6]] = a2;
                b2 = dArray;
            }
            return b2;
        }
        if (a2 > 2.019) {
            ...
            dArray[(int)Step.field879[1]] = 0.425;
            dArray[(int)Step.field879[0]] = Class3776.field8556;
            dArray[(int)Step.field879[6]] = 0.699;
            dArray[(int)Step.field879[7]] = Class3911.field8907;
            dArray[(int)Step.field879[2]] = 1.022;
            dArray[(int)Step.field879[4]] = 1.372;
            dArray[(int)Step.field879[10]] = 1.652;
            dArray[(int)Step.field879[11]] = 1.869;
            dArray[(int)Step.field879[8]] = 2.019;
            dArray[(int)Step.field879[9]] = Class1589.field5940;
            b2 = dArray;
        } else if (a2 > 1.5) {
            double[] dArray = new double[(int)field879[8]];
            dArray[(int)Step.field879[1]] = Class3305.field7114;
            dArray[(int)Step.field879[0]] = Class1782.field6678;
            dArray[(int)Step.field879[6]] = 0.63;
            dArray[(int)Step.field879[7]] = 0.51;
            dArray[(int)Step.field879[2]] = 0.9;
            dArray[(int)Step.field879[4]] = 1.21;
            dArray[(int)Step.field879[10]] = Class1572.field5877;
            dArray[(int)Step.field879[11]] = Class1145.field4593;
            b2 = dArray;
        } else if (a2 > 1.015) {
            double[] dArray = new double[(int)field879[4]];
            dArray[(int)Step.field879[1]] = 0.42;
            dArray[(int)Step.field879[0]] = Class3482.field7648;
            dArray[(int)Step.field879[6]] = Class6008.field11992;
            dArray[(int)Step.field879[7]] = 1.093;
            dArray[(int)Step.field879[2]] = Class1708.field6327;
            b2 = dArray;
        } else if (a2 > 0.6) {
            double[] dArray = new double[(int)field879[6]];
            dArray[(int)Step.field879[1]] = 0.42 * a2;
            dArray[(int)Step.field879[0]] = Class4205.field9829 * a2;
            b2 = dArray;
        }
        return b2;
    }
    ...
    protected void method3144(double R, double S) {
        block16: {
            block17: {
                ...
                I = Step.field290.field_1724.method_19538();
                J = I.method_1031(R, 0.0, S);
                K = new class_243(R, 0.0, S);
                L = Step.field290.field_1724.method_6029();
                M = (float)K.method_1027();
                if (M <= 0.001f) {
                    a = Step.field290.field_1724.field_3913.method_3128();
                    b = L * a.field_1343;
                    c = L * a.field_1342;
                    e = class_3532.method_15374((float)(Step.method3230(Step.field290).method_36454() * 0.017453292f));
                    d = class_3532.method_15362((float)(Step.field290.field_1724.method_36454() * Class3440.field7508));
                ...
                Q = Step.field290.field_1724.method_5663();
                N = (float)(Q.field_1352 * P.field_1352 + Q.field_1350 * P.field_1350);
                if (N < -0.15f) break block16;
                F = class_3726.method_16195((class_1297)Step.field290.field_1724);
                G = class_2338.method_49637((double)Step.field290.field_1724.method_23317(), (double)Step.field290.field_1724.method_5829().field_1325, (double)Step.method3137(Step.field290).method_23321());
                H = Step.method3160(Step.field290).method_37908().method_8320(G);
                if (!H.method_26194((class_1922)Step.field290.field_1724.method_37908(), G, F).method_1110()) break block17;
                v0 = 31470;
                ** GOTO lbl33
            }
            v0 = 31471;
...
lbl33:
                ...
                switch (v0) {
                    ...
                    case 31470: {
                        G = G.method_10084();
                        E = Step.field290.field_1724.method_37908().method_8320(G);
                        if (!E.method_26194((class_1922)Step.field290.field_1724.method_37908(), G, F).method_1110()) break block4;
                        o = 1.2f;
                        if (Step.field290.field_1724.method_6059(Step.method3145())) {
                            o += (float)(Step.field290.field_1724.method_6112(class_1294.field_5913).method_5578() + (int)Step.field879[0]) * 0.75f;
                        }
                        p = Math.max(L * 7.0f, 1.0f / O);
                        q = J.method_1019(P.method_1021((double)p));
                        r = Step.field290.field_1724.method_17681();
                        s = Step.field290.field_1724.method_17682();
                        ...
                        z = u.method_1019(w);
                        A = q.method_1019(w);
                        B = Step.field290.field_1724.method_37908().method_8600((class_1297)Step.field290.field_1724, t);
                        C = StreamSupport.stream(B.spliterator(), (boolean)Step.field879[1]).flatMap((Function<class_265, Stream>)LambdaMetafactory.metafactory(null, null, null, (Ljava/lang/Object;)Ljava/lang/Object;, method3223(net.minecraft.util.shape.VoxelShape ), (Lnet/minecraft/class_265;)Ljava/util/stream/Stream;)()).iterator();
                        D = 1.4E-45f;
                        while (C.hasNext()) {
                            m = (class_238)C.next();
                            ...
                            l = (int)Step.field879[0];
                            while ((float)l < o) {
                                g = k.method_10086(l);
                                h = Step.field290.field_1724.method_37908().method_8320(g);
                                i = h.method_26194((class_1922)Step.field290.field_1724.method_37908(), g, F);
...
lbl81:
                                ...
                                if ((double)D - Step.method3157(Step.field290).method_23318() > (double)o) {
                                    return;
                                }
                                if (l <= (int)Step.field879[0]) ** GOTO lbl99
                                G = G.method_10084();
                                f = Step.field290.field_1724.method_37908().method_8320(G);
                                if (f.method_26194((class_1922)Step.field290.field_1724.method_37908(), G, F).method_1110()) ** GOTO lbl90
                                v2 = 13879;
                                ** GOTO lbl94
lbl90:
                                // 1 sources
...
lbl99:
                        ...
                        n = (float)((double)D - Step.field290.field_1724.method_23318());
                        if (n <= 0.5f) {
                            while (true) {
                                // Infinite loop
                            }
                        ...
                        if (n > o) break block4;
                        Step.method3205(this, (boolean)Step.field879[0]);
                    }
                }
                break;
            }
    ...
    public static Class248 method3147(Step class338) {
        return class338.field881;
    }

    private static boolean method3148(Step class338) {
        return Step.method3171(class338);
    }

    public static void method3149(Step class338, float f2) {
    ...
    public static void method3151(Step class338, boolean bl2) {
    ...
    public void method3153(Class130 a2) {
        if (Step.field290.field_1724 == null) {
            return;
        }
    ...
    public static Class248 method3154(Step class338) {
        return class338.field881;
    }

    public static boolean method3155(Step class338) {
    ...
    private static class_746 method3160(class_310 class_3102) {
        return Step.method3170(class_3102);
    }
    ...
    private static Class248 method3164(Step class338) {
        return Step.method3135(class338);
    }
    ...
    public static boolean method3171(Step class338) {
        return class338.field888;
    }

    public static float method3172(Step class338) {
    ...
    public void method3177(Class154 a2) {
        block4: {
            block5: {
                if (this.field881.method507() == Step.method3152()) {
                    return;
                }
                if (Step.field290.field_1724 == null) break block4;
                if (a2.method302() == Step.field290.field_1724) break block5;
                if (!((Boolean)Step.method3156(this.field886)).booleanValue()) break block4;
                if (Step.field290.field_1724.method_5854() == null || Step.method3159(a2) != Step.field290.field_1724.method_5854()) break block4;
            }
            a2.method10();
            Step.method3169(a2, Step.method3172(this));
        }
    }

    private static class_746 method3178(class_310 class_3102) {
        return Step.method3176(class_3102);
    }

    public static Class925 method3179(Step class338) {
        return class338.field880;
    }

    static {
        Step.method3207(-2123511537891240934L);
    }
    ...
    private static class_746 method3181(class_310 class_3102) {
        return Step.method3175(class_3102);
    }

    @Override
    public String method1248() {
        return Class5587.method21919((Enum)Step.method3139(this).method507());
    }

    private static Class925 method3182(Step class338) {
        return Step.method3179(class338);
    }
    ...
    private static int method3184(int n2, int n3, Class1567 class1567, GhostHand class346) {
    ...
    private Boolean method1278() {
        return (Step.method3201(this).method507() == Class578.field2831 && ((Float)this.field882.method507()).floatValue() <= 2.5f ? (int)field879[0] : (int)field879[1]) != 0;
    }
    ...
    private static class_746 method3195(class_310 class_3102) {
        return Step.method3209(class_3102);
    }
    ...
    private boolean method3196() {
        block3: {
            block4: {
                if (!Step.field290.field_1724.method_24828() || Step.field290.field_1724.method_5715()) ** GOTO lbl-1000
                if (Step.field290.field_1724.method_5765()) break block4;
                v0 = 62715;
                ** GOTO lbl10
            }
            v0 = 62716;
...
lbl10:
        ...
        if (Step.method3199()) {
            v1 = (int)Step.field879[0];
        } else lbl-1000:
        // 2 sources

        {
            v1 = (int)Step.field879[1];
        }
        return (boolean)v1;
    }
    ...
    public void method3198(Class63 a2) {
        block7: {
            block6: {
                ...
                if (Step.method3195(field290).method_5799() || Step.field290.field_1724.method_5771()) break block6;
                if (!Step.method3178(field290).method_6128()) break block7;
            }
            Class5723.field11047.method19512(1.0f);
            Step.method3138(this, this.method3219(Step.method3220(field290).method_5854()) ? 1.0f : 0.6f);
            return;
        }
        if (Step.method3148(this) && Step.field290.field_1724.method_24828()) {
            Class5723.field11047.method19512(1.0f);
            this.field888 = (int)field879[1];
        }
        if (Step.method3181(field290).method_24828() && Step.method3231(this).method12595((int)field879[3])) {
            this.field887 = ((Float)this.field882.method507()).floatValue();
            Class6454.method24594();
            return;
        }
        Step.method3229(this, this.method3219(Step.field290.field_1724.method_5854()) ? 1.0f : 0.6f);
    }
    ...
    private static Class248 method3201(Step class338) {
        return Step.method3154(class338);
    }
    ...
    public void method1274() {
        if (Step.method3185(field290) == null) {
            return;
        }
        this.field887 = this.method3219(Step.field290.field_1724.method_5854()) ? 1.0f : 0.6f;
        Class5723.field11047.method19512(1.0f);
    }

    private static void method3205(Step class338, boolean bl2) {
        Step.method3208(class338, bl2);
    }
    ...
    private static void method3207(long l2) {
        Step.field879[7] = l2 ^ 0xE287C581D38C9419L;
        Step.field879[9] = l2 ^ 0xE287C581D38C9413L;
        Step.field879[10] = l2 ^ 0xE287C581D38C941CL;
        Step.field879[2] = l2 ^ 0xE287C581D38C941EL;
        Step.field879[6] = l2 ^ 0xE287C581D38C9418L;
        Step.field879[1] = l2 ^ 0xE287C581D38C941AL;
        Step.field879[4] = l2 ^ 0xE287C581D38C941FL;
        Step.field879[11] = l2 ^ 0xE287C581D38C941DL;
        Step.field879[3] = l2 ^ 0xE287C581D38C94D2L;
        Step.field879[5] = l2 ^ 0xE287C581D38C9410L;
        Step.field879[8] = l2 ^ 0xE287C581D38C9412L;
        Step.field879[0] = l2 ^ 0xE287C581D38C941BL;
    }

    public static void method3208(Step class338, boolean bl2) {
    ...
    public void method3215(Class204 a2) {
        if (this.field881.method507() == Class578.field2830) {
            Step.method3222(this, Step.method3167(a2), a2.method390());
        }
    }
    ...
    private Boolean method3221() {
        return (Step.method3164(this).method507() == Step.method3190() ? (int)field879[0] : (int)field879[1]) != 0;
    }

    @Override
    public void method1279() {
        Step.method3192(Class5723.field11047, 1.0f);
    }

    private static void method3222(Step class338, double d2, double d3) {
    ...
    public static void method3229(Step class338, float f2) {
        class338.field887 = f2;
    }
    ...
    public static Class925 method3231(Step class338) {
        return class338.field880;
    }
    ...
    public void method3233(Class217 a2) {
        if (this.field881.method507() == Class578.field2830) {
            if (this.field885 && Step.field290.field_1724.field_3913.field_3904) {
                a2.method10();
