...
extends Class278 {
    ...
    static {
        Class312.method2544(763678513555988045L);
    }

    @Override
    public void method1279() {
        if (this.field710 == null || Class312.method2550(field290) == null) {
            return;
        }
        ...
        for (int i2 = (int)field708[0]; i2 < n2; ++i2) {
            ...
            Class312.field290.field_1690.method_1631(a2, this.field710.contains(a2));
        }
    }

    private static void method2544(long l2) {
        Class312.method2547(l2);
    }
    ...
    public void method1274() {
        if (Class312.field290.field_1690 == null) {
            return;
        }
        Class312.method2551(this, ((d)Class312.field290.field_1690).getPlayerModelParts());
    }
    ...
    private static void method2547(long l2) {
        Class312.field708[1] = l2 ^ 0xA99218FDB1A5E4CL;
        Class312.field708[0] = l2 ^ 0xA99218FDB1A5E4DL;
    }

    public static Class925 method2548(Class312 class312) {
        return class312.field711;
    }

    public static void method2549(Class312 class312, Set set) {
    ...
    private static void method2551(Class312 class312, Set set) {
        Class312.method2549(class312, set);
    }

    @Class1
    public void method2552(Class63 c2) {
        if (c2.method128() == Class543.field2691) {
            if (!Class312.method2548(this).method12595(Float.valueOf(((Float)this.field709.method507()).floatValue() * Class1038.field4266))) {
                Class312.method2553(0.5469768f, 0.5654698f);
                return;
            }
            Set b2 = ((d)Class312.field290.field_1690).getPlayerModelParts();
            class_1664[] class_1664Array = class_1664.values();
            int n2 = class_1664Array.length;
            for (int i2 = (int)field708[0]; i2 < n2; ++i2) {
                class_1664 a2 = class_1664Array[i2];
                Class312.field290.field_1690.method_1631(a2, (((Boolean)this.field707.method507()).booleanValue() ? (Math.random() < 0.5 ? (int)field708[1] : (int)field708[0]) : (!b2.contains(a2) ? (int)field708[1] : (int)field708[0])) != 0);
            }
