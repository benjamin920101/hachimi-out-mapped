...
extends Class278 {
    ...
    private static Class248 method4452(AnvilRename class358) {
        return AnvilRename.method4465(class358);
    }
    ...
    private static int method4456(int n2, int n3, Class45 class45, Ping class359) {
    ...
    static {
        AnvilRename.method4461(5457029353613871877L);
    }
    ...
    public AnvilRename() {
        ...
        class_1792Array[(int)AnvilRename.field1129[3]] = class_1802.field_8463;
        class_1792Array[(int)AnvilRename.field1129[1]] = class_1802.field_8367;
        ...
        class_1792Array2[(int)AnvilRename.field1129[3]] = class_1802.field_8287;
    ...
    public static Class248 method4460(AnvilRename class358) {
        return class358.field1125;
    }

    private static void method4461(long l2) {
        AnvilRename.field1129[3] = l2 ^ 0x4BBB4348D708CB05L;
        AnvilRename.field1129[6] = l2 ^ 0x4BBB4348D708CB06L;
        AnvilRename.field1129[2] = l2 ^ 0x4BBB4348D708CB0FL;
        AnvilRename.field1129[5] = l2 ^ 0x4BBB4348D708CB22L;
        AnvilRename.field1129[1] = l2 ^ 0x4BBB4348D708CB04L;
        AnvilRename.field1129[4] = l2 ^ 0x4BBB4348D708CB07L;
        AnvilRename.field1129[0] = l2 ^ 0x4BBB4348D708CB61L;
    }
    ...
    public void method4462(Class210 e2) {
        String c2;
        void f2;
        if (AnvilRename.field290.field_1724 == null) return;
        if (AnvilRename.method4451(field290) == null) return;
        if (AnvilRename.field290.field_1761 == null) return;
        class_437 class_4372 = AnvilRename.field290.field_1755;
        ...
        AnvilRename.method4455(this.field1124);
        if (AnvilRename.method4478((class_310)AnvilRename.field290).field_7520 <= 0 && !AnvilRename.field290.field_1724.method_7337()) {
        ...
        String string = c2 = !((String)AnvilRename.method4477(this.field1128)).trim().isEmpty() ? (String)AnvilRename.method4473(this).method507() : "";
        if (!b2.method_7960()) {
            int n4 = !AnvilRename.method4481(this, b2, c2) ? 20410 : 20411;
            block14: while (true) {
                switch (n4) {
                    case 20411: {
                        n4 = 20409;
                    ...
                    case 20410: {
                        if (this.field1127.method507() == Class528.field2618 && ((List)AnvilRename.method4460(this).method507()).contains(b2.method_7909()) || this.field1127.method507() == Class528.field2621 && !((List)AnvilRename.method4452(this).method507()).contains(b2.method_7909())) break block14;
                        AnvilRename.field290.field_1761.method_2906(g2.field_7763, d2, (int)field1129[3], class_1713.field_7790, (class_1657)AnvilRename.method4471(field290));
                        AnvilRename.field290.field_1761.method_2906(g2.field_7763, g2.method_7611((int)((int)AnvilRename.field1129[3])).field_7874, (int)field1129[3], class_1713.field_7790, (class_1657)AnvilRename.method4459(field290));
                        ((class_471)AnvilRename.field290.field_1755).field_2821.method_1852(c2);
                        if (((Boolean)this.field1126.method507()).booleanValue()) {
                            this.method1250("Successfully renamed item in slot: " + d2 + ".");
                        }
                        AnvilRename.field290.field_1761.method_2906(g2.field_7763, g2.method_7611((int)((int)AnvilRename.field1129[4])).field_7874, (int)field1129[3], AnvilRename.method4480(), (class_1657)AnvilRename.field290.field_1724);
                        AnvilRename.field290.field_1761.method_2906(g2.field_7763, d2, (int)field1129[3], class_1713.field_7790, (class_1657)AnvilRename.method4463(field290));
                        return;
                    }
                }
                break;
    ...
    public static Class248 method4465(AnvilRename class358) {
    ...
    private static class_746 method4471(class_310 class_3102) {
        return AnvilRename.method4464(class_3102);
    }
    ...
    private void method4472(class_1706 c2, int d2) {
        if (AnvilRename.method4468(field290) == null) {
            return;
        }
        ...
        while (true) {
            ...
            if ((n3 = n2) == 55093) {
                ...
                AnvilRename.method4469(field290).method_2906(c2.field_7763, c2.method_7611((int)d2).field_7874, (int)field1129[3], AnvilRename.method4458(), (class_1657)AnvilRename.field290.field_1724);
                AnvilRename.method4474(field290).method_2906(c2.field_7763, b2, (int)field1129[3], class_1713.field_7790, (class_1657)AnvilRename.field290.field_1724);
                return;
            }
            if (n3 != 55094) {
                AnvilRename.field290.field_1761.method_2906(c2.field_7763, c2.method_7611((int)d2).field_7874, (int)field1129[3], class_1713.field_7795, (class_1657)AnvilRename.method4466(field290));
                return;
            }
            n2 = 55092;
        }
        AnvilRename.method4453(0.5389593f);
    }

    public static Class248 method4473(AnvilRename class358) {
    ...
    private static boolean method4481(AnvilRename class358, class_1799 class_17992, String string) {
