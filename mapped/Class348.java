...
extends Class278 {
    ...
    public static Map method3847(Class348 class348) {
    ...
    public static Class248 method3850(Class348 class348) {
    ...
    public static Class248 method3854(Class348 class348) {
    ...
    public void method3856(Class59 m2) {
        if (Class348.field290.field_1687 == null) {
            return;
        }
        int n2 = 16025;
    ...
    private static void method3858(long l2) {
        Class348.field1001[0] = l2 ^ 0x6DC8B4D8D87782B7L;
        Class348.field1001[4] = l2 ^ 0x6DC8B4D8D87781A0L;
        Class348.field1001[5] = l2 ^ 0x6DC8B4D8D8778249L;
        Class348.field1001[2] = l2 ^ 0x6DC8B4D8D8778248L;
        Class348.field1001[3] = l2 ^ 0x6DC8B4D8D8778274L;
        Class348.field1001[1] = l2 ^ 0x6DC8B4D8D8778280L;
    }
    ...
    private static int method3863(int n2, int n3, Class3666 class3666, Class418 class418) {
    ...
    private static Map method3866(Class348 class348) {
        return Class348.method3870(class348);
    }

    private void method3867(class_4587 a2, class_238 b2, int c2, int d2) {
        switch (Class348.method3861()[((Class570)((Object)Class348.method3862(Class348.method3850(this)))).ordinal()]) {
            case 1: {
    ...
    public String method1248() {
        class_3965 a2;
        if (Class348.method3869(field290) == null) {
            return super.method1248();
        }
        class_239 class_2392 = Class348.field290.field_1765;
        if (class_2392 instanceof class_3965 && Class348.field290.field_1687.method_8320((a2 = (class_3965)class_2392).method_17777()).method_26215()) {
            return super.method1248();
        }
    ...
    private static class_239 method3868(class_310 class_3102) {
        return Class348.method3855(class_3102);
    }
    ...
    public static Map method3870(Class348 class348) {
        return class348.field1002;
    }

    static {
        Class348.method3858(7910771588913922632L);
    }
