...
extends Class278 {
    ...
    public static Class248 method1886(Chams class298) {
    ...
    private static Freecam method1889() {
    ...
    public void method1890(Class59 l2) {
        ...
        for (Map.Entry e2 : new HashSet(this.field564.entrySet())) {
            ...
            int d2 = Chams.method1912(((Color)this.field563.method507()).getRGB(), b2);
            Class1567.method14628(l2.method125(), (class_742)e2.getKey(), ((Class1467)((Object)e2.getKey())).method14388(), Chams.method1998(l2), c2, d2, ((Float)Chams.method2000(Chams.method1956(this))).floatValue(), (this.field562.method507() != Class625.field3054 ? (int)field566[4] : (int)field566[3]) != 0, (boolean)field566[4], (boolean)field566[3]);
        }
        this.field564.entrySet().removeIf(Chams::method2002);
        Class6009.method23561();
        if (Chams.method1960(this.field562) == Class625.field3052) {
            return;
        }
        if (Shaders.method6202().method1265() && !((Boolean)Shaders.method6202().field1424.method507()).booleanValue()) {
            return;
        }
        if (((Boolean)this.field570.method507()).booleanValue()) {
            Chams.method1924();
        ...
        Iterator iterator = Chams.field290.field_1687.method_18112().iterator();
        while (true) {
            class_1297 k2;
            block21: {
                if (!iterator.hasNext()) {
                ...
                if (NoRender.method2481().method1265() && NoRender.method2481().method2445(k2)) {
                    Class1108.method12918(true);
                    return;
                }
                double g2 = Math.abs(Chams.field290.field_1773.method_19418().method_19326().field_1352 - k2.method_23317());
                double h2 = Math.abs(Chams.field290.field_1773.method_19418().method_19326().field_1350 - k2.method_23321());
                double i2 = ((Integer)Chams.field290.field_1690.method_42503().method_41753() + (int)field566[4]) * (int)field566[8];
                class_243 j2 = Freecam.method4718().method1265() ? Chams.method1982(Chams.method1943()) : Chams.method1958(field290).method_19538();
                if (j2.method_1025(k2.method_19538()) > Chams.method1929((Class252)this.field559) || g2 > i2 || h2 > i2 || !Chams.method1964(k2.method_5829())) continue;
                ...
                if (!(k2 instanceof class_1511) || !((Boolean)Chams.method1983(this).method507()).booleanValue()) continue;
            }
            if (((Boolean)Chams.method2007(this.field573)).booleanValue()) {
                while (true) {
                    // Infinite loop
                }
            }
    ...
    public static Class248 method1892(Chams class298) {
        return class298.field570;
    }

    private Boolean method1893() {
        return (((Boolean)Chams.method1886(this).method507()).booleanValue() && Chams.method1984(Chams.method1957(this)) != Class625.field3052 ? (int)field566[4] : (int)field566[3]) != 0;
    }
    ...
    public void method1903(Class156 a2) {
        if (Chams.method1923(this).method507() == Chams.method1927() && Chams.method1942(this, a2.method310())) {
            a2.method10();
        }
    }
    ...
    private static float method1906(Class56 class56) {
        return Chams.method1947(class56);
    }
    ...
    private static boolean method1908(Chams class298, class_1309 class_13092) {
    ...
    public static Chams method1913() {
        return INSTANCE;
    }
    ...
    static {
        ...
        Chams.method2001(-6388171171131631102L);
    }
    ...
    private static void method1921(Chams class298, class_4587 class_45872, class_1297 class_12972, float f2, int n2, int n3) {
    ...
    public static Class248 method1923(Chams class298) {
    ...
    public static Class248 method1926(Chams class298) {
        return class298.field571;
    }

    private static Class625 method1927() {
        return Chams.method1883();
    }
    ...
    private static class_1309 method1930(Class56 class56) {
        return Chams.method1925(class56);
    }
    ...
    private static class_8080 method1932(class_1309 class_13092) {
        return Chams.method1988(class_13092);
    }
    ...
    public void method1935(Class60 c2) {
        if (Chams.method1978(this.field562) != Class625.field3052) {
            int n2 = 3186;
            Class6009.method23561();
            return;
        }
        ...
        if (((Boolean)Chams.method1916(Chams.method1892(this))).booleanValue()) {
            Chams.method1924();
            Class6009.method23559(false);
            return;
        }
        Class6009.method23560();
        if (((Boolean)Chams.method1969(this).method507()).booleanValue()) {
            int a2 = ((Color)Chams.method1996(this.field571)).getRGB();
            int b2 = Class4045.method20093(a2, (int)field566[9]);
            Class1567.method14605(c2.method125(), c2.method124(), b2, a2, ((Float)Chams.method1931(this.field567)).floatValue(), (this.field562.method507() == Chams.method1971() ? (int)field566[3] : (int)field566[4]) != 0, (this.field562.method507() != Class625.field3057 ? (int)field566[4] : (int)field566[3]) != 0, (boolean)field566[3]);
        }
        Class6009.method23561();
    }
    ...
    public static Class248 method1937(Chams class298) {
        return class298.field562;
    }
    ...
    public void method1941(Class20 a2) {
        ...
        block4: while (true) {
            switch (n2) {
                ...
                case 63774: {
                    if ((Boolean)Chams.method1987(this.field572) != false) return;
                    a2.method10();
                    return;
                }
            }
    ...
    private static boolean method1942(Chams class298, class_1309 class_13092) {
        return class298.method1944(class_13092);
    }

    private Boolean method1269() {
        if (Chams.method1948(this.field562) == Class625.field3054) {
    ...
    private static Freecam method1943() {
        return Freecam.method4718();
    }
    ...
    public boolean method1944(class_1309 a2) {
        ...
        if (a2 instanceof class_1657) {
            int n3;
            if (a2 != Chams.method1939(field290)) return (Boolean)Chams.method1962(this).method507();
            if (((Boolean)this.field576.method507()).booleanValue() && (!Chams.field290.field_1690.method_31044().method_31034() || Chams.method1889().method1265())) {
                n3 = (int)field566[4];
                return n3 != 0;
            }
            n3 = (int)field566[3];
        ...
        if (Chams.method1940((class_1297)a2) && ((Boolean)this.field565.method507()).booleanValue() || (Chams.method1884((class_1297)a2) || Class1158.method13110((class_1297)a2)) && ((Boolean)this.field569.method507()).booleanValue()) {
            n2 = (int)field566[4];
            return n2 != 0;
        }
        n2 = (int)field566[3];
    ...
    private static class_1309 method1945(Class56 class56) {
        return Chams.method1976(class56);
    }
    ...
    public static Class248 method1956(Chams class298) {
        return class298.field567;
    }

    public static Class248 method1957(Chams class298) {
        return class298.field562;
    }
    ...
    private static int method1959(int n2, int n3, Class628 class628, Blink class376) {
    ...
    public static Class248 method1962(Chams class298) {
    ...
    public static Class248 method1969(Chams class298) {
                            ...
                            block23: {
                                block16: {
                                    block22: {
                                        block20: {
                                            block18: {
                                                block19: {
                                                    ...
                                                    if (Chams.field290.field_1724 == null) break block18;
                                                ...
                                                if (Chams.method1908(this, f.field76) && !(Chams.field290.field_1724.method_5858((class_1297)Chams.method1961(f)) > ((Class252)this.field559).method564())) break block20;
                                            }
                                            return;
                                        }
                                        f.method10();
                                        ...
                                        f.field75.field_3449 = Chams.method1930(f).method_5765();
                                        Chams.method1992((Class56)f).field_3448 = f.field76.method_6109();
                                        h = class_3532.method_17821((float)f.field78, (float)f.field76.field_6220, (float)f.field76.field_6283);
                                        i = class_3532.method_17821((float)Chams.method1991(f), (float)f.field76.field_6259, (float)Chams.method1896((Class56)f).field_6241);
                                        j = i - h;
                                        if (!f.field76.method_5765() || !((var5_5 = f.field76.method_5854()) instanceof class_1309)) break block21;
                                        b = (class_1309)var5_5;
                                        h = class_3532.method_17821((float)Chams.method1906(f), (float)b.field_6220, (float)b.field_6283);
                                        j = i - h;
...
lbl32:
                        ...
                        k = class_3532.method_16439((float)f.field78, (float)f.field76.field_6004, (float)Chams.method1945(f).method_36455());
                        if (class_922.method_38563((class_1309)f.field76)) {
                            k *= -1.0f;
                            j *= -1.0f;
                        }
                        if (Chams.method1914(f).method_41328(class_4050.field_18078)) {
                        ...
                        if (f.field76 instanceof class_1657) {
                            Class1567.method14579((class_742)Chams.method1891(f), f.field77, l, h, f.field78);
                        } else {
                            Class1567.method14747(f.field76, Chams.method1951(f), l, h, f.field78);
                        }
                        ...
                        m = Chams.method1932(f.field76).method_48572(f.field78);
...
lbl76:
        ...
        if (!f.field76.method_7325()) {
            for (E e : f.field81) {
                ((class_3887)e).method_4199(f.field77, f.field82, f.field73, (class_1297)Chams.method1977(f), m, g, f.field78, l, j, k);
            }
        }
    ...
    private static class_243 method1982(Freecam class365) {
        return class365.method4722();
    }

    public static Class248 method1983(Chams class298) {
    ...
    private Boolean method1278() {
        return (Chams.method1937(this).method507() != Chams.method1975() ? (int)field566[4] : (int)field566[3]) != 0;
    }
    ...
    public void method1995(Class80 a2) {
        if (this.field562.method507() == Chams.method1915()) {
            return;
        }
        if (!(Chams.field290.field_1724 == null || ((Boolean)this.field572.method507()).booleanValue() && ((Boolean)Chams.method1968(this.field573)).booleanValue())) {
            if (((Boolean)this.field568.method507()).booleanValue() && Chams.field290.field_1724.method_5858((class_1297)a2.field115) <= ((Class252)this.field559).method564()) {
                a2.method10();
            }
        }
    }
    ...
    public void method1999(class_4587 a2, class_1297 b2, float c2) {
        int d2 = ((Color)Chams.method1926(this).method507()).getRGB();
        int e2 = Class4045.method20093(d2, (int)field566[9]);
        Chams.method1921(this, a2, b2, c2, d2, e2);
    }
    ...
    private static void method2001(long l2) {
        Chams.field566[8] = l2 ^ 0xA758A82A744EDA12L;
        Chams.field566[9] = l2 ^ 0xA758A82A744EDA93L;
        Chams.field566[0] = l2 ^ 0xA758A82A744ED1BAL;
        Chams.field566[5] = l2 ^ 0xA758A82A744EDA3EL;
        Chams.field566[6] = l2 ^ 0xA758A82A744E5A06L;
        Chams.field566[3] = l2 ^ 0xA758A82A744EDA02L;
        Chams.field566[7] = l2 ^ 0xA758A82A744ED900L;
        Chams.field566[4] = l2 ^ 0xA758A82A744EDA03L;
        Chams.field566[10] = l2 ^ 0xA758A82A744EDA21L;
        Chams.field566[1] = l2 ^ 0xA758A82A744EDAFDL;
        Chams.field566[2] = l2 ^ 0xA758A82A744ED9EAL;
    }

    private static boolean method2002(Map.Entry a2) {
        return (Chams.method1994((Class6283)a2.getValue()) == 0.0 ? (int)field566[4] : (int)field566[3]) != 0;
    }
    ...
    public void method2004(Class133 f2) {
        class_2663 e2;
        if (Chams.field290.field_1687 == null) {
            return;
        }
        ...
        if (class_25962 instanceof class_2663 && (e2 = (class_2663)class_25962).method_11470() == (int)field566[10] && ((Boolean)this.field575.method507()).booleanValue()) {
            void c2;
            class_1297 b2 = e2.method_11469((class_1937)Chams.field290.field_1687);
            if (b2 == Chams.field290.field_1724 || !(b2 instanceof class_1657)) {
                return;
            }
