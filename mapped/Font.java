...
extends Class278 {
    ...
    public boolean method1837() {
        return (Boolean)Font.method1845(this.field549);
    }

    public Class626 method1838() {
        return (Class626)((Object)Font.method1854(this.field547));
    }

    private static void method1839(long l2) {
        Font.field546[4] = l2 ^ 0x4B82BA0399B6A124L;
        Font.field546[1] = l2 ^ 0x4B82BA0399B6A125L;
        Font.field546[2] = l2 ^ 0x4B82BA0399B6A129L;
        Font.field546[3] = l2 ^ 0x4B82BA0399B6A120L;
        Font.field546[0] = l2 ^ 0x4B82BA0399B6A12CL;
    }
    ...
    public static Class248 method1841(Font class296) {
    ...
    public void method1844(Class63 a2) {
        if (a2.method128() == Class543.field2690) {
            if (Class5836.field11397 != (float)((Integer)Font.method1841(this).method507()).intValue()) {
                Class5836.method22907(((Integer)Font.method1848(this.field553)).intValue());
            }
        }
    }
    ...
    public static Class248 method1852(Font class296) {
    ...
    static {
        Font.method1842(5441115824443531557L);
    }

    public static Font method1855() {
        return INSTANCE;
    }
    ...
    public void method1856(Class68 a) {
        block6: {
            block7: {
                ...
                if (a.method140() != Font.method1852(this)) break block7;
                v0 = 50910;
                ** GOTO lbl13
            }
            v0 = 50911;
