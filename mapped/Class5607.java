...
public class Class5607 {
    public static int method21972(int n2, int n3, Class3989 class3989, Class401 class401) {
        int n4 = n3;
    ...
    public static int method21976(int n2, int n3, Class614 class614, Class449 class449) {
        int n4 = n2;
        return (n4 | 0x2577CD0D) & (0xDA8832F2 | ~n4);
    }

    public static int method21977(int n2, int n3, Class284 class284, Class110 class110) {
