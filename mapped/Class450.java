...
extends Class278 {
    ...
    private void method10363(boolean a2, String b2, class_1657 c2) {
        ...
        Class450.method10367("\u00a7s[VisualRange] " + string + b2 + "\u00a7f entered your visual range", c2.hashCode() + this.hashCode() + (int)field2340[6]);
    }
    ...
    public void method10371(Class221 a2) {
        ...
        int b2 = Class450.method10413(Class5723.field11040, (class_1297)a2.method412());
        if (b2 == 0) {
            return;
        }
        String c2 = a2.method412().method_5477().getString();
        boolean d2 = Class450.method10388(Class5723.field11045, c2);
        if ((!d2 || ((Boolean)this.field2343.method507()).booleanValue()) && a2.method412() != Class450.field290.field_1724) {
            if (!d2) {
    ...
    public static Class248 method10372(Class450 class450) {
    ...
    private static int method10378(int n2, int n3, Class408 class408, Class376 class376) {
    ...
    public void method10380(Class22 e2) {
        if (((Boolean)Class450.method10372(this).method507()).booleanValue()) {
            class_1657 c2;
            class_1297 d2;
            if (((Boolean)Class450.method10397(this).method507()).booleanValue() && (d2 = Class450.field290.field_1687.method_8469(e2.method46().method_11820())) instanceof class_1657 && ((Class1150)(c2 = (class_1657)d2)).method12984()) {
                if (Class5659.method22180((class_1309)c2)) {
                    Class450.method10361();
                    return;
                }
                ...
                if (((Boolean)Class450.method10411(this.field2342)).booleanValue()) {
    ...
    private static void method10381(long l2) {
        Class450.field2340[1] = l2 ^ 0x4770568DFB949B9AL;
        Class450.field2340[5] = l2 ^ 0x4770568DFB949BFDL;
        Class450.field2340[3] = l2 ^ 0x4770568DFB949B99L;
        Class450.field2340[6] = l2 ^ 0x4770568DFB949B98L;
        Class450.field2340[0] = l2 ^ 0x4770568DFB949B9BL;
        Class450.field2340[2] = l2 ^ 0x4770568DFB949B8FL;
        Class450.field2340[4] = l2 ^ 0x4770568DFB949BB8L;
    }
    ...
    static {
        Class450.method10381(5147709541895674779L);
    }
    ...
    public void method10394(Class133 m2) {
        ...
        Object object;
        class_2596 a2;
        if (Class450.method10398(field290) == null) return;
        if (Class450.field290.field_1687 == null) {
            return;
        }
            ...
            block14: while (true) {
                switch (n2) {
                    ...
                    case 2644: {
                        ...
                        a2 = e2.method_11469((class_1937)Class450.field290.field_1687);
        ...
        if ((a2 = m2.method251()) instanceof class_2703) {
            ...
            int n3 = (Boolean)Class450.method10391(this.field2345) != false ? 6213 : 6214;
            block15: while (true) {
                switch (n3) {
                    case 6214: {
                        n3 = 6212;
                    ...
                    case 6213: {
                        int n4 = f2.method_46327().contains(Class450.method10410()) ? 28645 : 28646;
                        block16: while (true) {
                            switch (n4) {
                                case 28646: {
                                    n4 = 28644;
                                ...
                                case 28645: {
                                    if (Class450.method10386((class_310)Class450.field290).field_6012 >= (int)field2340[2]) break block16;
                                }
                                default: {
                                    return;
                                }
                        ...
                        f2.method_46329().stream().filter(Class450::method10409).filter(Class450::method10401).forEach(this::method10417);
                        break block15;
                    }
                }
                break;
    ...
    public void method10396(Class117 a2) {
        if (((Boolean)Class450.method10402(this.field2344)).booleanValue() && !field290.method_1542() && Class450.method10377(Class5723.field11056)) {
            Class1365.method13948("This server is running GrimAC", (int)field2340[5]);
        }
    }

    public static Class248 method10397(Class450 class450) {
        ...
        block13: {
            block12: {
                block11: {
                    ...
                    d2 = Class450.method10364(b2).method_5477().getString();
                    e2 = Class5723.field11045.method21233(d2);
                    if (!e2) break block11;
                    if (!((Boolean)Class450.method10379(this.field2343)).booleanValue()) break block12;
                }
                if (b2.method322() != Class450.field290.field_1724) break block13;
            }
            return;
        }
        if (((Boolean)Class450.method10405(this.field2346)).booleanValue()) {
            ((Class1150)b2.method322()).method12985((boolean)field2340[1]);
        } else {
            void c2;
            field290.method_40000(() -> this.method10390(e2, d2, (class_1657)c2));
            if (((Boolean)Class450.method10382(this.field2342)).booleanValue()) {
                Class5723.field11041.method22448(Class5693.field10946);
            }
        }
    }
    ...
    private static int method10406(int n2, int n3, Class3332 class3332, Class452 class452) {
    ...
    private void method10417(class_2703.class_2705 b2) {
        ...
        if (c2 != null) {
            ...
            if (!((Boolean)Class450.method10416(this.field2343)).booleanValue()) {
                if (a2) {
                    return;
                }
            }
