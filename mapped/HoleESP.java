...
extends Class278 {
    ...
    private static Class248 method2566(HoleESP class315) {
        return HoleESP.method2601(class315);
    }
    ...
    private static void method2571(long l2) {
        HoleESP.field716[3] = l2 ^ 0x4C543109AC1BCCD7L;
        HoleESP.field716[2] = l2 ^ 0x4C543109AC1BCC87L;
        HoleESP.field716[5] = l2 ^ 0x4C543109AC1BCDABL;
        HoleESP.field716[1] = l2 ^ 0x4C543109AC1BCC78L;
        HoleESP.field716[6] = l2 ^ 0x4C543109AC1BCC86L;
        HoleESP.field716[0] = l2 ^ 0x4C543109AC1BCC0BL;
        HoleESP.field716[4] = l2 ^ 0x4C543109AC1BCF6FL;
    }
    ...
    private static boolean method2572(Class6259 a2, Class6259 b2) {
        block5: {
            block4: {
                ...
                if (HoleESP.method2600(b2) != a2.method24243()) break block4;
                if (b2.method24233() != HoleESP.method2596(a2)) break block4;
    ...
    public static Class248 method2573(HoleESP class315) {
        return class315.field724;
    }

    public static HoleESP method2574() {
        return INSTANCE;
    }
    ...
    public static Class248 method2581(HoleESP class315) {
    ...
    static {
        field716 = new long[7];
        HoleESP.method2571(5500074962538187911L);
    }
    ...
    public static HoleESP method2586() {
        return HoleESP.method2574();
    }
    ...
    private static Class248 method2594(HoleESP class315) {
        return HoleESP.method2581(class315);
    }

    private static boolean method2595(HoleESP class315, Set set, Class6259 class6259) {
    ...
    public void method2598(Class59 i) {
        if (HoleESP.field290.field_1724 == null) {
            return;
        }
        for (Class6259 b : HoleESP.method2580(Class5723.field11042)) {
            if (HoleESP.method2595(this, this.field723.keySet(), b)) continue;
            a = new Class6283((boolean)HoleESP.field716[2], ((Integer)this.field720.method507()).intValue());
                ...
                block8: {
                    block11: {
                        block9: {
                            ...
                            d = c.method24223((class_1297)HoleESP.field290.field_1724);
                            if (!(d > ((Class252)this.field715).method564())) break block9;
                            ((Class6283)h.getValue()).method24284((boolean)HoleESP.field716[2]);
                            break block10;
                        }
                        if (!((Boolean)this.field718.method507()).booleanValue()) break block8;
                        if (!HoleESP.field290.field_1724.method_5829().method_994(c.method24228(Class839.field3675))) break block11;
                        v0 = 20888;
                        ** GOTO lbl26
                    }
                    v0 = 20889;
...
lbl26:
                ...
                if (c.method24233() && !((Boolean)HoleESP.method2583(HoleESP.method2602(this))).booleanValue()) {
                    Class1108.method12918(false);
                    return;
                }
                if (HoleESP.method2597(c) == Class537.field2656 && !((Boolean)this.field714.method507()).booleanValue()) ** GOTO lbl-1000
                if (c.method24222() == Class537.field2659 && !((Boolean)HoleESP.method2566(this).method507()).booleanValue() || c.method24222() == Class537.field2660 && !((Boolean)this.field717.method507()).booleanValue()) lbl-1000:
                // 3 sources
            ...
            g = (int)(Class1531.field5771 * HoleESP.method2605((Class6283)h.getValue()));
    ...
    private Boolean method1278() {
        return (Boolean)HoleESP.method2582(this.field717);
    }

    public static Class248 method2601(HoleESP class315) {
        return class315.field730;
    }

    public static Class248 method2602(HoleESP class315) {
    ...
    private int method2603(Class537 a2, int b2) {
        return switch (Class966.field4034[a2.ordinal()]) {
            ...
            case 3 -> HoleESP.method2578((Class251)this.field728, b2);
            case 4 -> HoleESP.method2590((Class251)this.field726, b2);
        };
    }

    private boolean method2604(Set a2, Class6259 b2) {
        return a2.stream().anyMatch(arg_0 -> HoleESP.method2572(b2, arg_0));
    }
    ...
    private void method2608(class_4587 a2, Class6259 b2, int c2, int d2) {
        class_238 e2 = b2.method24228(((Float)HoleESP.method2567(HoleESP.method2573(this))).floatValue());
        Class6454.method24621(a2, e2, c2);
        if (((Boolean)HoleESP.method2585(HoleESP.method2594(this))).booleanValue()) {
            Class6454.method24605(a2, e2, 1.5f, d2);
        }
        if (((Boolean)this.field725.method507()).booleanValue()) {
            HoleESP.method2576(a2, e2, 2.0f, d2);
        }
    }
