...
public class Swing
extends Class278 {
    Class248 field655 = this.method450(new Class260("Hand", "The player swinging hand", Class622.field3038, Swing.method2408()));
    ...
    static {
        Swing.method2404(-8717282300588390475L);
    }
    ...
    public static class_1268 method2390(Swing class309) {
        return class309.field656;
    }

    private static class_1268 method2391() {
        return Swing.method2396();
    }
    ...
    public int method2394() {
        if (class_1292.method_5576((class_1309)Swing.field290.field_1724)) {
            return (int)field657[3] - ((int)field657[2] + class_1292.method_5575((class_1309)Swing.field290.field_1724));
        }
        return Swing.field290.field_1724.method_6059(class_1294.field_5901) ? (int)field657[3] + ((int)field657[2] + Swing.field290.field_1724.method_6112(class_1294.field_5901).method_5578()) * (int)field657[1] : (int)field657[3];
    }
    ...
    public static Swing method2398() {
        return INSTANCE;
    }
    ...
    private static class_746 method2401(class_310 class_3102) {
        return Swing.method2388(class_3102);
    }
    ...
    public static class_1268 method2403(Swing class309) {
        return class309.field658;
    }

    private static void method2404(long l2) {
        Swing.field657[2] = l2 ^ 0x8705FDEF0AA107B4L;
        Swing.field657[0] = l2 ^ 0x8705FDEF0AA107B5L;
        Swing.field657[1] = l2 ^ 0x8705FDEF0AA107B7L;
        Swing.field657[3] = l2 ^ 0x8705FDEF0AA107B3L;
    }

    public static Class248 method2405(Swing class309) {
    ...
    public void method1279() {
        int n2 = Swing.method2401(field290) != null ? 51858 : 51859;
        block4: while (true) {
            switch (n2) {
                case 51859: {
                    n2 = 51857;
                ...
                case 51858: {
                    Swing.field290.field_1724.field_6266 = this.field656;
                    return;
                }
            }
            break;
    ...
    public void method1274() {
        if (Swing.field290.field_1724 != null) {
            this.field656 = Swing.field290.field_1724.field_6266;
            if (this.field655.method507() != Class622.field3040) {
                this.method2415((Class622)((Object)Swing.method2405(this).method507()));
            }
        }
    }
    ...
    public static Swing method2410() {
        return Swing.method2398();
    }

    public class_1268 method2411() {
        return Swing.method2390(this);
    }
    ...
    private void method2415(Class622 a2) {
        block11: {
            ...
            block8: {
                    ...
                    block10: {
                        block7: {
                            switch (a2.ordinal() ^ 0x1B761C3B) {
                                ...
                                case 460725305: {
                                    Swing.method2407(Class1456.field5540, 0.31164652f);
                                    return;
                                }
                                case 460725306: {
                                    break block9;
                ...
                class_12682 = Swing.method2391();
                break block11;
            }
            Swing.method2406((class_310)Swing.field290).field_6279 = (int)field657[0];
            Swing.field290.field_1724.field_6252 = (int)field657[0];
            class_12682 = this.field658 = null;
        }
        if (this.field658 != null) {
            Swing.field290.field_1724.field_6266 = this.field658;
        }
    }
