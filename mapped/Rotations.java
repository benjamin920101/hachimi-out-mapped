...
extends Class451 {
    ...
    public boolean method10600() {
        return (Boolean)Rotations.method10609(this).method507();
    }

    public Class522 method10601() {
        return (Class522)((Object)Rotations.method10608(this.field2410));
    }

    public static Rotations method10602() {
        return INSTANCE;
    }

    private static void method10603(long l2) {
        Rotations.method10611(l2);
    }

    private static Disabler method10604() {
        return Disabler.method5496();
    }

    private static boolean method10605(Disabler class390) {
    ...
    public static Class248 method10606(Rotations class456) {
    ...
    public boolean method10607() {
        int n2;
        if (!(!((Boolean)this.field2408.method507()).booleanValue() || Rotations.method10604().method1265() && Rotations.method10605(Disabler.method5496()))) {
            n2 = (int)field2406[1];
            return n2 != 0;
        }
        n2 = (int)field2406[0];
    ...
    public static Class248 method10609(Rotations class456) {
        return class456.field2407;
    }

    public Class632 method10610() {
        return (Class632)((Object)Rotations.method10606(this).method507());
    }

    private static void method10611(long l2) {
        Rotations.field2406[0] = l2 ^ 0x6E523B33E1E756A5L;
        Rotations.field2406[1] = l2 ^ 0x6E523B33E1E756A4L;
    }
    ...
    public static CallSite uSwajv4i6j8GDmBG(MethodHandles.Lookup lookup, String string, MethodType methodType, String string2, String string3, String string4, Integer n2) {
        ...
        int n3 = n2;
        MethodType methodType2 = MethodType.fromMethodDescriptorString(Rotations.Nih6eDuq5Blyzh6z(string7), Rotations.class.getClassLoader());
        try {
            if (n3 == 1) {
                return new ConstantCallSite(lookup.findVirtual(Class.forName(Rotations.Nih6eDuq5Blyzh6z(string5)), Rotations.Nih6eDuq5Blyzh6z(string6), methodType2).asType(methodType));
            }
            return new ConstantCallSite(lookup.findStatic(Class.forName(Rotations.Nih6eDuq5Blyzh6z(string5)), Rotations.Nih6eDuq5Blyzh6z(string6), methodType2).asType(methodType));
        }
    ...
    static {
        Rotations.method10603(7949481386281752229L);
    }
