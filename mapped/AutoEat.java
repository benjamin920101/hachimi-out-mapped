...
extends Class278 {
    ...
    private static int method4681(int n2, int n3, AutoMount class324, Class3432 class3432) {
    ...
    public void method1279() {
        ((Class6188)AutoEat.method4694(AutoEat.field290.field_1690)).method24106();
    }
    ...
    private static void method4684(long l2) {
        AutoEat.field1178[1] = l2 ^ 0x6BA9646758C051EBL;
        AutoEat.field1178[0] = l2 ^ 0x94569B98A73FAE15L;
        AutoEat.field1178[3] = l2 ^ 0x94569B98A73FAE1DL;
        AutoEat.field1178[2] = l2 ^ 0x94569B98A73FAE39L;
        AutoEat.field1178[4] = l2 ^ 0x94569B98A73FAE14L;
    }

    static {
        AutoEat.method4692(-7757842228155797996L);
    }
    ...
    public void method4686(Class63 b2) {
        class_1702 c2 = AutoEat.field290.field_1724.method_7344();
        if ((float)c2.method_7586() <= ((Float)AutoEat.method4682(this.field1179)).floatValue()) {
            int a2 = this.method4689();
            if (a2 == (int)field1178[1]) {
                return;
            }
            if (a2 == (int)field1178[2]) {
                AutoEat.field290.field_1724.method_6019(AutoEat.method4683());
            } else {
                Class5723.field11058.method18931(a2);
            }
            AutoEat.method4679(AutoEat.field290.field_1690).method_23481((boolean)field1178[0]);
        } else {
            ((Class6188)AutoEat.field290.field_1690.field_1904).method24106();
        }
    }
    ...
    public int method4689() {
        ...
        block8: while (true) {
            ...
            block9: while (true) {
                switch (n2) {
                    ...
                    case 18596: {
                        class_1799 b2 = AutoEat.field290.field_1724.method_31548().method_5438(c2);
        ...
        class_1799 g2 = AutoEat.field290.field_1724.method_6079();
