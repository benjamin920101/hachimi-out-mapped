...
extends Class278 {
    ...
    private static class_2596 method5361(int a2) {
        return new class_2886(FastPlace.field290.field_1724.method_6058(), a2, FastPlace.field290.field_1724.method_36454(), FastPlace.field290.field_1724.method_36455());
    }
    ...
    public void method5365(Class63 a2) {
        ...
        if (!FastPlace.field290.field_1690.field_1904.method_1434()) {
            FastPlace.method5368(this).method12593();
            return;
        }
        if (!this.field1320.method12601((Number)this.field1319.method507(), TimeUnit.SECONDS)) {
            return;
        }
        if (((bh)field290).hookGetItemUseCooldown() <= (Integer)FastPlace.method5371(this.field1315)) return;
        int n2 = this.method5370(FastPlace.field290.field_1724.method_6047()) ? 64240 : 64241;
        block4: while (true) {
            switch (n2) {
                case 64241: {
                    n2 = 64239;
                ...
                case 64240: {
                    if (((Boolean)FastPlace.method5381(this).method507()).booleanValue()) {
                        FastPlace.method5377().method21353(FastPlace::method5361);
                    }
                    ((bh)field290).hookSetItemUseCooldown((Integer)FastPlace.method5369(this.field1315));
                    return;
                }
            }
            break;
    ...
    private static class_746 method5366(class_310 class_3102) {
        return FastPlace.method5373(class_3102);
    }
    ...
    public static Class926 method5368(FastPlace class386) {
    ...
    static {
        FastPlace.method5384(5628064618298026047L);
    }
    ...
    public FastPlace() {
        ...
        class_1792Array[(int)FastPlace.field1316[2]] = class_1802.field_8287;
        class_1792Array[(int)FastPlace.field1316[0]] = class_1802.field_8543;
        class_1792Array[(int)FastPlace.field1316[1]] = class_1802.field_8803;
        ...
        class_1792Array2[(int)FastPlace.field1316[2]] = class_1802.field_8634;
        class_1792Array2[(int)FastPlace.field1316[0]] = class_1802.field_8449;
    ...
    public static Class248 method5381(FastPlace class386) {
    ...
    public void method5383(Class131 c2) {
        if (FastPlace.field290.field_1724 == null || FastPlace.field290.field_1687 == null) {
            return;
        }
        ...
        if (class_25962 instanceof class_2885) {
            ...
            if (((Boolean)this.field1317.method507()).booleanValue() && !c2.method252()) {
                if (!this.method5370(FastPlace.method5366(field290).method_5998(b2.method_12546()))) {
                    Class6009.method23560();
                    return;
                }
                class_2680 a2 = FastPlace.field290.field_1687.method_8320(b2.method_12543().method_17777());
    ...
    private static void method5384(long l2) {
        FastPlace.field1316[2] = l2 ^ 0x4E1AE6F39A99283FL;
        FastPlace.field1316[1] = l2 ^ 0x4E1AE6F39A99283DL;
        FastPlace.field1316[0] = l2 ^ 0x4E1AE6F39A99283EL;
        FastPlace.field1316[4] = l2 ^ 0x4E1AE6F39A99283BL;
        FastPlace.field1316[3] = l2 ^ 0x4E1AE6F39A99283CL;
    }
