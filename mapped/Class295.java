...
extends Class278 {
    ...
    private static Class295 INSTANCE;
    Class248 field540;
    Class248 field541;
    ...
    private static void method1779(long l2) {
        Class295.field543[4] = l2 ^ 0xB34F2863ECBB551CL;
        Class295.field543[1] = l2 ^ 0xB34F2863ECBB551EL;
        Class295.field543[5] = l2 ^ 0xB34F2863ECBB55E1L;
        Class295.field543[3] = l2 ^ 0xB34F2863ECBB551DL;
        Class295.field543[2] = l2 ^ 0x4CB0D79C1344AAE1L;
        Class295.field543[0] = l2 ^ 0xB34F2863ECBB551FL;
    }
    ...
    public static Map method1784(Class295 class295) {
    ...
    public void method1786(Class133 c2) {
        if (Class295.method1788(field290) == null || !((Boolean)this.field545.method507()).booleanValue()) {
            return;
        }
    ...
    static {
        field543 = new long[6];
        Class295.method1779(-5526153808121735906L);
    }
    ...
    public static Map method1794(Class295 class295) {
    ...
    public void method1279() {
        Class295.method1820().method20247();
        Class295.method1810(this).clear();
        this.field539.clear();
    }
    ...
    public void method1798(Class59 d) {
        if (Class295.field290.field_1724 == null || Class295.field290.field_1687 == null) {
            return;
        }
        Class6009.method23560();
        block0: for (Class243 a : Class5723.field11046.method20254()) {
            v0 = a.method445();
            v1 = Class295.field290.method_1542() ? "Singleplayer" : Class5723.field11048.method21362();
...
lbl16:
    ...
    public static Class295 method1800() {
        return INSTANCE;
    }
    ...
    public void method1806(Class63 b2) {
        ...
        for (class_1657 a2 : Class295.field290.field_1687.method_18456()) {
            if (a2 == null || a2.equals((Object)Class295.field290.field_1724)) continue;
            this.field542.put(a2.method_7334().getId(), a2);
        }
    }

    private static int method1807(int n2, int n3, Class433 class433, Class629 class629) {
    ...
    private void method1808(class_4587 a2, class_243 b2, String c2, boolean d2) {
        ...
        Class6454.method24605(a2, e2, 1.5f, Class457.method10620().method10615((int)field543[5]));
        int g2 = (int)Math.sqrt(Class295.field290.field_1724.method_5707(b2));
        if (((Boolean)this.field540.method507()).booleanValue()) {
            Object[] objectArray = new Object[(int)field543[3]];
            objectArray[(int)Class295.field543[1]] = field395.format(b2.method_10216());
            objectArray[(int)Class295.field543[0]] = field395.format(b2.method_10214());
            objectArray[(int)Class295.field543[4]] = field395.format(b2.method_10215());
        ...
        if (((Boolean)this.field541.method507()).booleanValue()) {
            ...
            objectArray[(int)Class295.field543[1]] = g2;
            string = String.format(" %sm", objectArray);
        } else {
            string = "";
        }
        String h2 = "\u00a77" + c2 + string2 + string;
        Class6454.method24616(h2, e2.field_1323 + f2, Class295.method1822(e2) + 0.4, e2.field_1321 + f2, (int)field543[2]);
    }
    ...
    public void method1809(Class221 b2) {
        if (b2.method412() instanceof class_746 && ((Boolean)this.field544.method507()).booleanValue()) {
            ...
            Class295.method1834(Class5723.field11046, new Class243("Last Death", a2, Class5550.method21885(), Class295.field290.field_1724.method_23317(), Class295.method1802(field290).method_23318(), Class295.method1804(field290).method_23321()));
        }
    }

    public static Map method1810(Class295 class295) {
        return class295.field542;
    }
    ...
    private static int method1819(int n2, int n3, Class32 class32, Class437 class437) {
    ...
    public void method1825(class_2596 h2) {
        ...
        if (h2 instanceof class_7828) {
            block11: {
                ...
                Iterator iterator = Class295.method1794(this).keySet().iterator();
                if (iterator.hasNext()) {
                    ...
                    if (!Class295.method1784(this).containsKey(e2)) {
