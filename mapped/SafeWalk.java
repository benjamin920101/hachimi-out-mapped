...
extends Class278 {
    ...
    public boolean method4758(double a2, double b2, double c2) {
        class_238 d2 = SafeWalk.method4784(field290).method_5829();
        class_238 e2 = new class_238(d2.field_1323, d2.field_1322, d2.field_1324, d2.field_1320, d2.field_1322 + 0.5, d2.field_1324);
        return (!SafeWalk.method4768((class_1297)SafeWalk.field290.field_1724, e2.method_989(a2, b2, c2)) ? (int)field1191[1] : (int)field1191[0]) != 0;
    }

    private static void method4759(long l2) {
        SafeWalk.field1191[0] = l2 ^ 0xB9D34B3CE454D10FL;
        SafeWalk.field1191[1] = l2 ^ 0xB9D34B3CE454D10EL;
    }
    ...
    public boolean method4762() {
        return (!((Boolean)this.field1192.method507()).booleanValue() || Velocity.method10252() ? (int)field1191[1] : (int)field1191[0]) != 0;
    }
    ...
    private static boolean method4764(SafeWalk class366, double d2, double d3, double d4) {
    ...
    static {
        SafeWalk.method4759(-5056615231706050289L);
    }
    ...
    private static boolean method4769(SafeWalk class366) {
    ...
    public void method4776(Class69 a2) {
        if (SafeWalk.field290.field_1724.method_24828()) {
            int n2 = 11118;
            Class1745.method15538();
            return;
        }
                ...
                case 11118: {
                    ...
                    block13: while (true) {
                        switch (n4) {
                            ...
                            case 56400: {
                                int n5 = SafeWalk.method4769(this) ? 43690 : 43691;
                                block14: while (true) {
                                    switch (n5) {
                                        case 43691: {
                                            n5 = 43689;
                                        ...
                                        case 43690: {
                                            if (this.method4758(((Float)this.field1193.method507()).floatValue(), -1.0, 0.0)) {
                                                SafeWalk.field290.field_1724.field_3913.field_3903 = (int)field1191[1];
                                                return;
                                            }
                                            if (this.method4758(0.0, Class6198.field12605, ((Float)SafeWalk.method4775(this.field1193)).floatValue())) {
                                                SafeWalk.method4755(SafeWalk.field290.field_1724.field_3913, (boolean)field1191[1]);
                                                SafeWalk.method4782();
                                                return;
                                            }
                    ...
                    if (SafeWalk.method4764(this, 0.0, -1.0, -((Float)this.field1193.method507()).floatValue())) {
                        SafeWalk.field290.field_1724.field_3913.field_3903 = (int)field1191[1];
                        return;
                    }
                    if (!SafeWalk.method4777(this, -((Float)this.field1193.method507()).floatValue(), -1.0, -((Float)this.field1193.method507()).floatValue())) return;
                    SafeWalk.field290.field_1724.field_3913.field_3903 = (int)field1191[1];
                    return;
                }
            }
    ...
    private static boolean method4777(SafeWalk class366, double d2, double d3, double d4) {
        return class366.method4758(d2, d3, d4);
    }
    ...
    public void method4778(Class40 a2) {
        int n2 = !SafeWalk.method4781(field290).method_5715() ? 9378 : 9379;
        int n3 = n2;
        if (n3 != 9378) {
            if (n3 == 9379) return;
            return;
        } else {
            if (((Boolean)SafeWalk.method4783(this).method507()).booleanValue()) {
                SafeWalk.method4779();
                return;
            }
    ...
    public static Class248 method4783(SafeWalk class366) {
