...
extends Class278 {
    ...
    public void method1274() {
        if (Skybox.field290.field_1687 != null) {
            this.field1233 = Skybox.method4907(field290).method_8546() ? Skybox.method4919() : (Skybox.field290.field_1687.method_8419() ? Skybox.method4917() : Class534.field2636);
            this.method4899((Class534)((Object)Skybox.method4920(this.field1230)));
        }
    }

    @Override
    public void method1279() {
        if (Skybox.field290.field_1687 != null && Skybox.method4904(this) != null) {
    ...
    public static Class248 method4881(Skybox class373) {
        return class373.field1236;
    }

    public static Class248 method4882(Skybox class373) {
        return class373.field1230;
    }

    private static Class248 method4883(Skybox class373) {
        return Skybox.method4882(class373);
    }
    ...
    public void method4886(Class63 a2) {
        if (a2.method128() == Class543.field2691) {
            ...
            if (((Boolean)this.field1227.method507()).booleanValue()) {
                Skybox.field290.field_1687.method_8435((long)((Integer)this.field1225.method507()).intValue());
            }
        }
    }
    ...
    private Boolean method1269() {
        return (Boolean)Skybox.method4892(Skybox.method4890(this));
    }
    ...
    public void method4889(Class155 a2) {
        if (((Boolean)Skybox.method4905(this).method507()).booleanValue()) {
            a2.method10();
            a2.method305(((Float)this.field1234.method507()).floatValue());
            a2.method309(((Float)Skybox.method4910(this).method507()).floatValue());
        }
    }

    public static Class248 method4890(Skybox class373) {
    ...
    private static Class248 method4895(Skybox class373) {
        return Skybox.method4881(class373);
    }
    ...
    public static Class248 method4897(Skybox class373) {
    ...
    public void method4898(Class133 b2) {
        ...
        if (b2.method251() instanceof class_2761 && ((Boolean)Skybox.method4912(this.field1227)).booleanValue()) {
            b2.method10();
        }
        ...
        block4: while (true) {
            switch (n2) {
                ...
                case 15500: {
                    ...
                    if (Skybox.method4883(this).method507() == Skybox.method4916()) return;
                    if (a2.method_11491() != class_2668.field_25646 && a2.method_11491() != class_2668.field_25652) {
                        if (a2.method_11491() == class_2668.field_25647) {
                            this.field1233 = Skybox.method4880();
                            b2.method10();
                            Class1745.method15538();
                            return;
                        }
    ...
    private void method4899(Class534 a2) {
        switch (a2.ordinal()) {
            case 0: 
            case 3: {
                Skybox.field290.field_1687.method_28104().method_157((boolean)field1231[0]);
                Skybox.field290.field_1687.method_8519(0.0f);
                Skybox.field290.field_1687.method_8496(0.0f);
                break;
            }
            case 1: {
                Skybox.method4914(field290).method_28104().method_157((boolean)field1231[1]);
                Skybox.field290.field_1687.method_8519(1.0f);
                Skybox.field290.field_1687.method_8496(0.0f);
                break;
            }
            case 2: {
                Skybox.field290.field_1687.method_28104().method_157((boolean)field1231[1]);
                Skybox.field290.field_1687.method_8519(2.0f);
                Skybox.method4887(field290).method_8496(1.0f);
            }
        }
    }
    ...
    public static Class248 method4903(Skybox class373) {
        return class373.field1226;
    }

    public static Class534 method4904(Skybox class373) {
        return class373.field1233;
    }

    public static Class248 method4905(Skybox class373) {
        return class373.field1229;
    }

    private Boolean method4906() {
        return (Boolean)Skybox.method4896(Skybox.method4897(this));
    }
    ...
    public void method4909(Class48 a2) {
        if (((Boolean)Skybox.method4895(this).method507()).booleanValue()) {
            a2.method10();
            a2.method96((Color)this.field1224.method507());
        }
    }

    public static Class248 method4910(Skybox class373) {
        return class373.field1235;
    }

    public static Class248 method4911(Skybox class373) {
        return class373.field1229;
    }
    ...
    public void method4913(Class200 a2) {
        if (Skybox.method4908(this.field1230) == Class534.field2640) {
            a2.method10();
    ...
    public static Class248 method4915(Skybox class373) {
        return class373.field1236;
    }
    ...
    public void method4918(Class46 a2) {
        if (((Boolean)Skybox.method4901(Skybox.method4911(this))).booleanValue()) {
            a2.method10();
            a2.method96((Color)Skybox.method4903(this).method507());
        }
    }
    ...
    static {
        Skybox.method4923(-2224621070924405250L);
    }

    private Boolean method1278() {
        return (Boolean)Skybox.method4915(this).method507();
    }
    ...
    private static void method4923(long l2) {
        Skybox.field1231[3] = l2 ^ 0xE1208EEC2BB3B28EL;
        Skybox.field1231[0] = l2 ^ 0xE1208EEC2BB3A5FEL;
        Skybox.field1231[2] = l2 ^ 0xE1208EEC2BB3A501L;
        Skybox.field1231[4] = l2 ^ 0xE1208EEC2BB3F83EL;
        Skybox.field1231[1] = l2 ^ 0xE1208EEC2BB3A5FFL;
    }
