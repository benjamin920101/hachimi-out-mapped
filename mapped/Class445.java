...
extends Class411 {
    ...
    Class248 field2279;
    private static Class445 INSTANCE;
    Class248 field2280;
    Class248 field2281;
    Class248 field2282;
    Class248 field2283;
    ...
    public boolean method9945() {
        class_238 d2 = Class445.method10113(field290).method_5829();
        for (int c2 = class_3532.method_15357((double)d2.field_1323); c2 < class_3532.method_15357((double)Class445.method10108(d2)) + (int)field2278[1]; ++c2) {
            for (int b2 = class_3532.method_15357((double)d2.field_1322); b2 < class_3532.method_15357((double)d2.field_1325) + (int)field2278[1]; ++b2) {
                int a2 = class_3532.method_15357((double)Class445.method10092(d2));
                if (a2 >= class_3532.method_15357((double)d2.field_1324) + (int)field2278[1]) continue;
                if (Class445.field290.field_1687.method_8320(new class_2338(c2, b2, a2)).method_51366() && d2.method_994(new class_238((double)c2, (double)b2, (double)a2, (double)c2 + 1.0, (double)b2 + 1.0, (double)a2 + 1.0))) {
    ...
    private static int method9950(int n2, int n3, Class395 class395, Class453 class453) {
    ...
    public static Class248 method9953(Class445 class445) {
        return class445.field2276;
    }

    private static int method9954(int n2, int n3, Class5649 class5649, Class402 class402) {
    ...
    private Boolean method9967() {
        int n2;
        if (this.field2285.method507() == Class526.field2611 && ((Boolean)Class445.method10102(this).method507()).booleanValue()) {
            n2 = (int)field2278[1];
            return n2 != 0;
        }
        n2 = (int)field2278[6];
    ...
    private Boolean method9974() {
        int n2;
        if (this.field2285.method507() == Class445.method10078() && ((Boolean)this.field2287.method507()).booleanValue()) {
            n2 = (int)field2278[1];
            return n2 != 0;
        }
        n2 = (int)field2278[6];
    ...
    private static Class248 method9976(Class445 class445) {
        return Class445.method10105(class445);
    }
    ...
    private Boolean method9979() {
        return (Class445.method9957(this.field2285) == Class526.field2611 ? (int)field2278[1] : (int)field2278[6]) != 0;
    }

    private static Class447 method9980() {
        return Class447.method10231();
    }
    ...
    public static Class248 method9983(Class445 class445) {
    ...
    private Boolean method9985() {
        return (Class445.method10070(this.field2285) == Class526.field2611 && (Boolean)this.field2295.method507() != false && (Boolean)this.field2288.method507() != false ? (int)field2278[1] : (int)field2278[6]) != 0;
    }
    ...
    private Boolean method9987() {
        return (Class445.method9999(this).method507() == Class526.field2611 ? (int)field2278[1] : (int)field2278[6]) != 0;
    }
    ...
    public void method9988(Class65 b2) {
        block2: {
            ...
            if (!Class445.field290.field_1724.method_5715() || !Class445.method10016(this)) break block2;
            float a2 = Class445.field290.field_1724.method_36454();
            Class445.field290.field_1724.method_5857(Class445.field290.field_1724.method_5829().method_989((double)((Float)this.field2293.method507()).floatValue() * Math.cos(Math.toRadians(a2 + Class5788.field11242)), 0.0, (double)((Float)this.field2293.method507()).floatValue() * Math.sin(Math.toRadians(a2 + Class6373.field13172))));
        }
    }
    ...
    private static int method9994(int n2, int n3, Class418 class418, Class159 class159) {
    ...
    private class_243 method9997() {
        int[] k2;
        class_2338 e2 = Class445.field290.field_1724.method_24515();
        class_243 f2 = Class445.field290.field_1724.method_19538();
        class_243 g2 = Class445.method10021(field290).method_24515().method_61082();
        float h2 = ((Float)this.field2274.method507()).floatValue();
        class_243 i2 = g2;
        double j2 = Double.MAX_VALUE;
        int[] nArray = new int[(int)field2278[9]];
        nArray[(int)Class445.field2278[6]] = (int)field2278[1];
        nArray[(int)Class445.field2278[1]] = (int)field2278[8];
            ...
            for (int i4 = (int)field2278[6]; i4 < n3; ++i4) {
                ...
                block5: {
                    block4: {
                        ...
                        if (!Class445.field290.field_1687.method_22347(e2.method_10069(d2, (int)field2278[6], (int)field2278[6]))) break block5;
                        if (!Class445.field290.field_1687.method_22347(e2.method_10069((int)field2278[6], (int)field2278[6], c2))) break block5;
                        if (!Class445.field290.field_1687.method_22347(e2.method_10069(d2, (int)field2278[6], c2))) break block5;
                    }
                    if (!this.method10014(e2.method_10069(d2, (int)field2278[6], (int)field2278[6])) && !Class445.method10041(this, e2.method_10069((int)field2278[6], (int)field2278[6], c2)) && !this.method10014(e2.method_10069(d2, (int)field2278[6], c2))) continue;
                }
    ...
    public static Class248 method9999(Class445 class445) {
        return class445.field2285;
    }

    private static int method10000(int n2, int n3, Class308 class308, Class133 class133) {
    ...
    public void method10005(Class178 a2) {
        if (Class445.field290.field_1724 == null) {
            return;
        }
        int n2 = ((Class526)((Object)this.field2285.method507())).ordinal();
        if (n2 == 0) {
            if (Class445.method10073(a2) == class_259.method_1073()) {
                while (true) {
                    // Infinite loop
                }
            }
            ...
            if (n2 == 1) {
                ...
                Class445.method10072((class_310)Class445.field290).field_5960 = (int)field2278[1];
                return;
            }
            if (n2 != 2) {
            ...
            if (Class445.field290.field_1724.field_5976) {
                a2.method10();
                a2.method349(class_259.method_1073());
            }
            if (!Class445.field290.field_1724.field_3913.field_3903) {
                if (!Class445.method10111(Class445.field290.field_1724.field_3913)) return;
                if (!((double)Class445.method9949(a2).method_10264() > Class445.method10050(field290).method_23318())) return;
            }
            a2.method10();
            return;
        }
        ...
        block5: while (true) {
            switch (n3) {
                ...
                case 22650: {
                    if (!(a2.method345().method_1107().field_1325 > Class445.method10048(Class445.field290.field_1724.method_5829()))) {
                        return;
                    }
                    if (!Class445.field290.field_1724.method_5715()) return;
                    a2.method10();
                    a2.method349(class_259.method_1073());
                    return;
                }
    ...
    private Boolean method10006() {
        return (Class445.method10085(this.field2285) == Class445.method10083() && (Boolean)Class445.method10034(this.field2287) != false && (Boolean)Class445.method10119(this).method507() != false ? (int)field2278[1] : (int)field2278[6]) != 0;
    }
    ...
    private static float method10010(Class445 class445) {
    ...
    private Boolean method10011() {
        int n2 = Class445.method10075(this).method507() != Class526.field2611 ? 12700 : 12699;
        block4: while (true) {
            switch (n2) {
                case 12700: {
                    n2 = 12698;
    ...
    public void method10012(Class210 h2) {
        ...
        block20: {
            block19: {
                block18: {
                    if (this.field2285.method507() != Class526.field2611) {
                        Class445.method10069();
                        return;
                    }
                    f2 = new Class3812(class_1802.field_8634, (Class607)((Object)this.field2286.method507())).method18502();
                    if (!Class445.method10025(f2) || Class445.field290.field_1724.method_7357().method_7904(Class445.method10060())) break block18;
            ...
            if (!Class445.field290.field_1724.method_24828() && !(Class445.method9971(field290).method_8320(Class445.field290.field_1724.method_24515()).method_26204() instanceof class_2399)) {
                return;
            }
        }
        ...
        if (((Boolean)this.field2290.method507()).booleanValue()) {
            class_2338 a2 = Class445.method9952((class_1657)Class445.method9992(field290), (boolean)field2278[1]);
            class_2338 b2 = a2.method_10084();
            Class425 c2 = Class425.method8407();
            if (Class445.field290.field_1687.method_8320(a2).method_26204() instanceof class_3736) {
                c2.method8517(a2, (Integer)this.field2281.method507());
                return;
            }
            if (Class445.field290.field_1687.method_8320(b2).method_26204() instanceof class_3736) {
                c2.method8517(b2, (Integer)Class445.method10032(this.field2281));
                return;
            }
        }
        for (class_1297 e2 : Class445.field290.field_1687.method_18112()) {
            if (e2 instanceof class_1511 && ((Boolean)Class445.method10098(Class445.method10064(this))).booleanValue()) {
                if (e2.method_23318() >= Class445.field290.field_1724.method_23318() || !e2.method_5829().method_994(Class445.field290.field_1724.method_5829())) continue;
                Class1745.method15567(e2, (Double)this.field2282.method507(), (Boolean)Class445.method10081(this.field2276));
                Class298.method1924();
                return;
            }
            if (((Boolean)this.field2275.method507()).booleanValue() && e2 instanceof class_1533) {
                class_1533 d2 = (class_1533)e2;
                if (!e2.method_5829().method_994(new class_238(Class445.field290.field_1724.method_24515()))) continue;
                if (!d2.method_6940().method_7960()) {
                    Class445.method9963(e2, (Double)this.field2282.method507(), (Boolean)this.field2276.method507());
                }
                Class445.method10003(e2, (Double)Class445.method10049(this.field2282), (Boolean)this.field2276.method507());
                continue;
            }
            if (!((Boolean)this.field2283.method507()).booleanValue() || !(e2 instanceof class_1534) || !e2.method_5829().method_994(new class_238(Class445.field290.field_1724.method_24515()))) continue;
            Class1745.method15567(e2, (Double)this.field2282.method507(), (Boolean)Class445.method9953(this).method507());
            return;
        }
        int g2 = Class445.method10013().method18969();
        f2.method18531(g2);
        Class1503.method14417(Class445.method10010(this), this.method10121());
        ...
        Class445.method9980().field2323.method12593();
        int n4 = (Boolean)Class445.method10031(this).method507() == false ? 4015 : 4016;
        block6: while (true) {
            switch (n4) {
                case 4016: {
                    n4 = 4014;
    ...
    private static boolean method10016(Class445 class445) {
    ...
    private static Class526 method10027() {
        return Class445.method9955();
    }

    public static Class445 method10028() {
        return INSTANCE;
    }

    private static int method10029(int n2, int n3, Class1503 class1503, Class367 class367) {
    ...
    private static Class248 method10031(Class445 class445) {
        return Class445.method9983(class445);
    }
    ...
    private static class_746 method10037(class_310 class_3102) {
        return Class445.method9946(class_3102);
    }

    private static void method10038(long l2) {
        Class445.field2278[1] = l2 ^ 0xE81F281997B86B79L;
        Class445.field2278[8] = l2 ^ 0x17E0D7E668479487L;
        Class445.field2278[6] = l2 ^ 0xE81F281997B86B78L;
        Class445.field2278[4] = l2 ^ 0xE81F281997B86890L;
        Class445.field2278[7] = l2 ^ 0xE81F281997B86B22L;
        Class445.field2278[2] = l2 ^ 0xE81F281997B86B7FL;
        Class445.field2278[9] = l2 ^ 0xE81F281997B86B7AL;
        Class445.field2278[0] = l2 ^ 0xE81F281997B86B3EL;
        Class445.field2278[5] = l2 ^ 0xE81F281997B86B72L;
        Class445.field2278[3] = l2 ^ 0xE81F281997B86B2DL;
    }
    ...
    static {
        Class445.method10038(-1720612442247500936L);
    }
    ...
    private static boolean method10041(Class445 class445, class_2338 class_23382) {
    ...
    private Boolean method1278() {
        return (Class445.method9976(this).method507() == Class526.field2611 ? (int)field2278[1] : (int)field2278[6]) != 0;
    }
    ...
    public void method1274() {
        ...
        if (((Boolean)this.field2280.method507()).booleanValue()) {
            double a2 = Math.cos(Math.toRadians(Class445.method10093(field290).method_36454() + 90.0f));
            double b2 = Math.sin(Math.toRadians(Class445.field290.field_1724.method_36454() + 90.0f));
            Class445.field290.field_1724.method_5814(Class445.field290.field_1724.method_23317() + (1.0 * (double)((Float)this.field2292.method507()).floatValue() * a2 + 0.0 * (double)((Float)this.field2292.method507()).floatValue() * b2), Class445.field290.field_1724.method_23318(), Class445.method10051(field290).method_23321() + (1.0 * (double)((Float)this.field2292.method507()).floatValue() * b2 - 0.0 * (double)((Float)this.field2292.method507()).floatValue() * a2));
        }
    }
    ...
    public Class445() {
        ...
        this.field2286 = this.method450(new Class260("SwapAction", "Decide which swap mode to use", Class607.field2953, Class445.method10084(), this::method10062));
    ...
    public void method10047(Class63 a2) {
        if (a2.method128() != Class543.field2690 || this.field2285.method507() != Class526.field2609 || !Class445.field290.field_1724.method_24828() || Class445.field290.field_1724.method_3144()) {
            return;
        }
        class_243 b2 = Class445.method10037(field290).method_24515().method_46558();
        int c2 = b2.field_1352 - Class445.field290.field_1724.method_23317() > 0.0 ? (int)field2278[1] : (int)field2278[6];
        int d2 = b2.field_1350 - Class445.method9984(field290).method_23321() > 0.0 ? (int)field2278[1] : (int)field2278[6];
        double e2 = Class445.method9968(b2) + 0.20000000009497754 * (double)(c2 != 0 ? (int)field2278[8] : (int)field2278[1]);
        double f2 = b2.field_1350 + Class3355.field7272 * (double)(d2 != 0 ? (int)field2278[8] : (int)field2278[1]);
        Class445.field290.field_1724.method_5814(e2, Class445.field290.field_1724.method_23318(), f2);
        this.method1268();
    }

    private static double method10048(class_238 class_2383) {
        return Class445.method9973(class_2383);
    }
    ...
    private static class_746 method10050(class_310 class_3102) {
        return Class445.method10040(class_3102);
    }
    ...
    private static int method10056(int n2, int n3, Class3815 class3815, Class284 class284) {
    ...
    private static int method10058(int n2, int n3, Class477 class477, Class404 class404) {
    ...
    private static Class248 method10064(Class445 class445) {
        return Class445.method10109(class445);
    }
    ...
    public String method1248() {
        return Class5587.method21919((Enum)Class445.method10033(this.field2285));
    }

    public static Class248 method10075(Class445 class445) {
        return class445.field2285;
    }
    ...
    public static Class248 method10089(Class445 class445) {
        return class445.field2285;
    }
    ...
    private static double method10092(class_238 class_2383) {
        return Class445.method9991(class_2383);
    }
    ...
    private Boolean method10095() {
        return (this.field2285.method507() != Class526.field2611 && Class445.method9970(this.field2285) != Class526.field2609 ? (int)field2278[1] : (int)field2278[6]) != 0;
    }
    ...
    private Boolean method10096() {
        int n2;
        if (this.field2285.method507() == Class445.method10027()) {
            int n3 = (Boolean)Class445.method10088(this.field2287) != false ? 10435 : 10436;
            block4: while (true) {
                switch (n3) {
                    case 10436: {
                        n3 = 10434;
    ...
    private Boolean method10099() {
        if (this.field2285.method507() != Class526.field2611) {
            if (this.field2285.method507() != Class445.method10066()) {
                int n2 = (int)field2278[1];
    ...
    public static Class248 method10102(Class445 class445) {
    ...
    private float method10103() {
        int n2 = (Boolean)Class445.method9956(this.field2295) != false ? 35432 : 35433;
        block4: while (true) {
            switch (n2) {
                case 35433: {
                    n2 = 35431;
                ...
                case 35432: {
                    ...
                    return class_3532.method_15393((float)(Class445.method10046(Class445.field290.field_1724.method_24515().method_46558())[(int)field2278[6]] - Class5858.field11560));
                }
            }
            break;
        }
        return Class445.method10094(field290).method_36454();
    }

    private static int method10104(int n2, int n3, Class288 class288, Class2300 class2300) {
        return Class1348.method13834(n2, n3, class288, class2300);
    }

    public static Class248 method10105(Class445 class445) {
        return class445.field2285;
    }
    ...
    public static Class248 method10109(Class445 class445) {
    ...
    private Boolean method10112() {
        return (this.field2285.method507() != Class526.field2611 && Class445.method9978(this.field2285) != Class526.field2609 ? (int)field2278[1] : (int)field2278[6]) != 0;
    }

    private static class_746 method10113(class_310 class_3102) {
        return Class445.method10115(class_3102);
    }
    ...
    private Boolean method10117() {
        return (this.field2285.method507() == Class526.field2611 && (Boolean)Class445.method9961(this.field2287) != false ? (int)field2278[1] : (int)field2278[6]) != 0;
    }
    ...
    public static Class248 method10119(Class445 class445) {
    ...
    private Boolean method10120() {
        block9: {
            block7: {
                block8: {
                    if (Class445.method9951(Class445.method10089(this)) != Class445.method10035()) break block8;
                    v0 = 16617;
                    ** GOTO lbl9
                }
                v0 = 16618;
...
lbl21:
    ...
    private float method10121() {
        ...
        if (((Boolean)this.field2295.method507()).booleanValue() && ((Boolean)this.field2288.method507()).booleanValue() && (a2 = this.method9997()) != null) {
            return Class445.method10071(a2)[(int)field2278[1]];
        }
