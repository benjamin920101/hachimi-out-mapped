...
extends Class278 {
    ...
    Class248 field688;
    Class248 field689;
    public Class248 field690 = this.method450(new Class260("Items", "Prevents dropped items from rendering", Class540.field2675, NoRender.method2460()));
    Class248 field691;
    Class248 field692;
    Class248 field693;
    Class248 field694;
    ...
    public void method2422(Class83 a2) {
        if (!((Boolean)NoRender.method2491(this.field680)).booleanValue()) {
            NoRender.method2506();
            return;
        }
        a2.method10();
    ...
    public static Class248 method2424(NoRender class310) {
    ...
    private Boolean method2431() {
        return (NoRender.method2495(this).method507() == Class540.field2677 ? (int)field661[1] : (int)field661[0]) != 0;
    }
    ...
    public void method2441(Class38 a2) {
        if (((Boolean)NoRender.method2470(this.field666)).booleanValue()) {
            a2.method10();
        }
    }
    ...
    public void method2446(Class232 a2) {
        int n2 = (Boolean)NoRender.method2476(this.field671) != false ? 15664 : 15665;
        block4: while (true) {
            switch (n2) {
                case 15665: {
                    n2 = 15663;
    ...
    public void method2447(Class24 a2) {
        if (((Boolean)this.field674.method507()).booleanValue() && a2.method48() == NoRender.method2484()) {
            a2.method10();
        }
    }
    ...
    private Boolean method1269() {
        return (NoRender.method2462(this).method507() == NoRender.method2472() ? (int)field661[1] : (int)field661[0]) != 0;
    }

    @Class1
    public void method2449(Class96 a2) {
        if (((Boolean)NoRender.method2487(NoRender.method2467(this))).booleanValue()) {
            a2.method10();
        }
    }
    ...
    public void method2458(Class116 a2) {
        if (((Boolean)NoRender.method2435(this.field667)).booleanValue()) {
            a2.method10();
        }
    }
    ...
    public void method2461(Class63 b2) {
        ...
        if (((Boolean)NoRender.method2515(this.field665)).booleanValue()) {
            NoRender.field290.field_1724.field_5973 = 4.0f;
        }
        if (this.field690.method507() == Class540.field2676) {
            for (class_1297 a2 : Lists.newArrayList((Iterable)NoRender.field290.field_1687.method_18112())) {
                if (!(a2 instanceof class_1542)) continue;
                NoRender.field290.field_1687.method_2945(a2.method_5628(), class_1297.class_5529.field_26999);
            }
        }
        if (((Boolean)this.field669.method507()).booleanValue() && NoRender.field290.field_1755 instanceof class_434 && !NoRender.method2498(GodMode.method6250())) {
            NoRender.field290.field_1755 = null;
        }
    }

    public static Class248 method2462(NoRender class310) {
    ...
    public static Class248 method2467(NoRender class310) {
    ...
    static {
        field661 = new long[2];
        NoRender.method2489(7873973689308312179L);
    }
    ...
    private static int method2480(int n2, int n3, PenisBuilder class361, Class113 class113) {
        return Class3952.method19458(n2, n3, class361, class113);
    }

    public static NoRender method2481() {
        return INSTANCE;
    }
    ...
    public void method2485(Class185 a2) {
        if (((Boolean)NoRender.method2513(this.field673)).booleanValue()) {
            a2.method10();
        }
    }
    ...
    private Boolean method2494() {
        if (NoRender.method2457(this.field690) == Class540.field2677) {
    ...
    public static Class248 method2495(NoRender class310) {
        return class310.field690;
    }
    ...
    private static boolean method2498(GodMode class403) {
    ...
    private static boolean method2501(NoRender class310, class_1297 class_12972) {
...
lbl10:
                ...
                if (!(a.method375() instanceof class_1542) || this.field690.method507() != Class540.field2673 && this.field690.method507() != Class540.field2676 && (!((Boolean)NoRender.method2450(this.field675)).booleanValue() || this.field690.method507() != Class540.field2677)) break block10;
                a.method10();
                break block9;
            }
            if (!(NoRender.method2464(a) instanceof class_1687)) ** GOTO lbl-1000
            if (((Boolean)NoRender.method2434(this.field662)).booleanValue()) {
                a.method10();
            } else if (NoRender.method2501(this, a.method375())) {
                a.method10();
            }
        }
        if (a.method11() && ((Boolean)this.field685.method507()).booleanValue()) {
            a.method375().field_6012 += (int)NoRender.field661[1];
        }
    }

    public static Class248 method2503(NoRender class310) {
        return class310.field677;
    }

    @Class1
    public void method2504(Class103 a2) {
        if (((Boolean)NoRender.method2424(this).method507()).booleanValue()) {
            a2.method10();
        }
    }
    ...
    public void method2508(Class155 a2) {
        if (NoRender.method2465(this.field695) == Class545.field2701 && NoRender.field290.field_1724 != null && NoRender.field290.field_1724.method_5777(class_3486.field_15518)) {
            a2.method10();
            a2.method305(a2.method308() * 4.0f);
            NoRender.method2479(a2, NoRender.method2451(a2) * 4.25f);
            return;
        }
    ...
    public void method2509(Class240 a2) {
        if (((Boolean)NoRender.method2503(this).method507()).booleanValue()) {
            a2.method10();
        }
    }
    ...
    private static void method2511(long l2) {
        NoRender.field661[0] = l2 ^ 0x6D45F95A31FE7273L;
        NoRender.field661[1] = l2 ^ 0x6D45F95A31FE7272L;
    }
    ...
    private static int method2514(int n2, int n3, AutoFish class330, Class1659 class1659) {
