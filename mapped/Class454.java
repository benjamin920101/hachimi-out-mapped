...
extends Class451 {
    private static Class454 INSTANCE;
    Class248 field2382 = this.method450(new Class250("Saved", "You cant see this setting", "default", Class454::method10539));
    ...
    private static void method10529(long l2) {
        Class454.field2385[0] = l2 ^ 0x820EDBCAB6C0651AL;
        Class454.field2385[1] = l2 ^ 0x820EDBCAB6C0651BL;
        Class454.field2385[2] = l2 ^ 0x820EDBCAB6C06532L;
    }
    ...
    private static boolean method10531(Class454 class454, boolean bl2) {
    ...
    public void method10533(Class117 a2) {
        Class454.method10542(Class454.method10546(), (boolean)field2385[1]);
    }

    public void method10534(String c2) {
        if (Class454.field290.field_1724 == null || Class454.field290.field_1687 == null) {
            return;
        }
        try {
            File a2 = new File(Class454.method10525().field5551, c2 + ".data");
            if (a2.exists()) {
                a2.delete();
            ...
            Class454.method10545("Failed to delete kit " + c2);
            Class454.method10552("\u00a7cFailed to delete kit " + c2);
            b2.printStackTrace();
        }
    }
    ...
    public boolean method10536(boolean g2) {
        ...
        try {
            ...
            if (e2.exists()) {
                ...
                for (String c2 : d2) {
                    String[] a2 = c2.split(":");
                    Class942 b2 = Class454.method10547(c2, (boolean)field2385[0]);
                    Class454.method10526().put(Integer.parseInt(a2[(int)field2385[1]]), b2);
                }
                if (g2) {
            ...
            field2383.clear();
            Class454.method10544("Failed to load kit " + h2);
    ...
    private static boolean method10542(Class454 class454, boolean bl2) {
        return class454.method10536(bl2);
    }

    private static int method10543(int n2, int n3, Class281 class281, Class34 class34) {
    ...
    public static Class454 method10546() {
        return INSTANCE;
    }
    ...
    public static Class942 method10547(String d2, boolean e2) {
        for (Class942 c2 : Class454.method10550().values()) {
            if (e2) {
                int a2 = d2.indexOf(":");
                String b2 = d2.substring(a2 + (int)field2385[0]);
                if (!Integer.valueOf(b2.hashCode()).equals(Class454.method10541(c2).hashCode())) continue;
                return c2;
            }
    ...
    public void method10548(String i2) {
        if (Class454.field290.field_1724 == null || Class454.method10535(field290) == null) {
            return;
        }
        try {
            ...
            for (int e2 = (int)field2385[1]; e2 < (int)field2385[2]; ++e2) {
                class_1799 d2 = Class454.field290.field_1724.method_31548().method_5438(e2);
            ...
            Class454.method10537("Failed to save kit " + i2);
    ...
    public static Class942 method10551(class_1799 c2) {
        ...
        class_1844 b2 = (class_1844)c2.method_57825(Class454.method10549(), (Object)Class454.method10527());
        for (class_1293 a2 : b2.method_57397()) {
            d2.append(":").append(a2.method_5586()).append("-").append(a2.method_5578());
        }
        return Class454.method10547(d2.toString(), (boolean)field2385[1]);
    }
    ...
    static {
        ...
        Class454.method10529(-9075074535409031909L);
    ...
    public void method10555(String c2) {
        if (Class454.method10538(field290) == null || Class454.field290.field_1687 == null) {
            return;
        }
        try {
            File a2 = new File(Class454.method10530(Class3979.field9083), c2 + ".data");
            if (a2.exists()) {
                this.field2382.method505(c2);
                Class454.method10531(this, (boolean)field2385[0]);
