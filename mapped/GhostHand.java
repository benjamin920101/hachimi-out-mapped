...
extends Class278 {
    ...
    private static GhostHand INSTANCE;
    Class248 field996;
    ...
    public GhostHand() {
        ...
        class_2248Array[(int)GhostHand.field995[1]] = class_2246.field_10034;
        ...
        class_2248Array2[(int)GhostHand.field995[1]] = class_2246.field_9987;
    ...
    public boolean method3830(class_2248 a2) {
        switch (((Class530)((Object)GhostHand.method3829(this.field997))).ordinal()) {
            case 0: {
    ...
    private static void method3831(long l2) {
        GhostHand.field995[0] = l2 ^ 0x696D361CEA068147L;
        GhostHand.field995[1] = l2 ^ 0x696D361CEA068146L;
    }
    ...
    public static CallSite Jy5F2lSIWlyYDwSm(MethodHandles.Lookup lookup, String string, MethodType methodType, String string2, String string3, String string4, Integer n2) {
        ...
        int n3 = n2;
        MethodType methodType2 = MethodType.fromMethodDescriptorString(GhostHand.t92Iw49OdEfG9F7T(string7), GhostHand.class.getClassLoader());
        try {
            if (n3 == 1) {
                return new ConstantCallSite(lookup.findVirtual(Class.forName(GhostHand.t92Iw49OdEfG9F7T(string5)), GhostHand.t92Iw49OdEfG9F7T(string6), methodType2).asType(methodType));
            }
            return new ConstantCallSite(lookup.findStatic(Class.forName(GhostHand.t92Iw49OdEfG9F7T(string5)), GhostHand.t92Iw49OdEfG9F7T(string6), methodType2).asType(methodType));
        }
    ...
    static {
        GhostHand.method3831(7596787644257173830L);
    }

    public static GhostHand method3832() {
        return INSTANCE;
    }
