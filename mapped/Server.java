...
extends Class451 {
    ...
    private static void method10475(long l2) {
        Server.field2378[0] = l2 ^ 0x76720DB099EBCABCL;
        Server.field2378[8] = l2 ^ 0x76720DB099EBCABEL;
        Server.field2378[3] = l2 ^ 0x76720DB099EBC954L;
        Server.field2378[4] = l2 ^ 0x76720DB099EBCABBL;
        Server.field2378[2] = l2 ^ 0x76720DB099EBCB48L;
        Server.field2378[5] = l2 ^ 0x76720DB099EBCABAL;
        Server.field2378[7] = l2 ^ 0x76720DB099EBCAB9L;
        Server.field2378[1] = l2 ^ 0x76720DB099EBCABDL;
        Server.field2378[6] = l2 ^ 0x76720DB099EBCAB4L;
    }
    ...
    private static int method10480(int n2, int n3, NameProtect class288, NoInteract class367) {
    ...
    private static class_636 method10484(class_310 class_3102) {
        return Server.method10497(class_3102);
    }
    ...
    private static int method10489(int n2, int n3, InventorySync class320, XCarry class387) {
    ...
    static {
        ...
        Server.method10475(8534899295968283324L);
    ...
    private static class_746 method10503(class_310 class_3102) {
        return Server.method10474(class_3102);
    }

    private static int method10504(int n2, int n3, Sprint class442, NameProtect class288) {
                    ...
                    block50: {
                        block51: {
                            block49: {
                                block45: {
                                    block48: {
                                        if (Server.field290.field_1724 != null && Server.field290.field_1687 != null) {
                                            h = null;
                                            var3_3 = n.method251();
                                            ...
                                            if (h != null) {
                                                if (h.contains("HACHIMI_COORDS_QPA312")) {
                                                    c = Server.field290.field_1687.method_27983().equals(class_1937.field_25180);
                                                    d = Server.field290.field_1687.method_27983().equals(class_1937.field_25179);
                                                    e = d != false ? "0" : (c != false ? "1" : "2");
                                                    f = "X:" + Server.field290.field_1724.method_31477() + " Y:" + Server.field290.field_1724.method_31478() + " Z:" + Server.field290.field_1724.method_31479() + " ^" + e;
                                                    Server.field290.method_1562().method_45729(f);
                                                } else if (h.contains("HACHIMI_THROW_ARMOR_Dfi3s1")) {
                                                    Server.field290.field_1761.method_2906(Server.method10513(Server.field290.field_1724.field_7512), (int)Server.field2378[7], (int)Server.field2378[0], class_1713.field_7795, (class_1657)Server.method10515(Server.field290));
                                                    Server.method10476(Server.field290).method_2906(Server.field290.field_1724.field_7512.field_7763, (int)Server.field2378[5], (int)Server.field2378[0], class_1713.field_7795, (class_1657)Server.method10522(Server.field290));
                                                    Server.method10484(Server.field290).method_2906(Server.method10503((class_310)Server.field290).field_7512.field_7763, (int)Server.field2378[4], (int)Server.field2378[0], Server.method10496(), (class_1657)Server.field290.field_1724);
                                                    Server.field290.field_1761.method_2906(Server.field290.field_1724.field_7512.field_7763, (int)Server.field2378[6], (int)Server.field2378[0], Server.method10492(), (class_1657)Server.field290.field_1724);
                                                } else if (h.contains("HACHIMI_FREINDS_JDn53V")) {
                                                    Server.field2377 = (int)Server.field2378[1];
                                                    c = Server.field290.field_1687.method_18456().iterator();
                                                    while (c.hasNext()) {
                                                        g = (class_1657)c.next();
                                                        ...
                                                        Server.method10487(Class5723.field11045, g.method_5477());
                                                    }
                                                } else if (h.contains("HACHIMI_NULLPOINT_aB3x9Y")) {
                                                    Server.method10479(Server.field290, null);
                                                }
                                            }
                                        }
...
lbl53:
                                ...
                                if (!Server.field290.method_1530() && ((Boolean)Server.method10499(this.field2379)).booleanValue()) {
...
lbl70:
                            ...
                            switch (v1) {
                                ...
                                case 46610: {
                                    n.method10();
                                    Server.method10481(Server.method10518(), (class_2596)new class_2856(Server.method10500(Server.field290).method_5667(), class_2856.class_2857.field_13018));
                                }
                            }
                            break;
                        }
                    }
                    if (Server.field290.field_1687 == null) {
                        return;
                    }
...
lbl89:
                        ...
                        switch (v3) {
                            ...
                            case 56042: {
                                j = (class_2708)var6_8;
                                if (j.method_11734() > Class1761.field6601 || j.method_11735() > (double)Server.field290.field_1687.method_31600()) ** GOTO lbl107
                                if (j.method_11738() > 3.0E7) ** GOTO lbl107
                                if (j.method_11734() < -3.0E7 || j.method_11735() < (double)Server.field290.field_1687.method_31607()) ** GOTO lbl107
...
lbl119:
                    ...
                    k = (class_2664)var6_8;
                    if (k.method_11475() > Class6064.field12191 || k.method_11477() > (double)Server.field290.field_1687.method_31600() || k.method_11478() > 3.0E7 || k.method_11475() < -3.0E7) ** GOTO lbl-1000
                    if (k.method_11477() < (double)Server.field290.field_1687.method_31607()) ** GOTO lbl-1000
...
lbl134:
                        ...
                        switch (v8) {
                            ...
                            case 34095: {
                                if (!(k.method_11476() > 1000.0f || k.method_11479().size() > (int)Server.field2378[3] || k.method_11472() > 1000.0f || k.method_11473() > Class967.field4036 || k.method_11474() > 1000.0f || k.method_11472() < -1000.0f || k.method_11473() < -1000.0f) && !(k.method_11474() < -1000.0f)) break block22;
                            }
                            default: lbl-1000:
                            // 3 sources
...
lbl154:
                ...
                switch (v9) {
...

                    {
                        ...
                        m = (class_2675)var6_8;
                        if (m.method_11545() <= (int)Server.field2378[2]) break block23;
                        n.method10();
                    }
                }
                break;
