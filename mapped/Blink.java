...
extends Class278 {
    ...
    private static void method4936(class_2664 a2) {
        ((bm)Blink.method4956(field290)).hookPlaySound(a2.method_11475(), a2.method_11477(), a2.method_11478(), (class_3414)class_3417.field_15152.comp_349(), class_3419.field_15245, Class3888.field8840, (1.0f + (field289.nextFloat() - field289.nextFloat()) * 0.2f) * 0.7f, (boolean)field1253[1], field289.nextLong());
    }

    static {
        field1253 = new long[6];
        Blink.method4967(1616117952775727183L);
    }

    private static void method4937(Blink class376, boolean bl2) {
        Blink.method4992(class376, bl2);
    }

    @Class1
    public void method4938(Class63 b2) {
        if (b2.method128() == Blink.method4988()) {
    ...
    public static void method4943(Blink class376, boolean bl2) {
    ...
    public void method4952(Class233 b2) {
        if (Blink.field290.field_1690.field_1842) {
            return;
        }
        int n2 = (Boolean)Blink.method4964(this).method507() != false ? 17708 : 17709;
        block4: while (true) {
            switch (n2) {
                case 17709: {
                    n2 = 17707;
    ...
    public void method4954(Class133 g2) {
        if (Blink.method4976(field290) == null || Blink.field290.field_1687 == null) {
            return;
        }
        class_2596 class_25962 = g2.method251();
        if (class_25962 instanceof class_2743) {
            class_2743 a2 = (class_2743)class_25962;
            if (a2.method_11818() != Blink.method4955(field290).method_5628()) {
                return;
            }
            g2.method10();
        } else {
            ...
            if (class_25962 instanceof class_2664) {
                ...
                g2.method10();
                field290.method_40000(() -> Blink.method4936(b2));
            ...
            if (class_25962 instanceof class_8042) {
                ...
                for (class_2596 d2 : f2.method_48324()) {
                    if (d2 instanceof class_2664) {
                        ...
                        field290.method_40000(() -> Blink.method4971(c2));
                        continue;
                    }
    ...
    public static Queue method4957(Blink class376) {
        return class376.field1243;
    }

    public static Class1468 method4958(Blink class376) {
    ...
    public Blink() {
        ...
        INSTANCE = this;
        Class5723.field11059.method24187((Class246)Blink.method4944(this.field1249));
    }
    ...
    public void method1274() {
        if (Blink.method4945(field290) == null) return;
        int n2 = (Boolean)Blink.method4970(this.field1250) != false ? 58736 : 58737;
        block4: while (true) {
            switch (n2) {
                case 58737: {
                    n2 = 58735;
                ...
                case 58736: {
                    this.field1241 = Blink.field290.field_1724.method_19538();
                    this.field1251 = Blink.field290.field_1724.method_36454();
                    this.field1244 = Blink.field290.field_1724.method_36455();
                    this.field1247 = new Class1468((class_1657)Blink.field290.field_1724);
                    Blink.method4958(this).method14391();
                    return;
                }
            }
            break;
    ...
    private static Blink method4960() {
        return Blink.method4986();
    }
    ...
    public static Blink method4963() {
        return INSTANCE;
    }

    public static Class248 method4964(Blink class376) {
        return class376.field1246;
    }

    public static Queue method4965(Blink class376) {
        return class376.field1243;
    }
    ...
    private static void method4971(class_2664 a2) {
        ((bm)Blink.field290.field_1687).hookPlaySound(a2.method_11475(), a2.method_11477(), a2.method_11478(), (class_3414)Blink.method4962().comp_349(), Blink.method4942(), Class1480.field5603, (1.0f + (field289.nextFloat() - field289.nextFloat()) * 0.2f) * 0.7f, (boolean)field1253[1], field289.nextLong());
    }
    ...
    public static Queue method4973(Blink class376) {
        return class376.field1243;
    }
    ...
    private static void method4975(long l2) {
        Blink.field1253[1] = l2 ^ 0x166D9AB72A54284FL;
        Blink.field1253[2] = l2 ^ 0x166D9AB72A54284EL;
        Blink.field1253[4] = l2 ^ 0x166D9AB72A542887L;
        Blink.field1253[3] = l2 ^ 0x166D9AB72A5428B0L;
        Blink.field1253[0] = l2 ^ 0xE9926548D5ABD777L;
        Blink.field1253[5] = l2 ^ 0xE9926548D5ABD7B0L;
    }
    ...
    public void method4978() {
        if (this.method1265() && this.field1241 != null) {
            ...
            Blink.field290.field_1724.method_33574(this.field1241);
            Blink.field290.field_1724.method_36456(this.field1251);
            Blink.field290.field_1724.method_36457(this.field1244);
            this.method1268();
        }
    }
    ...
    public void method4979(Class131 e2) {
        ...
        block9: {
            block10: {
                ...
                block8: {
                    if (Blink.field290.field_1724 == null) return;
                    if (Blink.method4980(field290).method_3144()) return;
                    if (this.field1245) {
                        return;
                    }
                    ...
                    block4: while (true) {
                        switch (n2) {
                            ...
                            default: {
                                e2.method10();
                                Blink.method4973(this).add(e2.method251());
                                return;
                            }
                        }
                        break;
                    ...
                    if (d2.method_12551() != Blink.method4983()) break block9;
                    break block10;
                }
                ...
                e2.method10();
                Blink.method4985(this).add(e2.method251());
                Blink.method4984();
                return;
            }
            class_1799 b2 = Class5723.field11058.method18908();
            if (b2.method_57353().method_57832(Blink.method4946())) return;
            Class1108.method12918(true);
            return;
        }
        if (d2.method_12551() == class_1268.field_5810 && (c2 = Blink.field290.field_1724.method_6079()).method_57353().method_57832(class_9334.field_50075)) {
            return;
        }
        e2.method10();
    ...
    private static Queue method4981(Blink class376) {
        return Blink.method4957(class376);
    }
    ...
    public static Queue method4985(Blink class376) {
        return class376.field1243;
    }

    public static Blink method4986() {
        return Blink.method4963();
    }

    public static boolean method4987() {
        if (Blink.method4960().method1265() && ((Boolean)Blink.method4986().field1252.method507()).booleanValue()) {
    ...
    public static Class1468 method4990(Blink class376) {
        return class376.field1247;
    }
    ...
    public void method1279() {
        if (Blink.field290.field_1724 == null) {
            return;
        }
        int n2 = !Blink.method4995(this).isEmpty() ? 22321 : 22322;
        block4: while (true) {
            switch (n2) {
                case 22322: {
                    n2 = 22320;
        ...
        if (this.field1247 != null) {
            Blink.method4990(this).method_5826(UUID.fromString("8667ba71-b85a-4004-af54-457a9734eed7"));
    ...
    public static void method4992(Blink class376, boolean bl2) {
        class376.field1245 = bl2;
    }
    ...
    private static Queue method4995(Blink class376) {
        return Blink.method4965(class376);
    }
