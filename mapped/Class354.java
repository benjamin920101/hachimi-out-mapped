...
extends Class278 {
    ...
    public void method4300(Class210 a2) {
        if (!((Boolean)Class354.method4301(this.field1067)).booleanValue()) {
            Class354.method4306(0.26249212f);
            return;
        }
        int n2 = 57449;
        block4: while (true) {
            switch (n2) {
                ...
                case 57449: {
                    if (!Class354.field290.field_1724.method_24828()) {
                        int n3 = 20392;
    ...
    private static int method4308(class_1703 class_17032) {
        return Class354.method4305(class_17032);
    }

    private static class_1304 method4309() {
        return Class354.method4302();
    }
    ...
    private static void method4311(long l2) {
        Class354.field1066[1] = l2 ^ 0xAF6601394D1B85F6L;
        Class354.field1066[2] = l2 ^ 0xAF6601394D1B85F7L;
        Class354.field1066[0] = l2 ^ 0xAF6601394D1B85F1L;
    }
    ...
    static {
        Class354.method4311(-5807953323829262864L);
    }
