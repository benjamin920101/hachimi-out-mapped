...
extends Class414 {
    ...
    private boolean method8995(class_2338 a2) {
        Class3442 b2 = new Class3442(a2, (List)this.field2059.method507(), (boolean)((Boolean)Blocker.method9020(this.field2070)), (Class607)((Object)this.field2069.method507()));
        return b2.method17369((Double)Blocker.method9069(this.field2062), (Boolean)this.field2073.method507(), (Boolean)this.field2072.method507(), (Double)Blocker.method9035(this).method507());
    }

    public static Class248 method8996(Blocker class433) {
    ...
    private void method8998() {
        Blocker.method9068(this);
        List n2 = Class5659.method22141(Blocker.field290.field_1724.method_19538());
        Iterator iterator = n2.iterator();
        block28: while (true) {
            if (!iterator.hasNext()) {
                this.method9066();
                this.field2067 = this.field2067 > 0 ? Blocker.method9000(this) - (int)field2064[1] : (Integer)Blocker.method9015(this.field2066);
                return;
            }
                    ...
                    switch (n5) {
                        ...
                        case 53534: {
                            ...
                            if (((Boolean)this.field2065.method507()).booleanValue()) {
                                int n10 = Blocker.field290.field_1687.method_8320(h2).method_45474() ? 27760 : 27761;
                                block34: while (true) {
                                    switch (n10) {
                                        case 27761: {
                                            n10 = 27759;
                            ...
                            if (n2.contains(h2) || Blocker.method9018(this, h2)) break block30;
    ...
    public static int method9000(Blocker class433) {
    ...
    public static Class248 method9010(Blocker class433) {
        return class433.field2051;
    }

    private boolean method9011(class_2338 a2) {
        return Blocker.field290.field_1687.method_8320(a2).method_27852(Blocker.method9026());
    }

    private static Surround method9012() {
        return Surround.method6779();
    }
    ...
    private static void method9016(Blocker class433, class_2338 class_23382) {
    ...
    private static boolean method9018(Blocker class433, class_2338 class_23382) {
    ...
    private static class_2248 method9026() {
        return Blocker.method9022();
    }

    private boolean method9027() {
        return (Blocker.method9012().method1265() || SelfTrap.method8968().method1265() ? (int)field2064[1] : (int)field2064[0]) != 0;
    }
    ...
    private static int method9033(int n2, int n3, FastPlace class386, Class691 class691) {
    ...
    public static Class248 method9035(Blocker class433) {
    ...
    public Blocker() {
        ...
        class_2248Array[(int)Blocker.field2064[0]] = class_2246.field_10540;
        class_2248Array[(int)Blocker.field2064[1]] = class_2246.field_10443;
    ...
    public void method9040(Class210 d2) {
        Iterator iterator;
        block22: {
            if (Blocker.field290.field_1724 == null) return;
            if (Blocker.method8994(field290) == null) {
                return;
            }
            this.method8998();
            if (((Boolean)this.field1536.method507()).booleanValue()) {
                Blocker.method9001(0.9450699f, 0.07982212f, 0.59128845f, 0.9490435f, 0.11744833f, 0.44879562f);
                return;
            }
            if (this.method6626()) {
                return;
            ...
            Blocker.method9053(this.field2055);
            this.field2071 = (int)field2064[0];
            ...
            if (Blocker.method9032().isEmpty()) return;
            ...
            block11: while (true) {
                switch (n3) {
                    ...
                    case 47790: {
                        ...
                        if (this.field2071 >= (Integer)Blocker.method9067(this).method507()) {
                            int n4 = 1900;
    ...
    private static void method9043(Blocker class433, class_2338 class_23382) {
    ...
    private static void method9046(long l2) {
        Blocker.field2064[2] = l2 ^ 0x3542DD67B8D14208L;
        Blocker.field2064[3] = l2 ^ 0x3542DD67B8D1421EL;
        Blocker.field2064[1] = l2 ^ 0x3542DD67B8D1421DL;
        Blocker.field2064[5] = l2 ^ 0x3542DD67B8D1421FL;
        Blocker.field2064[0] = l2 ^ 0x3542DD67B8D1421CL;
        Blocker.field2064[4] = l2 ^ 0x3542DD67B8D14214L;
    }
    ...
    private static int method9049(int n2, int n3, Class1610 class1610, ESP class360) {
    ...
    private void method9050(class_2338 a2) {
        class_2680 b2 = Blocker.field290.field_1687.method_8320(a2);
        ...
        class_2350 c2 = Class1745.method15668(a2, (Double)Blocker.method9048(this.field2062));
        if (c2 != null) {
            return;
        }
    ...
    private void method9051(class_2338 a2) {
        ...
        block4: while (true) {
            switch (n2) {
                ...
                case 14673: {
                    Blocker.method9063().add(a2);
                    if (!this.method9006()) return;
                    Blocker.method9016(this, a2);
                    return;
                }
            }
            break;
    ...
    private class_1511 method9059(class_2338 a2) {
        return Blocker.field290.field_1687.method_8335(null, new class_238(a2)).stream().filter(Blocker::method9014).min(Comparator.comparingDouble(Blocker::method9061)).orElse(null);
    }
    ...
    private static double method9061(class_1297 a2) {
        return Blocker.method9058(field290).method_5739(a2);
    }
    ...
    private void method9066() {
        ...
        if (((Boolean)Blocker.method8996(this).method507()).booleanValue()) {
            ...
            b2.ifPresent(Blocker::method9065);
        }
    }

    public static Class248 method9067(Blocker class433) {
        return class433.field2058;
    }

    private static void method9068(Blocker class433) {
        class433.method9013();
    }
    ...
    static {
        ___.___(15, Blocker.class);
        ____.___15_1250(Blocker.class);
    }

    private Boolean method1269() {
        return ((Integer)Blocker.method9010(this).method507() > 0 ? (int)field2064[1] : (int)field2064[0]) != 0;
    }
