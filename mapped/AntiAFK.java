...
extends Class411 {
    ...
    public void method9653(Class210 b2) {
        class_304[] class_304Array = AntiAFK.method9665((class_310)AntiAFK.field290).field_1839;
        ...
        if (this.field2227.method12595(Float.valueOf(((Float)this.field2226.method507()).floatValue() * 1000.0f)) && AntiAFK.method9667(this).method12595((Number)this.field2221.method507())) {
            if (((Boolean)this.field2229.method507()).booleanValue() && AntiAFK.method9669(field290).method_24828()) {
                AntiAFK.field290.field_1724.method_6043();
            }
            if (((Boolean)this.field2225.method507()).booleanValue()) {
                this.method6468(AntiAFK.field290.field_1724.method_36454() + field289.nextFloat(90.0f) * (field289.nextBoolean() ? 1.0f : -1.0f), AntiAFK.field290.field_1724.method_36455() + field289.nextFloat(90.0f) * (field289.nextBoolean() ? 1.0f : Class5542.field10486));
            }
    ...
    private static void method9662(long l2) {
        AntiAFK.field2219[0] = l2 ^ 0xDAEB2433AA16F28DL;
        AntiAFK.field2219[1] = l2 ^ 0xDAEB2433AA16F28CL;
    }
    ...
    static {
        AntiAFK.method9655(-2672002149598694772L);
    }
        ...
        block4: while (true) {
            switch (n2) {
                ...
                case 28771: {
                    ...
                    Class1365.method13926("r [Hachimi] " + (String)AntiAFK.method9661(this.field2220));
                    return;
                }
            }
            break;
    ...
    public static Class925 method9667(AntiAFK class443) {
