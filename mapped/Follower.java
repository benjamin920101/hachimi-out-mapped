...
extends Class414 {
    ...
    private static boolean method8223(Rotations class456) {
    ...
    public void method8224(Class210 b2) {
        ...
        if (((Boolean)this.field1841.method507()).booleanValue() && !Follower.method8238(Follower.method8230())) {
            return;
        }
        ...
        if (Follower.method8237(Rotations.method10602())) {
            float[] a2 = Class1503.method14416(Follower.field290.field_1724.method_33571(), ((class_1297)this.field1842.getFirst()).method_33571());
    ...
    public boolean method8226() {
        int n2;
        if (this.method1265() && !Follower.method8233(this).isEmpty()) {
            n2 = (int)field1839[2];
            return n2 != 0;
        }
        n2 = (int)field1839[1];
    ...
    public void method8227(Class69 a2) {
        if (!Class3979.method19539()) {
            Follower.method8242(-1033638430, -1691740758, 1921735346, -1906427349);
            return;
        }
        if (BaritoneAPI.getProvider().getPrimaryBaritone().getPathingBehavior().isPathing()) {
            return;
        }
        if (Follower.method8223(Rotations.method10602()) && !this.field1842.isEmpty()) {
            Follower.method8235(Follower.field290.field_1724.field_3913, 1.0f);
            Follower.field290.field_1724.field_3913.field_3907 = 0.0f;
        }
    }
    ...
    private static ElytraFly method8230() {
        return ElytraFly.method9765();
    }
    ...
    private static void method8232(long l2) {
        Follower.method8236(l2);
    }

    public static List method8233(Follower class423) {
    ...
    private static void method8236(long l2) {
        Follower.field1839[0] = l2 ^ 0x18490E7DF63F6CDEL;
        Follower.field1839[2] = l2 ^ 0x18490E7DF63F637FL;
        Follower.field1839[1] = l2 ^ 0x18490E7DF63F637EL;
    }

    private static boolean method8237(Rotations class456) {
        return class456.method10607();
    }

    private static boolean method8238(ElytraFly class444) {
        return class444.method9866();
    }

    static {
        field1839 = new long[3];
        Follower.method8232(1749945864375198590L);
    }
    ...
    private boolean method8243(class_1297 b2) {
        if (b2.equals((Object)Follower.field290.field_1724)) {
            return Class3979.method19551();
        }
        if (b2.equals((Object)Follower.field290.field_1719)) {
    ...
    public static Class248 method8245(Follower class423) {
        return class423.field1840;
    }

    public static Follower method8246() {
        return INSTANCE;
    }
