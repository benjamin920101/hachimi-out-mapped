...
extends Class278 {
    ...
    HashMap field816;
    private static PlaceEcho INSTANCE;
    Class248 field817;
    Class248 field818;
    Class248 field819;
    Class248 field820;
    ...
    static {
        PlaceEcho.method2921(176924078269811815L);
    }

    private static HashMap method2906(PlaceEcho class331) {
        return PlaceEcho.method2911(class331);
    }
    ...
    public static PlaceEcho method2909() {
        return INSTANCE;
    }
    ...
    public static HashMap method2911(PlaceEcho class331) {
    ...
    public void method2912(Class59 a2) {
        if (!PlaceEcho.method2915(this).isEmpty()) {
            int n2 = 45880;
        ...
        this.field816.values().removeIf(arg_0 -> PlaceEcho.method2914(a2, arg_0));
    ...
    private Boolean method1269() {
        return ((Boolean)PlaceEcho.method2910(this.field823) == false ? (int)field815[4] : (int)field815[1]) != 0;
    }
    ...
    public static HashMap method2915(PlaceEcho class331) {
        return class331.field816;
    }
    ...
    private static void method2921(long l2) {
        PlaceEcho.field815[5] = l2 ^ 0x2748F83057C4C9DL;
        PlaceEcho.field815[6] = l2 ^ 0x2748F83057C4D93L;
        PlaceEcho.field815[4] = l2 ^ 0x2748F83057C4C66L;
        PlaceEcho.field815[1] = l2 ^ 0x2748F83057C4C67L;
        PlaceEcho.field815[7] = l2 ^ 0x2748F83057C4C03L;
        PlaceEcho.field815[0] = l2 ^ 0x2748F83057C4CC7L;
        PlaceEcho.field815[3] = l2 ^ 0x2748F83057C47DFL;
        PlaceEcho.field815[2] = l2 ^ 0x2748F83057C4C98L;
    }
