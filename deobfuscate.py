...
def save_mappings_to_file(mappings, filename='mappings_1.21.1.txt'):
    """保存映射到文本文件"""
    print(f"正在保存映射到 {filename}...")
    
    with open(filename, 'w', encoding='utf-8') as f:
        f.write("# Minecraft 1.21.1 Yarn Mappings\n")
...
def main():
    ...
    if user_input.lower() == 'y':
        ...
        print("  2. 查看 mappings_1.21.1.txt 文件中的映射")
        print("  3. 重新運行腳本")
